...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:qi,depthTest:!1,depthWrite:!1})}function Jg(){return new Zi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Rh(),fragmentShader:`
		...
		`,blending:qi,depthTest:!1,depthWrite:!1})}function Qg(){return new Zi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Rh(),fragmentShader:`
	...
	`}function v1(r){let e=new WeakMap,t=null;function o(d){if(d&&d.isTexture){const f=d.mapping,p=f===Cf||f===Rf,m=f===Ms||f===ws;if(p||m){let v=e.get(d);const y=v!==void 0?v.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==y)return t===null&&(t=new Kg(r)),v=p?t.fromEquirectangular(d,v):t.fromCubemap(d,v),v.texture.pmremVersion=d.pmremVersion,e.set(d,v),v.texture;if(v!==void 0)return v.texture;{const S=d.image;return p&&S&&S.height>0||m&&S&&s(S)?(t===null&&(t=new Kg(r)),v=p?t.fromEquirectangular(d):t.fromCubemap(d),v.texture.pmremVersion=d.pmremVersion,e.set(d,v),d.addEventListener("dispose",l),v.texture):null}}}return d}function s(d){let f=0;const p=6;for(let m=0;m<p;m++)d[m]!==void 0&&f++;return f===p}function l(d){const f=d.target;f.removeEventListener("dispose",l);const p=e.get(f);p!==void 0&&(e.delete(f),p.dispose())}function c(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:o,dispose:c}}function _1(r){const e={};function t(o){if(e[o]!==void 0)return e[o];let s;switch(o){case"WEBGL_depth_texture":s=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=r.getExtension(o)}return e[o]=s,s}return{has:function(o){return t(o)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(o){const s=t(o);return s===null&&ys("THREE.WebGLRenderer: "+o+" extension not supported."),s}}}function x1(r,e,t,o){const s={},l=new WeakMap;function c(v){const y=v.target;y.index!==null&&e.remove(y.index);for(const E in y.attributes)e.remove(y.attributes[E]);y.removeEventListener("dispose",c),delete s[y.id];const S=l.get(y);S&&(e.remove(S),l.delete(y)),o.releaseStatesOfGeometry(y),y.isInstancedBufferGeometry===!0&&delete y._maxInstanceCount,t.memory.geometries--}function d(v,y){return s[y.id]===!0||(y.addEventListener("dispose",c),s[y.id]=!0,t.memory.geometries++),y}function f(v){const y=v.attributes;for(const S in y)e.update(y[S],r.ARRAY_BUFFER)}function p(v){const y=[],S=v.index,E=v.attributes.position;let M=0;if(S!==null){const L=S.array;M=S.version;for(let P=0,A=L.length;P<A;P+=3){const G=L[P+0],I=L[P+1],k=L[P+2];y.push(G,I,I,k,k,G)}}else if(E!==void 0){const L=E.array;M=E.version;for(let P=0,A=L.length/3-1;P<A;P+=3){const G=P+0,I=P+1,k=P+2;y.push(G,I,I,k,k,G)}}else return;const x=new(C_(y)?L_:P_)(y,1);x.version=M;const _=l.get(v);_&&e.remove(_),l.set(v,x)}function m(v){const y=l.get(v);if(y){const S=v.index;S!==null&&y.version<S.version&&p(v)}else p(v);return l.get(v)}return{get:d,update:f,getWireframeAttribute:m}}function y1(r,e,t){let o;function s(y){o=y}let l,c;function d(y){l=y.type,c=y.bytesPerElement}function f(y,S){r.drawElements(o,S,l,y*c),t.update(S,o,1)}function p(y,S,E){E!==0&&(r.drawElementsInstanced(o,S,l,y*c,E),t.update(S,o,E))}function m(y,S,E){if(E===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(o,S,0,l,y,0,E);let x=0;for(let _=0;_<E;_++)x+=S[_];t.update(x,o,1)}function v(y,S,E,M){if(E===0)return;const x=e.get("WEBGL_multi_draw");if(x===null)for(let _=0;_<y.length;_++)p(y[_]/c,S[_],M[_]);else{x.multiDrawElementsInstancedWEBGL(o,S,0,l,y,0,M,0,E);let _=0;for(let L=0;L<E;L++)_+=S[L]*M[L];t.update(_,o,1)}}this.setMode=s,this.setIndex=d,this.render=f,this.renderInstances=p,this.renderMultiDraw=m,this.renderMultiDrawInstances=v}function S1(r){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function o(l,c,d){switch(t.calls++,c){case r.TRIANGLES:t.triangles+=d*(l/3);break;case r.LINES:t.lines+=d*(l/2);break;case r.LINE_STRIP:t.lines+=d*(l-1);break;case r.LINE_LOOP:t.lines+=d*l;break;case r.POINTS:t.points+=d*l;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",c);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:o}}function E1(r,e,t){const o=new WeakMap,s=new Jt;function l(c,d,f){const p=c.morphTargetInfluences,m=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,v=m!==void 0?m.length:0;let y=o.get(d);if(y===void 0||y.count!==v){let b=function(){k.dispose(),o.delete(d),d.removeEventListener("dispose",b)};y!==void 0&&y.texture.dispose();const S=d.morphAttributes.position!==void 0,E=d.morphAttributes.normal!==void 0,M=d.morphAttributes.color!==void 0,x=d.morphAttributes.position||[],_=d.morphAttributes.normal||[],L=d.morphAttributes.color||[];let P=0;S===!0&&(P=1),E===!0&&(P=2),M===!0&&(P=3);let A=d.attributes.position.count*P,G=1;A>e.maxTextureSize&&(G=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const I=new Float32Array(A*G*4*v),k=new R_(I,A,G,v);k.type=hi,k.needsUpdate=!0;const X=P*4;for(let C=0;C<v;C++){const V=x[C],ae=_[C],J=L[C],ee=A*G*4*C;for(let fe=0;fe<V.count;fe++){const ue=fe*X;S===!0&&(s.fromBufferAttribute(V,fe),I[ee+ue+0]=s.x,I[ee+ue+1]=s.y,I[ee+ue+2]=s.z,I[ee+ue+3]=0),E===!0&&(s.fromBufferAttribute(ae,fe),I[ee+ue+4]=s.x,I[ee+ue+5]=s.y,I[ee+ue+6]=s.z,I[ee+ue+7]=0),M===!0&&(s.fromBufferAttribute(J,fe),I[ee+ue+8]=s.x,I[ee+ue+9]=s.y,I[ee+ue+10]=s.z,I[ee+ue+11]=J.itemSize===4?s.w:1)}}y={count:v,texture:k,size:new Dt(A,G)},o.set(d,y),d.addEventListener("dispose",b)}if(c.isInstancedMesh===!0&&c.morphTexture!==null)f.getUniforms().setValue(r,"morphTexture",c.morphTexture,t);else{let S=0;for(let M=0;M<p.length;M++)S+=p[M];const E=d.morphTargetsRelative?1:1-S;f.getUniforms().setValue(r,"morphTargetBaseInfluence",E),f.getUniforms().setValue(r,"morphTargetInfluences",p)}f.getUniforms().setValue(r,"morphTargetsTexture",y.texture,t),f.getUniforms().setValue(r,"morphTargetsTextureSize",y.size)}return{update:l}}function M1(r,e,t,o){let s=new WeakMap;function l(f){const p=o.render.frame,m=f.geometry,v=e.get(f,m);if(s.get(v)!==p&&(e.update(v),s.set(v,p)),f.isInstancedMesh&&(f.hasEventListener("dispose",d)===!1&&f.addEventListener("dispose",d),s.get(f)!==p&&(t.update(f.instanceMatrix,r.ARRAY_BUFFER),f.instanceColor!==null&&t.update(f.instanceColor,r.ARRAY_BUFFER),s.set(f,p))),f.isSkinnedMesh){const y=f.skeleton;s.get(y)!==p&&(y.update(),s.set(y,p))}return v}function c(){s=new WeakMap}function d(f){const p=f.target;p.removeEventListener("dispose",d),t.remove(p.instanceMatrix),p.instanceColor!==null&&t.remove(p.instanceColor)}return{update:l,dispose:c}}const O_=new zn,ev=new I_(1,1),B_=new R_,z_=new XE,H_=new U_,tv=[],nv=[],rv=new Float32Array(16),iv=new Float32Array(9),ov=new Float32Array(4);function Ns(r,e,t){const o=r[0];if(o<=0||o>0)return r;const s=e*t;let l=tv[s];if(l===void 0&&(l=new Float32Array(s),tv[s]=l),e!==0){o.toArray(l,0);for(let c=1,d=0;c!==e;++c)d+=t,r[c].toArray(l,d)}return l}function an(r,e){if(r.length!==e.length)return!1;for(let t=0,o=r.length;t<o;t++)if(r[t]!==e[t])return!1;return!0}function ln(r,e){for(let t=0,o=e.length;t<o;t++)r[t]=e[t]}function Hu(r,e){let t=nv[e];t===void 0&&(t=new Int32Array(e),nv[e]=t);for(let o=0;o!==e;++o)t[o]=r.allocateTextureUnit();return t}function w1(r,e){const t=this.cache;t[0]!==e&&(r.uniform1f(this.addr,e),t[0]=e)}function T1(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(an(t,e))return;r.uniform2fv(this.addr,e),ln(t,e)}}function C1(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(r.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(an(t,e))return;r.uniform3fv(this.addr,e),ln(t,e)}}function R1(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(an(t,e))return;r.uniform4fv(this.addr,e),ln(t,e)}}function A1(r,e){const t=this.cache,o=e.elements;if(o===void 0){if(an(t,e))return;r.uniformMatrix2fv(this.addr,!1,e),ln(t,e)}else{if(an(t,o))return;ov.set(o),r.uniformMatrix2fv(this.addr,!1,ov),ln(t,o)}}function b1(r,e){const t=this.cache,o=e.elements;if(o===void 0){if(an(t,e))return;r.uniformMatrix3fv(this.addr,!1,e),ln(t,e)}else{if(an(t,o))return;iv.set(o),r.uniformMatrix3fv(this.addr,!1,iv),ln(t,o)}}function P1(r,e){const t=this.cache,o=e.elements;if(o===void 0){if(an(t,e))return;r.uniformMatrix4fv(this.addr,!1,e),ln(t,e)}else{if(an(t,o))return;rv.set(o),r.uniformMatrix4fv(this.addr,!1,rv),ln(t,o)}}function L1(r,e){const t=this.cache;t[0]!==e&&(r.uniform1i(this.addr,e),t[0]=e)}function D1(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(an(t,e))return;r.uniform2iv(this.addr,e),ln(t,e)}}function N1(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(an(t,e))return;r.uniform3iv(this.addr,e),ln(t,e)}}function U1(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(an(t,e))return;r.uniform4iv(this.addr,e),ln(t,e)}}function I1(r,e){const t=this.cache;t[0]!==e&&(r.uniform1ui(this.addr,e),t[0]=e)}function F1(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(an(t,e))return;r.uniform2uiv(this.addr,e),ln(t,e)}}function k1(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(an(t,e))return;r.uniform3uiv(this.addr,e),ln(t,e)}}function O1(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(an(t,e))return;r.uniform4uiv(this.addr,e),ln(t,e)}}function B1(r,e,t){const o=this.cache,s=t.allocateTextureUnit();o[0]!==s&&(r.uniform1i(this.addr,s),o[0]=s);let l;this.type===r.SAMPLER_2D_SHADOW?(ev.compareFunction=T_,l=ev):l=O_,t.setTexture2D(e||l,s)}function z1(r,e,t){const o=this.cache,s=t.allocateTextureUnit();o[0]!==s&&(r.uniform1i(this.addr,s),o[0]=s),t.setTexture3D(e||z_,s)}function H1(r,e,t){const o=this.cache,s=t.allocateTextureUnit();o[0]!==s&&(r.uniform1i(this.addr,s),o[0]=s),t.setTextureCube(e||H_,s)}function V1(r,e,t){const o=this.cache,s=t.allocateTextureUnit();o[0]!==s&&(r.uniform1i(this.addr,s),o[0]=s),t.setTexture2DArray(e||B_,s)}function G1(r){switch(r){case 5126:return w1;case 35664:return T1;case 35665:return C1;case 35666:return R1;case 35674:return A1;case 35675:return b1;case 35676:return P1;case 5124:case 35670:return L1;case 35667:case 35671:return D1;case 35668:case 35672:return N1;case 35669:case 35673:return U1;case 5125:return I1;case 36294:return F1;case 36295:return k1;case 36296:return O1;case 35678:case 36198:case 36298:case 36306:case 35682:return B1;case 35679:case 36299:case 36307:return z1;case 35680:case 36300:case 36308:case 36293:return H1;case 36289:case 36303:case 36311:case 36292:return V1}}function W1(r,e){r.uniform1fv(this.addr,e)}function X1(r,e){const t=Ns(e,this.size,2);r.uniform2fv(this.addr,t)}function j1(r,e){const t=Ns(e,this.size,3);r.uniform3fv(this.addr,t)}function $1(r,e){const t=Ns(e,this.size,4);r.uniform4fv(this.addr,t)}function Y1(r,e){const t=Ns(e,this.size,4);r.uniformMatrix2fv(this.addr,!1,t)}function q1(r,e){const t=Ns(e,this.size,9);r.uniformMatrix3fv(this.addr,!1,t)}function K1(r,e){const t=Ns(e,this.size,16);r.uniformMatrix4fv(this.addr,!1,t)}function Z1(r,e){r.uniform1iv(this.addr,e)}function J1(r,e){r.uniform2iv(this.addr,e)}function Q1(r,e){r.uniform3iv(this.addr,e)}function eC(r,e){r.uniform4iv(this.addr,e)}function tC(r,e){r.uniform1uiv(this.addr,e)}function nC(r,e){r.uniform2uiv(this.addr,e)}function rC(r,e){r.uniform3uiv(this.addr,e)}function iC(r,e){r.uniform4uiv(this.addr,e)}function oC(r,e,t){const o=this.cache,s=e.length,l=Hu(t,s);an(o,l)||(r.uniform1iv(this.addr,l),ln(o,l));for(let c=0;c!==s;++c)t.setTexture2D(e[c]||O_,l[c])}function sC(r,e,t){const o=this.cache,s=e.length,l=Hu(t,s);an(o,l)||(r.uniform1iv(this.addr,l),ln(o,l));for(let c=0;c!==s;++c)t.setTexture3D(e[c]||z_,l[c])}function aC(r,e,t){const o=this.cache,s=e.length,l=Hu(t,s);an(o,l)||(r.uniform1iv(this.addr,l),ln(o,l));for(let c=0;c!==s;++c)t.setTextureCube(e[c]||H_,l[c])}function lC(r,e,t){const o=this.cache,s=e.length,l=Hu(t,s);an(o,l)||(r.uniform1iv(this.addr,l),ln(o,l));for(let c=0;c!==s;++c)t.setTexture2DArray(e[c]||B_,l[c])}function uC(r){switch(r){case 5126:return W1;case 35664:return X1;case 35665:return j1;case 35666:return $1;case 35674:return Y1;case 35675:return q1;case 35676:return K1;case 5124:case 35670:return Z1;case 35667:case 35671:return J1;case 35668:case 35672:return Q1;case 35669:case 35673:return eC;case 5125:return tC;case 36294:return nC;case 36295:return rC;case 36296:return iC;case 35678:case 36198:case 36298:case 36306:case 35682:return oC;case 35679:case 36299:case 36307:return sC;case 35680:case 36300:case 36308:case 36293:return aC;case 36289:case 36303:case 36311:case 36292:return lC}}class cC{constructor(e,t,o){this.id=e,this.addr=o,this.cache=[],this.type=t.type,this.setValue=G1(t.type)}}class dC{constructor(e,t,o){this.id=e,this.addr=o,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=uC(t.type)}}class fC{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,o){const s=this.seq;for(let l=0,c=s.length;l!==c;++l){const d=s[l];d.setValue(e,t[d.id],o)}}}const sf=/(\w+)(\])?(\[|\.)?/g;function sv(r,e){r.seq.push(e),r.map[e.id]=e}function hC(r,e,t){const o=r.name,s=o.length;for(sf.lastIndex=0;;){const l=sf.exec(o),c=sf.lastIndex;let d=l[1];const f=l[2]==="]",p=l[3];if(f&&(d=d|0),p===void 0||p==="["&&c+2===s){sv(t,p===void 0?new cC(d,r,e):new dC(d,r,e));break}else{let v=t.map[d];v===void 0&&(v=new fC(d),sv(t,v)),t=v}}}class Ru{constructor(e,t){this.seq=[],this.map={};const o=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<o;++s){const l=e.getActiveUniform(t,s),c=e.getUniformLocation(t,l.name);hC(l,c,this)}}setValue(e,t,o,s){const l=this.map[t];l!==void 0&&l.setValue(e,o,s)}setOptional(e,t,o){const s=t[o];s!==void 0&&this.setValue(e,o,s)}static upload(e,t,o,s){for(let l=0,c=t.length;l!==c;++l){const d=t[l],f=o[d.id];f.needsUpdate!==!1&&d.setValue(e,f.value,s)}}static seqWithValue(e,t){const o=[];for(let s=0,l=e.length;s!==l;++s){const c=e[s];c.id in t&&o.push(c)}return o}}function av(r,e,t){const o=r.createShader(e);return r.shaderSource(o,t),r.compileShader(o),o}const pC=37297;let mC=0;function gC(r,e){const t=r.split(`
`),o=[],s=Math.max(e-6,0),l=Math.min(e+6,t.length);for(let c=s;c<l;c++){const d=c+1;o.push(`${d===e?">":" "} ${d}: ${t[c]}`)}return o.join(`
`)}const lv=new gt;function vC(r){Pt._getMatrix(lv,Pt.workingColorSpace,r);const e=`mat3( ${lv.elements.map(t=>t.toFixed(4))} )`;switch(Pt.getTransfer(r)){case Du:return[e,"LinearTransferOETF"];case Ft:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",r),[e,"LinearTransferOETF"]}}function uv(r,e,t){const o=r.getShaderParameter(e,r.COMPILE_STATUS),s=r.getShaderInfoLog(e).trim();if(o&&s==="")return"";const l=/ERROR: 0:(\d+)/.exec(s);if(l){const c=parseInt(l[1]);return t.toUpperCase()+`

`+s+`

`+gC(r.getShaderSource(e),c)}else return s}function _C(r,e){const t=vC(e);return[`vec4 ${r}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function xC(r,e){let t;switch(e){case tE:t="Linear";break;case nE:t="Reinhard";break;case rE:t="Cineon";break;case iE:t="ACESFilmic";break;case sE:t="AgX";break;case aE:t="Neutral";break;case oE:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const pu=new re;function yC(){Pt.getLuminanceCoefficients(pu);const r=pu.x.toFixed(4),e=pu.y.toFixed(4),t=pu.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function SC(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ma).join(`
`)}function EC(r){const e=[];for(const t in r){const o=r[t];o!==!1&&e.push("#define "+t+" "+o)}return e.join(`
`)}function MC(r,e){const t={},o=r.getProgramParameter(e,r.ACTIVE_ATTRIBUTES);for(let s=0;s<o;s++){const l=r.getActiveAttrib(e,s),c=l.name;let d=1;l.type===r.FLOAT_MAT2&&(d=2),l.type===r.FLOAT_MAT3&&(d=3),l.type===r.FLOAT_MAT4&&(d=4),t[c]={type:l.type,location:r.getAttribLocation(e,c),locationSize:d}}return t}function Ma(r){return r!==""}function cv(r,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function dv(r,e){return r.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const wC=/^[ \t]*#include +<([\w\d./]+)>/gm;function th(r){return r.replace(wC,CC)}const TC=new Map;function CC(r,e){let t=_t[e];if(t===void 0){const o=TC.get(e);if(o!==void 0)t=_t[o],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,o);else throw new Error("Can not resolve #include <"+e+">")}return th(t)}const RC=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function fv(r){return r.replace(RC,AC)}function AC(r,e,t,o){let s="";for(let l=parseInt(e);l<parseInt(t);l++)s+=o.replace(/\[\s*i\s*\]/g,"[ "+l+" ]").replace(/UNROLLED_LOOP_INDEX/g,l);return s}function hv(r){let e=`precision ${r.precision} float;
...
#define LOW_PRECISION`),e}function bC(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===p_?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===US?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===ci&&(e="SHADOWMAP_TYPE_VSM"),e}function PC(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Ms:case ws:e="ENVMAP_TYPE_CUBE";break;case Ou:e="ENVMAP_TYPE_CUBE_UV";break}return e}function LC(r){let e="ENVMAP_MODE_REFLECTION";return r.envMap&&r.envMapMode===ws&&(e="ENVMAP_MODE_REFRACTION"),e}function DC(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case m_:e="ENVMAP_BLENDING_MULTIPLY";break;case QS:e="ENVMAP_BLENDING_MIX";break;case eE:e="ENVMAP_BLENDING_ADD";break}return e}function NC(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,o=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:o,maxMip:t}}function UC(r,e,t,o){const s=r.getContext(),l=t.defines;let c=t.vertexShader,d=t.fragmentShader;const f=bC(t),p=PC(t),m=LC(t),v=DC(t),y=NC(t),S=SC(t),E=EC(l),M=s.createProgram();let x,_,L=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+_);const P=L+x+c,A=L+_+d,G=av(s,s.VERTEX_SHADER,P),I=av(s,s.FRAGMENT_SHADER,A);s.attachShader(M,G),s.attachShader(M,I),t.index0AttributeName!==void 0?s.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function k(V){if(r.debug.checkShaderErrors){const ae=s.getProgramInfoLog(M).trim(),J=s.getShaderInfoLog(G).trim(),ee=s.getShaderInfoLog(I).trim();let fe=!0,ue=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(fe=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(s,M,G,I);else{const he=uv(s,G,"vertex"),z=uv(s,I,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
...
}`;class rR{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,o){if(this.texture===null){const s=new zn,l=e.properties.get(s);l.__webglTexture=t.texture,(t.depthNear!==o.depthNear||t.depthFar!==o.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=s}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,o=new Zi({vertexShader:tR,fragmentShader:nR,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Gr(new zu(20,20),o)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class iR extends Ps{constructor(e,t){super();const o=this;let s=null,l=1,c=null,d="local-floor",f=1,p=null,m=null,v=null,y=null,S=null,E=null;const M=new rR,x=t.getContextAttributes();let _=null,L=null;const P=[],A=[],G=new Dt;let I=null;const k=new hr;k.viewport=new Jt;const X=new hr;X.viewport=new Jt;const b=[k,X],C=new TM;let V=null,ae=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(ne){let me=P[ne];return me===void 0&&(me=new Kd,P[ne]=me),me.getTargetRaySpace()},this.getControllerGrip=function(ne){let me=P[ne];return me===void 0&&(me=new Kd,P[ne]=me),me.getGripSpace()},this.getHand=function(ne){let me=P[ne];return me===void 0&&(me=new Kd,P[ne]=me),me.getHandSpace()};function J(ne){const me=A.indexOf(ne.inputSource);if(me===-1)return;const Ce=P[me];Ce!==void 0&&(Ce.update(ne.inputSource,ne.frame,p||c),Ce.dispatchEvent({type:ne.type,data:ne.inputSource}))}function ee(){s.removeEventListener("select",J),s.removeEventListener("selectstart",J),s.removeEventListener("selectend",J),s.removeEventListener("squeeze",J),s.removeEventListener("squeezestart",J),s.removeEventListener("squeezeend",J),s.removeEventListener("end",ee),s.removeEventListener("inputsourceschange",fe);for(let ne=0;ne<P.length;ne++){const me=A[ne];me!==null&&(A[ne]=null,P[ne].disconnect(me))}V=null,ae=null,M.reset(),e.setRenderTarget(_),S=null,y=null,v=null,s=null,L=null,Oe.stop(),o.isPresenting=!1,e.setPixelRatio(I),e.setSize(G.width,G.height,!1),o.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(ne){l=ne,o.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(ne){d=ne,o.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||c},this.setReferenceSpace=function(ne){p=ne},this.getBaseLayer=function(){return y!==null?y:S},this.getBinding=function(){return v},this.getFrame=function(){return E},this.getSession=function(){return s},this.setSession=async function(ne){if(s=ne,s!==null){if(_=e.getRenderTarget(),s.addEventListener("select",J),s.addEventListener("selectstart",J),s.addEventListener("selectend",J),s.addEventListener("squeeze",J),s.addEventListener("squeezestart",J),s.addEventListener("squeezeend",J),s.addEventListener("end",ee),s.addEventListener("inputsourceschange",fe),x.xrCompatible!==!0&&await t.makeXRCompatible(),I=e.getPixelRatio(),e.getSize(G),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let Ce=null,Se=null,Ae=null;x.depth&&(Ae=x.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,Ce=x.stencil?Na:Da,Se=x.stencil?La:Ao);const K={colorFormat:t.RGBA8,depthFormat:Ae,scaleFactor:l};v=new XRWebGLBinding(s,t),y=v.createProjectionLayer(K),s.updateRenderState({layers:[y]}),e.setPixelRatio(1),e.setSize(y.textureWidth,y.textureHeight,!1),L=new bo(y.textureWidth,y.textureHeight,{format:Ar,type:Yr,depthTexture:new I_(y.textureWidth,y.textureHeight,Se,void 0,void 0,void 0,void 0,void 0,void 0,Ce),stencilBuffer:x.stencil,colorSpace:e.outputColorSpace,samples:x.antialias?4:0,resolveDepthBuffer:y.ignoreDepthValues===!1,resolveStencilBuffer:y.ignoreDepthValues===!1})}else{const Ce={antialias:x.antialias,alpha:!0,depth:x.depth,stencil:x.stencil,framebufferScaleFactor:l};S=new XRWebGLLayer(s,t,Ce),s.updateRenderState({baseLayer:S}),e.setPixelRatio(1),e.setSize(S.framebufferWidth,S.framebufferHeight,!1),L=new bo(S.framebufferWidth,S.framebufferHeight,{format:Ar,type:Yr,colorSpace:e.outputColorSpace,stencilBuffer:x.stencil,resolveDepthBuffer:S.ignoreDepthValues===!1,resolveStencilBuffer:S.ignoreDepthValues===!1})}L.isXRRenderTarget=!0,this.setFoveation(f),p=null,c=await s.requestReferenceSpace(d),Oe.setContext(s),Oe.start(),o.isPresenting=!0,o.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function fe(ne){for(let me=0;me<ne.removed.length;me++){const Ce=ne.removed[me],Se=A.indexOf(Ce);Se>=0&&(A[Se]=null,P[Se].disconnect(Ce))}for(let me=0;me<ne.added.length;me++){const Ce=ne.added[me];let Se=A.indexOf(Ce);if(Se===-1){for(let K=0;K<P.length;K++)if(K>=A.length){A.push(Ce),Se=K;break}else if(A[K]===null){A[K]=Ce,Se=K;break}if(Se===-1)break}const Ae=P[Se];Ae&&Ae.connect(Ce)}}const ue=new re,he=new re;function z(ne,me,Ce){ue.setFromMatrixPosition(me.matrixWorld),he.setFromMatrixPosition(Ce.matrixWorld);const Se=ue.distanceTo(he),Ae=me.projectionMatrix.elements,K=Ce.projectionMatrix.elements,Ee=Ae[14]/(Ae[10]-1),be=Ae[14]/(Ae[10]+1),ot=(Ae[9]+1)/Ae[5],Ze=(Ae[9]-1)/Ae[5],N=(Ae[8]-1)/Ae[0],mt=(K[8]+1)/K[0],pt=Ee*N,Mt=Ee*mt,Be=Se/(-N+mt),ht=Be*-N;if(me.matrixWorld.decompose(ne.position,ne.quaternion,ne.scale),ne.translateX(ht),ne.translateZ(Be),ne.matrixWorld.compose(ne.position,ne.quaternion,ne.scale),ne.matrixWorldInverse.copy(ne.matrixWorld).invert(),Ae[10]===-1)ne.projectionMatrix.copy(me.projectionMatrix),ne.projectionMatrixInverse.copy(me.projectionMatrixInverse);else{const et=Ee+Be,He=be+Be,Tt=pt-ht,D=Mt+(Se-ht),T=ot*be/He*et,Q=Ze*be/He*et;ne.projectionMatrix.makePerspective(Tt,D,T,Q,et,He),ne.projectionMatrixInverse.copy(ne.projectionMatrix).invert()}}function de(ne,me){me===null?ne.matrixWorld.copy(ne.matrix):ne.matrixWorld.multiplyMatrices(me.matrixWorld,ne.matrix),ne.matrixWorldInverse.copy(ne.matrixWorld).invert()}this.updateCamera=function(ne){if(s===null)return;let me=ne.near,Ce=ne.far;M.texture!==null&&(M.depthNear>0&&(me=M.depthNear),M.depthFar>0&&(Ce=M.depthFar)),C.near=X.near=k.near=me,C.far=X.far=k.far=Ce,(V!==C.near||ae!==C.far)&&(s.updateRenderState({depthNear:C.near,depthFar:C.far}),V=C.near,ae=C.far),k.layers.mask=ne.layers.mask|2,X.layers.mask=ne.layers.mask|4,C.layers.mask=k.layers.mask|X.layers.mask;const Se=ne.parent,Ae=C.cameras;de(C,Se);for(let K=0;K<Ae.length;K++)de(Ae[K],Se);Ae.length===2?z(C,k,X):C.projectionMatrix.copy(k.projectionMatrix),le(ne,C,Se)};function le(ne,me,Ce){Ce===null?ne.matrix.copy(me.matrixWorld):(ne.matrix.copy(Ce.matrixWorld),ne.matrix.invert(),ne.matrix.multiply(me.matrixWorld)),ne.matrix.decompose(ne.position,ne.quaternion,ne.scale),ne.updateMatrixWorld(!0),ne.projectionMatrix.copy(me.projectionMatrix),ne.projectionMatrixInverse.copy(me.projectionMatrixInverse),ne.isPerspectiveCamera&&(ne.fov=Ua*2*Math.atan(1/ne.projectionMatrix.elements[5]),ne.zoom=1)}this.getCamera=function(){return C},this.getFoveation=function(){if(!(y===null&&S===null))return f},this.setFoveation=function(ne){f=ne,y!==null&&(y.fixedFoveation=ne),S!==null&&S.fixedFoveation!==void 0&&(S.fixedFoveation=ne)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(C)};let F=null;function oe(ne,me){if(m=me.getViewerPose(p||c),E=me,m!==null){const Ce=m.views;S!==null&&(e.setRenderTargetFramebuffer(L,S.framebuffer),e.setRenderTarget(L));let Se=!1;Ce.length!==C.cameras.length&&(C.cameras.length=0,Se=!0);for(let Ee=0;Ee<Ce.length;Ee++){const be=Ce[Ee];let ot=null;if(S!==null)ot=S.getViewport(be);else{const N=v.getViewSubImage(y,be);ot=N.viewport,Ee===0&&(e.setRenderTargetTextures(L,N.colorTexture,N.depthStencilTexture),e.setRenderTarget(L))}let Ze=b[Ee];Ze===void 0&&(Ze=new hr,Ze.layers.enable(Ee),Ze.viewport=new Jt,b[Ee]=Ze),Ze.matrix.fromArray(be.transform.matrix),Ze.matrix.decompose(Ze.position,Ze.quaternion,Ze.scale),Ze.projectionMatrix.fromArray(be.projectionMatrix),Ze.projectionMatrixInverse.copy(Ze.projectionMatrix).invert(),Ze.viewport.set(ot.x,ot.y,ot.width,ot.height),Ee===0&&(C.matrix.copy(Ze.matrix),C.matrix.decompose(C.position,C.quaternion,C.scale)),Se===!0&&C.cameras.push(Ze)}const Ae=s.enabledFeatures;if(Ae&&Ae.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&v){const Ee=v.getDepthInformation(Ce[0]);Ee&&Ee.isValid&&Ee.texture&&M.init(e,Ee,s.renderState)}}for(let Ce=0;Ce<P.length;Ce++){const Se=A[Ce],Ae=P[Ce];Se!==null&&Ae!==void 0&&Ae.update(Se,me,p||c)}F&&F(ne,me),me.detectedPlanes&&o.dispatchEvent({type:"planesdetected",data:me}),E=null}const Oe=new k_;Oe.setAnimationLoop(oe),this.setAnimationLoop=function(ne){F=ne},this.dispose=function(){}}}const xo=new Bn,oR=new Qt;function sR(r,e){function t(x,_){x.matrixAutoUpdate===!0&&x.updateMatrix(),_.value.copy(x.matrix)}function o(x,_){_.color.getRGB(x.fogColor.value,D_(r)),_.isFog?(x.fogNear.value=_.near,x.fogFar.value=_.far):_.isFogExp2&&(x.fogDensity.value=_.density)}function s(x,_,L,P,A){_.isMeshBasicMaterial||_.isMeshLambertMaterial?l(x,_):_.isMeshToonMaterial?(l(x,_),v(x,_)):_.isMeshPhongMaterial?(l(x,_),m(x,_)):_.isMeshStandardMaterial?(l(x,_),y(x,_),_.isMeshPhysicalMaterial&&S(x,_,A)):_.isMeshMatcapMaterial?(l(x,_),E(x,_)):_.isMeshDepthMaterial?l(x,_):_.isMeshDistanceMaterial?(l(x,_),M(x,_)):_.isMeshNormalMaterial?l(x,_):_.isLineBasicMaterial?(c(x,_),_.isLineDashedMaterial&&d(x,_)):_.isPointsMaterial?f(x,_,L,P):_.isSpriteMaterial?p(x,_):_.isShadowMaterial?(x.color.value.copy(_.color),x.opacity.value=_.opacity):_.isShaderMaterial&&(_.uniformsNeedUpdate=!1)}function l(x,_){x.opacity.value=_.opacity,_.color&&x.diffuse.value.copy(_.color),_.emissive&&x.emissive.value.copy(_.emissive).multiplyScalar(_.emissiveIntensity),_.map&&(x.map.value=_.map,t(_.map,x.mapTransform)),_.alphaMap&&(x.alphaMap.value=_.alphaMap,t(_.alphaMap,x.alphaMapTransform)),_.bumpMap&&(x.bumpMap.value=_.bumpMap,t(_.bumpMap,x.bumpMapTransform),x.bumpScale.value=_.bumpScale,_.side===Yn&&(x.bumpScale.value*=-1)),_.normalMap&&(x.normalMap.value=_.normalMap,t(_.normalMap,x.normalMapTransform),x.normalScale.value.copy(_.normalScale),_.side===Yn&&x.normalScale.value.negate()),_.displacementMap&&(x.displacementMap.value=_.displacementMap,t(_.displacementMap,x.displacementMapTransform),x.displacementScale.value=_.displacementScale,x.displacementBias.value=_.displacementBias),_.emissiveMap&&(x.emissiveMap.value=_.emissiveMap,t(_.emissiveMap,x.emissiveMapTransform)),_.specularMap&&(x.specularMap.value=_.specularMap,t(_.specularMap,x.specularMapTransform)),_.alphaTest>0&&(x.alphaTest.value=_.alphaTest);const L=e.get(_),P=L.envMap,A=L.envMapRotation;P&&(x.envMap.value=P,xo.copy(A),xo.x*=-1,xo.y*=-1,xo.z*=-1,P.isCubeTexture&&P.isRenderTargetTexture===!1&&(xo.y*=-1,xo.z*=-1),x.envMapRotation.value.setFromMatrix4(oR.makeRotationFromEuler(xo)),x.flipEnvMap.value=P.isCubeTexture&&P.isRenderTargetTexture===!1?-1:1,x.reflectivity.value=_.reflectivity,x.ior.value=_.ior,x.refractionRatio.value=_.refractionRatio),_.lightMap&&(x.lightMap.value=_.lightMap,x.lightMapIntensity.value=_.lightMapIntensity,t(_.lightMap,x.lightMapTransform)),_.aoMap&&(x.aoMap.value=_.aoMap,x.aoMapIntensity.value=_.aoMapIntensity,t(_.aoMap,x.aoMapTransform))}function c(x,_){x.diffuse.value.copy(_.color),x.opacity.value=_.opacity,_.map&&(x.map.value=_.map,t(_.map,x.mapTransform))}function d(x,_){x.dashSize.value=_.dashSize,x.totalSize.value=_.dashSize+_.gapSize,x.scale.value=_.scale}function f(x,_,L,P){x.diffuse.value.copy(_.color),x.opacity.value=_.opacity,x.size.value=_.size*L,x.scale.value=P*.5,_.map&&(x.map.value=_.map,t(_.map,x.uvTransform)),_.alphaMap&&(x.alphaMap.value=_.alphaMap,t(_.alphaMap,x.alphaMapTransform)),_.alphaTest>0&&(x.alphaTest.value=_.alphaTest)}function p(x,_){x.diffuse.value.copy(_.color),x.opacity.value=_.opacity,x.rotation.value=_.rotation,_.map&&(x.map.value=_.map,t(_.map,x.mapTransform)),_.alphaMap&&(x.alphaMap.value=_.alphaMap,t(_.alphaMap,x.alphaMapTransform)),_.alphaTest>0&&(x.alphaTest.value=_.alphaTest)}function m(x,_){x.specular.value.copy(_.specular),x.shininess.value=Math.max(_.shininess,1e-4)}function v(x,_){_.gradientMap&&(x.gradientMap.value=_.gradientMap)}function y(x,_){x.metalness.value=_.metalness,_.metalnessMap&&(x.metalnessMap.value=_.metalnessMap,t(_.metalnessMap,x.metalnessMapTransform)),x.roughness.value=_.roughness,_.roughnessMap&&(x.roughnessMap.value=_.roughnessMap,t(_.roughnessMap,x.roughnessMapTransform)),_.envMap&&(x.envMapIntensity.value=_.envMapIntensity)}function S(x,_,L){x.ior.value=_.ior,_.sheen>0&&(x.sheenColor.value.copy(_.sheenColor).multiplyScalar(_.sheen),x.sheenRoughness.value=_.sheenRoughness,_.sheenColorMap&&(x.sheenColorMap.value=_.sheenColorMap,t(_.sheenColorMap,x.sheenColorMapTransform)),_.sheenRoughnessMap&&(x.sheenRoughnessMap.value=_.sheenRoughnessMap,t(_.sheenRoughnessMap,x.sheenRoughnessMapTransform))),_.clearcoat>0&&(x.clearcoat.value=_.clearcoat,x.clearcoatRoughness.value=_.clearcoatRoughness,_.clearcoatMap&&(x.clearcoatMap.value=_.clearcoatMap,t(_.clearcoatMap,x.clearcoatMapTransform)),_.clearcoatRoughnessMap&&(x.clearcoatRoughnessMap.value=_.clearcoatRoughnessMap,t(_.clearcoatRoughnessMap,x.clearcoatRoughnessMapTransform)),_.clearcoatNormalMap&&(x.clearcoatNormalMap.value=_.clearcoatNormalMap,t(_.clearcoatNormalMap,x.clearcoatNormalMapTransform),x.clearcoatNormalScale.value.copy(_.clearcoatNormalScale),_.side===Yn&&x.clearcoatNormalScale.value.negate())),_.dispersion>0&&(x.dispersion.value=_.dispersion),_.iridescence>0&&(x.iridescence.value=_.iridescence,x.iridescenceIOR.value=_.iridescenceIOR,x.iridescenceThicknessMinimum.value=_.iridescenceThicknessRange[0],x.iridescenceThicknessMaximum.value=_.iridescenceThicknessRange[1],_.iridescenceMap&&(x.iridescenceMap.value=_.iridescenceMap,t(_.iridescenceMap,x.iridescenceMapTransform)),_.iridescenceThicknessMap&&(x.iridescenceThicknessMap.value=_.iridescenceThicknessMap,t(_.iridescenceThicknessMap,x.iridescenceThicknessMapTransform))),_.transmission>0&&(x.transmission.value=_.transmission,x.transmissionSamplerMap.value=L.texture,x.transmissionSamplerSize.value.set(L.width,L.height),_.transmissionMap&&(x.transmissionMap.value=_.transmissionMap,t(_.transmissionMap,x.transmissionMapTransform)),x.thickness.value=_.thickness,_.thicknessMap&&(x.thicknessMap.value=_.thicknessMap,t(_.thicknessMap,x.thicknessMapTransform)),x.attenuationDistance.value=_.attenuationDistance,x.attenuationColor.value.copy(_.attenuationColor)),_.anisotropy>0&&(x.anisotropyVector.value.set(_.anisotropy*Math.cos(_.anisotropyRotation),_.anisotropy*Math.sin(_.anisotropyRotation)),_.anisotropyMap&&(x.anisotropyMap.value=_.anisotropyMap,t(_.anisotropyMap,x.anisotropyMapTransform))),x.specularIntensity.value=_.specularIntensity,x.specularColor.value.copy(_.specularColor),_.specularColorMap&&(x.specularColorMap.value=_.specularColorMap,t(_.specularColorMap,x.specularColorMapTransform)),_.specularIntensityMap&&(x.specularIntensityMap.value=_.specularIntensityMap,t(_.specularIntensityMap,x.specularIntensityMapTransform))}function E(x,_){_.matcap&&(x.matcap.value=_.matcap)}function M(x,_){const L=e.get(_).light;x.referencePosition.value.setFromMatrixPosition(L.matrixWorld),x.nearDistance.value=L.shadow.camera.near,x.farDistance.value=L.shadow.camera.far}return{refreshFogUniforms:o,refreshMaterialUniforms:s}}function aR(r,e,t,o){let s={},l={},c=[];const d=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function f(L,P){const A=P.program;o.uniformBlockBinding(L,A)}function p(L,P){let A=s[L.id];A===void 0&&(E(L),A=m(L),s[L.id]=A,L.addEventListener("dispose",x));const G=P.program;o.updateUBOMapping(L,G);const I=e.render.frame;l[L.id]!==I&&(y(L),l[L.id]=I)}function m(L){const P=v();L.__bindingPointIndex=P;const A=r.createBuffer(),G=L.__size,I=L.usage;return r.bindBuffer(r.UNIFORM_BUFFER,A),r.bufferData(r.UNIFORM_BUFFER,G,I),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,P,A),A}function v(){for(let L=0;L<d;L++)if(c.indexOf(L)===-1)return c.push(L),L;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function y(L){const P=s[L.id],A=L.uniforms,G=L.__cache;r.bindBuffer(r.UNIFORM_BUFFER,P);for(let I=0,k=A.length;I<k;I++){const X=Array.isArray(A[I])?A[I]:[A[I]];for(let b=0,C=X.length;b<C;b++){const V=X[b];if(S(V,I,b,G)===!0){const ae=V.__offset,J=Array.isArray(V.value)?V.value:[V.value];let ee=0;for(let fe=0;fe<J.length;fe++){const ue=J[fe],he=M(ue);typeof ue=="number"||typeof ue=="boolean"?(V.__data[0]=ue,r.bufferSubData(r.UNIFORM_BUFFER,ae+ee,V.__data)):ue.isMatrix3?(V.__data[0]=ue.elements[0],V.__data[1]=ue.elements[1],V.__data[2]=ue.elements[2],V.__data[3]=0,V.__data[4]=ue.elements[3],V.__data[5]=ue.elements[4],V.__data[6]=ue.elements[5],V.__data[7]=0,V.__data[8]=ue.elements[6],V.__data[9]=ue.elements[7],V.__data[10]=ue.elements[8],V.__data[11]=0):(ue.toArray(V.__data,ee),ee+=he.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,ae,V.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function S(L,P,A,G){const I=L.value,k=P+"_"+A;if(G[k]===void 0)return typeof I=="number"||typeof I=="boolean"?G[k]=I:G[k]=I.clone(),!0;{const X=G[k];if(typeof I=="number"||typeof I=="boolean"){if(X!==I)return G[k]=I,!0}else if(X.equals(I)===!1)return X.copy(I),!0}return!1}function E(L){const P=L.uniforms;let A=0;const G=16;for(let k=0,X=P.length;k<X;k++){const b=Array.isArray(P[k])?P[k]:[P[k]];for(let C=0,V=b.length;C<V;C++){const ae=b[C],J=Array.isArray(ae.value)?ae.value:[ae.value];for(let ee=0,fe=J.length;ee<fe;ee++){const ue=J[ee],he=M(ue),z=A%G,de=z%he.boundary,le=z+de;A+=de,le!==0&&G-le<he.storage&&(A+=G-le),ae.__data=new Float32Array(he.storage/Float32Array.BYTES_PER_ELEMENT),ae.__offset=A,A+=he.storage}}}const I=A%G;return I>0&&(A+=G-I),L.__size=A,L.__cache={},this}function M(L){const P={boundary:0,storage:0};return typeof L=="number"||typeof L=="boolean"?(P.boundary=4,P.storage=4):L.isVector2?(P.boundary=8,P.storage=8):L.isVector3||L.isColor?(P.boundary=16,P.storage=12):L.isVector4?(P.boundary=16,P.storage=16):L.isMatrix3?(P.boundary=48,P.storage=48):L.isMatrix4?(P.boundary=64,P.storage=64):L.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",L),P}function x(L){const P=L.target;P.removeEventListener("dispose",x);const A=c.indexOf(P.__bindingPointIndex);c.splice(A,1),r.deleteBuffer(s[P.id]),delete s[P.id],delete l[P.id]}function _(){for(const L in s)r.deleteBuffer(s[L]);c=[],s={},l={}}return{bind:f,update:p,dispose:_}}class lR{constructor(e={}){const{canvas:t=FE(),context:o=null,depth:s=!0,stencil:l=!1,alpha:c=!1,antialias:d=!1,premultipliedAlpha:f=!0,preserveDrawingBuffer:p=!1,powerPreference:m="default",failIfMajorPerformanceCaveat:v=!1,reverseDepthBuffer:y=!1}=e;this.isWebGLRenderer=!0;let S;if(o!==null){if(typeof WebGLRenderingContext<"u"&&o instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");S=o.getContextAttributes().alpha}else S=c;const E=new Uint32Array(4),M=new Int32Array(4);let x=null,_=null;const L=[],P=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=gi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const A=this;let G=!1;this._outputColorSpace=On;let I=0,k=0,X=null,b=-1,C=null;const V=new Jt,ae=new Jt;let J=null;const ee=new Ut(0);let fe=0,ue=t.width,he=t.height,z=1,de=null,le=null;const F=new Jt(0,0,ue,he),oe=new Jt(0,0,ue,he);let Oe=!1;const ne=new Th;let me=!1,Ce=!1;const Se=new Qt,Ae=new Qt,K=new re,Ee=new Jt,be={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ot=!1;function Ze(){return X===null?z:1}let N=o;function mt(R,$){return t.getContext(R,$)}try{const R={alpha:!0,depth:s,stencil:l,antialias:d,premultipliedAlpha:f,preserveDrawingBuffer:p,powerPreference:m,failIfMajorPerformanceCaveat:v};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${ph}`),t.addEventListener("webglcontextlost",Ue,!1),t.addEventListener("webglcontextrestored",we,!1),t.addEventListener("webglcontextcreationerror",ge,!1),N===null){const $="webgl2";if(N=mt($,R),N===null)throw mt($)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(R){throw console.error("THREE.WebGLRenderer: "+R.message),R}let pt,Mt,Be,ht,et,He,Tt,D,T,Q,pe,ve,ce,Ke,Le,Ge,Je,_e,ze,it,nt,De,st,W;function Ne(){pt=new _1(N),pt.init(),De=new eR(N,pt),Mt=new d1(N,pt,e,De),Be=new JC(N,pt),Mt.reverseDepthBuffer&&y&&Be.buffers.depth.setReversed(!0),ht=new S1(N),et=new BC,He=new QC(N,pt,Be,et,Mt,De,ht),Tt=new h1(A),D=new v1(A),T=new RM(N),st=new u1(N,T),Q=new x1(N,T,ht,st),pe=new M1(N,Q,T,ht),ze=new E1(N,Mt,He),Ge=new f1(et),ve=new OC(A,Tt,D,pt,Mt,st,Ge),ce=new sR(A,et),Ke=new HC,Le=new $C(pt),_e=new l1(A,Tt,D,Be,pe,S,f),Je=new KC(A,pe,Mt),W=new aR(N,ht,Mt,Be),it=new c1(N,pt,ht),nt=new y1(N,pt,ht),ht.programs=ve.programs,A.capabilities=Mt,A.extensions=pt,A.properties=et,A.renderLists=Ke,A.shadowMap=Je,A.state=Be,A.info=ht}Ne();const xe=new iR(A,N);this.xr=xe,this.getContext=function(){return N},this.getContextAttributes=function(){return N.getContextAttributes()},this.forceContextLoss=function(){const R=pt.get("WEBGL_lose_context");R&&R.loseContext()},this.forceContextRestore=function(){const R=pt.get("WEBGL_lose_context");R&&R.restoreContext()},this.getPixelRatio=function(){return z},this.setPixelRatio=function(R){R!==void 0&&(z=R,this.setSize(ue,he,!1))},this.getSize=function(R){return R.set(ue,he)},this.setSize=function(R,$,se=!0){if(xe.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}ue=R,he=$,t.width=Math.floor(R*z),t.height=Math.floor($*z),se===!0&&(t.style.width=R+"px",t.style.height=$+"px"),this.setViewport(0,0,R,$)},this.getDrawingBufferSize=function(R){return R.set(ue*z,he*z).floor()},this.setDrawingBufferSize=function(R,$,se){ue=R,he=$,z=se,t.width=Math.floor(R*se),t.height=Math.floor($*se),this.setViewport(0,0,R,$)},this.getCurrentViewport=function(R){return R.copy(V)},this.getViewport=function(R){return R.copy(F)},this.setViewport=function(R,$,se,Z){R.isVector4?F.set(R.x,R.y,R.z,R.w):F.set(R,$,se,Z),Be.viewport(V.copy(F).multiplyScalar(z).round())},this.getScissor=function(R){return R.copy(oe)},this.setScissor=function(R,$,se,Z){R.isVector4?oe.set(R.x,R.y,R.z,R.w):oe.set(R,$,se,Z),Be.scissor(ae.copy(oe).multiplyScalar(z).round())},this.getScissorTest=function(){return Oe},this.setScissorTest=function(R){Be.setScissorTest(Oe=R)},this.setOpaqueSort=function(R){de=R},this.setTransparentSort=function(R){le=R},this.getClearColor=function(R){return R.copy(_e.getClearColor())},this.setClearColor=function(){_e.setClearColor(...arguments)},this.getClearAlpha=function(){return _e.getClearAlpha()},this.setClearAlpha=function(){_e.setClearAlpha(...arguments)},this.clear=function(R=!0,$=!0,se=!0){let Z=0;if(R){let Y=!1;if(X!==null){const Re=X.texture.format;Y=Re===yh||Re===xh||Re===_h}if(Y){const Re=X.texture.type,Fe=Re===Yr||Re===Ao||Re===Pa||Re===La||Re===gh||Re===vh,je=_e.getClearColor(),Xe=_e.getClearAlpha(),dt=je.r,ut=je.g,Ye=je.b;Fe?(E[0]=dt,E[1]=ut,E[2]=Ye,E[3]=Xe,N.clearBufferuiv(N.COLOR,0,E)):(M[0]=dt,M[1]=ut,M[2]=Ye,M[3]=Xe,N.clearBufferiv(N.COLOR,0,M))}else Z|=N.COLOR_BUFFER_BIT}$&&(Z|=N.DEPTH_BUFFER_BIT),se&&(Z|=N.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),N.clear(Z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Ue,!1),t.removeEventListener("webglcontextrestored",we,!1),t.removeEventListener("webglcontextcreationerror",ge,!1),_e.dispose(),Ke.dispose(),Le.dispose(),et.dispose(),Tt.dispose(),D.dispose(),pe.dispose(),st.dispose(),W.dispose(),ve.dispose(),xe.dispose(),xe.removeEventListener("sessionstart",Si),xe.removeEventListener("sessionend",gr),qn.stop()};function Ue(R){R.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),G=!0}function we(){console.log("THREE.WebGLRenderer: Context Restored."),G=!1;const R=ht.autoReset,$=Je.enabled,se=Je.autoUpdate,Z=Je.needsUpdate,Y=Je.type;Ne(),ht.autoReset=R,Je.enabled=$,Je.autoUpdate=se,Je.needsUpdate=Z,Je.type=Y}function ge(R){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",R.statusMessage)}function Ie(R){const $=R.target;$.removeEventListener("dispose",Ie),ct($)}function ct(R){Lt(R),et.remove(R)}function Lt(R){const $=et.get(R).programs;$!==void 0&&($.forEach(function(se){ve.releaseProgram(se)}),R.isShaderMaterial&&ve.releaseShaderCache(R))}this.renderBufferDirect=function(R,$,se,Z,Y,Re){$===null&&($=be);const Fe=Y.isMesh&&Y.matrixWorld.determinant()<0,je=kt(R,$,se,Z,Y);Be.setMaterial(Z,Fe);let Xe=se.index,dt=1;if(Z.wireframe===!0){if(Xe=Q.getWireframeAttribute(se),Xe===void 0)return;dt=2}const ut=se.drawRange,Ye=se.attributes.position;let xt=ut.start*dt,vt=(ut.start+ut.count)*dt;Re!==null&&(xt=Math.max(xt,Re.start*dt),vt=Math.min(vt,(Re.start+Re.count)*dt)),Xe!==null?(xt=Math.max(xt,0),vt=Math.min(vt,Xe.count)):Ye!=null&&(xt=Math.max(xt,0),vt=Math.min(vt,Ye.count));const Gt=vt-xt;if(Gt<0||Gt===1/0)return;st.setup(Y,Z,je,se,Xe);let Ot,Nt=it;if(Xe!==null&&(Ot=T.get(Xe),Nt=nt,Nt.setIndex(Ot)),Y.isMesh)Z.wireframe===!0?(Be.setLineWidth(Z.wireframeLinewidth*Ze()),Nt.setMode(N.LINES)):Nt.setMode(N.TRIANGLES);else if(Y.isLine){let rt=Z.linewidth;rt===void 0&&(rt=1),Be.setLineWidth(rt*Ze()),Y.isLineSegments?Nt.setMode(N.LINES):Y.isLineLoop?Nt.setMode(N.LINE_LOOP):Nt.setMode(N.LINE_STRIP)}else Y.isPoints?Nt.setMode(N.POINTS):Y.isSprite&&Nt.setMode(N.TRIANGLES);if(Y.isBatchedMesh)if(Y._multiDrawInstances!==null)ys("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Nt.renderMultiDrawInstances(Y._multiDrawStarts,Y._multiDrawCounts,Y._multiDrawCount,Y._multiDrawInstances);else if(pt.get("WEBGL_multi_draw"))Nt.renderMultiDraw(Y._multiDrawStarts,Y._multiDrawCounts,Y._multiDrawCount);else{const rt=Y._multiDrawStarts,It=Y._multiDrawCounts,yt=Y._multiDrawCount,un=Xe?T.get(Xe).bytesPerElement:1,Ei=et.get(Z).currentProgram.getUniforms();for(let Dn=0;Dn<yt;Dn++)Ei.setValue(N,"_gl_DrawID",Dn),Nt.render(rt[Dn]/un,It[Dn])}else if(Y.isInstancedMesh)Nt.renderInstances(xt,Gt,Y.count);else if(se.isInstancedBufferGeometry){const rt=se._maxInstanceCount!==void 0?se._maxInstanceCount:1/0,It=Math.min(se.instanceCount,rt);Nt.renderInstances(xt,Gt,It)}else Nt.render(xt,Gt)};function Ct(R,$,se){R.transparent===!0&&R.side===zr&&R.forceSinglePass===!1?(R.side=Yn,R.needsUpdate=!0,We(R,$,se),R.side=Ki,R.needsUpdate=!0,We(R,$,se),R.side=zr):We(R,$,se)}this.compile=function(R,$,se=null){se===null&&(se=R),_=Le.get(se),_.init($),P.push(_),se.traverseVisible(function(Y){Y.isLight&&Y.layers.test($.layers)&&(_.pushLight(Y),Y.castShadow&&_.pushShadow(Y))}),R!==se&&R.traverseVisible(function(Y){Y.isLight&&Y.layers.test($.layers)&&(_.pushLight(Y),Y.castShadow&&_.pushShadow(Y))}),_.setupLights();const Z=new Set;return R.traverse(function(Y){if(!(Y.isMesh||Y.isPoints||Y.isLine||Y.isSprite))return;const Re=Y.material;if(Re)if(Array.isArray(Re))for(let Fe=0;Fe<Re.length;Fe++){const je=Re[Fe];Ct(je,se,Y),Z.add(je)}else Ct(Re,se,Y),Z.add(Re)}),_=P.pop(),Z},this.compileAsync=function(R,$,se=null){const Z=this.compile(R,$,se);return new Promise(Y=>{function Re(){if(Z.forEach(function(Fe){et.get(Fe).currentProgram.isReady()&&Z.delete(Fe)}),Z.size===0){Y(R);return}setTimeout(Re,10)}pt.get("KHR_parallel_shader_compile")!==null?Re():setTimeout(Re,10)})};let gn=null;function rn(R){gn&&gn(R)}function Si(){qn.stop()}function gr(){qn.start()}const qn=new k_;qn.setAnimationLoop(rn),typeof self<"u"&&qn.setContext(self),this.setAnimationLoop=function(R){gn=R,xe.setAnimationLoop(R),R===null?qn.stop():qn.start()},xe.addEventListener("sessionstart",Si),xe.addEventListener("sessionend",gr),this.render=function(R,$){if($!==void 0&&$.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(G===!0)return;if(R.matrixWorldAutoUpdate===!0&&R.updateMatrixWorld(),$.parent===null&&$.matrixWorldAutoUpdate===!0&&$.updateMatrixWorld(),xe.enabled===!0&&xe.isPresenting===!0&&(xe.cameraAutoUpdate===!0&&xe.updateCamera($),$=xe.getCamera()),R.isScene===!0&&R.onBeforeRender(A,R,$,X),_=Le.get(R,P.length),_.init($),P.push(_),Ae.multiplyMatrices($.projectionMatrix,$.matrixWorldInverse),ne.setFromProjectionMatrix(Ae),Ce=this.localClippingEnabled,me=Ge.init(this.clippingPlanes,Ce),x=Ke.get(R,L.length),x.init(),L.push(x),xe.enabled===!0&&xe.isPresenting===!0){const Re=A.xr.getDepthSensingMesh();Re!==null&&vr(Re,$,-1/0,A.sortObjects)}vr(R,$,0,A.sortObjects),x.finish(),A.sortObjects===!0&&x.sort(de,le),ot=xe.enabled===!1||xe.isPresenting===!1||xe.hasDepthSensing()===!1,ot&&_e.addToRenderList(x,R),this.info.render.frame++,me===!0&&Ge.beginShadows();const se=_.state.shadowsArray;Je.render(se,R,$),me===!0&&Ge.endShadows(),this.info.autoReset===!0&&this.info.reset();const Z=x.opaque,Y=x.transmissive;if(_.setupLights(),$.isArrayCamera){const Re=$.cameras;if(Y.length>0)for(let Fe=0,je=Re.length;Fe<je;Fe++){const Xe=Re[Fe];Pr(Z,Y,R,Xe)}ot&&_e.render(R);for(let Fe=0,je=Re.length;Fe<je;Fe++){const Xe=Re[Fe];qr(x,R,Xe,Xe.viewport)}}else Y.length>0&&Pr(Z,Y,R,$),ot&&_e.render(R),qr(x,R,$);X!==null&&k===0&&(He.updateMultisampleRenderTarget(X),He.updateRenderTargetMipmap(X)),R.isScene===!0&&R.onAfterRender(A,R,$),st.resetDefaultState(),b=-1,C=null,P.pop(),P.length>0?(_=P[P.length-1],me===!0&&Ge.setGlobalState(A.clippingPlanes,_.state.camera)):_=null,L.pop(),L.length>0?x=L[L.length-1]:x=null};function vr(R,$,se,Z){if(R.visible===!1)return;if(R.layers.test($.layers)){if(R.isGroup)se=R.renderOrder;else if(R.isLOD)R.autoUpdate===!0&&R.update($);else if(R.isLight)_.pushLight(R),R.castShadow&&_.pushShadow(R);else if(R.isSprite){if(!R.frustumCulled||ne.intersectsSprite(R)){Z&&Ee.setFromMatrixPosition(R.matrixWorld).applyMatrix4(Ae);const Fe=pe.update(R),je=R.material;je.visible&&x.push(R,Fe,je,se,Ee.z,null)}}else if((R.isMesh||R.isLine||R.isPoints)&&(!R.frustumCulled||ne.intersectsObject(R))){const Fe=pe.update(R),je=R.material;if(Z&&(R.boundingSphere!==void 0?(R.boundingSphere===null&&R.computeBoundingSphere(),Ee.copy(R.boundingSphere.center)):(Fe.boundingSphere===null&&Fe.computeBoundingSphere(),Ee.copy(Fe.boundingSphere.center)),Ee.applyMatrix4(R.matrixWorld).applyMatrix4(Ae)),Array.isArray(je)){const Xe=Fe.groups;for(let dt=0,ut=Xe.length;dt<ut;dt++){const Ye=Xe[dt],xt=je[Ye.materialIndex];xt&&xt.visible&&x.push(R,Fe,xt,se,Ee.z,Ye)}}else je.visible&&x.push(R,Fe,je,se,Ee.z,null)}}const Re=R.children;for(let Fe=0,je=Re.length;Fe<je;Fe++)vr(Re[Fe],$,se,Z)}function qr(R,$,se,Z){const Y=R.opaque,Re=R.transmissive,Fe=R.transparent;_.setupLightsView(se),me===!0&&Ge.setGlobalState(A.clippingPlanes,se),Z&&Be.viewport(V.copy(Z)),Y.length>0&&Lr(Y,$,se),Re.length>0&&Lr(Re,$,se),Fe.length>0&&Lr(Fe,$,se),Be.buffers.depth.setTest(!0),Be.buffers.depth.setMask(!0),Be.buffers.color.setMask(!0),Be.setPolygonOffset(!1)}function Pr(R,$,se,Z){if((se.isScene===!0?se.overrideMaterial:null)!==null)return;_.state.transmissionRenderTarget[Z.id]===void 0&&(_.state.transmissionRenderTarget[Z.id]=new bo(1,1,{generateMipmaps:!0,type:pt.has("EXT_color_buffer_half_float")||pt.has("EXT_color_buffer_float")?Ha:Yr,minFilter:Co,samples:4,stencilBuffer:l,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Pt.workingColorSpace}));const Re=_.state.transmissionRenderTarget[Z.id],Fe=Z.viewport||V;Re.setSize(Fe.z*A.transmissionResolutionScale,Fe.w*A.transmissionResolutionScale);const je=A.getRenderTarget(),Xe=A.getActiveCubeFace(),dt=A.getActiveMipmapLevel();A.setRenderTarget(Re),A.getClearColor(ee),fe=A.getClearAlpha(),fe<1&&A.setClearColor(16777215,.5),A.clear(),ot&&_e.render(se);const ut=A.toneMapping;A.toneMapping=gi;const Ye=Z.viewport;if(Z.viewport!==void 0&&(Z.viewport=void 0),_.setupLightsView(Z),me===!0&&Ge.setGlobalState(A.clippingPlanes,Z),Lr(R,se,Z),He.updateMultisampleRenderTarget(Re),He.updateRenderTargetMipmap(Re),pt.has("WEBGL_multisampled_render_to_texture")===!1){let xt=!1;for(let vt=0,Gt=$.length;vt<Gt;vt++){const Ot=$[vt],Nt=Ot.object,rt=Ot.geometry,It=Ot.material,yt=Ot.group;if(It.side===zr&&Nt.layers.test(Z.layers)){const un=It.side;It.side=Yn,It.needsUpdate=!0,Lo(Nt,se,Z,rt,It,yt),It.side=un,It.needsUpdate=!0,xt=!0}}xt===!0&&(He.updateMultisampleRenderTarget(Re),He.updateRenderTargetMipmap(Re))}A.setRenderTarget(je,Xe,dt),A.setClearColor(ee,fe),Ye!==void 0&&(Z.viewport=Ye),A.toneMapping=ut}function Lr(R,$,se){const Z=$.isScene===!0?$.overrideMaterial:null;for(let Y=0,Re=R.length;Y<Re;Y++){const Fe=R[Y],je=Fe.object,Xe=Fe.geometry,dt=Fe.group;let ut=Fe.material;ut.allowOverride===!0&&Z!==null&&(ut=Z),je.layers.test(se.layers)&&Lo(je,$,se,Xe,ut,dt)}}function Lo(R,$,se,Z,Y,Re){R.onBeforeRender(A,$,se,Z,Y,Re),R.modelViewMatrix.multiplyMatrices(se.matrixWorldInverse,R.matrixWorld),R.normalMatrix.getNormalMatrix(R.modelViewMatrix),Y.onBeforeRender(A,$,se,Z,R,Re),Y.transparent===!0&&Y.side===zr&&Y.forceSinglePass===!1?(Y.side=Yn,Y.needsUpdate=!0,A.renderBufferDirect(se,$,Z,Y,R,Re),Y.side=Ki,Y.needsUpdate=!0,A.renderBufferDirect(se,$,Z,Y,R,Re),Y.side=zr):A.renderBufferDirect(se,$,Z,Y,R,Re),R.onAfterRender(A,$,se,Z,Y,Re)}function We(R,$,se){$.isScene!==!0&&($=be);const Z=et.get(R),Y=_.state.lights,Re=_.state.shadowsArray,Fe=Y.state.version,je=ve.getParameters(R,Y.state,Re,$,se),Xe=ve.getProgramCacheKey(je);let dt=Z.programs;Z.environment=R.isMeshStandardMaterial?$.environment:null,Z.fog=$.fog,Z.envMap=(R.isMeshStandardMaterial?D:Tt).get(R.envMap||Z.environment),Z.envMapRotation=Z.environment!==null&&R.envMap===null?$.environmentRotation:R.envMapRotation,dt===void 0&&(R.addEventListener("dispose",Ie),dt=new Map,Z.programs=dt);let ut=dt.get(Xe);if(ut!==void 0){if(Z.currentProgram===ut&&Z.lightsStateVersion===Fe)return Et(R,je),ut}else je.uniforms=ve.getUniforms(R),R.onBeforeCompile(je,A),ut=ve.acquireProgram(je,Xe),dt.set(Xe,ut),Z.uniforms=je.uniforms;const Ye=Z.uniforms;return(!R.isShaderMaterial&&!R.isRawShaderMaterial||R.clipping===!0)&&(Ye.clippingPlanes=Ge.uniform),Et(R,je),Z.needsLights=Ln(R),Z.lightsStateVersion=Fe,Z.needsLights&&(Ye.ambientLightColor.value=Y.state.ambient,Ye.lightProbe.value=Y.state.probe,Ye.directionalLights.value=Y.state.directional,Ye.directionalLightShadows.value=Y.state.directionalShadow,Ye.spotLights.value=Y.state.spot,Ye.spotLightShadows.value=Y.state.spotShadow,Ye.rectAreaLights.value=Y.state.rectArea,Ye.ltc_1.value=Y.state.rectAreaLTC1,Ye.ltc_2.value=Y.state.rectAreaLTC2,Ye.pointLights.value=Y.state.point,Ye.pointLightShadows.value=Y.state.pointShadow,Ye.hemisphereLights.value=Y.state.hemi,Ye.directionalShadowMap.value=Y.state.directionalShadowMap,Ye.directionalShadowMatrix.value=Y.state.directionalShadowMatrix,Ye.spotShadowMap.value=Y.state.spotShadowMap,Ye.spotLightMatrix.value=Y.state.spotLightMatrix,Ye.spotLightMap.value=Y.state.spotLightMap,Ye.pointShadowMap.value=Y.state.pointShadowMap,Ye.pointShadowMatrix.value=Y.state.pointShadowMatrix),Z.currentProgram=ut,Z.uniformsList=null,ut}function qt(R){if(R.uniformsList===null){const $=R.currentProgram.getUniforms();R.uniformsList=Ru.seqWithValue($.seq,R.uniforms)}return R.uniformsList}function Et(R,$){const se=et.get(R);se.outputColorSpace=$.outputColorSpace,se.batching=$.batching,se.batchingColor=$.batchingColor,se.instancing=$.instancing,se.instancingColor=$.instancingColor,se.instancingMorph=$.instancingMorph,se.skinning=$.skinning,se.morphTargets=$.morphTargets,se.morphNormals=$.morphNormals,se.morphColors=$.morphColors,se.morphTargetsCount=$.morphTargetsCount,se.numClippingPlanes=$.numClippingPlanes,se.numIntersection=$.numClipIntersection,se.vertexAlphas=$.vertexAlphas,se.vertexTangents=$.vertexTangents,se.toneMapping=$.toneMapping}function kt(R,$,se,Z,Y){$.isScene!==!0&&($=be),He.resetTextureUnits();const Re=$.fog,Fe=Z.isMeshStandardMaterial?$.environment:null,je=X===null?A.outputColorSpace:X.isXRRenderTarget===!0?X.texture.colorSpace:Ts,Xe=(Z.isMeshStandardMaterial?D:Tt).get(Z.envMap||Fe),dt=Z.vertexColors===!0&&!!se.attributes.color&&se.attributes.color.itemSize===4,ut=!!se.attributes.tangent&&(!!Z.normalMap||Z.anisotropy>0),Ye=!!se.morphAttributes.position,xt=!!se.morphAttributes.normal,vt=!!se.morphAttributes.color;let Gt=gi;Z.toneMapped&&(X===null||X.isXRRenderTarget===!0)&&(Gt=A.toneMapping);const Ot=se.morphAttributes.position||se.morphAttributes.normal||se.morphAttributes.color,Nt=Ot!==void 0?Ot.length:0,rt=et.get(Z),It=_.state.lights;if(me===!0&&(Ce===!0||R!==C)){const vn=R===C&&Z.id===b;Ge.setState(Z,R,vn)}let yt=!1;Z.version===rt.__version?(rt.needsLights&&rt.lightsStateVersion!==It.state.version||rt.outputColorSpace!==je||Y.isBatchedMesh&&rt.batching===!1||!Y.isBatchedMesh&&rt.batching===!0||Y.isBatchedMesh&&rt.batchingColor===!0&&Y.colorTexture===null||Y.isBatchedMesh&&rt.batchingColor===!1&&Y.colorTexture!==null||Y.isInstancedMesh&&rt.instancing===!1||!Y.isInstancedMesh&&rt.instancing===!0||Y.isSkinnedMesh&&rt.skinning===!1||!Y.isSkinnedMesh&&rt.skinning===!0||Y.isInstancedMesh&&rt.instancingColor===!0&&Y.instanceColor===null||Y.isInstancedMesh&&rt.instancingColor===!1&&Y.instanceColor!==null||Y.isInstancedMesh&&rt.instancingMorph===!0&&Y.morphTexture===null||Y.isInstancedMesh&&rt.instancingMorph===!1&&Y.morphTexture!==null||rt.envMap!==Xe||Z.fog===!0&&rt.fog!==Re||rt.numClippingPlanes!==void 0&&(rt.numClippingPlanes!==Ge.numPlanes||rt.numIntersection!==Ge.numIntersection)||rt.vertexAlphas!==dt||rt.vertexTangents!==ut||rt.morphTargets!==Ye||rt.morphNormals!==xt||rt.morphColors!==vt||rt.toneMapping!==Gt||rt.morphTargetsCount!==Nt)&&(yt=!0):(yt=!0,rt.__version=Z.version);let un=rt.currentProgram;yt===!0&&(un=We(Z,$,Y));let Ei=!1,Dn=!1,Kr=!1;const Bt=un.getUniforms(),Mn=rt.uniforms;if(Be.useProgram(un.program)&&(Ei=!0,Dn=!0,Kr=!0),Z.id!==b&&(b=Z.id,Dn=!0),Ei||C!==R){Be.buffers.depth.getReversed()?(Se.copy(R.projectionMatrix),OE(Se),BE(Se),Bt.setValue(N,"projectionMatrix",Se)):Bt.setValue(N,"projectionMatrix",R.projectionMatrix),Bt.setValue(N,"viewMatrix",R.matrixWorldInverse);const dn=Bt.map.cameraPosition;dn!==void 0&&dn.setValue(N,K.setFromMatrixPosition(R.matrixWorld)),Mt.logarithmicDepthBuffer&&Bt.setValue(N,"logDepthBufFC",2/(Math.log(R.far+1)/Math.LN2)),(Z.isMeshPhongMaterial||Z.isMeshToonMaterial||Z.isMeshLambertMaterial||Z.isMeshBasicMaterial||Z.isMeshStandardMaterial||Z.isShaderMaterial)&&Bt.setValue(N,"isOrthographic",R.isOrthographicCamera===!0),C!==R&&(C=R,Dn=!0,Kr=!0)}if(Y.isSkinnedMesh){Bt.setOptional(N,Y,"bindMatrix"),Bt.setOptional(N,Y,"bindMatrixInverse");const vn=Y.skeleton;vn&&(vn.boneTexture===null&&vn.computeBoneTexture(),Bt.setValue(N,"boneTexture",vn.boneTexture,He))}Y.isBatchedMesh&&(Bt.setOptional(N,Y,"batchingTexture"),Bt.setValue(N,"batchingTexture",Y._matricesTexture,He),Bt.setOptional(N,Y,"batchingIdTexture"),Bt.setValue(N,"batchingIdTexture",Y._indirectTexture,He),Bt.setOptional(N,Y,"batchingColorTexture"),Y._colorsTexture!==null&&Bt.setValue(N,"batchingColorTexture",Y._colorsTexture,He));const cn=se.morphAttributes;if((cn.position!==void 0||cn.normal!==void 0||cn.color!==void 0)&&ze.update(Y,se,un),(Dn||rt.receiveShadow!==Y.receiveShadow)&&(rt.receiveShadow=Y.receiveShadow,Bt.setValue(N,"receiveShadow",Y.receiveShadow)),Z.isMeshGouraudMaterial&&Z.envMap!==null&&(Mn.envMap.value=Xe,Mn.flipEnvMap.value=Xe.isCubeTexture&&Xe.isRenderTargetTexture===!1?-1:1),Z.isMeshStandardMaterial&&Z.envMap===null&&$.environment!==null&&(Mn.envMapIntensity.value=$.environmentIntensity),Dn&&(Bt.setValue(N,"toneMappingExposure",A.toneMappingExposure),rt.needsLights&&Kt(Mn,Kr),Re&&Z.fog===!0&&ce.refreshFogUniforms(Mn,Re),ce.refreshMaterialUniforms(Mn,Z,z,he,_.state.transmissionRenderTarget[R.id]),Ru.upload(N,qt(rt),Mn,He)),Z.isShaderMaterial&&Z.uniformsNeedUpdate===!0&&(Ru.upload(N,qt(rt),Mn,He),Z.uniformsNeedUpdate=!1),Z.isSpriteMaterial&&Bt.setValue(N,"center",Y.center),Bt.setValue(N,"modelViewMatrix",Y.modelViewMatrix),Bt.setValue(N,"normalMatrix",Y.normalMatrix),Bt.setValue(N,"modelMatrix",Y.matrixWorld),Z.isShaderMaterial||Z.isRawShaderMaterial){const vn=Z.uniformsGroups;for(let dn=0,Rt=vn.length;dn<Rt;dn++){const Dr=vn[dn];W.update(Dr,un),W.bind(Dr,un)}}return un}function Kt(R,$){R.ambientLightColor.needsUpdate=$,R.lightProbe.needsUpdate=$,R.directionalLights.needsUpdate=$,R.directionalLightShadows.needsUpdate=$,R.pointLights.needsUpdate=$,R.pointLightShadows.needsUpdate=$,R.spotLights.needsUpdate=$,R.spotLightShadows.needsUpdate=$,R.rectAreaLights.needsUpdate=$,R.hemisphereLights.needsUpdate=$}function Ln(R){return R.isMeshLambertMaterial||R.isMeshToonMaterial||R.isMeshPhongMaterial||R.isMeshStandardMaterial||R.isShadowMaterial||R.isShaderMaterial&&R.lights===!0}this.getActiveCubeFace=function(){return I},this.getActiveMipmapLevel=function(){return k},this.getRenderTarget=function(){return X},this.setRenderTargetTextures=function(R,$,se){const Z=et.get(R);Z.__autoAllocateDepthBuffer=R.resolveDepthBuffer===!1,Z.__autoAllocateDepthBuffer===!1&&(Z.__useRenderToTexture=!1),et.get(R.texture).__webglTexture=$,et.get(R.depthTexture).__webglTexture=Z.__autoAllocateDepthBuffer?void 0:se,Z.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(R,$){const se=et.get(R);se.__webglFramebuffer=$,se.__useDefaultFramebuffer=$===void 0};const Sn=N.createFramebuffer();this.setRenderTarget=function(R,$=0,se=0){X=R,I=$,k=se;let Z=!0,Y=null,Re=!1,Fe=!1;if(R){const Xe=et.get(R);if(Xe.__useDefaultFramebuffer!==void 0)Be.bindFramebuffer(N.FRAMEBUFFER,null),Z=!1;else if(Xe.__webglFramebuffer===void 0)He.setupRenderTarget(R);else if(Xe.__hasExternalTextures)He.rebindTextures(R,et.get(R.texture).__webglTexture,et.get(R.depthTexture).__webglTexture);else if(R.depthBuffer){const Ye=R.depthTexture;if(Xe.__boundDepthTexture!==Ye){if(Ye!==null&&et.has(Ye)&&(R.width!==Ye.image.width||R.height!==Ye.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");He.setupDepthRenderbuffer(R)}}const dt=R.texture;(dt.isData3DTexture||dt.isDataArrayTexture||dt.isCompressedArrayTexture)&&(Fe=!0);const ut=et.get(R).__webglFramebuffer;R.isWebGLCubeRenderTarget?(Array.isArray(ut[$])?Y=ut[$][se]:Y=ut[$],Re=!0):R.samples>0&&He.useMultisampledRTT(R)===!1?Y=et.get(R).__webglMultisampledFramebuffer:Array.isArray(ut)?Y=ut[se]:Y=ut,V.copy(R.viewport),ae.copy(R.scissor),J=R.scissorTest}else V.copy(F).multiplyScalar(z).floor(),ae.copy(oe).multiplyScalar(z).floor(),J=Oe;if(se!==0&&(Y=Sn),Be.bindFramebuffer(N.FRAMEBUFFER,Y)&&Z&&Be.drawBuffers(R,Y),Be.viewport(V),Be.scissor(ae),Be.setScissorTest(J),Re){const Xe=et.get(R.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_CUBE_MAP_POSITIVE_X+$,Xe.__webglTexture,se)}else if(Fe){const Xe=et.get(R.texture),dt=$;N.framebufferTextureLayer(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,Xe.__webglTexture,se,dt)}else if(R!==null&&se!==0){const Xe=et.get(R.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,Xe.__webglTexture,se)}b=-1},this.readRenderTargetPixels=function(R,$,se,Z,Y,Re,Fe,je=0){if(!(R&&R.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Xe=et.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Fe!==void 0&&(Xe=Xe[Fe]),Xe){Be.bindFramebuffer(N.FRAMEBUFFER,Xe);try{const dt=R.textures[je],ut=dt.format,Ye=dt.type;if(!Mt.textureFormatReadable(ut)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Mt.textureTypeReadable(Ye)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}$>=0&&$<=R.width-Z&&se>=0&&se<=R.height-Y&&(R.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+je),N.readPixels($,se,Z,Y,De.convert(ut),De.convert(Ye),Re))}finally{const dt=X!==null?et.get(X).__webglFramebuffer:null;Be.bindFramebuffer(N.FRAMEBUFFER,dt)}}},this.readRenderTargetPixelsAsync=async function(R,$,se,Z,Y,Re,Fe,je=0){if(!(R&&R.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Xe=et.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Fe!==void 0&&(Xe=Xe[Fe]),Xe)if($>=0&&$<=R.width-Z&&se>=0&&se<=R.height-Y){Be.bindFramebuffer(N.FRAMEBUFFER,Xe);const dt=R.textures[je],ut=dt.format,Ye=dt.type;if(!Mt.textureFormatReadable(ut))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Mt.textureTypeReadable(Ye))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const xt=N.createBuffer();N.bindBuffer(N.PIXEL_PACK_BUFFER,xt),N.bufferData(N.PIXEL_PACK_BUFFER,Re.byteLength,N.STREAM_READ),R.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+je),N.readPixels($,se,Z,Y,De.convert(ut),De.convert(Ye),0);const vt=X!==null?et.get(X).__webglFramebuffer:null;Be.bindFramebuffer(N.FRAMEBUFFER,vt);const Gt=N.fenceSync(N.SYNC_GPU_COMMANDS_COMPLETE,0);return N.flush(),await kE(N,Gt,4),N.bindBuffer(N.PIXEL_PACK_BUFFER,xt),N.getBufferSubData(N.PIXEL_PACK_BUFFER,0,Re),N.deleteBuffer(xt),N.deleteSync(Gt),Re}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(R,$=null,se=0){const Z=Math.pow(2,-se),Y=Math.floor(R.image.width*Z),Re=Math.floor(R.image.height*Z),Fe=$!==null?$.x:0,je=$!==null?$.y:0;He.setTexture2D(R,0),N.copyTexSubImage2D(N.TEXTURE_2D,se,0,0,Fe,je,Y,Re),Be.unbindTexture()};const Kn=N.createFramebuffer(),En=N.createFramebuffer();this.copyTextureToTexture=function(R,$,se=null,Z=null,Y=0,Re=null){Re===null&&(Y!==0?(ys("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Re=Y,Y=0):Re=0);let Fe,je,Xe,dt,ut,Ye,xt,vt,Gt;const Ot=R.isCompressedTexture?R.mipmaps[Re]:R.image;if(se!==null)Fe=se.max.x-se.min.x,je=se.max.y-se.min.y,Xe=se.isBox3?se.max.z-se.min.z:1,dt=se.min.x,ut=se.min.y,Ye=se.isBox3?se.min.z:0;else{const cn=Math.pow(2,-Y);Fe=Math.floor(Ot.width*cn),je=Math.floor(Ot.height*cn),R.isDataArrayTexture?Xe=Ot.depth:R.isData3DTexture?Xe=Math.floor(Ot.depth*cn):Xe=1,dt=0,ut=0,Ye=0}Z!==null?(xt=Z.x,vt=Z.y,Gt=Z.z):(xt=0,vt=0,Gt=0);const Nt=De.convert($.format),rt=De.convert($.type);let It;$.isData3DTexture?(He.setTexture3D($,0),It=N.TEXTURE_3D):$.isDataArrayTexture||$.isCompressedArrayTexture?(He.setTexture2DArray($,0),It=N.TEXTURE_2D_ARRAY):(He.setTexture2D($,0),It=N.TEXTURE_2D),N.pixelStorei(N.UNPACK_FLIP_Y_WEBGL,$.flipY),N.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL,$.premultiplyAlpha),N.pixelStorei(N.UNPACK_ALIGNMENT,$.unpackAlignment);const yt=N.getParameter(N.UNPACK_ROW_LENGTH),un=N.getParameter(N.UNPACK_IMAGE_HEIGHT),Ei=N.getParameter(N.UNPACK_SKIP_PIXELS),Dn=N.getParameter(N.UNPACK_SKIP_ROWS),Kr=N.getParameter(N.UNPACK_SKIP_IMAGES);N.pixelStorei(N.UNPACK_ROW_LENGTH,Ot.width),N.pixelStorei(N.UNPACK_IMAGE_HEIGHT,Ot.height),N.pixelStorei(N.UNPACK_SKIP_PIXELS,dt),N.pixelStorei(N.UNPACK_SKIP_ROWS,ut),N.pixelStorei(N.UNPACK_SKIP_IMAGES,Ye);const Bt=R.isDataArrayTexture||R.isData3DTexture,Mn=$.isDataArrayTexture||$.isData3DTexture;if(R.isDepthTexture){const cn=et.get(R),vn=et.get($),dn=et.get(cn.__renderTarget),Rt=et.get(vn.__renderTarget);Be.bindFramebuffer(N.READ_FRAMEBUFFER,dn.__webglFramebuffer),Be.bindFramebuffer(N.DRAW_FRAMEBUFFER,Rt.__webglFramebuffer);for(let Dr=0;Dr<Xe;Dr++)Bt&&(N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,et.get(R).__webglTexture,Y,Ye+Dr),N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,et.get($).__webglTexture,Re,Gt+Dr)),N.blitFramebuffer(dt,ut,Fe,je,xt,vt,Fe,je,N.DEPTH_BUFFER_BIT,N.NEAREST);Be.bindFramebuffer(N.READ_FRAMEBUFFER,null),Be.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else if(Y!==0||R.isRenderTargetTexture||et.has(R)){const cn=et.get(R),vn=et.get($);Be.bindFramebuffer(N.READ_FRAMEBUFFER,Kn),Be.bindFramebuffer(N.DRAW_FRAMEBUFFER,En);for(let dn=0;dn<Xe;dn++)Bt?N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,cn.__webglTexture,Y,Ye+dn):N.framebufferTexture2D(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,cn.__webglTexture,Y),Mn?N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,vn.__webglTexture,Re,Gt+dn):N.framebufferTexture2D(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,vn.__webglTexture,Re),Y!==0?N.blitFramebuffer(dt,ut,Fe,je,xt,vt,Fe,je,N.COLOR_BUFFER_BIT,N.NEAREST):Mn?N.copyTexSubImage3D(It,Re,xt,vt,Gt+dn,dt,ut,Fe,je):N.copyTexSubImage2D(It,Re,xt,vt,dt,ut,Fe,je);Be.bindFramebuffer(N.READ_FRAMEBUFFER,null),Be.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else Mn?R.isDataTexture||R.isData3DTexture?N.texSubImage3D(It,Re,xt,vt,Gt,Fe,je,Xe,Nt,rt,Ot.data):$.isCompressedArrayTexture?N.compressedTexSubImage3D(It,Re,xt,vt,Gt,Fe,je,Xe,Nt,Ot.data):N.texSubImage3D(It,Re,xt,vt,Gt,Fe,je,Xe,Nt,rt,Ot):R.isDataTexture?N.texSubImage2D(N.TEXTURE_2D,Re,xt,vt,Fe,je,Nt,rt,Ot.data):R.isCompressedTexture?N.compressedTexSubImage2D(N.TEXTURE_2D,Re,xt,vt,Ot.width,Ot.height,Nt,Ot.data):N.texSubImage2D(N.TEXTURE_2D,Re,xt,vt,Fe,je,Nt,rt,Ot);N.pixelStorei(N.UNPACK_ROW_LENGTH,yt),N.pixelStorei(N.UNPACK_IMAGE_HEIGHT,un),N.pixelStorei(N.UNPACK_SKIP_PIXELS,Ei),N.pixelStorei(N.UNPACK_SKIP_ROWS,Dn),N.pixelStorei(N.UNPACK_SKIP_IMAGES,Kr),Re===0&&$.generateMipmaps&&N.generateMipmap(It),Be.unbindTexture()},this.copyTextureToTexture3D=function(R,$,se=null,Z=null,Y=0){return ys('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(R,$,se,Z,Y)},this.initRenderTarget=function(R){et.get(R).__webglFramebuffer===void 0&&He.setupRenderTarget(R)},this.initTexture=function(R){R.isCubeTexture?He.setTextureCube(R,0):R.isData3DTexture?He.setTexture3D(R,0):R.isDataArrayTexture||R.isCompressedArrayTexture?He.setTexture2DArray(R,0):He.setTexture2D(R,0),Be.unbindTexture()},this.resetState=function(){I=0,k=0,X=null,Be.reset(),st.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return pi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=Pt._getDrawingBufferColorSpace(e),t.unpackColorSpace=Pt._getUnpackColorSpace()}}function uR(r){switch(r){case"fa-user-tag":case"fa-person":return B.jsxs(B.Fragment,{children:[B.jsx("circle",{cx:"12",cy:"7",r:"3.5"}),B.jsx("path",{d:"M5 21c0-4.2 3.1-7 7-7s7 2.8 7 7"})]});case"fa-venus-mars":return B.jsxs(B.Fragment,{children:[B.jsx("circle",{cx:"8",cy:"9",r:"3.5"}),B.jsx("path",{d:"M8 12.5V21M5 17.5h6"}),B.jsx("circle",{cx:"16.5",cy:"14.5",r:"3.5"}),B.jsx("path",{d:"M19 12l3-3m0 0h-4m4 0v4"})]});case"fa-palette":return B.jsxs(B.Fragment,{children:[B.jsx("path",{d:"M12 3a9 9 0 1 0 0 18h1.5a2.5 2.5 0 0 0 0 0-5H12a2 2 0 0 1 0-4h3a6 6 0 0 0-3-9Z"}),B.jsx("circle",{cx:"7",cy:"10",r:".7",fill:"currentColor",stroke:"none"}),B.jsx("circle",{cx:"9",cy:"6.5",r:".7",fill:"currentColor",stroke:"none"}),B.jsx("circle",{cx:"13",cy:"5.8",r:".7",fill:"currentColor",stroke:"none"})]});case"fa-eye":return B.jsxs(B.Fragment,{children:[B.jsx("path",{d:"M2.5 12s3.5-5.5 9.5-5.5 9.5 5.5 9.5 5.5-3.5 5.5-9.5 5.5S2.5 12 2.5 12Z"}),B.jsx("circle",{cx:"12",cy:"12",r:"2.5"})]});case"fa-eye-dropper":return B.jsxs(B.Fragment,{children:[B.jsx("path",{d:"m14 5 5 5M16.5 2.5l5 5-10 10-4 1 1-4 10-10Z"}),B.jsx("path",{d:"M5 19h6"})]});case"fa-scissors":return B.jsxs(B.Fragment,{children:[B.jsx("circle",{cx:"6",cy:"7",r:"2.5"}),B.jsx("circle",{cx:"6",cy:"17",r:"2.5"}),B.jsx("path",{d:"m8 8.5 12 8.5M8 15.5 20 7"})]});case"fa-fill-drip":return B.jsxs(B.Fragment,{children:[B.jsx("path",{d:"m4 14 8-8 6 6-8 8H4v-6Z"}),B.jsx("path",{d:"M15 5 12 2"}),B.jsx("path",{d:"M20 15s2 2.2 2 3.5a2 2 0 0 1-4 0c0-1.3 2-3.5 2-3.5Z"})]});case"fa-hat-cowboy":return B.jsxs(B.Fragment,{children:[B.jsx("path",{d:"M4 16h16M7 16l1.5-7h7L17 16"}),B.jsx("path",{d:"M2.5 16c1.5 3 17.5 3 19 0"})]});case"fa-shirt":return B.jsx("path",{d:"M8 4h8l5 4-3 4-2-2v10H8V10l-2 2-3-4 5-4Z"});case"fa-shoe-prints":return B.jsxs(B.Fragment,{children:[B.jsx("ellipse",{cx:"8",cy:"8",rx:"2.5",ry:"4",transform:"rotate(-20 8 8)"}),B.jsx("ellipse",{cx:"16",cy:"16",rx:"2.5",ry:"4",transform:"rotate(-20 16 16)"})]});case"fa-gem":return B.jsxs(B.Fragment,{children:[B.jsx("path",{d:"M6 4h12l4 5-10 11L2 9l4-5Z"}),B.jsx("path",{d:"M2 9h20M8 4l4 16 4-16"})]});case"fa-sliders":return B.jsxs(B.Fragment,{children:[B.jsx("path",{d:"M4 6h5M15 6h5M4 12h10M18 12h2M4 18h2M10 18h10"}),B.jsx("circle",{cx:"12",cy:"6",r:"2"}),B.jsx("circle",{cx:"16",cy:"12",r:"2"}),B.jsx("circle",{cx:"8",cy:"18",r:"2"})]});case"fa-grip-vertical":return B.jsxs(B.Fragment,{children:[B.jsx("circle",{cx:"9",cy:"6",r:"1",fill:"currentColor",stroke:"none"}),B.jsx("circle",{cx:"15",cy:"6",r:"1",fill:"currentColor",stroke:"none"}),B.jsx("circle",{cx:"9",cy:"12",r:"1",fill:"currentColor",stroke:"none"}),B.jsx("circle",{cx:"15",cy:"12",r:"1",fill:"currentColor",stroke:"none"}),B.jsx("circle",{cx:"9",cy:"18",r:"1",fill:"currentColor",stroke:"none"}),B.jsx("circle",{cx:"15",cy:"18",r:"1",fill:"currentColor",stroke:"none"})]});case"fa-chevron-up":return B.jsx("path",{d:"m6 15 6-6 6 6"});case"fa-chevron-down":return B.jsx("path",{d:"m6 9 6 6 6-6"});case"fa-check":return B.jsx("path",{d:"m5 12 4 4L19 6"});case"fa-arrows-rotate":return B.jsxs(B.Fragment,{children:[B.jsx("path",{d:"M20 7v5h-5"}),B.jsx("path",{d:"M4 17v-5h5"}),B.jsx("path",{d:"M6.2 8.2A7 7 0 0 1 18.8 10M17.8 15.8A7 7 0 0 1 5.2 14"})]});case"fa-layer-group":return B.jsxs(B.Fragment,{children:[B.jsx("path",{d:"m12 3 9 5-9 5-9-5 9-5Z"}),B.jsx("path",{d:"m3 12 9 5 9-5M3 16l9 5 9-5"})]});case"fa-pause":return B.jsx("path",{d:"M8 5v14M16 5v14"});case"fa-play":return B.jsx("path",{d:"m8 5 11 7-11 7V5Z"});case"fa-download":return B.jsxs(B.Fragment,{children:[B.jsx("path",{d:"M12 3v12m0 0 4-4m-4 4-4-4"}),B.jsx("path",{d:"M5 20h14"})]});default:return B.jsxs(B.Fragment,{children:[B.jsx("circle",{cx:"12",cy:"12",r:"8"}),B.jsx("path",{d:"M9.5 9a2.5 2.5 0 0 1 5 0c0 2-2.5 2-2.5 4M12 17h.01"})]})}}function di({name:r,className:e=""}){return B.jsx("svg",{className:`skincrafter-icon ${e}`.trim(),viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",focusable:"false","data-skincrafter-icon":r,children:uR(r)})}function V_({title:r,icon:e,iconClassName:t="skincrafter-accent-text",className:o="",children:s}){return B.jsxs("section",{className:`mb-4 md:mb-0 md:flex md:flex-col md:h-full md:min-h-0 p-4 ${o}`,children:[B.jsxs("h2",{className:"text-xl font-bold mb-2 skincrafter-heading flex items-center",children:[B.jsx(di,{name:e,className:`skincrafter-heading-icon ${t}`.trim()}),r]}),s]})}function _a({icon:r,className:e="",children:t,...o}){return B.jsxs("button",{className:`pixel-button preview-action-button p-2 pixel-border transition-colors ${e}`,...o,children:[r&&B.jsx(di,{name:r,className:"skincrafter-button-icon"}),t]})}const cR=""+new URL("/dev/assets/default-BAcllNor-BAcllNor.png",import.meta.url).href,dR=""+new URL("/dev/assets/male.tintable-fxeAI3uu-fxeAI3uu.png",import.meta.url).href,fR=""+new URL("/dev/assets/male.fixed-DcqZ3kjg-DcqZ3kjg.png",import.meta.url).href,hR=""+new URL("/dev/assets/female.tintable-BLp5_Gdk-BLp5_Gdk.png",import.meta.url).href,pR=""+new URL("/dev/assets/female.fixed-DbzKxh-8-DbzKxh-8.png",import.meta.url).href,mR=""+new URL("/dev/assets/male.fixed-C1cq_pNO-C1cq_pNO.png",import.meta.url).href,gR=""+new URL("/dev/assets/male.tintable-D_4mkZ79-D_4mkZ79.png",import.meta.url).href,vR=""+new URL("/dev/assets/male.fixed-BGzxECBj-BGzxECBj.png",import.meta.url).href,_R=""+new URL("/dev/assets/male.tintable-Dll7q7aD-Dll7q7aD.png",import.meta.url).href,xR=""+new URL("/dev/assets/male.fixed-DKYrqDB3-DKYrqDB3.png",import.meta.url).href,yR=""+new URL("/dev/assets/none.tintable-Bs7knCxE-Bs7knCxE.png",import.meta.url).href,SR=""+new URL("/dev/assets/none.fixed-DGZLEiFj-DGZLEiFj.png",import.meta.url).href,ER=""+new URL("/dev/assets/big.tintable-NvbZ8U4q-NvbZ8U4q.png",import.meta.url).href,MR=""+new URL("/dev/assets/clasic.fixed-Dli_mmU6-Dli_mmU6.png",import.meta.url).href,wR=""+new URL("/dev/assets/big.tintable-NvbZ8U4q-NvbZ8U4q.png",import.meta.url).href,TR=""+new URL("/dev/assets/big.tintable-NvbZ8U4q-NvbZ8U4q.png",import.meta.url).href,CR=""+new URL("/dev/assets/big.fixed-BuEC2Ubs-BuEC2Ubs.png",import.meta.url).href,RR=""+new URL("/dev/assets/duck-Dz_q_Va_-Dz_q_Va_.png",import.meta.url).href,AR=""+new URL("/dev/assets/hoodie-C1a1is5P-C1a1is5P.png",import.meta.url).href,bR=""+new URL("/dev/assets/pants-gRdPSA1G-gRdPSA1G.png",import.meta.url).href,G_={"textures/preview/default.png":cR,"textures/race/human/male.tintable.png":dR,"textures/race/human/male.fixed.png":fR,"textures/race/human/female.tintable.png":hR,"textures/race/human/female.fixed.png":pR,"textures/race/bear/male.fixed.png":mR,"textures/race/orc/male.tintable.png":gR,"textures/race/orc/male.fixed.png":vR,"textures/race/zombie/male.tintable.png":_R,"textures/race/zombie/male.fixed.png":xR,"textures/race/template/none.tintable.png":yR,"textures/race/template/none.fixed.png":SR,"textures/eyes/clasic.tintable.png":ER,"textures/eyes/clasic.fixed.png":MR,"textures/eyes/small.tintable.png":wR,"textures/eyes/big.tintable.png":TR,"textures/eyes/big.fixed.png":CR,"textures/hat/duck.png":RR,"textures/top/male/hoodie.png":AR,"textures/bottom/pants.png":bR};function af(r,e){return e?`${e.replace(/\/+$/,"")}/${r.replace(/^\/+/,"")}`:G_[r]}const vv=G_["textures/preview/default.png"],ms=64,PR=["bottom"];function dr(r,e,t,o,s,l,c,d,f={}){const{transparent:p=!1,expand:m=0,rotate180Faces:v=[],flipXFaces:y=[],flipYFaces:S=PR}=f,E=new Set(v),M=new Set(y),x=new Set(S),_=new Ds(e+m,t+m,o+m),L=()=>new wh({transparent:p,toneMapped:!1,alphaTest:p?.1:0,side:zr}),P=[L(),L(),L(),L(),L(),L()],A=(X,b,C=!1,V=!1)=>{const ae=r.clone(),J=(b[2]-b[0])/ms,ee=(b[3]-b[1])/ms,fe=b[0]/ms,ue=b[2]/ms,he=1-b[1]/ms,z=1-b[3]/ms;ae.magFilter=yn,ae.minFilter=yn,ae.generateMipmaps=!1,ae.wrapS=ba,ae.wrapT=ba,ae.repeat.set(C?-J:J,V?-ee:ee),ae.offset.set(C?ue:fe,V?he:z),ae.needsUpdate=!0,X.map=ae},G=X=>E.has(X)||M.has(X),I=X=>E.has(X)||x.has(X);A(P[0],d.right,G("right"),I("right")),A(P[1],d.left,G("left"),I("left")),A(P[2],d.top,G("top"),I("top")),A(P[3],d.bottom,G("bottom"),I("bottom")),A(P[4],d.front,G("front"),I("front")),A(P[5],d.back,G("back"),I("back"));const k=new Gr(_,P);return k.position.set(s,l,c),k}const LR=-6,DR=6,mu=new re(-5,16,0),gu=new re(5,16,0),W_=-1.9,X_=1.9,_v=new re(W_,6,0),xv=new re(X_,6,0);function fr(r,e,t,o){if(!r)return;const s=e.clone().sub(t).applyEuler(o).add(t);r.position.copy(s),r.rotation.copy(o)}function NR(r,e,t={}){const{armL:o,armR:s,legL:l,legR:c,armLOL:d,armROL:f,legLOL:p,legROL:m}=e,v=t.leftArmX??DR,y=t.rightArmX??LR,S=new re(v,12,0),E=new re(y,12,0),M=new re(X_,0,0),x=new re(W_,0,0);if(!(!o||!s||!l||!c)){if([o,s,l,c,d,f,p,m].forEach(_=>_?.rotation.set(0,0,0)),o.position.copy(S),s.position.copy(E),l.position.copy(M),c.position.copy(x),d?.position.copy(S),f?.position.copy(E),p?.position.copy(M),m?.position.copy(x),r==="tpose"){const _=new Bn(0,0,Math.PI/2),L=new Bn(0,0,-Math.PI/2);fr(o,S,gu,_),fr(s,E,mu,L),fr(d,S,gu,_),fr(f,E,mu,L)}else if(r==="walking"){const _=-Math.PI/4,L=Math.PI/4,P=new Bn(_,0,0),A=new Bn(L,0,0),G=new Bn(L,0,0),I=new Bn(_,0,0);fr(o,S,gu,P),fr(s,E,mu,A),fr(l,M,xv,G),fr(c,x,_v,I),fr(d,S,gu,P),fr(f,E,mu,A),fr(p,M,xv,G),fr(m,x,_v,I)}}}const UR={left:[0,8,8,16],right:[16,8,24,16],top:[8,0,16,8],bottom:[16,0,24,8],front:[8,8,16,16],back:[24,8,32,16]},IR={right:[28,20,32,32],left:[16,20,20,32],top:[20,16,28,20],bottom:[28,16,36,20],front:[20,20,28,32],back:[32,20,40,32]},FR={left:[40,20,44,32],right:[48,20,52,32],top:[44,16,48,20],bottom:[48,16,52,20],front:[44,20,48,32],back:[52,20,56,32]},kR={left:[40,20,44,32],right:[47,20,51,32],top:[44,16,47,20],bottom:[47,16,50,20],front:[44,20,47,32],back:[51,20,54,32]},OR={left:[0,20,4,32],right:[8,20,12,32],top:[4,16,8,20],bottom:[8,16,12,20],front:[4,20,8,32],back:[12,20,16,32]},BR={left:[32,8,40,16],right:[48,8,56,16],top:[40,0,48,8],bottom:[48,0,56,8],front:[40,8,48,16],back:[56,8,64,16]},zR={right:[28,36,32,48],left:[16,36,20,48],top:[20,32,28,36],bottom:[28,32,36,36],front:[20,36,28,48],back:[32,36,40,48]},HR={left:[40,36,44,48],right:[48,36,52,48],top:[44,32,48,36],bottom:[48,32,52,36],front:[44,36,48,48],back:[52,36,56,48]},VR={left:[40,36,44,48],right:[47,36,51,48],top:[44,32,47,36],bottom:[47,32,50,36],front:[44,36,47,48],back:[51,36,54,48]},GR={left:[0,36,4,48],right:[8,36,12,48],top:[4,32,8,36],bottom:[8,32,12,36],front:[4,36,8,48],back:[12,36,16,48]},WR={left:[32,52,36,64],right:[40,52,44,64],top:[36,48,40,52],bottom:[40,48,44,52],front:[36,52,40,64],back:[44,52,48,64]},XR={left:[32,52,36,64],right:[39,52,43,64],top:[36,48,39,52],bottom:[39,48,42,52],front:[36,52,39,64],back:[43,52,46,64]},jR={left:[16,52,20,64],right:[24,52,28,64],top:[20,48,24,52],bottom:[24,48,28,52],front:[20,52,24,64],back:[28,52,32,64]},$R={left:[48,52,52,64],right:[56,52,60,64],top:[52,48,56,52],bottom:[56,48,60,52],front:[52,52,56,64],back:[60,52,64,64]},YR={left:[48,52,52,64],right:[55,52,59,64],top:[52,48,55,52],bottom:[55,48,58,52],front:[52,52,55,64],back:[59,52,62,64]},qR={left:[0,52,4,64],right:[8,52,12,64],top:[4,48,8,52],bottom:[8,48,12,52],front:[4,52,8,64],back:[12,52,16,64]},lf=0,KR=44,ZR=24,JR=72,QR=.04,yv=.01,Sv=Sa.degToRad(50),eA=.6,tA=1/60,nA=.05,rA=8,iA=1,oA=.5,Ev=-6,Mv=6,wv=-5.5,Tv=5.5,Cv=-1.9,Rv=1.9,Av=()=>({armL:null,armR:null,legL:null,legR:null,armLOL:null,armROL:null,legLOL:null,legROL:null,headOL:null,bodyOL:null}),sA={createRenderer:()=>new lR({antialias:!1,alpha:!0}),createTextureLoader:()=>new yM,createResizeObserver:r=>new ResizeObserver(r),requestAnimationFrame:r=>window.requestAnimationFrame(r),cancelAnimationFrame:r=>window.cancelAnimationFrame(r),addWindowResizeListener:r=>window.addEventListener("resize",r),removeWindowResizeListener:r=>window.removeEventListener("resize",r),getDevicePixelRatio:()=>window.devicePixelRatio||1};class aA{constructor(e,t,o=sA){this.container=e,this.dependencies=o,this.pose=t.pose,this.model=t.model,this.showOverlay=t.showOverlay,this.autoRotate=t.autoRotate,this.onError=t.onError,this.initialCursor=e.style.cursor;const s=e.clientWidth||1,l=e.clientHeight||1;this.renderer=o.createRenderer(),this.renderer.setClearColor(0,0),this.renderer.outputColorSpace=On,this.renderer.toneMapping=gi,this.renderer.setPixelRatio(this.getClampedDpr()),this.renderer.setSize(s,l),e.appendChild(this.renderer.domElement),this.camera=new hr(52,s/l,.1,1e3),this.camera.position.set(0,lf,this.cameraDistance),this.camera.lookAt(0,lf,0),this.scene=new dM;const c=new wM(16777215,1);c.position.set(10,10,10),this.scene.add(c),this.group=new Ea,this.group.position.y=-10,this.scene.add(this.group),this.textureLoader=o.createTextureLoader(),this.resizeObserver=o.createResizeObserver(this.handleResize),this.resizeObserver.observe(e),o.addWindowResizeListener(this.handleResize),e.addEventListener("wheel",this.handleWheel,{passive:!1}),e.addEventListener("pointerdown",this.handlePointerDown),e.addEventListener("pointermove",this.handlePointerMove),e.addEventListener("pointerup",this.handlePointerUp),e.addEventListener("pointercancel",this.handlePointerCancel),e.addEventListener("lostpointercapture",this.handleLostPointerCapture),e.style.cursor="grab",this.handleResize(),this.scheduleAnimationFrame(),this.setTexture(t.textureUrl)}container;dependencies;renderer;camera;scene;group;textureLoader;resizeObserver;onError;disposedTextures=new WeakSet;pendingTextures=new Map;initialCursor;parts=Av();modelMeshes=[];currentTexture=null;requestedTextureUrl=null;textureLoadVersion=0;animationFrameId=null;disposed=!1;pose;model;showOverlay;autoRotate;cameraDistance=KR;modelRevision=0;textureRevision=0;activePointerId=null;lastPointerX=0;lastPointerY=0;isDragging=!1;previousFrameTimestamp=null;setTexture(e){if(this.disposed||e===this.requestedTextureUrl)return;this.requestedTextureUrl=e;const t=++this.textureLoadVersion;let o=!1;const s=this.textureLoader.load(e,l=>{o=!0,this.pendingTextures.delete(t),this.handleTextureLoaded(t,l)},void 0,l=>{o=!0;const c=this.pendingTextures.get(t);c&&(this.disposeTexture(c),this.pendingTextures.delete(t)),!this.disposed&&t===this.textureLoadVersion&&(this.requestedTextureUrl=null,this.onError?.({code:"texture_load_failed",textureUrl:e,cause:l}))});o||this.pendingTextures.set(t,s)}setModel(e){this.disposed||e===this.model||(this.model=e,this.currentTexture&&this.buildModel(this.currentTexture))}setPose(e){this.disposed||e===this.pose||(this.pose=e,this.applyCurrentPose())}setShowOverlay(e){this.disposed||e===this.showOverlay||(this.showOverlay=e,this.applyOverlayVisibility())}setAutoRotate(e){this.disposed||(this.autoRotate=e)}getDiagnostics(){const e=this.parts.armR?.geometry.parameters.width;return{rendererAttached:this.renderer.domElement.parentNode===this.container,modelRevision:this.modelRevision,textureRevision:this.textureRevision,meshCount:this.modelMeshes.length,rightArmWidth:typeof e=="number"?e:null,overlayVisible:this.getOverlayMeshes().map(t=>t.visible),cameraDistance:this.cameraDistance,rotation:this.group.rotation.y,rotationX:this.group.rotation.x,rotationY:this.group.rotation.y,rotationZ:this.group.rotation.z,isDragging:this.isDragging}}dispose(){if(this.disposed)return;const e=this.activePointerId;this.disposed=!0,this.textureLoadVersion+=1,this.container.removeEventListener("wheel",this.handleWheel),this.container.removeEventListener("pointerdown",this.handlePointerDown),this.container.removeEventListener("pointermove",this.handlePointerMove),this.container.removeEventListener("pointerup",this.handlePointerUp),this.container.removeEventListener("pointercancel",this.handlePointerCancel),this.container.removeEventListener("lostpointercapture",this.handleLostPointerCapture),this.dependencies.removeWindowResizeListener(this.handleResize),this.resizeObserver.disconnect(),e!==null&&this.releasePointerCapture(e),this.activePointerId=null,this.isDragging=!1,this.previousFrameTimestamp=null,this.container.style.cursor=this.initialCursor,this.animationFrameId!==null&&(this.dependencies.cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null),this.pendingTextures.forEach(t=>this.disposeTexture(t)),this.pendingTextures.clear(),this.disposeModel(),this.currentTexture&&(this.disposeTexture(this.currentTexture),this.currentTexture=null),this.renderer.dispose(),this.renderer.forceContextLoss(),this.renderer.domElement.parentNode===this.container&&this.container.removeChild(this.renderer.domElement)}handleResize=()=>{if(this.disposed)return;const e=this.container.clientWidth||1,t=this.container.clientHeight||1;this.renderer.setPixelRatio(this.getClampedDpr()),this.renderer.setSize(e,t),this.camera.aspect=e/t,this.camera.updateProjectionMatrix()};handleWheel=e=>{this.disposed||(e.preventDefault(),this.cameraDistance=Sa.clamp(this.cameraDistance+e.deltaY*QR,ZR,JR),this.camera.position.z=this.cameraDistance,this.camera.lookAt(0,lf,0),this.camera.updateProjectionMatrix())};handlePointerDown=e=>{this.disposed||this.activePointerId!==null||e.pointerType==="mouse"&&e.button!==0||(this.activePointerId=e.pointerId,this.lastPointerX=e.clientX,this.lastPointerY=e.clientY,this.isDragging=!0,this.container.style.cursor="grabbing",this.capturePointer(e.pointerId),e.preventDefault())};handlePointerMove=e=>{if(this.disposed||!this.isDragging||e.pointerId!==this.activePointerId)return;const t=e.clientX-this.lastPointerX,o=e.clientY-this.lastPointerY;this.lastPointerX=e.clientX,this.lastPointerY=e.clientY,this.group.rotation.y+=t*yv,this.group.rotation.x=Sa.clamp(this.group.rotation.x+o*yv,-Sv,Sv),this.group.rotation.z=0,e.preventDefault()};handlePointerUp=e=>{this.finishPointerInteraction(e.pointerId,!0)};handlePointerCancel=e=>{this.finishPointerInteraction(e.pointerId,!1)};handleLostPointerCapture=e=>{this.finishPointerInteraction(e.pointerId,!1)};finishPointerInteraction(e,t){this.disposed||e!==this.activePointerId||(this.activePointerId=null,this.isDragging=!1,this.container.style.cursor="grab",t&&this.releasePointerCapture(e))}capturePointer(e){try{this.container.setPointerCapture?.(e)}catch{}}releasePointerCapture(e){try{if(this.container.hasPointerCapture?.(e)===!1)return;this.container.releasePointerCapture?.(e)}catch{}}scheduleAnimationFrame(){this.animationFrameId=this.dependencies.requestAnimationFrame(this.handleAnimationFrame)}handleAnimationFrame=e=>{if(this.disposed)return;const t=this.previousFrameTimestamp===null?tA:Sa.clamp((e-this.previousFrameTimestamp)/1e3,0,nA);this.previousFrameTimestamp=e,this.autoRotate&&!this.isDragging&&(this.group.rotation.y+=eA*t,this.group.rotation.x=Sa.damp(this.group.rotation.x,0,rA,t),this.group.rotation.z=0),this.renderer.render(this.scene,this.camera),this.scheduleAnimationFrame()};getClampedDpr(){return Math.min(this.dependencies.getDevicePixelRatio(),2)}handleTextureLoaded(e,t){if(this.disposed||e!==this.textureLoadVersion){this.disposeTexture(t);return}this.configureTexture(t);const o=this.currentTexture;this.modelMeshes.length===0?this.buildModel(t):this.replaceModelTexture(t),this.currentTexture=t,this.textureRevision+=1,o&&o!==t&&this.disposeTexture(o)}configureTexture(e){e.magFilter=yn,e.minFilter=yn,e.generateMipmaps=!1,e.colorSpace=On,e.wrapS=fi,e.wrapT=fi}buildModel(e){this.disposeModel();const t=this.model==="slim",o=t?3:4,s=t?wv:Ev,l=t?Tv:Mv,c=t?kR:FR,d=t?XR:WR,f=t?VR:HR,p=t?YR:$R,m=dr(e,8,8,8,0,22,0,UR),v=dr(e,8,12,4,0,12,0,IR),y=dr(e,o,12,4,s,12,0,c),S=dr(e,o,12,4,l,12,0,d),E=dr(e,4,12,4,Cv,0,0,OR),M=dr(e,4,12,4,Rv,0,0,jR),x={transparent:!0,expand:iA},_={transparent:!0,expand:oA},L=dr(e,8,8,8,0,22,0,BR,x),P=dr(e,8,12,4,0,12,0,zR,_),A=dr(e,o,12,4,s,12,0,f,_),G=dr(e,o,12,4,l,12,0,p,_),I=dr(e,4,12,4,Cv,0,0,GR,_),k=dr(e,4,12,4,Rv,0,0,qR,_);this.parts={armL:S,armR:y,legL:M,legR:E,armLOL:G,armROL:A,legLOL:k,legROL:I,headOL:L,bodyOL:P},this.modelMeshes=[m,v,y,S,E,M,L,P,A,G,I,k],this.group.add(...this.modelMeshes),this.modelRevision+=1,this.applyOverlayVisibility(),this.applyCurrentPose()}replaceModelTexture(e){this.modelMeshes.forEach(t=>{t.material.forEach(o=>{const s=o.map;if(!s)return;const l=e.clone();l.magFilter=yn,l.minFilter=yn,l.generateMipmaps=!1,l.colorSpace=On,l.wrapS=s.wrapS,l.wrapT=s.wrapT,l.repeat.copy(s.repeat),l.offset.copy(s.offset),l.center.copy(s.center),l.rotation=s.rotation,l.flipY=s.flipY,l.needsUpdate=!0,o.map=l,o.needsUpdate=!0,this.disposeTexture(s)})})}applyCurrentPose(){const e=this.model==="slim";NR(this.pose,{armL:this.parts.armL,armR:this.parts.armR,legL:this.parts.legL,legR:this.parts.legR,armLOL:this.parts.armLOL,armROL:this.parts.armROL,legLOL:this.parts.legLOL,legROL:this.parts.legROL},{leftArmX:e?Tv:Mv,rightArmX:e?wv:Ev})}applyOverlayVisibility(){this.getOverlayMeshes().forEach(e=>{e.visible=this.showOverlay})}getOverlayMeshes(){return[this.parts.headOL,this.parts.bodyOL,this.parts.armLOL,this.parts.armROL,this.parts.legLOL,this.parts.legROL].filter(e=>e!==null)}disposeModel(){this.modelMeshes.forEach(e=>{this.group.remove(e),e.geometry.dispose(),e.material.forEach(t=>{t.map&&(this.disposeTexture(t.map),t.map=null),t.dispose()})}),this.modelMeshes=[],this.parts=Av()}disposeTexture(e){this.disposedTextures.has(e)||(this.disposedTextures.add(e),e.dispose())}}function lA(r,e,t){return new aA(r,e,t)}function uA(r){return{code:"preview_texture_load_failed",category:"preview",message:`Failed to load preview texture: ${r.textureUrl}`,assetUrl:r.textureUrl,cause:r.cause}}function cA({texture:r,pose:e="default",model:t="classic",showOverlay:o=!0,autoRotate:s=!0,textureRequestRevision:l=0,style:c,onError:d}){const f=O.useRef(null),p=O.useRef(null),m=O.useRef(d),v=O.useRef({textureUrl:r??vv,pose:e,model:t,showOverlay:o,autoRotate:s,onError:y=>m.current?.(uA(y))});return O.useEffect(()=>{m.current=d},[d]),O.useEffect(()=>{const y=f.current;if(!y)return;let S;try{S=lA(y,v.current)}catch(E){m.current?.({code:"preview_webgl_initialization_failed",category:"preview",message:"Failed to initialize the WebGL skin preview.",cause:E});return}return p.current=S,()=>{S.dispose(),p.current===S&&(p.current=null)}},[]),O.useEffect(()=>{p.current?.setTexture(r??vv)},[r,l]),O.useEffect(()=>{p.current?.setModel(t)},[t]),O.useEffect(()=>{p.current?.setPose(e)},[e]),O.useEffect(()=>{p.current?.setShowOverlay(o)},[o]),O.useEffect(()=>{p.current?.setAutoRotate(s)},[s]),B.jsx("div",{ref:f,style:{width:"100%",height:"100%",minHeight:0,position:"relative",touchAction:"none",...c??{}}})}const j_=["en","pl","pt-BR"],Us="en",bv={en:{"app.title":"SkinCrafter","nav.wardrobe":"Wardrobe","nav.skinView":"Skin View","nav.language":"Language","nav.workInProgress":"Work in progress","panel.preview":"Preview","panel.customization":"Customization","panel.loadSkin":"Load Minecraft Skin","action.changePose":"Change Pose","action.hideOverlay":"Hide Overlay","action.showOverlay":"Show Overlay","action.disableAutoRotate":"Stop Rotation","action.enableAutoRotate":"Start Rotation","action.download":"Download","action.downloadSkin":"Download character skin","action.dragLayer":"Drag layer","action.moveLayerUp":"Move layer up","action.moveLayerDown":"Move layer down","action.loadSkin":"Load Skin","action.loading":"Loading...","action.retryPreview":"Retry Preview","error.assetLoad":"A skin texture could not be loaded. Check the selected assets and try again.","error.generation":"The skin could not be generated. Change the selection and try again.","error.initialSkin":"The supplied skin is not a valid 64x64 Minecraft PNG.","error.preview":"The 3D preview could not be loaded. Skin editing and download may still be available.","skinView.player":"Player","skinView.username":"Minecraft username","category.race":"Character Race","category.sex":"Sex","category.skinColor":"Skin Color","category.eyes":"Eyes","category.eyesColor":"Eye Color","category.hair":"Hair","category.hairColor":"Hair Color","category.hat":"Hat","category.shirt":"Shirt","category.pants":"Pants","category.shoes":"Shoes","category.accessory":"Accessory","wardrobeColor.primary":"Color","wardrobeColor.secondary":"Secondary color","option.none":"None","option.sex.Male":"Male","option.sex.Female":"Female","option.race.Human":"Human","option.race.Bear":"Bear","option.race.Orc":"Orc","option.race.Zombie":"Zombie","option.race.Template":"Template","option.eyes.Classic":"Classic","option.eyes.Small":"Small","option.eyes.Big":"Big","option.hat.Duck":"Duck","option.shirt.Hoodie":"Hoodie","option.pants.Pants":"Pants","option.color.blue":"Blue","option.color.green":"Green","option.color.brown":"Brown","option.color.blond":"Blond","option.color.black":"Black"},pl:{"app.title":"SkinCrafter","nav.wardrobe":"Kreator","nav.skinView":"Podglad","nav.language":"Jezyk","nav.workInProgress":"Produkt w trakcie prac","panel.preview":"Podglad","panel.customization":"Personalizacja","panel.loadSkin":"Wczytaj skin Minecraft","action.changePose":"Zmien Poze","action.hideOverlay":"Ukryj Warstwe","action.showOverlay":"Pokaz Warstwe","action.disableAutoRotate":"Zatrzymaj Obrot","action.enableAutoRotate":"Wlacz Obrot","action.download":"Pobierz","action.downloadSkin":"Pobierz skin postaci","action.dragLayer":"Przeciagnij warstwe","action.moveLayerUp":"Przesun warstwe wyzej","action.moveLayerDown":"Przesun warstwe nizej","action.loadSkin":"Wczytaj Skin","action.loading":"Wczytywanie...","action.retryPreview":"Ponow Podglad","error.assetLoad":"Nie udalo sie wczytac tekstury skina. Sprawdz wybrane elementy i sprobuj ponownie.","error.generation":"Nie udalo sie wygenerowac skina. Zmien wybor i sprobuj ponownie.","error.initialSkin":"Przekazany skin nie jest prawidlowym plikiem PNG Minecraft 64x64.","error.preview":"Nie udalo sie uruchomic podgladu 3D. Edycja i pobieranie skina moga nadal dzialac.","skinView.player":"Gracz","skinView.username":"Nazwa gracza Minecraft","category.race":"Rasa Postaci","category.sex":"Plec","category.skinColor":"Kolor Skory","category.eyes":"Oczy","category.eyesColor":"Kolor Oczu","category.hair":"Wlosy","category.hairColor":"Kolor Wlosow","category.hat":"Czapka","category.shirt":"Koszulka","category.pants":"Spodnie","category.shoes":"Buty","category.accessory":"Dodatek","wardrobeColor.primary":"Kolor","wardrobeColor.secondary":"Kolor dodatkowy","option.none":"Brak","option.sex.Male":"Mezczyzna","option.sex.Female":"Kobieta","option.race.Human":"Czlowiek","option.race.Bear":"Niedzwiedz","option.race.Orc":"Ork","option.race.Zombie":"Zombie","option.race.Template":"Szablon","option.eyes.Classic":"Klasyczne","option.eyes.Small":"Male","option.eyes.Big":"Duze","option.hat.Duck":"Kaczka","option.shirt.Hoodie":"Bluza","option.pants.Pants":"Spodnie","option.color.blue":"Niebieski","option.color.green":"Zielony","option.color.brown":"Brazowy","option.color.blond":"Blond","option.color.black":"Czarny"},"pt-BR":{"app.title":"SkinCrafter","nav.wardrobe":"Criador","nav.skinView":"Visualizador","nav.language":"Idioma","nav.workInProgress":"Produto em desenvolvimento","panel.preview":"Pré-visualização","panel.customization":"Personalização","panel.loadSkin":"Carregar skin do Minecraft","action.changePose":"Mudar pose","action.hideOverlay":"Ocultar camada","action.showOverlay":"Mostrar camada","action.disableAutoRotate":"Parar rotação","action.enableAutoRotate":"Iniciar rotação","action.download":"Baixar","action.downloadSkin":"Baixar skin do personagem","action.dragLayer":"Arrastar camada","action.moveLayerUp":"Mover camada para cima","action.moveLayerDown":"Mover camada para baixo","action.loadSkin":"Carregar skin","action.loading":"Carregando...","action.retryPreview":"Tentar pré-visualização novamente","error.assetLoad":"Não foi possível carregar uma textura da skin. Verifique os itens selecionados e tente novamente.","error.generation":"Não foi possível gerar a skin. Altere a seleção e tente novamente.","error.initialSkin":"A skin fornecida não é um PNG válido do Minecraft em 64x64.","error.preview":"Não foi possível carregar a pré-visualização 3D. A edição e o download da skin ainda podem estar disponíveis.","skinView.player":"Jogador","skinView.username":"Nome de usuário do Minecraft","category.race":"Raça do personagem","category.sex":"Gênero","category.skinColor":"Cor da pele","category.eyes":"Olhos","category.eyesColor":"Cor dos olhos","category.hair":"Cabelo","category.hairColor":"Cor do cabelo","category.hat":"Chapéu","category.shirt":"Camisa","category.pants":"Calças","category.shoes":"Calçados","category.accessory":"Acessório","wardrobeColor.primary":"Cor","wardrobeColor.secondary":"Cor secundária","option.none":"Nenhum","option.sex.Male":"Masculino","option.sex.Female":"Feminino","option.race.Human":"Humano","option.race.Bear":"Urso","option.race.Orc":"Orc","option.race.Zombie":"Zumbi","option.race.Template":"Modelo","option.eyes.Classic":"Clássico","option.eyes.Small":"Pequenos","option.eyes.Big":"Grandes","option.hat.Duck":"Pato","option.shirt.Hoodie":"Moletom","option.pants.Pants":"Calças","option.color.blue":"Azul","option.color.green":"Verde","option.color.brown":"Marrom","option.color.blond":"Loiro","option.color.black":"Preto"}};function dA(r){return!!r&&j_.includes(r)}function Wa(r,e){return bv[r][e]??bv[Us][e]??e}const fA=r=>Wa(Us,r);function hA(r){return r.code==="asset_load_failed"?"error.assetLoad":r.code==="invalid_initial_skin"?"error.initialSkin":r.category==="preview"?"error.preview":"error.generation"}function $_({texture:r,model:e="classic",footerHeight:t=0,t:o=fA,onSave:s,canSave:l,generationStatus:c,generationError:d,onError:f}){const[p,m]=O.useState("default"),[v,y]=O.useState(!0),[S,E]=O.useState(!0),[M,x]=O.useState(null),[_,L]=O.useState(0),P=()=>{m(ee=>ee==="default"?"tpose":ee==="tpose"?"walking":"default")},A=()=>{y(ee=>!ee)},G=()=>{E(ee=>!ee)},I=l??!!r,k=()=>{if(!r||!I)return;const ee=document.createElement("a");ee.href=r,ee.download="skincrafter-skin.png",ee.click()},X=()=>{if(I){if(s){s();return}k()}},b=O.useCallback(ee=>{x(ee),f?.(ee)},[f]),C=()=>{x(null),L(ee=>ee+1)};O.useEffect(()=>{x(ee=>ee?.code==="preview_texture_load_failed"?null:ee)},[r]);const V=c==="error"&&d?d:M,ae=V===M&&M?.code==="preview_texture_load_failed",J={"--skincrafter-preview-bottom-offset":`${Math.max(0,t)}px`};return B.jsxs(V_,{title:o("panel.preview"),icon:"fa-eye",children:[B.jsx("div",{className:"skincrafter-preview-surface overflow-hidden pixel-border flex-grow min-h-0 max-h-[70dvh] md:max-h-full",style:J,children:B.jsx("div",{className:"flex justify-center items-center model-placeholder h-full",children:B.jsx(cA,{texture:r,pose:p,model:e,showOverlay:v,autoRotate:S,textureRequestRevision:_,onError:b})})}),V&&B.jsx("p",{className:"mt-3 text-sm font-semibold skincrafter-error-text",role:"alert",children:o(hA(V))}),ae&&B.jsx(_a,{className:"mt-2 skincrafter-secondary-action",icon:"fa-arrows-rotate","aria-label":o("action.retryPreview"),onClick:C,children:o("action.retryPreview")}),B.jsxs("div",{className:"mt-4 preview-actions",children:[B.jsx(_a,{className:"skincrafter-secondary-action",icon:"fa-arrows-rotate","aria-label":o("action.changePose"),onClick:P,children:o("action.changePose")}),B.jsx(_a,{className:"skincrafter-secondary-action",icon:"fa-layer-group","aria-label":o(v?"action.hideOverlay":"action.showOverlay"),onClick:A,children:o(v?"action.hideOverlay":"action.showOverlay")}),B.jsx(_a,{className:"skincrafter-secondary-action",icon:S?"fa-pause":"fa-play","aria-label":o(S?"action.disableAutoRotate":"action.enableAutoRotate"),onClick:G,children:o(S?"action.disableAutoRotate":"action.enableAutoRotate")}),B.jsx(_a,{className:"skincrafter-secondary-action disabled:opacity-50 disabled:cursor-not-allowed",icon:"fa-download","aria-label":o("action.downloadSkin"),onClick:X,disabled:!I,children:o("action.download")})]})]})}function pA({left:r,right:e}){return B.jsxs("div",{className:"flex-1 min-h-0 flex flex-col md:flex-row",children:[B.jsx("div",{className:"flex-1 min-h-0 w-full md:w-1/2",children:r}),B.jsx("div",{className:"flex-1 min-h-0 w-full md:w-1/2",children:e})]})}function mA(r,e){if(r.length===0)return null;for(const t of r){const o=t.top+(t.bottom-t.top)/2;if(e<o)return{targetLayer:t.layer,position:"before"};if(e<=t.bottom)return{targetLayer:t.layer,position:"after"}}return{targetLayer:r[r.length-1].layer,position:"after"}}function gA(r,e,t,o){if(!r.includes(e)||!r.includes(t))return[...r];if(e===t)return[...r];const s=r.filter(c=>c!==e),l=s.indexOf(t)+(o==="after"?1:0);return s.splice(l,0,e),s}function vA({heading:r,icon:e,iconClassName:t="skincrafter-category-icon",className:o="",children:s,...l}){return B.jsxs("div",{className:`option-card skincrafter-surface p-4 pixel-border relative ${r?"pt-5":""} ${o}`,...l,children:[r&&B.jsxs("h3",{className:"font-medium mb-2 flex items-center absolute -top-3 left-4 px-2 skincrafter-surface skincrafter-heading z-10",children:[e&&B.jsx(di,{name:e,className:`skincrafter-heading-icon ${t}`.trim()}),r]}),s]})}function $n(r){const e=(r.tintable===void 0?[]:Array.isArray(r.tintable)?r.tintable:[r.tintable]).map(t=>typeof t=="string"?{texture:t}:{...t});if(e.length===0&&!r.fixed)throw new Error("A texture-backed option must define a tintable layer, a fixed layer, or both.");return e.length>0?{tintable:e,...r.fixed?{fixed:r.fixed}:{}}:{fixed:r.fixed}}function _A(r,e){return r.tintable?{tintable:r.tintable.map(t=>({texture:af(t.texture,e),...t.colorSlot?{colorSlot:t.colorSlot}:{}})),...r.fixed?{fixed:af(r.fixed,e)}:{}}:{fixed:af(r.fixed,e)}}const Pv=r=>/^#[0-9a-f]{6}$/i.test(r);function xA(r,e){const t=r??[],o=e??[];return t.length!==o.length?!1:t.every((s,l)=>{const c=o[l];return!!c&&s.id===c.id&&s.labelKey===c.labelKey&&s.defaultColor===c.defaultColor&&s.palette.length===c.palette.length&&s.palette.every((d,f)=>d===c.palette[f])})}function yA(r){const e=r.textureLayers.tintable??[],t=r.colorSlots??[];if(e.length===0){if(t.length>0)throw new Error("A fixed-only texture item must not define color slots.");return}if(t.length===0)throw new Error("Every tintable texture item must define at least one color slot.");const o=new Map;for(const l of t){if(!l.id.trim())throw new Error("Texture item color slot ids must not be empty.");if(o.has(l.id))throw new Error(`Texture item color slot "${l.id}" is defined more than once.`);if(l.palette.length===0)throw new Error(`Texture item color slot "${l.id}" must define a non-empty palette.`);if(!Pv(l.defaultColor)||l.palette.some(c=>!Pv(c)))throw new Error(`Texture item color slot "${l.id}" must use #RRGGBB palette colors.`);if(!l.palette.includes(l.defaultColor))throw new Error(`Texture item color slot "${l.id}" defaultColor must be present in its palette.`);o.set(l.id,l)}const s=new Set;for(const l of e){if(!l.colorSlot||!o.has(l.colorSlot))throw new Error("Every tintable texture layer must reference a declared colorSlot.");s.add(l.colorSlot)}for(const l of t)if(!s.has(l.id))throw new Error(`Texture item color slot "${l.id}" is not used by any tintable layer.`)}function Rs(r){const e=r.skinModel;if(e!=="classic"&&e!=="slim")throw new Error('A texture item must define skinModel as "classic" or "slim".');return yA(r),{...r,skinModel:e,...r.colorSlots?{colorSlots:r.colorSlots.map(t=>({...t,palette:[...t.palette]}))}:{}}}function To(r){const e={};for(const o of["classic","slim"]){const s=r[o];if(!s)continue;const l=Rs(s);if(l.skinModel!==o)throw new Error(`Texture item variant "${o}" must declare the same skinModel.`);e[o]=l}const t=Object.values(e).filter(o=>!!o?.colorSlots?.length);if(t.length>1){const o=t[0].colorSlots;if(t.some(s=>!xA(s.colorSlots,o)))throw new Error("Colorable texture item variants must define identical color slots across skin models.")}return e}function SA(r,e){return{skinModel:r.skinModel,textureLayers:_A(r.textureLayers,e),...r.colorSlots?{colorSlots:r.colorSlots}:{}}}function Vu(r,e,t){const o=r[e];return o?SA(o,t):null}function EA(r,e){return r.skinModel===e}function MA(r,e){if(!r)return[];const t=new Map((r.colorSlots??[]).map(s=>[s.id,s])),o=[];for(const s of r.textureLayers.tintable??[]){const l=s.colorSlot?t.get(s.colorSlot):void 0;o.push({url:s.texture,role:"tintable",tint:(s.colorSlot?e?.[s.colorSlot]:void 0)??l?.defaultColor??"#FFFFFF"})}return r.textureLayers.fixed&&o.push({url:r.textureLayers.fixed,role:"fixed"}),o}const Fa=Rs,Ah=To,bh=Vu,wA=EA,TA=["None","Duck"],CA={Duck:Ah({classic:Fa({skinModel:"classic",textureLayers:$n({fixed:"textures/hat/duck.png"})}),slim:Fa({skinModel:"slim",textureLayers:$n({fixed:"textures/hat/duck.png"})})})};function RA(r,e,t){return r==="None"?null:bh(CA[r],e,t)}const AA=["None","Pants"],bA={Pants:Ah({classic:Fa({skinModel:"classic",textureLayers:$n({fixed:"textures/bottom/pants.png"})}),slim:Fa({skinModel:"slim",textureLayers:$n({fixed:"textures/bottom/pants.png"})})})};function PA(r,e,t){return r==="None"?null:bh(bA[r],e,t)}const Eo={id:"iris",labelKey:"category.eyesColor",defaultColor:"#2F5D9B",palette:["#2F5D9B","#2F8F4E","#5B3A29"]},Y_={id:"primary",labelKey:"category.hairColor",defaultColor:"#4A2F20",palette:["#4A2F20","#D6B15D","#1F1A17"]};function uf(r,e){return To({classic:Rs({skinModel:"classic",textureLayers:r,colorSlots:[e]}),slim:Rs({skinModel:"slim",textureLayers:r,colorSlots:[e]})})}const q_={Classic:uf($n({tintable:{texture:"textures/eyes/clasic.tintable.png",colorSlot:Eo.id},fixed:"textures/eyes/clasic.fixed.png"}),Eo),Small:uf($n({tintable:{texture:"textures/eyes/small.tintable.png",colorSlot:Eo.id}}),Eo),Big:uf($n({tintable:{texture:"textures/eyes/big.tintable.png",colorSlot:Eo.id},fixed:"textures/eyes/big.fixed.png"}),Eo)},K_={None:null},LA=Object.keys(q_),DA=Object.keys(K_);function NA(r,e,t){const o=q_[r];return o?Vu(o,e,t):null}function UA(r,e,t){const o=K_[r];return o?Vu(o,e,t):null}function Z_(){return Eo.palette}function J_(){return Y_.palette}function IA(){return Y_}function FA(r){return{id:"skin",labelKey:"category.skinColor",defaultColor:r[0],palette:r}}function xa(r,e,t){return Rs({skinModel:r,textureLayers:e,colorSlots:[FA(t)]})}const cf=["#D5BAAA","#E0AC69","#C68642"],kA=["#5D4037","#8D6E63","#A1887F"],Lv=["#558B2F","#7CB342"],Dv=["#556B2F"],Nv=["#FFFFFF"],Ph={Human:{skinColors:cf,sexes:{classic:"Male",slim:"Female"},variants:To({classic:xa("classic",$n({tintable:{texture:"textures/race/human/male.tintable.png",colorSlot:"skin"},fixed:"textures/race/human/male.fixed.png"}),cf),slim:xa("slim",$n({tintable:{texture:"textures/race/human/female.tintable.png",colorSlot:"skin"},fixed:"textures/race/human/female.fixed.png"}),cf)})},Bear:{skinColors:kA,sexes:{classic:"Male"},variants:To({classic:Rs({skinModel:"classic",textureLayers:$n({fixed:"textures/race/bear/male.fixed.png"})})})},Orc:{skinColors:Lv,sexes:{classic:"Male"},variants:To({classic:xa("classic",$n({tintable:{texture:"textures/race/orc/male.tintable.png",colorSlot:"skin"},fixed:"textures/race/orc/male.fixed.png"}),Lv)})},Zombie:{skinColors:Dv,sexes:{classic:"Male"},variants:To({classic:xa("classic",$n({tintable:{texture:"textures/race/zombie/male.tintable.png",colorSlot:"skin"},fixed:"textures/race/zombie/male.fixed.png"}),Dv)})},Template:{skinColors:Nv,sexes:{classic:"None"},variants:To({classic:xa("classic",$n({tintable:{texture:"textures/race/template/none.tintable.png",colorSlot:"skin"},fixed:"textures/race/template/none.fixed.png"}),Nv)})}};function OA(r){const e=Object.values(Ph[r].sexes).flatMap(t=>t?[t]:[]);return[...new Set(e)]}function Q_(r){return Ph[r].skinColors}function BA(r,e,t){return Vu(Ph[r].variants,e,t)}const e0=["Human","Bear","Orc","Zombie"],zA=["None","Hoodie"],Uv=["#4A6FA5","#A33A3A","#2F8F4E","#D6B15D","#7047A3","#5B3A29","#1F1A17","#FFFFFF"],HA={Hoodie:Ah({classic:Fa({skinModel:"classic",textureLayers:$n({tintable:[{texture:"textures/top/male/hoodie.png",colorSlot:"primary"}]}),colorSlots:[{id:"primary",labelKey:"wardrobeColor.primary",defaultColor:Uv[0],palette:Uv}]})})};function VA(r,e,t){return r==="None"?null:bh(HA[r],e,t)}const Ji=[{id:"race",labelKey:"category.race",icon:"fa-user-tag",control:"choice"},{id:"sex",labelKey:"category.sex",icon:"fa-venus-mars",control:"choice"},{id:"skinColor",labelKey:"category.skinColor",icon:"fa-palette",control:"color"},{id:"eyes",labelKey:"category.eyes",icon:"fa-eye",control:"choice"},{id:"eyesColor",labelKey:"category.eyesColor",icon:"fa-eye-dropper",control:"color"},{id:"hair",labelKey:"category.hair",icon:"fa-scissors",control:"choice"},{id:"hairColor",labelKey:"category.hairColor",icon:"fa-fill-drip",control:"color"},{id:"hat",labelKey:"category.hat",icon:"fa-hat-cowboy",control:"choice"},{id:"shirt",labelKey:"category.shirt",icon:"fa-shirt",control:"choice"},{id:"pants",labelKey:"category.pants",icon:"fa-person",control:"choice"},{id:"shoes",labelKey:"category.shoes",icon:"fa-shoe-prints",control:"choice"},{id:"accessory",labelKey:"category.accessory",icon:"fa-gem",control:"choice"}],t0=[{ownerCategoryId:"race",colorControlId:"skinColor",slotId:"skin"},{ownerCategoryId:"eyes",colorControlId:"eyesColor",slotId:"iris"},{ownerCategoryId:"hair",colorControlId:"hairColor",slotId:"primary"}],GA={race:"race",sex:"race",skinColor:"race",eyes:"eyes",eyesColor:"eyes",hair:"hair",hairColor:"hair",hat:"hat",shirt:"shirt",pants:"pants",shoes:"shoes",accessory:"accessory"};function WA(r){return GA[r]}function n0(r){return t0.find(e=>e.ownerCategoryId===r)??null}function r0(r){return t0.find(e=>e.colorControlId===r)??null}function XA(r){return r0(r)!==null}const Wr={race:"Human",sex:"Male",skinColor:Q_("Human")[0],eyes:"Classic",eyesColor:Z_()[0],hair:"None",hairColor:J_()[0],hat:"None",shirt:"None",pants:"None",shoes:"None",accessory:"None"},Qi=["hat","shirt","pants","shoes","accessory"],vs={id:"None",labelKey:"option.none",textureItem:null,textureLayers:null},jA={Male:{id:"Male",labelKey:"option.sex.Male",textureItem:null,textureLayers:null},Female:{id:"Female",labelKey:"option.sex.Female",textureItem:null,textureLayers:null},None:vs};function Xa(r){return r.sex==="Female"?"slim":"classic"}function Au(r,e,t){return t?[{id:r,labelKey:e,textureItem:t,textureLayers:t.textureLayers,...t.colorSlots?{colorSlots:t.colorSlots}:{}}]:[]}function df(r,e,t,o){return!t||!wA(t,o)?[]:Au(r,e,t)}function Iv(r,e="option.color"){const t={"#2F5D9B":`${e}.blue`,"#2F8F4E":`${e}.green`,"#5B3A29":`${e}.brown`,"#4A2F20":`${e}.brown`,"#D6B15D":`${e}.blond`,"#1F1A17":`${e}.black`};return r.map(o=>({id:o,labelKey:t[o]??`option.skinColor.${o}`,color:o}))}function mi(r,e,t,o=Xa(e)){return r==="race"?e0.flatMap(s=>Au(s,`option.race.${s}`,BA(s,o,t))):r==="sex"?OA(e.race).map(s=>jA[s]):r==="skinColor"?Q_(e.race).map(s=>({id:s,labelKey:`option.skinColor.${s}`,color:s})):r==="eyes"?LA.flatMap(s=>Au(s,`option.eyes.${s}`,NA(s,o,t))):r==="eyesColor"?Iv(Z_()):r==="hair"?DA.flatMap(s=>s==="None"?[vs]:Au(s,`option.hair.${s}`,UA(s,o,t))):r==="hairColor"?Iv(J_()):r==="hat"?TA.flatMap(s=>s==="None"?[vs]:df(s,`option.hat.${s}`,RA(s,o,t),o)):r==="shirt"?zA.flatMap(s=>s==="None"?[vs]:df(s,`option.shirt.${s}`,VA(s,o,t),o)):r==="pants"?AA.flatMap(s=>s==="None"?[vs]:df(s,`option.pants.${s}`,PA(s,o,t),o)):[vs]}function Gu(r,e){const t={...Wr,...r??{}};(e?mi("race",t,void 0,e).map(c=>c.id):[...e0]).includes(t.race)||(t.race=Wr.race);const o=mi("sex",t).map(c=>c.id);o.includes(t.sex)||(t.sex=o[0]??Wr.sex);const s=e??Xa(t),l=mi("skinColor",t,void 0,s).map(c=>c.id);return l.includes(t.skinColor)||(t.skinColor=l[0]??Wr.skinColor),Ji.forEach(c=>{if(c.id==="race"||c.id==="sex"||c.id==="skinColor")return;const d=mi(c.id,t,void 0,s).map(f=>f.id);d.includes(t[c.id])||(t[c.id]=d[0]??"None")}),t}function $A(r){const e=new Map;for(const t of["classic","slim"])for(const o of mi(r,Wr,void 0,t)){const s=e.get(o.id);(!s||!s.textureItem?.colorSlots?.length&&o.textureItem?.colorSlots?.length)&&e.set(o.id,o)}return[...e.values()]}function pr(r){const e={};for(const t of Qi){const o={};for(const s of $A(t)){const l=s.textureItem?.colorSlots??[];if(l.length===0)continue;const c={};for(const d of l){const f=r?.[t]?.[s.id]?.[d.id];c[d.id]=typeof f=="string"&&d.palette.includes(f)?f:d.defaultColor}o[s.id]=c}Object.keys(o).length>0&&(e[t]=o)}return e}function Wu(r){const e={};for(const t of Qi){const o=r[t];o&&(e[t]=Object.fromEntries(Object.entries(o).map(([s,l])=>[s,{...l}])))}return e}function eo(r){const e=new Set(Qi),t=[];return(r??[]).forEach(o=>{e.has(o)&&!t.includes(o)&&t.push(o)}),Qi.forEach(o=>{t.includes(o)||t.push(o)}),t}function ff(r){const e=n0(r);return({appearance:t,assetBaseUrl:o,skinModel:s})=>{const l=mi(r,t,o,s).find(d=>d.id===t[r]),c=e?{[e.slotId]:t[e.colorControlId]}:void 0;return{item:l?.textureItem??null,colors:c}}}function ya(r){return({appearance:e,assetBaseUrl:t,skinModel:o,wardrobeColors:s})=>({item:mi(r,e,t,o).find(l=>l.id===e[r])?.textureItem??null,colors:s[r]?.[e[r]]})}const YA={race:ff("race"),eyes:ff("eyes"),hair:ff("hair"),hat:ya("hat"),shirt:ya("shirt"),pants:ya("pants"),shoes:ya("shoes"),accessory:ya("accessory")};function i0(r){return["race","eyes","hair",...eo(r)]}function o0(r,e){const t=YA[r](e);return MA(t.item,t.colors)}function qA(r,e=Qi,t,o=Xa(r),s){const l={appearance:r,assetBaseUrl:t,skinModel:o,wardrobeColors:pr(s)};return i0(e).flatMap(c=>o0(c,l))}function KA(r,e,t,o,s=Xa(r),l){const c=new Set(t.map(WA)),d={appearance:r,assetBaseUrl:o,skinModel:s,wardrobeColors:pr(l)};return i0(e).filter(f=>c.has(f)).flatMap(f=>o0(f,d))}function ZA(r,e,t,o=Xa(e)){const s=r0(r);return s?!!mi(s.ownerCategoryId,e,t,o).find(l=>l.id===e[s.ownerCategoryId])?.textureItem?.colorSlots?.some(l=>l.id===s.slotId):!0}function s0({colorSlots:r,colors:e,onChange:t,t:o,testId:s="texture-item-color-palettes"}){return r.length===0?null:B.jsx("div",{className:"mt-2 space-y-2","data-testid":s,children:r.map(l=>{const c=e?.[l.id]??l.defaultColor,d=o(l.labelKey);return B.jsxs("div",{"data-color-slot":l.id,children:[B.jsx("div",{className:"text-xs font-semibold mb-1",children:d}),B.jsx("div",{className:"flex flex-wrap gap-1.5",role:"group","aria-label":d,children:l.palette.map(f=>{const p=c===f;return B.jsx("button",{type:"button",className:`color-option-swatch h-7 w-7 border pixel-border ${p?"is-selected":""}`,style:{backgroundColor:f},"aria-label":`${d}: ${f}`,"aria-pressed":p,onClick:()=>t(l.id,f),children:p&&B.jsx(di,{name:"fa-check"})},f)})})]},l.id)})})}function JA(r){return B.jsx(s0,{...r,testId:"wardrobe-color-palettes"})}const vu=r=>Qi.includes(r),Fv=(r,e)=>r.length===e.length&&r.every((t,o)=>t===e[o]);function QA({appearance:r,textureLayerOrder:e,wardrobeColors:t,onAppearanceChange:o,onWardrobeColorChange:s,onLayerOrderChange:l,t:c,assetBaseUrl:d,skinModel:f}){const[p,m]=O.useState(null),[v,y]=O.useState(null),[S,E]=O.useState(null),[M,x]=O.useState(null),_=O.useRef(null),L=O.useRef(null),P=O.useRef(null),A=O.useRef(null),G=O.useRef([]),I=O.useRef(new Map),k=O.useMemo(()=>new Map(Ji.map(K=>[K.id,K])),[]),X=O.useMemo(()=>Ji.filter(K=>!vu(K.id)&&!XA(K.id)),[]),b=p&&v?v:e,C=O.useMemo(()=>b.map(K=>k.get(K)).filter(K=>!!K),[k,b]);O.useLayoutEffect(()=>{const K=A.current;if(!K)return;const Ee=new Map;K.querySelectorAll("[data-layer-id]").forEach(be=>{const ot=be.dataset.layerId;if(!ot||!vu(ot))return;const Ze=be.offsetTop,N=I.current.get(ot);if(Ee.set(ot,Ze),N===void 0||N===Ze||typeof be.animate!="function")return;typeof be.getAnimations=="function"&&be.getAnimations().filter(pt=>pt.id==="skincrafter-layer-preview").forEach(pt=>pt.cancel());const mt=be.animate([{transform:`translateY(${N-Ze}px)`},{transform:"translateY(0)"}],{duration:150,easing:"ease-out"});mt.id="skincrafter-layer-preview"}),I.current=Ee},[b]);const V=K=>{const Ee=A.current;if(!Ee)return[];const be=Ee.getBoundingClientRect().top;return[...Ee.querySelectorAll("[data-layer-id]")].flatMap(ot=>{const Ze=ot.dataset.layerId;if(!Ze||!vu(Ze)||Ze===K)return[];const N=ot.getBoundingClientRect();return[{layer:Ze,top:N.top-be,bottom:N.bottom-be}]})},ae=K=>{const Ee=A.current;if(!Ee)return null;const be=K-Ee.getBoundingClientRect().top;return mA(G.current,be)},J=()=>{_.current=null,L.current=null,P.current=null,G.current=[],m(null),y(null),E(null),x(null)},ee=(K,Ee)=>{const be=[...e];G.current=V(K),_.current=K,L.current=be,m(K),y(be),E(null),x(Ee)},fe=(K,Ee)=>{const be=_.current;if(!be)return;const ot=gA(e,be,K,Ee);L.current=ot,y(Ze=>Ze&&Fv(Ze,ot)?Ze:ot),E({targetLayer:K,position:Ee})},ue=()=>{const K=L.current,Ee=K&&!Fv(K,e);J(),Ee&&K&&l(K)},he=(K,Ee)=>{const be=e.indexOf(K),ot=be+Ee;if(be<0||ot<0||ot>=e.length)return;const Ze=[...e];[Ze[be],Ze[ot]]=[Ze[ot],Ze[be]],l(Ze)},z=(K,Ee)=>{if(ee(Ee,{x:K.clientX,y:K.clientY,pointerType:"mouse"}),K.dataTransfer.effectAllowed="move",K.dataTransfer.setData("text/plain",Ee),typeof K.dataTransfer.setDragImage=="function"){const be=document.createElement("div");be.style.position="fixed",be.style.left="-10000px",be.style.top="-10000px",be.style.width="1px",be.style.height="1px",be.style.opacity="0",document.body.appendChild(be),K.dataTransfer.setDragImage(be,0,0),window.setTimeout(()=>be.remove(),0)}},de=K=>{!_.current||K.clientX===0&&K.clientY===0||x({x:K.clientX,y:K.clientY,pointerType:"mouse"})},le=()=>{_.current&&J()},F=K=>{if(!_.current)return;K.preventDefault(),K.dataTransfer.dropEffect="move";const Ee=ae(K.clientY);Ee&&fe(Ee.targetLayer,Ee.position)},oe=K=>{K.preventDefault(),ue()},Oe=(K,Ee)=>{if(!(K.pointerType==="mouse"||K.button>0||!(K.target instanceof Element?K.target:null)?.closest("h3"))){K.preventDefault(),P.current=K.pointerId;try{K.currentTarget.setPointerCapture(K.pointerId)}catch{}ee(Ee,{x:K.clientX,y:K.clientY,pointerType:"touch"})}},ne=K=>{if(K.pointerId!==P.current||!_.current)return;K.preventDefault(),x({x:K.clientX,y:K.clientY,pointerType:"touch"});const Ee=ae(K.clientY);Ee&&fe(Ee.targetLayer,Ee.position)},me=K=>{if(K.pointerId===P.current){K.preventDefault();try{K.currentTarget.releasePointerCapture(K.pointerId)}catch{}ue()}},Ce=K=>{K.pointerId===P.current&&J()},Se=K=>{const Ee=mi(K.id,r,d,f),be=vu(K.id)?K.id:null,ot=be?e.indexOf(be):-1,Ze=be&&S?.targetLayer===be,N=Ee.find(He=>r[K.id]===He.id),mt=n0(K.id),pt=mt?N?.textureItem?.colorSlots?.filter(He=>He.id===mt.slotId)??[]:[],Mt=mt&&ZA(mt.colorControlId,r,d,f)?pt:mt&&K.id==="hair"&&N?.id==="None"?[IA()]:[],Be=be?N?.textureItem?.colorSlots??[]:[],ht=be&&N?t?.[be]?.[N.id]:void 0,et=mt?{[mt.slotId]:r[mt.colorControlId]}:void 0;return B.jsxs(vA,{heading:c(K.labelKey),icon:K.icon,className:`wardrobe-option-card p-2.5 pt-6 ${be?"layer-order-card":""} ${be===p?"is-dragging":""} ${Ze?`drop-${S.position}`:""}`,"data-layer-id":be??void 0,onPointerDown:be?He=>Oe(He,be):void 0,onPointerMove:be?ne:void 0,onPointerUp:be?me:void 0,onPointerCancel:be?Ce:void 0,children:[be&&B.jsxs("div",{className:"layer-order-controls",children:[B.jsx("button",{type:"button",className:"layer-order-nudge","aria-label":`${c("action.moveLayerUp")} ${c(K.labelKey)}`,title:c("action.moveLayerUp"),disabled:ot<=0,onClick:()=>he(be,-1),children:B.jsx(di,{name:"fa-chevron-up"})}),B.jsx("button",{type:"button",className:"layer-order-handle","aria-label":`${c("action.dragLayer")} ${c(K.labelKey)}`,title:c("action.dragLayer"),draggable:!0,onDragStart:He=>z(He,be),onDrag:de,onDragEnd:le,children:B.jsx(di,{name:"fa-grip-vertical"})}),B.jsx("button",{type:"button",className:"layer-order-nudge","aria-label":`${c("action.moveLayerDown")} ${c(K.labelKey)}`,title:c("action.moveLayerDown"),disabled:ot>=e.length-1,onClick:()=>he(be,1),children:B.jsx(di,{name:"fa-chevron-down"})})]}),B.jsx("div",{className:K.control==="color"?"mt-2 flex flex-wrap gap-1.5":"mt-2 grid grid-cols-2 lg:grid-cols-3 gap-1.5",role:"group","aria-label":c(K.labelKey),children:Ee.map(He=>{const Tt=r[K.id]===He.id;return K.control==="color"?B.jsx("button",{type:"button",className:`color-option-swatch h-7 w-7 border pixel-border ${Tt?"is-selected":""}`,style:{backgroundColor:He.color??He.id},"aria-label":c(He.labelKey),"aria-pressed":Tt,onClick:()=>o(K.id,He.id),children:Tt&&B.jsx(di,{name:"fa-check"})},He.id):B.jsx("button",{type:"button",className:`pixel-button min-h-8 px-2 py-1 border text-xs leading-tight transition-colors ${Tt?"skincrafter-option-selected":"skincrafter-secondary-action"}`,"aria-pressed":Tt,onClick:()=>o(K.id,He.id),children:c(He.labelKey)},He.id)})}),mt&&Mt.length>0&&B.jsx(s0,{colorSlots:Mt,colors:et,t:c,testId:`appearance-color-palettes-${K.id}`,onChange:(He,Tt)=>o(mt.colorControlId,Tt)}),be&&N&&Be.length>0&&B.jsx(JA,{colorSlots:Be,colors:ht,t:c,onChange:(He,Tt)=>s?.(be,N.id,He,Tt)})]},K.id)},Ae=p?k.get(p):null;return B.jsxs(V_,{title:c("panel.customization"),icon:"fa-sliders",className:"overflow-visible md:overflow-hidden customization-panel p-3",children:[B.jsxs("div",{className:"space-y-1.5 options-container md:flex-1 md:min-h-0",children:[X.map(Se),B.jsx("div",{ref:A,className:"layer-order-list space-y-1.5",onDragOver:F,onDrop:oe,children:C.map(Se)})]}),M&&Ae&&B.jsxs("div",{className:`layer-drag-ghost ${M.pointerType==="touch"?"is-touch":""}`,style:{left:M.x,top:M.y},"aria-hidden":"true","data-testid":"layer-drag-ghost",children:[B.jsx(di,{name:Ae.icon}),B.jsx("span",{children:c(Ae.labelKey)})]})]})}const kv=[137,80,78,71,13,10,26,10],Uu=64;class rr extends Error{cause;constructor(e,t){super(e),this.name="InvalidInitialSkinError",this.cause=t}}function eb(r){let e="";for(let t=0;t<r.length;t+=32768){const o=r.subarray(t,Math.min(t+32768,r.length));e+=String.fromCharCode(...o)}return`data:image/png;base64,${btoa(e)}`}async function tb(r){const e=globalThis.crypto?.subtle;if(!e)throw new rr("Initial skin fingerprint could not be computed because Web Crypto is unavailable.");try{const t=new Uint8Array(r.byteLength);t.set(r);const o=await e.digest("SHA-256",t);return Array.from(new Uint8Array(o),s=>s.toString(16).padStart(2,"0")).join("")}catch(t){throw new rr("Initial skin fingerprint could not be computed.",t)}}function nb(r){if(r.length<24)throw new rr("Initial skin is not a valid PNG file.");for(let s=0;s<kv.length;s+=1)if(r[s]!==kv[s])throw new rr("Initial skin is not a valid PNG file.");const e=new DataView(r.buffer,r.byteOffset,r.byteLength),t=e.getUint32(8),o=String.fromCharCode(r[12],r[13],r[14],r[15]);if(t!==13||o!=="IHDR")throw new rr("Initial skin PNG is missing a valid IHDR header.");return{width:e.getUint32(16),height:e.getUint32(20)}}async function rb(r){return typeof r.arrayBuffer=="function"?new Uint8Array(await r.arrayBuffer()):new Promise((e,t)=>{const o=new FileReader;o.onload=()=>{if(!(o.result instanceof ArrayBuffer)){t(new Error("Blob reader did not return an ArrayBuffer."));return}e(new Uint8Array(o.result))},o.onerror=()=>t(o.error??new Error("Blob reader failed.")),o.readAsArrayBuffer(r)})}async function ib(r){await new Promise((e,t)=>{const o=new Image;o.onload=()=>{const s=o.naturalWidth||o.width,l=o.naturalHeight||o.height;if(o.onload=null,o.onerror=null,s!==Uu||l!==Uu){t(new rr("Initial skin must be a 64x64 Minecraft PNG."));return}e()},o.onerror=s=>{o.onload=null,o.onerror=null,t(new rr("Initial skin PNG could not be decoded.",s))},o.src=r})}async function ob(r,e){if(r.type&&r.type.toLowerCase()!=="image/png")throw new rr("Initial skin must use the image/png MIME type.");let t;try{t=await rb(r)}catch(c){throw new rr("Initial skin data could not be read.",c)}const o=nb(t);if(o.width!==Uu||o.height!==Uu)throw new rr("Initial skin must be a 64x64 Minecraft PNG.");const s=eb(t);await ib(s);const l=await tb(t);return{dataUrl:s,fingerprint:l,model:e}}function sb(r){const[e,t]=r.split(",",2),o=e.match(/^data:([^;]+);base64$/)?.[1]??"image/png",s=atob(t??""),l=new Uint8Array(s.length);for(let c=0;c<s.length;c+=1)l[c]=s.charCodeAt(c);return new Blob([l],{type:o})}function ab(r,e,t,o=e.sex==="Female"?"slim":"classic",s){const l=sb(r),c=new File([l],"skincrafter-skin.png",{type:"image/png"}),d=pr(s);return{blob:l,file:c,dataUrl:r,metadata:{width:64,height:64,mimeType:"image/png",model:o,appearance:{...e},layerOrder:[...t],wardrobeColors:Wu(d)}}}const wa=2,lb=new Map([[0,r=>({...r,schemaVersion:1})],[1,r=>({...r,schemaVersion:2,wardrobeColors:r.wardrobeColors??{}})]]);function Ra(r){return typeof r=="object"&&r!==null&&!Array.isArray(r)}function kr(r){return{success:!1,error:{code:"invalid_state",message:r}}}function Ov(r){return{success:!1,error:{code:"unsupported_schema_version",message:`Unsupported SkinCrafter state schema version: ${r}.`,schemaVersion:r}}}function ub(r){return{schemaVersion:wa,appearance:Gu(r.appearance),layerOrder:eo(r.layerOrder),wardrobeColors:pr(r.wardrobeColors)}}function Lh(r){const e=ub(r);return{...e,appearance:{...e.appearance},layerOrder:[...e.layerOrder],wardrobeColors:Wu(e.wardrobeColors)}}function cb(r){const e={};for(const t of Qi){const o=r[t];if(o===void 0)continue;if(!Ra(o))return`SkinCrafter persisted wardrobeColors.${t} must be an object.`;const s={};for(const[l,c]of Object.entries(o)){if(!Ra(c))return`SkinCrafter persisted wardrobeColors.${t}.${l} must be an object.`;const d={};for(const[f,p]of Object.entries(c)){if(typeof p!="string")return`SkinCrafter persisted wardrobeColors.${t}.${l}.${f} must be a string.`;d[f]=p}s[l]=d}e[t]=s}return e}function a0(r){if(!Ra(r))return kr("SkinCrafter persisted state must be an object.");const e=[],t=r.schemaVersion;let o,s;if(t===void 0)o=null,e.push({code:"legacy_unversioned",message:"Migrated legacy unversioned SkinCrafter state."}),s={...r,schemaVersion:0};else{if(typeof t!="number"||!Number.isInteger(t)||t<0)return kr("SkinCrafter schemaVersion must be a non-negative integer.");if(o=t,o>wa)return Ov(o);s={...r}}let l=o??0;for(;l<wa;){const x=lb.get(l);if(!x)return Ov(l);const _=l+1;s=x(s),e.push({code:"schema_version_migrated",message:`Migrated SkinCrafter state schema from version ${l} to ${_}.`,from:l,to:_}),l=_}if(s.schemaVersion!==wa)return kr("SkinCrafter state migration did not produce the current schema version.");const c=o===null||o===0;if(!Ra(s.appearance))return kr("SkinCrafter persisted appearance must be an object.");const d={};for(const x of Ji){const _=s.appearance[x.id];if(_===void 0){if(!c)return kr(`SkinCrafter persisted appearance is missing ${x.id}.`);continue}if(typeof _!="string")return kr(`SkinCrafter persisted appearance.${x.id} must be a string.`);d[x.id]=_}const f=s.layerOrder;if(f===void 0&&!c)return kr("SkinCrafter persisted state is missing layerOrder.");if(f!==void 0&&(!Array.isArray(f)||f.some(x=>typeof x!="string")))return kr("SkinCrafter persisted layerOrder must be an array of strings.");if(!Ra(s.wardrobeColors))return kr("SkinCrafter persisted wardrobeColors must be an object.");const p=cb(s.wardrobeColors);if(typeof p=="string")return kr(p);const m=Gu(d);for(const x of Ji){const _=s.appearance[x.id],L=m[x.id];_!==L&&e.push({code:"appearance_value_defaulted",message:`Normalized persisted appearance.${x.id} to a supported value.`,path:x.id,from:_,to:L})}const v=f??[],y=eo(v);(v.length!==y.length||v.some((x,_)=>x!==y[_]))&&e.push({code:"layer_order_normalized",message:"Normalized persisted layer order by removing invalid/duplicate layers and appending missing layers.",path:"layerOrder",from:[...v],to:[...y]});const S=pr(p);JSON.stringify(p)!==JSON.stringify(S)&&e.push({code:"wardrobe_colors_normalized",message:"Normalized wardrobe color slots by removing unknown values and filling missing slots with defaults.",path:"wardrobeColors",from:p,to:S});const E={appearance:m,layerOrder:y,wardrobeColors:S},M=Lh(E);return{success:!0,state:E,serializedState:M,sourceSchemaVersion:o,migrated:o!==wa||e.length>0,notices:e}}class nh extends Error{assetUrl;cause;constructor(e,t){super(`Failed to load texture asset: ${e}`),this.name="TextureLoadError",this.assetUrl=e,this.cause=t}}const Xr=64,db=r=>r?typeof r=="string"?{url:r,role:"fixed"}:r.url?r.role==="tintable"?{url:r.url,role:"tintable",tint:r.tint}:{url:r.url,role:"fixed"}:null:null;function fb(r){const e=r.replace("#",""),t=e.length===3?e.split("").map(o=>`${o}${o}`).join(""):e;return{r:Number.parseInt(t.slice(0,2),16),g:Number.parseInt(t.slice(2,4),16),b:Number.parseInt(t.slice(4,6),16),a:255}}function hb(r,e){return r===Xr&&e===Xr}function pb(r,e){if(r.a===0)return r;const t=(r.r+r.g+r.b)/765;return{r:Math.round(e.r*t),g:Math.round(e.g*t),b:Math.round(e.b*t),a:r.a}}function mb(r,e){const t=new Uint8ClampedArray(r);for(let o=0;o<t.length;o+=4){const s=pb({r:r[o],g:r[o+1],b:r[o+2],a:r[o+3]},e);t[o]=s.r,t[o+1]=s.g,t[o+2]=s.b,t[o+3]=s.a}return t}const gb=(r,e,t)=>{const o=document.createElement("canvas");o.width=Xr,o.height=Xr;const s=o.getContext("2d",{willReadFrequently:!0});if(!s)throw new Error("Could not create a 2D canvas context for tintable skin composition.");s.imageSmoothingEnabled=!1,s.drawImage(e,0,0);const l=s.getImageData(0,0,Xr,Xr);l.data.set(mb(l.data,fb(t))),s.putImageData(l,0,0),r.drawImage(o,0,0)},vb=(r,e,t)=>{if(t.role==="fixed"){r.drawImage(e,0,0);return}gb(r,e,t.tint??"#FFFFFF")},_b=r=>new Promise((e,t)=>{const o=new Image;o.crossOrigin="anonymous",o.onload=()=>{const s=o.naturalWidth||o.width,l=o.naturalHeight||o.height;if(!hb(s,l)){t(new nh(r,new Error(`Skin texture atlas must be ${Xr}x${Xr}; got ${s}x${l}.`)));return}e(o)},o.onerror=s=>t(new nh(r,s)),o.src=r});async function Bv(r){const e=r.map(db).filter(l=>!!l);if(e.length===0)throw new Error("No texture assets were available for skin composition.");const t=await Promise.all(e.map(l=>_b(l.url))),o=document.createElement("canvas");o.width=Xr,o.height=Xr;const s=o.getContext("2d",{willReadFrequently:!0});if(!s)throw new Error("Could not create a 2D canvas context for skin composition.");return s.imageSmoothingEnabled=!1,t.forEach((l,c)=>vb(s,l,e[c])),o.toDataURL("image/png")}function Hr(r,e){return{appearance:Gu(r?.appearance??null,e),layerOrder:eo(r?.layerOrder),wardrobeColors:pr(r?.wardrobeColors)}}function xb(r,e){return JSON.stringify(pr(r))===JSON.stringify(pr(e))}function zv(r,e){return r.layerOrder.length!==e.layerOrder.length||r.layerOrder.some((t,o)=>t!==e.layerOrder[o])||!xb(r.wardrobeColors,e.wardrobeColors)?!1:Ji.every(({id:t})=>r.appearance[t]===e.appearance[t])}function l0(r,e){return{code:r==="load"?"persistence_load_failed":"persistence_save_failed",category:"persistence",message:r==="load"?"Failed to load persisted SkinCrafter state.":"Failed to save SkinCrafter state.",cause:e}}function Hv(r){try{const e=r?.load()??null;return e&&"status"in e?e.status==="incompatible"?{state:Hr(null),writesBlocked:!0,error:null}:e.status==="empty"?{state:Hr(null),writesBlocked:!1,error:null}:{state:Hr(e.state),writesBlocked:!1,error:null}:{state:Hr(e),writesBlocked:!1,error:null}}catch(e){return{state:Hr(null),writesBlocked:!0,error:l0("load",e)}}}function yb(r){return{appearance:{...r.appearance},layerOrder:[...r.layerOrder],wardrobeColors:Wu(pr(r.wardrobeColors))}}function Sb(r){return r?{"--skincrafter-accent":r.accent,"--skincrafter-accent-strong":r.accentStrong,"--skincrafter-surface":r.surface,"--skincrafter-text":r.text,"--skincrafter-muted":r.muted,"--skincrafter-border":r.border}:{}}function Eb(r){return r instanceof nh?{code:"asset_load_failed",category:"asset",message:`Failed to load skin texture asset: ${r.assetUrl}`,assetUrl:r.assetUrl,cause:r.cause}:{code:"generation_failed",category:"generation",message:"Failed to generate the current skin.",cause:r}}function Vv(r){return{code:"invalid_initial_skin",category:"input",message:r instanceof rr?r.message:"Initial skin must be a decodable 64x64 Minecraft PNG.",cause:r instanceof rr?r.cause??r:r}}function In(r,...e){if(r)try{r(...e)}catch(t){console.error("SkinCrafter host callback failed",t)}}function Mb({locale:r=Us,value:e,initialSkin:t,persistence:o,assetBaseUrl:s,onStateChange:l,onSkinChange:c,onSave:d,onStatusChange:f,onError:p,className:m="",style:v,theme:y,previewBottomOffset:S=0}){const E=t?.image??null,M=t?.model??null,x=E!==null,[_]=O.useState(()=>{if(e)return{state:Hr(e,M??void 0),writesBlocked:!1,error:null};const We=Hv(o);return t?{state:Hr(t,M??void 0),writesBlocked:We.writesBlocked,error:We.error}:We}),[L,P]=O.useState(_.state),[A,G]=O.useState(null),[I,k]=O.useState({key:null,status:"idle",error:null}),[X,b]=O.useState(null),[C,V]=O.useState({source:null,model:null,status:"idle",error:null}),[ae,J]=O.useState([]),ee=O.useRef(0),fe=O.useRef({}),ue=O.useRef(c),he=O.useRef(f),z=O.useRef(p),de=O.useRef(null),le=O.useRef(!1),F=O.useRef(null),oe=O.useRef("classic"),Oe=O.useRef(o),ne=O.useRef(!e),me=O.useRef(_.writesBlocked),Ce=O.useRef(_.error!==null),Se=O.useRef(!1),Ae=O.useRef(null),K=x&&M!==null&&X?.source===E&&X.model===M,Ee=K&&X?X.baselineState.appearance.sex:_.state.appearance.sex,be=ae.includes("sex"),ot=O.useMemo(()=>{if(!e)return null;const We=M!==null&&!be&&e.appearance.sex===Ee?M:void 0;return Hr(e,We)},[Ee,M,be,e]),Ze=O.useMemo(()=>{if(!K||M===null||be)return L;const We=Hr(L,M);return zv(L,We)?L:We},[K,M,L,be]),N=ot??Ze,mt=O.useMemo(()=>pr(N.wardrobeColors),[N.wardrobeColors]),pt=O.useRef(N);pt.current=N;const Mt=O.useCallback(We=>Wa(r,We),[r]),Be=O.useCallback(We=>{const qt=ee.current+1;ee.current=qt,fe.current[We]=qt,J(Et=>Et.includes(We)?Et:[...Et,We])},[]);O.useEffect(()=>{ot&&P(We=>zv(We,ot)?We:ot)},[ot]),O.useEffect(()=>{e||Ze===L||P(Ze)},[L,Ze,e]),O.useEffect(()=>{!e||!x||be||e.appearance.sex!==Ee&&Be("sex")},[x,Ee,Be,be,e]);const ht=O.useCallback(We=>{e||P(We),l?.(We)},[l,e]),et=O.useCallback((We,qt)=>{x&&Be(We);const Et=We==="sex"?qt==="Female"?"slim":"classic":oe.current;ht({...N,appearance:Gu({...N.appearance,[We]:qt},Et),wardrobeColors:mt})},[x,Be,ht,N,mt]),He=O.useCallback((We,qt,Et,kt)=>{x&&(e?Ae.current={category:We,itemId:qt,slotId:Et,color:kt}:Be(We));const Kt=Wu(mt),Ln=Kt[We]??{},Sn=Ln[qt]??{};Kt[We]={...Ln,[qt]:{...Sn,[Et]:kt}},ht({...N,wardrobeColors:pr(Kt)})},[x,Be,ht,N,mt,e]),Tt=O.useCallback(We=>{ht({...N,layerOrder:eo(We)})},[ht,N]);O.useEffect(()=>{const We=Ae.current;!We||!e||N.appearance[We.category]===We.itemId&&mt[We.category]?.[We.itemId]?.[We.slotId]===We.color&&(Ae.current=null,Be(We.category))},[K,Be,N.appearance,mt,e]),O.useEffect(()=>{Ae.current=null},[E,M]),O.useEffect(()=>{ue.current=c},[c]),O.useEffect(()=>{he.current=f},[f]),O.useEffect(()=>{z.current=p},[p]),O.useEffect(()=>{Se.current||!_.error||(Se.current=!0,In(z.current,_.error))},[_.error]),O.useEffect(()=>{if(!E){de.current=null,le.current=!1,b(null),ee.current=0,fe.current={},J([]),V({source:null,model:null,status:"idle",error:null});return}if(!M){le.current=!1;const kt=Vv(new rr("Initial skin model must be either classic or slim."));V({source:E,model:null,status:"error",error:kt}),In(he.current,"error"),In(z.current,kt);return}let We=!0;const qt=yb(pt.current),Et=ee.current;return V({source:E,model:M,status:"loading",error:null}),In(he.current,"generating"),ob(E,M).then(kt=>{if(!We)return;const Kt=de.current,Ln=Kt!==null&&Kt.fingerprint===kt.fingerprint&&Kt.model===kt.model,Sn=Ln?{...Kt,source:E}:{source:E,dataUrl:kt.dataUrl,fingerprint:kt.fingerprint,model:kt.model,baselineState:Hr(qt,kt.model)};if(le.current=Ln,de.current=Sn,b(Sn),!Ln){const Kn=Object.entries(fe.current).filter(([,En])=>(En??0)>Et).map(([En])=>En);J(Kn)}V({source:E,model:M,status:"ready",error:null}),Ln&&In(he.current,"ready")}).catch(kt=>{if(!We)return;le.current=!1;const Kt=Vv(kt);V({source:E,model:M,status:"error",error:Kt}),In(he.current,"error"),In(z.current,Kt)}),()=>{We=!1}},[E,M]),O.useEffect(()=>{if(!(e||Ce.current)){if(!ne.current||Oe.current!==o){const We=Hv(o);if(Oe.current=o,ne.current=!0,me.current=We.writesBlocked,We.error){Ce.current=!0,In(z.current,We.error);return}}if(!(me.current||!o))try{o.save(Lh(N))}catch(We){me.current=!0,Ce.current=!0,In(z.current,l0("save",We))}}},[o,N,e]);const D=O.useMemo(()=>{if(!K||!X)return[];const We=new Set(ae);for(const Et of Ji)N.appearance[Et.id]!==X.baselineState.appearance[Et.id]&&We.add(Et.id);const qt=pr(X.baselineState.wardrobeColors);for(const Et of Qi){const kt=N.appearance[Et];if(kt!==X.baselineState.appearance[Et])continue;const Kt=mt[Et]?.[kt]??{},Ln=qt[Et]?.[kt]??{};JSON.stringify(Kt)!==JSON.stringify(Ln)&&We.add(Et)}return Ji.map(Et=>Et.id).filter(Et=>We.has(Et))},[ae,K,X,N.appearance,mt]),{race:T,sex:Q,skinColor:pe,eyes:ve,eyesColor:ce,hair:Ke,hairColor:Le,hat:Ge,shirt:Je,pants:_e,shoes:ze,accessory:it}=N.appearance,nt=JSON.stringify(N.layerOrder),De=JSON.stringify(mt),st=JSON.stringify(D),W=s?.replace(/\/+$/,"")||void 0,Ne=D.includes("sex"),xe=K&&X&&!Ne?X.model==="slim"?"Female":"Male":Q,Ue=K&&X&&!Ne?X.model:Q==="Female"?"slim":"classic";oe.current=Ue;const we=K?X?.fingerprint??null:null,ge=K?X?.dataUrl??null:null,Ie=JSON.stringify([T,Q,pe,ve,ce,Ke,Le,Ge,Je,_e,ze,it,nt,De,W??null,we,Ue,st]),ct=A?.key===Ie?A:null,Lt=x&&C.source===E&&C.model===M,Ct=x&&(!Lt||C.status==="loading"),gn=Lt&&C.status==="error",rn=Ct?"generating":gn?"error":I.key===Ie?I.status:"idle",Si=gn?C.error:I.key===Ie?I.error:null;O.useEffect(()=>{if(x&&!K)return;if(le.current){const Sn=F.current===Ie;if(le.current=!1,Sn)return}let We=!0;const qt={race:T,sex:Q,skinColor:pe,eyes:ve,eyesColor:ce,hair:Ke,hairColor:Le,hat:Ge,shirt:Je,pants:_e,shoes:ze,accessory:it},Et={...qt,sex:xe},kt=JSON.parse(nt),Kt=JSON.parse(De),Ln=JSON.parse(st);return k({key:Ie,status:"generating",error:null}),In(he.current,"generating"),(async()=>{let Sn;try{let Kn;if(ge){const En=KA(Et,kt,Ln,W,Ue,Kt);Kn=En.filter(Boolean).length===0?ge:await Bv([ge,...En])}else{const En=qA(qt,kt,W,Ue,Kt);Kn=await Bv(En)}Sn={dataUrl:Kn,output:ab(Kn,qt,kt,Ue,Kt)}}catch(Kn){if(!We)return;const En=Eb(Kn);k({key:Ie,status:"error",error:En}),In(he.current,"error"),In(z.current,En);return}We&&(F.current=Ie,G({key:Ie,texture:Sn.dataUrl,output:Sn.output}),k({key:Ie,status:"ready",error:null}),In(ue.current,Sn.output),In(he.current,"ready"))})(),()=>{We=!1}},[it,st,W,xe,Ue,ve,ce,Ie,Ke,Le,x,Ge,ge,K,nt,_e,T,Q,Je,ze,pe,De]);const gr=ct??A,qn=ct?.output??null,vr=gr?.texture??null,qr=gr?.output.metadata.model??Ue,Pr=rn==="ready"&&qn!==null,Lr=d&&Pr&&qn?()=>d(qn):void 0,Lo=O.useCallback(We=>{In(z.current,We)},[]);return B.jsx("div",{className:`skincrafter-editor h-full min-h-0 w-full ${m}`.trim(),style:{...Sb(y),...v},"data-testid":"skincrafter-editor","data-skincrafter-locale":r,"data-skincrafter-generation-status":rn,children:B.jsx(pA,{left:B.jsx($_,{texture:vr,model:qr,footerHeight:S,t:Mt,onSave:Lr,canSave:Pr,generationStatus:rn,generationError:Si,onError:Lo}),right:B.jsx(QA,{appearance:N.appearance,textureLayerOrder:N.layerOrder,wardrobeColors:mt,onAppearanceChange:et,onWardrobeColorChange:He,onLayerOrderChange:Tt,t:Mt,assetBaseUrl:s,skinModel:Ue})})})}function wb({texture:r,model:e="classic",locale:t=Us,bottomOffset:o=0,className:s="",style:l,theme:c,onError:d}){const f=m=>Wa(t,m),p={"--skincrafter-accent":c?.accent,"--skincrafter-accent-strong":c?.accentStrong,"--skincrafter-surface":c?.surface,"--skincrafter-text":c?.text,"--skincrafter-muted":c?.muted,"--skincrafter-border":c?.border};return B.jsx("div",{className:`skincrafter-editor h-full min-h-0 ${s}`.trim(),style:{...p,...l},children:B.jsx($_,{texture:r,model:e,footerHeight:o,t:f,onError:d})})}const u0={en:{"skinView.error.usernameRequired":"Please enter a Minecraft username.","skinView.error.playerNotFound":"Minecraft player not found.","skinView.error.skinTextureMissing":"This player does not have an available skin texture.","skinView.error.network":"Could not reach PlayerDB. Check your connection and try again.","skinView.error.serviceUnavailable":"PlayerDB is temporarily unavailable. Try again later.","skinView.error.rateLimited":"Too many player lookup requests. Try again in a moment.","skinView.error.invalidResponse":"PlayerDB returned an unexpected response. Try again later.","notFound.title":"Page not found","notFound.description":"This address does not point to a SkinCrafter page.","notFound.backToCreator":"Back to creator"},pl:{"skinView.error.usernameRequired":"Podaj nazwe gracza Minecraft.","skinView.error.playerNotFound":"Nie znaleziono gracza Minecraft.","skinView.error.skinTextureMissing":"Ten gracz nie ma dostepnej tekstury skina.","skinView.error.network":"Nie udalo sie polaczyc z PlayerDB. Sprawdz polaczenie i sprobuj ponownie.","skinView.error.serviceUnavailable":"PlayerDB jest chwilowo niedostepne. Sprobuj ponownie pozniej.","skinView.error.rateLimited":"Za duzo zapytan o graczy. Sprobuj ponownie za chwile.","skinView.error.invalidResponse":"PlayerDB zwrocilo nieoczekiwana odpowiedz. Sprobuj ponownie pozniej.","notFound.title":"Nie znaleziono strony","notFound.description":"Ten adres nie prowadzi do żadnej strony SkinCraftera.","notFound.backToCreator":"Wróć do kreatora"},"pt-BR":{"skinView.error.usernameRequired":"Digite um nome de usuário do Minecraft.","skinView.error.playerNotFound":"Jogador do Minecraft não encontrado.","skinView.error.skinTextureMissing":"Este jogador não possui uma textura de skin disponível.","skinView.error.network":"Não foi possível acessar o PlayerDB. Verifique sua conexão e tente novamente.","skinView.error.serviceUnavailable":"O PlayerDB está temporariamente indisponível. Tente novamente mais tarde.","skinView.error.rateLimited":"Muitas consultas de jogadores. Tente novamente em instantes.","skinView.error.invalidResponse":"O PlayerDB retornou uma resposta inesperada. Tente novamente mais tarde.","notFound.title":"Página não encontrada","notFound.description":"Este endereço não aponta para uma página do SkinCrafter.","notFound.backToCreator":"Voltar ao criador"}};function Tb(r){return r in u0.en}function Cb(r,e){return Tb(e)?u0[r][e]:Wa(r,e)}function Rb(r=()=>window.localStorage){return{read:e=>{try{return{status:"available",value:r().getItem(e)}}catch{return{status:"unavailable"}}},write:(e,t)=>{try{return r().setItem(e,t),!0}catch{return!1}}}}const Dh=Rb(),Ab=jv.forwardRef((r,e)=>B.jsx("footer",{ref:e,className:"bg-gray-800 text-white py-4 px-4",children:B.jsx("div",{className:"container mx-auto text-center text-sm",children:B.jsx("p",{children:"(c) 2026 SkinCrafter. All rights reserved."})})})),bb="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2060%2036'%20role='img'%20aria-label='Brazil%20flag'%3e%3crect%20width='60'%20height='36'%20fill='%23009B3A'/%3e%3cpath%20d='M30%204%2054%2018%2030%2032%206%2018Z'%20fill='%23FFDF00'/%3e%3ccircle%20cx='30'%20cy='18'%20r='9'%20fill='%23002776'/%3e%3cpath%20d='M22.5%2016.5c5.5-2%2011-1.5%2015%201.5'%20fill='none'%20stroke='%23fff'%20stroke-width='1.6'%20stroke-linecap='round'/%3e%3c/svg%3e",Pb="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2060%2036'%20role='img'%20aria-label='United%20Kingdom%20flag'%3e%3crect%20width='60'%20height='36'%20fill='%23012169'/%3e%3cpath%20d='M0%200%2060%2036M60%200%200%2036'%20stroke='%23fff'%20stroke-width='8'/%3e%3cpath%20d='M0%200%2060%2036M60%200%200%2036'%20stroke='%23C8102E'%20stroke-width='4'/%3e%3cpath%20d='M30%200v36M0%2018h60'%20stroke='%23fff'%20stroke-width='12'/%3e%3cpath%20d='M30%200v36M0%2018h60'%20stroke='%23C8102E'%20stroke-width='7'/%3e%3c/svg%3e",Lb="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2060%2036'%20role='img'%20aria-label='Poland%20flag'%3e%3crect%20width='60'%20height='18'%20fill='%23fff'/%3e%3crect%20y='18'%20width='60'%20height='18'%20fill='%23DC143C'/%3e%3c/svg%3e",Db=r=>Wa(Us,r),Nb="/dev/logo.png",Ub={en:{flagSrc:Pb,label:"English"},pl:{flagSrc:Lb,label:"Polski"},"pt-BR":{flagSrc:bb,label:"Português"}},Gv=r=>Ub[r],Ib=r=>"DEV",hf=Ib(),Wv=({src:r})=>B.jsx("img",{src:r,alt:"","aria-hidden":"true",className:"h-[14px] w-6 shrink-0 object-contain"}),Fb=({logoSrc:r=Nb,logoAlt:e="SkinCrafter logo",language:t="en",onLanguageChange:o,t:s=Db})=>{const l=O.useRef(null),c=Gv(t),d=f=>{l.current?.removeAttribute("open"),o?.(f)};return B.jsx("nav",{className:"bg-green-800 text-white px-4 py-3 shadow-md",children:B.jsxs("div",{className:"container mx-auto flex flex-col sm:flex-row sm:items-center justify-between gap-3",children:[B.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[B.jsx("div",{className:"h-8 w-36 flex items-center",children:B.jsx("img",{src:r,alt:e,className:"h-auto max-h-8 w-full object-contain",style:{imageRendering:"pixelated"}})}),B.jsx("span",{className:"pixel-border bg-amber-500 px-2 py-0.5 text-xs font-bold uppercase tracking-normal text-green-950 shadow-sm",title:hf,"aria-label":hf,children:hf})]}),B.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[B.jsx(gf,{to:"/",className:({isActive:f})=>`pixel-button px-3 py-1 pixel-border transition-colors ${f?"bg-amber-600 text-white":"bg-green-700 hover:bg-green-600 text-white"}`,children:s("nav.wardrobe")}),B.jsx(gf,{to:"/mcskinview",className:({isActive:f})=>`pixel-button px-3 py-1 pixel-border transition-colors ${f?"bg-amber-600 text-white":"bg-green-700 hover:bg-green-600 text-white"}`,children:s("nav.skinView")}),o&&B.jsxs("details",{ref:l,className:"group relative ml-auto sm:ml-0",children:[B.jsxs("summary",{className:"pixel-button pixel-border flex h-9 min-w-16 cursor-pointer list-none items-center justify-center gap-2 bg-green-700 px-3 py-1 text-white transition-colors hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-offset-2 focus:ring-offset-green-800 [&::-webkit-details-marker]:hidden","aria-label":`${s("nav.language")}: ${c.label}`,children:[B.jsx(Wv,{src:c.flagSrc}),B.jsx("span",{className:"text-xs transition-transform group-open:rotate-180","aria-hidden":"true",children:"▾"})]}),B.jsx("div",{className:"pixel-border absolute right-0 z-50 mt-2 min-w-44 bg-green-800 p-1 text-white shadow-md",role:"menu","aria-label":s("nav.language"),children:j_.map(f=>{const p=Gv(f),m=f===t;return B.jsxs("button",{type:"button",className:`pixel-button pixel-border mb-1 flex w-full items-center gap-3 px-3 py-2 text-left text-sm transition-colors last:mb-0 ${m?"bg-green-700 text-white hover:bg-green-800 focus:bg-green-800":"bg-gray-100 text-gray-700 hover:bg-gray-200 focus:bg-gray-200"} focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-inset`,role:"menuitemradio","aria-checked":m,onClick:()=>d(f),children:[B.jsx(Wv,{src:p.flagSrc}),B.jsx("span",{children:p.label})]},f)})})]})]})]})})},c0="skincrafterLanguage",kb=()=>{const r=Dh.read(c0);return r.status==="available"&&dA(r.value)?r.value:Us};function Nh({children:r}){const[e,t]=O.useState(()=>kb()),o=O.useRef(null),[s,l]=O.useState(0),c=O.useCallback(f=>Cb(e,f),[e]),d=O.useCallback(f=>{t(f)},[]);return O.useLayoutEffect(()=>{document.documentElement.lang=e},[e]),O.useEffect(()=>{Dh.write(c0,e)},[e]),O.useEffect(()=>{const f=()=>{l(o.current?.offsetHeight??0)};return f(),window.addEventListener("resize",f),()=>window.removeEventListener("resize",f)},[]),B.jsxs("div",{className:"max-w-full min-h-dvh md:h-dvh overflow-x-visible overflow-y-auto md:overflow-y-hidden flex flex-col",children:[B.jsx("div",{className:"shrink-0",children:B.jsx(Fb,{language:e,onLanguageChange:d,t:c})}),r({footerHeight:s,language:e,t:c}),B.jsx("div",{className:"shrink-0",children:B.jsx(Ab,{ref:o})})]})}const bu="skincrafterState",Uh="wardrobeAppearance",Ih="wardrobeLayerOrder";function ka(r){return JSON.parse(r)}function _u(){return{appearance:{...Wr},layerOrder:eo(null)}}function d0(r){const e=a0(r);return e.success?{state:e.state,serializedState:e.serializedState}:null}function Ob(r){let e;try{e=ka(r)}catch{return{kind:"invalid"}}const t=a0(e);return t.success?{kind:"loaded",value:{state:t.state,serializedState:t.serializedState}}:t.error.code==="unsupported_schema_version"?{kind:"unsupported"}:{kind:"invalid"}}function Bb(r){const e=r(Uh);if(e.status==="unavailable")return{kind:"unavailable"};if(e.value===null)return{kind:"missing"};const t=r(Ih);if(t.status==="unavailable")return{kind:"unavailable"};if(t.value===null)return{kind:"missing"};try{const o=d0({appearance:ka(e.value),layerOrder:ka(t.value)});return o?{kind:"loaded",value:o}:{kind:"missing"}}catch{return{kind:"missing"}}}function zb(r,e){const t=r(Uh);if(t.status==="unavailable")return _u();let o;if(t.value)try{o=ka(t.value)}catch{o={...Wr}}else{const d=r("wardrobeRace"),f=r("wardrobeSkinColor"),p=r("wardrobeHat");if(d.status==="unavailable"||f.status==="unavailable"||p.status==="unavailable")return _u();o={race:d.value??Wr.race,skinColor:f.value??Wr.skinColor,hat:p.value??Wr.hat}}let s=eo(null);const l=r(Ih);if(l.status==="unavailable")return _u();if(l.value)try{s=ka(l.value)}catch{s=eo(null)}const c=d0({appearance:o,layerOrder:s});return c?(e(bu,JSON.stringify(c.serializedState)),c.state):_u()}function Hb(r,e){return JSON.stringify(r.appearance)===JSON.stringify(e.appearance)&&JSON.stringify(r.layerOrder)===JSON.stringify(e.layerOrder)}function Vb(r=Dh){let e=!0;const t=s=>{const l=r.read(s);return l.status==="unavailable"&&(e=!1),l},o=(s,l)=>{if(!e)return!1;const c=r.write(s,l);return c||(e=!1),c};return{load:()=>{e=!0;const s=t(bu);if(s.status==="unavailable")return{status:"empty"};if(s.value===null)return{status:"loaded",state:zb(t,o)};const l=Ob(s.value);if(l.kind==="unsupported")return e=!1,{status:"incompatible"};if(l.kind==="invalid")return{status:"empty"};const c=Bb(t);if(c.kind==="loaded"&&!Hb(c.value.serializedState,l.value.serializedState)){const d={...c.value.state,wardrobeColors:l.value.state.wardrobeColors},f=Lh(d);return o(bu,JSON.stringify(f)),{status:"loaded",state:d}}return{status:"loaded",state:l.value.state}},save:s=>{o(bu,JSON.stringify(s))&&o(Uh,JSON.stringify(s.appearance))&&o(Ih,JSON.stringify(s.layerOrder))}}}const Gb=Vb();class $t extends Error{code;status;cause;constructor(e,t={}){super(e),this.name="FetchSkinError",this.code=e,this.status=t.status,this.cause=t.cause}}const Wb="textures.minecraft.net",Xb=(r,e)=>{let t;try{t=new URL(r)}catch(s){throw new $t("invalid_response",{status:e,cause:s})}if(!(t.hostname===Wb&&t.port===""&&t.username===""&&t.password==="")||t.protocol!=="http:"&&t.protocol!=="https:")throw new $t("invalid_response",{status:e});return t.protocol="https:",t.toString()},Br=r=>typeof r=="object"&&r!==null,jb=r=>Br(r)&&typeof r.name=="string"&&typeof r.value=="string",$b=r=>{if(!Br(r)||typeof r.success!="boolean")throw new $t("invalid_response");if(!r.success)return{success:!1};if(!Br(r.data)||!Br(r.data.player))throw new $t("invalid_response");const e=r.data.player;if(e.skin_texture!==void 0&&typeof e.skin_texture!="string")throw new $t("invalid_response");if(e.properties!==void 0&&(!Array.isArray(e.properties)||!e.properties.every(jb)))throw new $t("invalid_response");return{success:!0,data:{player:{skin_texture:e.skin_texture,properties:e.properties}}}},Yb=r=>{if(!r)return null;let e;try{e=JSON.parse(atob(r.value))}catch(l){throw new $t("invalid_response",{cause:l})}if(!Br(e))throw new $t("invalid_response");const t=e.textures;if(t===void 0)return{};if(!Br(t))throw new $t("invalid_response");const o=t.SKIN;if(o===void 0)return{textures:{}};if(!Br(o))throw new $t("invalid_response");if(o.url!==void 0&&typeof o.url!="string")throw new $t("invalid_response");const s=o.metadata;if(s!==void 0&&!Br(s))throw new $t("invalid_response");if(Br(s)&&s.model!==void 0&&typeof s.model!="string")throw new $t("invalid_response");return{textures:{SKIN:{url:o.url,metadata:Br(s)&&typeof s.model=="string"?{model:s.model}:void 0}}}},qb=r=>r===404?new $t("player_not_found",{status:r}):r===429?new $t("rate_limited",{status:r}):r>=500?new $t("service_unavailable",{status:r}):new $t("invalid_response",{status:r});async function Kb(r){let e;try{e=await fetch(`https://playerdb.co/api/player/minecraft/${encodeURIComponent(r)}`)}catch(f){throw new $t("network_error",{cause:f})}if(!e.ok)throw qb(e.status);let t;try{t=await e.json()}catch(f){throw new $t("invalid_response",{status:e.status,cause:f})}const o=$b(t);if(!o.success)throw new $t("player_not_found",{status:e.status});const s=o.data?.player;if(!s)throw new $t("invalid_response",{status:e.status});const l=s.properties?.find(f=>f.name==="textures"),c=Yb(l)?.textures?.SKIN,d=c?.url??s.skin_texture;if(!d)throw new $t("skin_texture_missing",{status:e.status});return{texture:Xb(d,e.status),model:c?.metadata?.model==="slim"?"slim":"classic"}}const Zb={player_not_found:"skinView.error.playerNotFound",skin_texture_missing:"skinView.error.skinTextureMissing",rate_limited:"skinView.error.rateLimited",service_unavailable:"skinView.error.serviceUnavailable",network_error:"skinView.error.network",invalid_response:"skinView.error.invalidResponse"},Jb=({className:r})=>B.jsxs("svg",{"aria-hidden":"true","data-standalone-icon":"user",focusable:"false",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:r,children:[B.jsx("circle",{cx:"12",cy:"8",r:"4"}),B.jsx("path",{d:"M4 21c0-4.25 3.6-7 8-7s8 2.75 8 7"})]}),Qb=({className:r})=>B.jsxs("svg",{"aria-hidden":"true","data-standalone-icon":"player-card",focusable:"false",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:r,children:[B.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),B.jsx("circle",{cx:"9",cy:"11",r:"2"}),B.jsx("path",{d:"M6.5 16c.7-1.4 1.5-2 2.5-2s1.8.6 2.5 2M14 10h4M14 14h4"})]}),e2=({className:r})=>B.jsxs("svg",{"aria-hidden":"true","data-standalone-icon":"download",focusable:"false",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:r,children:[B.jsx("path",{d:"M7 18H6a4 4 0 0 1-.4-7.98A6.5 6.5 0 0 1 18.2 9 4.5 4.5 0 0 1 18 18h-1"}),B.jsx("path",{d:"M12 11v8m0 0-3-3m3 3 3-3"})]}),t2=()=>{const[r,e]=O.useState(""),[t,o]=O.useState(null),[s,l]=O.useState(null),[c,d]=O.useState(!1),f=O.useCallback(m=>{e(m.target.value)},[]),p=O.useCallback(async m=>{if(m.preventDefault(),!r.trim()){l("skinView.error.usernameRequired");return}l(null),o(null),d(!0);try{o(await Kb(r.trim()))}catch(v){l(v instanceof $t?Zb[v.code]:"skinView.error.invalidResponse"),o(null)}finally{d(!1)}},[r]);return B.jsx(Nh,{children:({footerHeight:m,language:v,t:y})=>B.jsxs("div",{className:"flex-1 min-h-0 flex flex-col md:flex-row",children:[B.jsx("div",{className:"flex-1 min-h-0 w-full md:w-1/2",children:B.jsx(wb,{texture:t?.texture??null,model:t?.model??"classic",locale:v,bottomOffset:m})}),B.jsx("div",{className:"flex-1 min-h-0 w-full md:w-1/2",children:B.jsxs("section",{className:"mb-4 md:mb-0 md:flex md:flex-col md:h-full md:min-h-0 p-4",children:[B.jsxs("h2",{className:"text-xl font-bold mb-2 text-gray-700 flex items-center",children:[B.jsx(Jb,{className:"mr-2 h-5 w-5 shrink-0 text-green-700"}),y("panel.loadSkin")]}),B.jsxs("div",{className:"space-y-4 md:flex-1 md:min-h-0 overflow-y-auto pr-2",children:[B.jsxs("div",{className:"option-card bg-white shadow p-4 pixel-border relative pt-5",children:[B.jsxs("h3",{className:"font-medium text-gray-800 mb-2 flex items-center absolute -top-3 left-4 px-2 bg-white z-10",children:[B.jsx(Qb,{className:"mr-2 h-4 w-4 shrink-0 text-amber-600"}),y("skinView.player")]}),B.jsxs("form",{onSubmit:p,className:"mt-4 flex flex-col gap-3",children:[B.jsx("input",{type:"text",value:r,onChange:f,placeholder:y("skinView.username"),"aria-label":y("skinView.username"),className:"w-full border px-3 py-2 pixel-border bg-gray-50 text-gray-800"}),B.jsxs("button",{type:"submit",disabled:c,className:"pixel-button p-2 pixel-border bg-green-700 hover:bg-green-800 disabled:opacity-50 disabled:cursor-not-allowed text-white",children:[B.jsx(e2,{className:"mr-2 inline-block h-4 w-4 align-middle"}),y(c?"action.loading":"action.loadSkin")]})]})]}),s&&B.jsx("div",{role:"alert",className:"option-card bg-red-50 text-red-700 shadow p-4 pixel-border",children:y(s)})]})]})})]})})},n2=()=>B.jsx(Nh,{children:({t:r})=>B.jsx("main",{className:"flex-1 min-h-0 flex items-center justify-center p-4",children:B.jsxs("section",{className:"option-card bg-white shadow p-6 pixel-border max-w-xl w-full text-center","aria-labelledby":"not-found-title",children:[B.jsx("p",{className:"text-sm font-semibold uppercase tracking-wider text-amber-700 mb-2",children:"404"}),B.jsx("h1",{id:"not-found-title",className:"text-2xl font-bold text-gray-800 mb-3",children:r("notFound.title")}),B.jsx("p",{className:"text-gray-600 mb-6",children:r("notFound.description")}),B.jsx(hh,{to:"/",className:"inline-block pixel-button p-3 pixel-border bg-green-700 hover:bg-green-800 text-white",children:r("notFound.backToCreator")})]})})}),r2=()=>B.jsx(Nh,{children:({footerHeight:r,language:e})=>B.jsx(Mb,{locale:e,persistence:Gb,previewBottomOffset:r})}),i2=()=>B.jsxs(Qy,{children:[B.jsx(xu,{path:"/",element:B.jsx(r2,{})}),B.jsx(xu,{path:"/mcskinview",element:B.jsx(t2,{})}),B.jsx(xu,{path:"*",element:B.jsx(n2,{})})]}),o2="__skincrafter_spa",rh="/dev/",s2=rh.replace(/\/$/,""),a2=()=>{const e=new URL(window.location.href).searchParams.get(o2);if(!e)return;let t;try{t=new URL(e,window.location.origin)}catch{return}const o=rh.replace(/\/$/,""),s=t.pathname===o||t.pathname.startsWith(rh);t.origin!==window.location.origin||!s||window.history.replaceState(null,"",`${t.pathname}${t.search}${t.hash}`)};a2();Qx.createRoot(document.getElementById("root")).render(B.jsx(jv.StrictMode,{children:B.jsx(MS,{basename:s2,children:B.jsx(i2,{})})}));
