 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Xp;function H_(){if(Xp)return Io;Xp=1;var s=ad(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),r=Object.prototype.hasOwnProperty,a=s.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function c(f,h,p){var v,g={},x=null,S=null;p!==void 0&&(x=""+p),h.key!==void 0&&(x=""+h.key),h.ref!==void 0&&(S=h.ref);for(v in h)r.call(h,v)&&!l.hasOwnProperty(v)&&(g[v]=h[v]);if(f&&f.defaultProps)for(v in h=f.defaultProps,h)g[v]===void 0&&(g[v]=h[v]);return{$$typeof:e,type:f,key:x,ref:S,props:g,_owner:a.current}}return Io.Fragment=t,Io.jsx=c,Io.jsxs=c,Io}var jp;function V_(){return jp||(jp=1,bc.exports=H_()),bc.exports}var We=V_(),he=ad();const ld=sg(he),G_=B_({__proto__:null,default:ld},[he]);var fl={},Dc={exports:{}},Un={},Uc={exports:{}},Nc={};/**
 * @license React
 ...
 *
 * @license MIT
 */function Wo(){return Wo=Object.assign?Object.assign.bind():function(s){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&(s[r]=t[r])}return s},Wo.apply(this,arguments)}var yr;(function(s){s.Pop="POP",s.Push="PUSH",s.Replace="REPLACE"})(yr||(yr={}));const Qp="popstate";function K_(s){s===void 0&&(s={});function e(r,a){let{pathname:l,search:c,hash:f}=r.location;return gf("",{pathname:l,search:c,hash:f},a.state&&a.state.usr||null,a.state&&a.state.key||"default")}function t(r,a){return typeof a=="string"?a:Hl(a)}return Q_(e,t,null,s)}function Xt(s,e){if(s===!1||s===null||typeof s>"u")throw new Error(e)}function ag(s,e){if(!s){typeof console<"u"&&console.warn(e);try{throw new Error(e)}catch{}}}function Z_(){return Math.random().toString(36).substr(2,8)}function Jp(s,e){return{usr:s.state,key:s.key,idx:e}}function gf(s,e,t,r){return t===void 0&&(t=null),Wo({pathname:typeof s=="string"?s:s.pathname,search:"",hash:""},typeof e=="string"?Js(e):e,{state:t,key:e&&e.key||r||Z_()})}function Hl(s){let{pathname:e="/",search:t="",hash:r=""}=s;return t&&t!=="?"&&(e+=t.charAt(0)==="?"?t:"?"+t),r&&r!=="#"&&(e+=r.charAt(0)==="#"?r:"#"+r),e}function Js(s){let e={};if(s){let t=s.indexOf("#");t>=0&&(e.hash=s.substr(t),s=s.substr(0,t));let r=s.indexOf("?");r>=0&&(e.search=s.substr(r),s=s.substr(0,r)),s&&(e.pathname=s)}return e}function Q_(s,e,t,r){r===void 0&&(r={});let{window:a=document.defaultView,v5Compat:l=!1}=r,c=a.history,f=yr.Pop,h=null,p=v();p==null&&(p=0,c.replaceState(Wo({},c.state,{idx:p}),""));function v(){return(c.state||{idx:null}).idx}function g(){f=yr.Pop;let y=v(),_=y==null?null:y-p;p=y,h&&h({action:f,location:w.location,delta:_})}function x(y,_){f=yr.Push;let U=gf(w.location,y,_);p=v()+1;let b=Jp(U,p),R=w.createHref(U);try{c.pushState(b,"",R)}catch(W){if(W instanceof DOMException&&W.name==="DataCloneError")throw W;a.location.assign(R)}l&&h&&h({action:f,location:w.location,delta:1})}function S(y,_){f=yr.Replace;let U=gf(w.location,y,_);p=v();let b=Jp(U,p),R=w.createHref(U);c.replaceState(b,"",R),l&&h&&h({action:f,location:w.location,delta:0})}function T(y){let _=a.location.origin!=="null"?a.location.origin:a.location.href,U=typeof y=="string"?y:Hl(y);return U=U.replace(/ $/,"%20"),Xt(_,"No window.location.(origin|href) available to create URL for href: "+U),new URL(U,_)}let w={get action(){return f},get location(){return s(a,c)},listen(y){if(h)throw new Error("A history only accepts one active listener");return a.addEventListener(Qp,g),h=y,()=>{a.removeEventListener(Qp,g),h=null}},createHref(y){return e(a,y)},createURL:T,encodeLocation(y){let _=T(y);return{pathname:_.pathname,search:_.search,hash:_.hash}},push:x,replace:S,go(y){return c.go(y)}};return w}var em;(function(s){s.data="data",s.deferred="deferred",s.redirect="redirect",s.error="error"})(em||(em={}));function J_(s,e,t){return t===void 0&&(t="/"),e0(s,e,t)}function e0(s,e,t,r){let a=typeof e=="string"?Js(e):e,l=Ys(a.pathname||"/",t);if(l==null)return null;let c=lg(s);t0(c);let f=null;for(let h=0;f==null&&h<c.length;++h){let p=d0(l);f=c0(c[h],p)}return f}function lg(s,e,t,r){e===void 0&&(e=[]),t===void 0&&(t=[]),r===void 0&&(r="");let a=(l,c,f)=>{let h={relativePath:f===void 0?l.path||"":f,caseSensitive:l.caseSensitive===!0,childrenIndex:c,route:l};h.relativePath.startsWith("/")&&(Xt(h.relativePath.startsWith(r),'Absolute route path "'+h.relativePath+'" nested under path '+('"'+r+'" is not valid. An absolute child route path ')+"must start with the combined path of all its parent routes."),h.relativePath=h.relativePath.slice(r.length));let p=Sr([r,h.relativePath]),v=t.concat(h);l.children&&l.children.length>0&&(Xt(l.index!==!0,"Index routes must not have child routes. Please remove "+('all child routes from route path "'+p+'".')),lg(l.children,e,v,p)),!(l.path==null&&!l.index)&&e.push({path:p,score:l0(p,l.index),routesMeta:v})};return s.forEach((l,c)=>{var f;if(l.path===""||!((f=l.path)!=null&&f.includes("?")))a(l,c);else for(let h of ug(l.path))a(l,c,h)}),e}function ug(s){let e=s.split("/");if(e.length===0)return[];let[t,...r]=e,a=t.endsWith("?"),l=t.replace(/\?$/,"");if(r.length===0)return a?[l,""]:[l];let c=ug(r.join("/")),f=[];return f.push(...c.map(h=>h===""?l:[l,h].join("/"))),a&&f.push(...c),f.map(h=>s.startsWith("/")&&h===""?"/":h)}function t0(s){s.sort((e,t)=>e.score!==t.score?t.score-e.score:u0(e.routesMeta.map(r=>r.childrenIndex),t.routesMeta.map(r=>r.childrenIndex)))}const n0=/^:[\w-]+$/,i0=3,r0=2,s0=1,o0=10,a0=-2,tm=s=>s==="*";function l0(s,e){let t=s.split("/"),r=t.length;return t.some(tm)&&(r+=a0),e&&(r+=r0),t.filter(a=>!tm(a)).reduce((a,l)=>a+(n0.test(l)?i0:l===""?s0:o0),r)}function u0(s,e){return s.length===e.length&&s.slice(0,-1).every((r,a)=>r===e[a])?s[s.length-1]-e[e.length-1]:0}function c0(s,e,t){let{routesMeta:r}=s,a={},l="/",c=[];for(let f=0;f<r.length;++f){let h=r[f],p=f===r.length-1,v=l==="/"?e:e.slice(l.length)||"/",g=vf({path:h.relativePath,caseSensitive:h.caseSensitive,end:p},v),x=h.route;if(!g)return null;Object.assign(a,g.params),c.push({params:a,pathname:Sr([l,g.pathname]),pathnameBase:g0(Sr([l,g.pathnameBase])),route:x}),g.pathnameBase!=="/"&&(l=Sr([l,g.pathnameBase]))}return c}function vf(s,e){typeof s=="string"&&(s={path:s,caseSensitive:!1,end:!0});let[t,r]=f0(s.path,s.caseSensitive,s.end),a=e.match(t);if(!a)return null;let l=a[0],c=l.replace(/(.)\/+$/,"$1"),f=a.slice(1);return{params:r.reduce((p,v,g)=>{let{paramName:x,isOptional:S}=v;if(x==="*"){let w=f[g]||"";c=l.slice(0,l.length-w.length).replace(/(.)\/+$/,"$1")}const T=f[g];return S&&!T?p[x]=void 0:p[x]=(T||"").replace(/%2F/g,"/"),p},{}),pathname:l,pathnameBase:c,pattern:s}}function f0(s,e,t){e===void 0&&(e=!1),t===void 0&&(t=!0),ag(s==="*"||!s.endsWith("*")||s.endsWith("/*"),'Route path "'+s+'" will be treated as if it were '+('"'+s.replace(/\*$/,"/*")+'" because the `*` character must ')+"always follow a `/` in the pattern. To get rid of this warning, "+('please change the route path to "'+s.replace(/\*$/,"/*")+'".'));let r=[],a="^"+s.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(c,f,h)=>(r.push({paramName:f,isOptional:h!=null}),h?"/?([^\\/]+)?":"/([^\\/]+)"));return s.endsWith("*")?(r.push({paramName:"*"}),a+=s==="*"||s==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):t?a+="\\/*$":s!==""&&s!=="/"&&(a+="(?:(?=\\/|$))"),[new RegExp(a,e?void 0:"i"),r]}function d0(s){try{return s.split("/").map(e=>decodeURIComponent(e).replace(/\//g,"%2F")).join("/")}catch(e){return ag(!1,'The URL path "'+s+'" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent '+("encoding ("+e+").")),s}}function Ys(s,e){if(e==="/")return s;if(!s.toLowerCase().startsWith(e.toLowerCase()))return null;let t=e.endsWith("/")?e.length-1:e.length,r=s.charAt(t);return r&&r!=="/"?null:s.slice(t)||"/"}function h0(s,e){e===void 0&&(e="/");let{pathname:t,search:r="",hash:a=""}=typeof s=="string"?Js(s):s;return{pathname:t?t.startsWith("/")?t:p0(t,e):e,search:v0(r),hash:_0(a)}}function p0(s,e){let t=e.replace(/\/+$/,"").split("/");return s.split("/").forEach(a=>{a===".."?t.length>1&&t.pop():a!=="."&&t.push(a)}),t.length>1?t.join("/"):"/"}function Ic(s,e,t,r){return"Cannot include a '"+s+"' character in a manually specified "+("`to."+e+"` field ["+JSON.stringify(r)+"].  Please separate it out to the ")+("`to."+t+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function m0(s){return s.filter((e,t)=>t===0||e.route.path&&e.route.path.length>0)}function cg(s,e){let t=m0(s);return e?t.map((r,a)=>a===t.length-1?r.pathname:r.pathnameBase):t.map(r=>r.pathnameBase)}function fg(s,e,t,r){r===void 0&&(r=!1);let a;typeof s=="string"?a=Js(s):(a=Wo({},s),Xt(!a.pathname||!a.pathname.includes("?"),Ic("?","pathname","search",a)),Xt(!a.pathname||!a.pathname.includes("#"),Ic("#","pathname","hash",a)),Xt(!a.search||!a.search.includes("#"),Ic("#","search","hash",a)));let l=s===""||a.pathname==="",c=l?"/":a.pathname,f;if(c==null)f=t;else{let g=e.length-1;if(!r&&c.startsWith("..")){let x=c.split("/");for(;x[0]==="..";)x.shift(),g-=1;a.pathname=x.join("/")}f=g>=0?e[g]:"/"}let h=h0(a,f),p=c&&c!=="/"&&c.endsWith("/"),v=(l||c===".")&&t.endsWith("/");return!h.pathname.endsWith("/")&&(p||v)&&(h.pathname+="/"),h}const Sr=s=>s.join("/").replace(/\/\/+/g,"/"),g0=s=>s.replace(/\/+$/,"").replace(/^\/*/,"/"),v0=s=>!s||s==="?"?"":s.startsWith("?")?s:"?"+s,_0=s=>!s||s==="#"?"":s.startsWith("#")?s:"#"+s;function x0(s){return s!=null&&typeof s.status=="number"&&typeof s.statusText=="string"&&typeof s.internal=="boolean"&&"data"in s}const dg=["post","put","patch","delete"];new Set(dg);const y0=["get",...dg];new Set(y0);/**
 ...
 *
 * @license MIT
 */function Xo(){return Xo=Object.assign?Object.assign.bind():function(s){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&(s[r]=t[r])}return s},Xo.apply(this,arguments)}const Xl=he.createContext(null),hg=he.createContext(null),Ar=he.createContext(null),jl=he.createContext(null),ts=he.createContext({outlet:null,matches:[],isDataRoute:!1}),pg=he.createContext(null);function S0(s,e){let{relative:t}=e===void 0?{}:e;Qo()||Xt(!1);let{basename:r,navigator:a}=he.useContext(Ar),{hash:l,pathname:c,search:f}=Yl(s,{relative:t}),h=c;return r!=="/"&&(h=c==="/"?r:Sr([r,c])),a.createHref({pathname:h,search:f,hash:l})}function Qo(){return he.useContext(jl)!=null}function Jo(){return Qo()||Xt(!1),he.useContext(jl).location}function mg(s){he.useContext(Ar).static||he.useLayoutEffect(s)}function E0(){let{isDataRoute:s}=he.useContext(ts);return s?I0():M0()}function M0(){Qo()||Xt(!1);let s=he.useContext(Xl),{basename:e,future:t,navigator:r}=he.useContext(Ar),{matches:a}=he.useContext(ts),{pathname:l}=Jo(),c=JSON.stringify(cg(a,t.v7_relativeSplatPath)),f=he.useRef(!1);return mg(()=>{f.current=!0}),he.useCallback(function(p,v){if(v===void 0&&(v={}),!f.current)return;if(typeof p=="number"){r.go(p);return}let g=fg(p,JSON.parse(c),l,v.relative==="path");s==null&&e!=="/"&&(g.pathname=g.pathname==="/"?e:Sr([e,g.pathname])),(v.replace?r.replace:r.push)(g,v.state,v)},[e,r,c,l,s])}function Yl(s,e){let{relative:t}=e===void 0?{}:e,{future:r}=he.useContext(Ar),{matches:a}=he.useContext(ts),{pathname:l}=Jo(),c=JSON.stringify(cg(a,r.v7_relativeSplatPath));return he.useMemo(()=>fg(s,JSON.parse(c),l,t==="path"),[s,c,l,t])}function T0(s,e){return w0(s,e)}function w0(s,e,t,r){Qo()||Xt(!1);let{navigator:a}=he.useContext(Ar),{matches:l}=he.useContext(ts),c=l[l.length-1],f=c?c.params:{};c&&c.pathname;let h=c?c.pathnameBase:"/";c&&c.route;let p=Jo(),v;if(e){var g;let y=typeof e=="string"?Js(e):e;h==="/"||(g=y.pathname)!=null&&g.startsWith(h)||Xt(!1),v=y}else v=p;let x=v.pathname||"/",S=x;if(h!=="/"){let y=h.replace(/^\//,"").split("/");S="/"+x.replace(/^\//,"").split("/").slice(y.length).join("/")}let T=J_(s,{pathname:S}),w=b0(T&&T.map(y=>Object.assign({},y,{params:Object.assign({},f,y.params),pathname:Sr([h,a.encodeLocation?a.encodeLocation(y.pathname).pathname:y.pathname]),pathnameBase:y.pathnameBase==="/"?h:Sr([h,a.encodeLocation?a.encodeLocation(y.pathnameBase).pathname:y.pathnameBase])})),l,t,r);return e&&w?he.createElement(jl.Provider,{value:{location:Xo({pathname:"/",search:"",hash:"",state:null,key:"default"},v),navigationType:yr.Pop}},w):w}function A0(){let s=N0(),e=x0(s)?s.status+" "+s.statusText:s instanceof Error?s.message:JSON.stringify(s),t=s instanceof Error?s.stack:null,a={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return he.createElement(he.Fragment,null,he.createElement("h2",null,"Unexpected Application Error!"),he.createElement("h3",{style:{fontStyle:"italic"}},e),t?he.createElement("pre",{style:a},t):null,null)}const C0=he.createElement(A0,null);class R0 extends he.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,t){return t.location!==e.location||t.revalidation!=="idle"&&e.revalidation==="idle"?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error!==void 0?e.error:t.error,location:t.location,revalidation:e.revalidation||t.revalidation}}componentDidCatch(e,t){console.error("React Router caught the following error during render",e,t)}render(){return this.state.error!==void 0?he.createElement(ts.Provider,{value:this.props.routeContext},he.createElement(pg.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function P0(s){let{routeContext:e,match:t,children:r}=s,a=he.useContext(Xl);return a&&a.static&&a.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(a.staticContext._deepestRenderedBoundaryId=t.route.id),he.createElement(ts.Provider,{value:e},r)}function b0(s,e,t,r){var a;if(e===void 0&&(e=[]),t===void 0&&(t=null),r===void 0&&(r=null),s==null){var l;if(!t)return null;if(t.errors)s=t.matches;else if((l=r)!=null&&l.v7_partialHydration&&e.length===0&&!t.initialized&&t.matches.length>0)s=t.matches;else return null}let c=s,f=(a=t)==null?void 0:a.errors;if(f!=null){let v=c.findIndex(g=>g.route.id&&f?.[g.route.id]!==void 0);v>=0||Xt(!1),c=c.slice(0,Math.min(c.length,v+1))}let h=!1,p=-1;if(t&&r&&r.v7_partialHydration)for(let v=0;v<c.length;v++){let g=c[v];if((g.route.HydrateFallback||g.route.hydrateFallbackElement)&&(p=v),g.route.id){let{loaderData:x,errors:S}=t,T=g.route.loader&&x[g.route.id]===void 0&&(!S||S[g.route.id]===void 0);if(g.route.lazy||T){h=!0,p>=0?c=c.slice(0,p+1):c=[c[0]];break}}}return c.reduceRight((v,g,x)=>{let S,T=!1,w=null,y=null;t&&(S=f&&g.route.id?f[g.route.id]:void 0,w=g.route.errorElement||C0,h&&(p<0&&x===0?(F0("route-fallback"),T=!0,y=null):p===x&&(T=!0,y=g.route.hydrateFallbackElement||null)));let _=e.concat(c.slice(0,x+1)),U=()=>{let b;return S?b=w:T?b=y:g.route.Component?b=he.createElement(g.route.Component,null):g.route.element?b=g.route.element:b=v,he.createElement(P0,{match:g,routeContext:{outlet:v,matches:_,isDataRoute:t!=null},children:b})};return t&&(g.route.ErrorBoundary||g.route.errorElement||x===0)?he.createElement(R0,{location:t.location,revalidation:t.revalidation,component:w,error:S,children:U(),routeContext:{outlet:null,matches:_,isDataRoute:!0}}):U()},null)}var gg=function(s){return s.UseBlocker="useBlocker",s.UseRevalidator="useRevalidator",s.UseNavigateStable="useNavigate",s}(gg||{}),vg=function(s){return s.UseBlocker="useBlocker",s.UseLoaderData="useLoaderData",s.UseActionData="useActionData",s.UseRouteError="useRouteError",s.UseNavigation="useNavigation",s.UseRouteLoaderData="useRouteLoaderData",s.UseMatches="useMatches",s.UseRevalidator="useRevalidator",s.UseNavigateStable="useNavigate",s.UseRouteId="useRouteId",s}(vg||{});function L0(s){let e=he.useContext(Xl);return e||Xt(!1),e}function D0(s){let e=he.useContext(hg);return e||Xt(!1),e}function U0(s){let e=he.useContext(ts);return e||Xt(!1),e}function _g(s){let e=U0(),t=e.matches[e.matches.length-1];return t.route.id||Xt(!1),t.route.id}function N0(){var s;let e=he.useContext(pg),t=D0(vg.UseRouteError),r=_g();return e!==void 0?e:(s=t.errors)==null?void 0:s[r]}function I0(){let{router:s}=L0(gg.UseNavigateStable),e=_g(),t=he.useRef(!1);return mg(()=>{t.current=!0}),he.useCallback(function(a,l){l===void 0&&(l={}),t.current&&(typeof a=="number"?s.navigate(a):s.navigate(a,Xo({fromRouteId:e},l)))},[s,e])}const nm={};function F0(s,e,t){nm[s]||(nm[s]=!0)}function O0(s,e){s?.v7_startTransition,s?.v7_relativeSplatPath}function _f(s){Xt(!1)}function k0(s){let{basename:e="/",children:t=null,location:r,navigationType:a=yr.Pop,navigator:l,static:c=!1,future:f}=s;Qo()&&Xt(!1);let h=e.replace(/^\/*/,"/"),p=he.useMemo(()=>({basename:h,navigator:l,static:c,future:Xo({v7_relativeSplatPath:!1},f)}),[h,f,l,c]);typeof r=="string"&&(r=Js(r));let{pathname:v="/",search:g="",hash:x="",state:S=null,key:T="default"}=r,w=he.useMemo(()=>{let y=Ys(v,h);return y==null?null:{location:{pathname:y,search:g,hash:x,state:S,key:T},navigationType:a}},[h,v,g,x,S,T,a]);return w==null?null:he.createElement(Ar.Provider,{value:p},he.createElement(jl.Provider,{children:t,value:w}))}function B0(s){let{children:e,location:t}=s;return T0(xf(e),t)}new Promise(()=>{});function xf(s,e){e===void 0&&(e=[]);let t=[];return he.Children.forEach(s,(r,a)=>{if(!he.isValidElement(r))return;let l=[...e,a];if(r.type===he.Fragment){t.push.apply(t,xf(r.props.children,l));return}r.type!==_f&&Xt(!1),!r.props.index||!r.props.children||Xt(!1);let c={id:r.props.id||l.join("-"),caseSensitive:r.props.caseSensitive,element:r.props.element,Component:r.props.Component,index:r.props.index,path:r.props.path,loader:r.props.loader,action:r.props.action,errorElement:r.props.errorElement,ErrorBoundary:r.props.ErrorBoundary,hasErrorBoundary:r.props.ErrorBoundary!=null||r.props.errorElement!=null,shouldRevalidate:r.props.shouldRevalidate,handle:r.props.handle,lazy:r.props.lazy};r.props.children&&(c.children=xf(r.props.children,l)),t.push(c)}),t}/**
...
#endif`,hS="gl_FragColor = linearToOutputTexel( gl_FragColor );",pS=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	`}function AM(s){let e=new WeakMap,t=null;function r(f){if(f&&f.isTexture){const h=f.mapping,p=h===bf||h===Lf,v=h===$s||h===Ks;if(p||v){let g=e.get(f);const x=g!==void 0?g.texture.pmremVersion:0;if(f.isRenderTargetTexture&&f.pmremVersion!==x)return t===null&&(t=new Om(s)),g=p?t.fromEquirectangular(f,g):t.fromCubemap(f,g),g.texture.pmremVersion=f.pmremVersion,e.set(f,g),g.texture;if(g!==void 0)return g.texture;{const S=f.image;return p&&S&&S.height>0||v&&S&&a(S)?(t===null&&(t=new Om(s)),g=p?t.fromEquirectangular(f):t.fromCubemap(f),g.texture.pmremVersion=f.pmremVersion,e.set(f,g),f.addEventListener("dispose",l),g.texture):null}}}return f}function a(f){let h=0;const p=6;for(let v=0;v<p;v++)f[v]!==void 0&&h++;return h===p}function l(f){const h=f.target;h.removeEventListener("dispose",l);const p=e.get(h);p!==void 0&&(e.delete(h),p.dispose())}function c(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:r,dispose:c}}function CM(s){const e={};function t(r){if(e[r]!==void 0)return e[r];let a;switch(r){case"WEBGL_depth_texture":a=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":a=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":a=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":a=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:a=s.getExtension(r)}return e[r]=a,a}return{has:function(r){return t(r)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(r){const a=t(r);return a===null&&Ws("THREE.WebGLRenderer: "+r+" extension not supported."),a}}}function RM(s,e,t,r){const a={},l=new WeakMap;function c(g){const x=g.target;x.index!==null&&e.remove(x.index);for(const T in x.attributes)e.remove(x.attributes[T]);x.removeEventListener("dispose",c),delete a[x.id];const S=l.get(x);S&&(e.remove(S),l.delete(x)),r.releaseStatesOfGeometry(x),x.isInstancedBufferGeometry===!0&&delete x._maxInstanceCount,t.memory.geometries--}function f(g,x){return a[x.id]===!0||(x.addEventListener("dispose",c),a[x.id]=!0,t.memory.geometries++),x}function h(g){const x=g.attributes;for(const S in x)e.update(x[S],s.ARRAY_BUFFER)}function p(g){const x=[],S=g.index,T=g.attributes.position;let w=0;if(S!==null){const U=S.array;w=S.version;for(let b=0,R=U.length;b<R;b+=3){const W=U[b+0],B=U[b+1],I=U[b+2];x.push(W,B,B,I,I,W)}}else if(T!==void 0){const U=T.array;w=T.version;for(let b=0,R=U.length/3-1;b<R;b+=3){const W=b+0,B=b+1,I=b+2;x.push(W,B,B,I,I,W)}}else return;const y=new(Ng(x)?Bg:kg)(x,1);y.version=w;const _=l.get(g);_&&e.remove(_),l.set(g,y)}function v(g){const x=l.get(g);if(x){const S=g.index;S!==null&&x.version<S.version&&p(g)}else p(g);return l.get(g)}return{get:f,update:h,getWireframeAttribute:v}}function PM(s,e,t){let r;function a(x){r=x}let l,c;function f(x){l=x.type,c=x.bytesPerElement}function h(x,S){s.drawElements(r,S,l,x*c),t.update(S,r,1)}function p(x,S,T){T!==0&&(s.drawElementsInstanced(r,S,l,x*c,T),t.update(S,r,T))}function v(x,S,T){if(T===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(r,S,0,l,x,0,T);let y=0;for(let _=0;_<T;_++)y+=S[_];t.update(y,r,1)}function g(x,S,T,w){if(T===0)return;const y=e.get("WEBGL_multi_draw");if(y===null)for(let _=0;_<x.length;_++)p(x[_]/c,S[_],w[_]);else{y.multiDrawElementsInstancedWEBGL(r,S,0,l,x,0,w,0,T);let _=0;for(let U=0;U<T;U++)_+=S[U]*w[U];t.update(_,r,1)}}this.setMode=a,this.setIndex=f,this.render=h,this.renderInstances=p,this.renderMultiDraw=v,this.renderMultiDrawInstances=g}function bM(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function r(l,c,f){switch(t.calls++,c){case s.TRIANGLES:t.triangles+=f*(l/3);break;case s.LINES:t.lines+=f*(l/2);break;case s.LINE_STRIP:t.lines+=f*(l-1);break;case s.LINE_LOOP:t.lines+=f*l;break;case s.POINTS:t.points+=f*l;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",c);break}}function a(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:a,update:r}}function LM(s,e,t){const r=new WeakMap,a=new Wt;function l(c,f,h){const p=c.morphTargetInfluences,v=f.morphAttributes.position||f.morphAttributes.normal||f.morphAttributes.color,g=v!==void 0?v.length:0;let x=r.get(f);if(x===void 0||x.count!==g){let C=function(){G.dispose(),r.delete(f),f.removeEventListener("dispose",C)};var S=C;x!==void 0&&x.texture.dispose();const T=f.morphAttributes.position!==void 0,w=f.morphAttributes.normal!==void 0,y=f.morphAttributes.color!==void 0,_=f.morphAttributes.position||[],U=f.morphAttributes.normal||[],b=f.morphAttributes.color||[];let R=0;T===!0&&(R=1),w===!0&&(R=2),y===!0&&(R=3);let W=f.attributes.position.count*R,B=1;W>e.maxTextureSize&&(B=Math.ceil(W/e.maxTextureSize),W=e.maxTextureSize);const I=new Float32Array(W*B*4*g),G=new Ig(I,W,B,g);G.type=Bi,G.needsUpdate=!0;const P=R*4;for(let O=0;O<g;O++){const re=_[O],Q=U[O],fe=b[O],ce=W*B*4*O;for(let oe=0;oe<re.count;oe++){const ue=oe*P;T===!0&&(a.fromBufferAttribute(re,oe),I[ce+ue+0]=a.x,I[ce+ue+1]=a.y,I[ce+ue+2]=a.z,I[ce+ue+3]=0),w===!0&&(a.fromBufferAttribute(Q,oe),I[ce+ue+4]=a.x,I[ce+ue+5]=a.y,I[ce+ue+6]=a.z,I[ce+ue+7]=0),y===!0&&(a.fromBufferAttribute(fe,oe),I[ce+ue+8]=a.x,I[ce+ue+9]=a.y,I[ce+ue+10]=a.z,I[ce+ue+11]=fe.itemSize===4?a.w:1)}}x={count:g,texture:G,size:new At(W,B)},r.set(f,x),f.addEventListener("dispose",C)}if(c.isInstancedMesh===!0&&c.morphTexture!==null)h.getUniforms().setValue(s,"morphTexture",c.morphTexture,t);else{let T=0;for(let y=0;y<p.length;y++)T+=p[y];const w=f.morphTargetsRelative?1:1-T;h.getUniforms().setValue(s,"morphTargetBaseInfluence",w),h.getUniforms().setValue(s,"morphTargetInfluences",p)}h.getUniforms().setValue(s,"morphTargetsTexture",x.texture,t),h.getUniforms().setValue(s,"morphTargetsTextureSize",x.size)}return{update:l}}function DM(s,e,t,r){let a=new WeakMap;function l(h){const p=r.render.frame,v=h.geometry,g=e.get(h,v);if(a.get(g)!==p&&(e.update(g),a.set(g,p)),h.isInstancedMesh&&(h.hasEventListener("dispose",f)===!1&&h.addEventListener("dispose",f),a.get(h)!==p&&(t.update(h.instanceMatrix,s.ARRAY_BUFFER),h.instanceColor!==null&&t.update(h.instanceColor,s.ARRAY_BUFFER),a.set(h,p))),h.isSkinnedMesh){const x=h.skeleton;a.get(x)!==p&&(x.update(),a.set(x,p))}return g}function c(){a=new WeakMap}function f(h){const p=h.target;p.removeEventListener("dispose",f),t.remove(p.instanceMatrix),p.instanceColor!==null&&t.remove(p.instanceColor)}return{update:l,dispose:c}}const jg=new An,Hm=new Gg(1,1),Yg=new Ig,qg=new ey,$g=new Vg,Vm=[],Gm=[],Wm=new Float32Array(16),Xm=new Float32Array(9),jm=new Float32Array(4);function no(s,e,t){const r=s[0];if(r<=0||r>0)return s;const a=e*t;let l=Vm[a];if(l===void 0&&(l=new Float32Array(a),Vm[a]=l),e!==0){r.toArray(l,0);for(let c=1,f=0;c!==e;++c)f+=t,s[c].toArray(l,f)}return l}function Jt(s,e){if(s.length!==e.length)return!1;for(let t=0,r=s.length;t<r;t++)if(s[t]!==e[t])return!1;return!0}function en(s,e){for(let t=0,r=e.length;t<r;t++)s[t]=e[t]}function Ql(s,e){let t=Gm[e];t===void 0&&(t=new Int32Array(e),Gm[e]=t);for(let r=0;r!==e;++r)t[r]=s.allocateTextureUnit();return t}function UM(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function NM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Jt(t,e))return;s.uniform2fv(this.addr,e),en(t,e)}}function IM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Jt(t,e))return;s.uniform3fv(this.addr,e),en(t,e)}}function FM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Jt(t,e))return;s.uniform4fv(this.addr,e),en(t,e)}}function OM(s,e){const t=this.cache,r=e.elements;if(r===void 0){if(Jt(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),en(t,e)}else{if(Jt(t,r))return;jm.set(r),s.uniformMatrix2fv(this.addr,!1,jm),en(t,r)}}function kM(s,e){const t=this.cache,r=e.elements;if(r===void 0){if(Jt(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),en(t,e)}else{if(Jt(t,r))return;Xm.set(r),s.uniformMatrix3fv(this.addr,!1,Xm),en(t,r)}}function BM(s,e){const t=this.cache,r=e.elements;if(r===void 0){if(Jt(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),en(t,e)}else{if(Jt(t,r))return;Wm.set(r),s.uniformMatrix4fv(this.addr,!1,Wm),en(t,r)}}function zM(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function HM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Jt(t,e))return;s.uniform2iv(this.addr,e),en(t,e)}}function VM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Jt(t,e))return;s.uniform3iv(this.addr,e),en(t,e)}}function GM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Jt(t,e))return;s.uniform4iv(this.addr,e),en(t,e)}}function WM(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function XM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Jt(t,e))return;s.uniform2uiv(this.addr,e),en(t,e)}}function jM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Jt(t,e))return;s.uniform3uiv(this.addr,e),en(t,e)}}function YM(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Jt(t,e))return;s.uniform4uiv(this.addr,e),en(t,e)}}function qM(s,e,t){const r=this.cache,a=t.allocateTextureUnit();r[0]!==a&&(s.uniform1i(this.addr,a),r[0]=a);let l;this.type===s.SAMPLER_2D_SHADOW?(Hm.compareFunction=Ug,l=Hm):l=jg,t.setTexture2D(e||l,a)}function $M(s,e,t){const r=this.cache,a=t.allocateTextureUnit();r[0]!==a&&(s.uniform1i(this.addr,a),r[0]=a),t.setTexture3D(e||qg,a)}function KM(s,e,t){const r=this.cache,a=t.allocateTextureUnit();r[0]!==a&&(s.uniform1i(this.addr,a),r[0]=a),t.setTextureCube(e||$g,a)}function ZM(s,e,t){const r=this.cache,a=t.allocateTextureUnit();r[0]!==a&&(s.uniform1i(this.addr,a),r[0]=a),t.setTexture2DArray(e||Yg,a)}function QM(s){switch(s){case 5126:return UM;case 35664:return NM;case 35665:return IM;case 35666:return FM;case 35674:return OM;case 35675:return kM;case 35676:return BM;case 5124:case 35670:return zM;case 35667:case 35671:return HM;case 35668:case 35672:return VM;case 35669:case 35673:return GM;case 5125:return WM;case 36294:return XM;case 36295:return jM;case 36296:return YM;case 35678:case 36198:case 36298:case 36306:case 35682:return qM;case 35679:case 36299:case 36307:return $M;case 35680:case 36300:case 36308:case 36293:return KM;case 36289:case 36303:case 36311:case 36292:return ZM}}function JM(s,e){s.uniform1fv(this.addr,e)}function eT(s,e){const t=no(e,this.size,2);s.uniform2fv(this.addr,t)}function tT(s,e){const t=no(e,this.size,3);s.uniform3fv(this.addr,t)}function nT(s,e){const t=no(e,this.size,4);s.uniform4fv(this.addr,t)}function iT(s,e){const t=no(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function rT(s,e){const t=no(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function sT(s,e){const t=no(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function oT(s,e){s.uniform1iv(this.addr,e)}function aT(s,e){s.uniform2iv(this.addr,e)}function lT(s,e){s.uniform3iv(this.addr,e)}function uT(s,e){s.uniform4iv(this.addr,e)}function cT(s,e){s.uniform1uiv(this.addr,e)}function fT(s,e){s.uniform2uiv(this.addr,e)}function dT(s,e){s.uniform3uiv(this.addr,e)}function hT(s,e){s.uniform4uiv(this.addr,e)}function pT(s,e,t){const r=this.cache,a=e.length,l=Ql(t,a);Jt(r,l)||(s.uniform1iv(this.addr,l),en(r,l));for(let c=0;c!==a;++c)t.setTexture2D(e[c]||jg,l[c])}function mT(s,e,t){const r=this.cache,a=e.length,l=Ql(t,a);Jt(r,l)||(s.uniform1iv(this.addr,l),en(r,l));for(let c=0;c!==a;++c)t.setTexture3D(e[c]||qg,l[c])}function gT(s,e,t){const r=this.cache,a=e.length,l=Ql(t,a);Jt(r,l)||(s.uniform1iv(this.addr,l),en(r,l));for(let c=0;c!==a;++c)t.setTextureCube(e[c]||$g,l[c])}function vT(s,e,t){const r=this.cache,a=e.length,l=Ql(t,a);Jt(r,l)||(s.uniform1iv(this.addr,l),en(r,l));for(let c=0;c!==a;++c)t.setTexture2DArray(e[c]||Yg,l[c])}function _T(s){switch(s){case 5126:return JM;case 35664:return eT;case 35665:return tT;case 35666:return nT;case 35674:return iT;case 35675:return rT;case 35676:return sT;case 5124:case 35670:return oT;case 35667:case 35671:return aT;case 35668:case 35672:return lT;case 35669:case 35673:return uT;case 5125:return cT;case 36294:return fT;case 36295:return dT;case 36296:return hT;case 35678:case 36198:case 36298:case 36306:case 35682:return pT;case 35679:case 36299:case 36307:return mT;case 35680:case 36300:case 36308:case 36293:return gT;case 36289:case 36303:case 36311:case 36292:return vT}}class xT{constructor(e,t,r){this.id=e,this.addr=r,this.cache=[],this.type=t.type,this.setValue=QM(t.type)}}class yT{constructor(e,t,r){this.id=e,this.addr=r,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=_T(t.type)}}class ST{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,r){const a=this.seq;for(let l=0,c=a.length;l!==c;++l){const f=a[l];f.setValue(e,t[f.id],r)}}}const mf=/(\w+)(\])?(\[|\.)?/g;function Ym(s,e){s.seq.push(e),s.map[e.id]=e}function ET(s,e,t){const r=s.name,a=r.length;for(mf.lastIndex=0;;){const l=mf.exec(r),c=mf.lastIndex;let f=l[1];const h=l[2]==="]",p=l[3];if(h&&(f=f|0),p===void 0||p==="["&&c+2===a){Ym(t,p===void 0?new xT(f,s,e):new yT(f,s,e));break}else{let g=t.map[f];g===void 0&&(g=new ST(f),Ym(t,g)),t=g}}}class Bl{constructor(e,t){this.seq=[],this.map={};const r=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<r;++a){const l=e.getActiveUniform(t,a),c=e.getUniformLocation(t,l.name);ET(l,c,this)}}setValue(e,t,r,a){const l=this.map[t];l!==void 0&&l.setValue(e,r,a)}setOptional(e,t,r){const a=t[r];a!==void 0&&this.setValue(e,r,a)}static upload(e,t,r,a){for(let l=0,c=t.length;l!==c;++l){const f=t[l],h=r[f.id];h.needsUpdate!==!1&&f.setValue(e,h.value,a)}}static seqWithValue(e,t){const r=[];for(let a=0,l=e.length;a!==l;++a){const c=e[a];c.id in t&&r.push(c)}return r}}function qm(s,e,t){const r=s.createShader(e);return s.shaderSource(r,t),s.compileShader(r),r}const MT=37297;let TT=0;function wT(s,e){const t=s.split(`
`),r=[],a=Math.max(e-6,0),l=Math.min(e+6,t.length);for(let c=a;c<l;c++){const f=c+1;r.push(`${f===e?">":" "} ${f}: ${t[c]}`)}return r.join(`
`)}const $m=new ut;function AT(s){wt._getMatrix($m,wt.workingColorSpace,s);const e=`mat3( ${$m.elements.map(t=>t.toFixed(4))} )`;switch(wt.getTransfer(s)){case Gl:return[e,"LinearTransferOETF"];case Dt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function Km(s,e,t){const r=s.getShaderParameter(e,s.COMPILE_STATUS),a=s.getShaderInfoLog(e).trim();if(r&&a==="")return"";const l=/ERROR: 0:(\d+)/.exec(a);if(l){const c=parseInt(l[1]);return t.toUpperCase()+`

`+a+`

`+wT(s.getShaderSource(e),c)}else return a}function CT(s,e){const t=AT(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function RT(s,e){let t;switch(e){case wx:t="Linear";break;case Ax:t="Reinhard";break;case Cx:t="Cineon";break;case Rx:t="ACESFilmic";break;case bx:t="AgX";break;case Lx:t="Neutral";break;case Px:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Dl=new ne;function PT(){wt.getLuminanceCoefficients(Dl);const s=Dl.x.toFixed(4),e=Dl.y.toFixed(4),t=Dl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function bT(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Vo).join(`
`)}function LT(s){const e=[];for(const t in s){const r=s[t];r!==!1&&e.push("#define "+t+" "+r)}return e.join(`
`)}function DT(s,e){const t={},r=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let a=0;a<r;a++){const l=s.getActiveAttrib(e,a),c=l.name;let f=1;l.type===s.FLOAT_MAT2&&(f=2),l.type===s.FLOAT_MAT3&&(f=3),l.type===s.FLOAT_MAT4&&(f=4),t[c]={type:l.type,location:s.getAttribLocation(e,c),locationSize:f}}return t}function Vo(s){return s!==""}function Zm(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Qm(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const UT=/^[ \t]*#include +<([\w\d./]+)>/gm;function od(s){return s.replace(UT,IT)}const NT=new Map;function IT(s,e){let t=ft[e];if(t===void 0){const r=NT.get(e);if(r!==void 0)t=ft[r],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,r);else throw new Error("Can not resolve #include <"+e+">")}return od(t)}const FT=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Jm(s){return s.replace(FT,OT)}function OT(s,e,t,r){let a="";for(let l=parseInt(e);l<parseInt(t);l++)a+=r.replace(/\[\s*i\s*\]/g,"[ "+l+" ]").replace(/UNROLLED_LOOP_INDEX/g,l);return a}function eg(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function kT(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Eg?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===rx?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Fi&&(e="SHADOWMAP_TYPE_VSM"),e}function BT(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case $s:case Ks:e="ENVMAP_TYPE_CUBE";break;case $l:e="ENVMAP_TYPE_CUBE_UV";break}return e}function zT(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Ks:e="ENVMAP_MODE_REFRACTION";break}return e}function HT(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Mg:e="ENVMAP_BLENDING_MULTIPLY";break;case Mx:e="ENVMAP_BLENDING_MIX";break;case Tx:e="ENVMAP_BLENDING_ADD";break}return e}function VT(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:r,maxMip:t}}function GT(s,e,t,r){const a=s.getContext(),l=t.defines;let c=t.vertexShader,f=t.fragmentShader;const h=kT(t),p=BT(t),v=zT(t),g=HT(t),x=VT(t),S=bT(t),T=LT(l),w=a.createProgram();let y,_,U=t.glslVersion?"#version "+t.glslVersion+`
