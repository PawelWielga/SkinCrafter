 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(N,V){var B=N.length;N.push(V);t:for(;0<B;){var tt=B-1>>>1,at=N[tt];if(0<a(at,V))N[tt]=V,N[B]=at,B=tt;else break t}}function n(N){return N.length===0?null:N[0]}function i(N){if(N.length===0)return null;var V=N[0],B=N.pop();if(B!==V){N[0]=B;t:for(var tt=0,at=N.length,_t=at>>>1;tt<_t;){var Pt=2*(tt+1)-1,jt=N[Pt],W=Pt+1,it=N[W];if(0>a(jt,B))W<at&&0>a(it,jt)?(N[tt]=it,N[W]=B,tt=W):(N[tt]=jt,N[Pt]=B,tt=Pt);else if(W<at&&0>a(it,B))N[tt]=it,N[W]=B,tt=W;else break t}}return V}function a(N,V){var B=N.sortIndex-V.sortIndex;return B!==0?B:N.id-V.id}if(e.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var r=performance;e.unstable_now=function(){return r.now()}}else{var s=Date,o=s.now();e.unstable_now=function(){return s.now()-o}}var l=[],c=[],h=1,d=null,f=3,p=!1,S=!1,y=!1,m=!1,u=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;function v(N){for(var V=n(c);V!==null;){if(V.callback===null)i(c);else if(V.startTime<=N)i(c),V.sortIndex=V.expirationTime,t(l,V);else break;V=n(c)}}function R(N){if(y=!1,v(N),!S)if(n(l)!==null)S=!0,C||(C=!0,k());else{var V=n(c);V!==null&&Y(R,V.startTime-N)}}var C=!1,b=-1,w=5,T=-1;function M(){return m?!0:!(e.unstable_now()-T<w)}function U(){if(m=!1,C){var N=e.unstable_now();T=N;var V=!0;try{t:{S=!1,y&&(y=!1,g(b),b=-1),p=!0;var B=f;try{e:{for(v(N),d=n(l);d!==null&&!(d.expirationTime>N&&M());){var tt=d.callback;if(typeof tt=="function"){d.callback=null,f=d.priorityLevel;var at=tt(d.expirationTime<=N);if(N=e.unstable_now(),typeof at=="function"){d.callback=at,v(N),V=!0;break e}d===n(l)&&i(l),v(N)}else i(l);d=n(l)}if(d!==null)V=!0;else{var _t=n(c);_t!==null&&Y(R,_t.startTime-N),V=!1}}break t}finally{d=null,f=B,p=!1}V=void 0}}finally{V?k():C=!1}}}var k;if(typeof _=="function")k=function(){_(U)};else if(typeof MessageChannel<"u"){var G=new MessageChannel,K=G.port2;G.port1.onmessage=U,k=function(){K.postMessage(null)}}else k=function(){u(U,0)};function Y(N,V){b=u(function(){N(e.unstable_now())},V)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(N){N.callback=null},e.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):w=0<N?Math.floor(1e3/N):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_next=function(N){switch(f){case 1:case 2:case 3:var V=3;break;default:V=f}var B=f;f=V;try{return N()}finally{f=B}},e.unstable_requestPaint=function(){m=!0},e.unstable_runWithPriority=function(N,V){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var B=f;f=N;try{return V()}finally{f=B}},e.unstable_scheduleCallback=function(N,V,B){var tt=e.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?tt+B:tt):B=tt,N){case 1:var at=-1;break;case 2:at=250;break;case 5:at=1073741823;break;case 4:at=1e4;break;default:at=5e3}return at=B+at,N={id:h++,callback:V,priorityLevel:N,startTime:B,expirationTime:at,sortIndex:-1},B>tt?(N.sortIndex=B,t(c,N),n(l)===null&&N===n(c)&&(y?(g(b),b=-1):y=!0,Y(R,B-tt))):(N.sortIndex=at,t(l,N),S||p||(S=!0,C||(C=!0,k()))),N},e.unstable_shouldYield=M,e.unstable_wrapCallback=function(N){var V=f;return function(){var B=f;f=V;try{return N.apply(this,arguments)}finally{f=B}}}})(Zg);Yg.exports=Zg;var NS=Yg.exports,jg={exports:{}},ln={};/**
 * @license React
...
`)+`
`+u);const _=g+m+s,v=g+u+o,R=bg(a,a.VERTEX_SHADER,_),C=bg(a,a.FRAGMENT_SHADER,v);a.attachShader(y,R),a.attachShader(y,C),n.index0AttributeName!==void 0?a.bindAttribLocation(y,0,n.index0AttributeName):n.morphTargets===!0&&a.bindAttribLocation(y,0,"position"),a.linkProgram(y);function b(U){if(e.debug.checkShaderErrors){const k=a.getProgramInfoLog(y).trim(),G=a.getShaderInfoLog(R).trim(),K=a.getShaderInfoLog(C).trim();let Y=!0,N=!0;if(a.getProgramParameter(y,a.LINK_STATUS)===!1)if(Y=!1,typeof e.debug.onShaderError=="function")e.debug.onShaderError(a,y,R,C);else{const V=Rg(a,R,"vertex"),B=Rg(a,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+a.getError()+" - VALIDATE_STATUS "+a.getProgramParameter(y,a.VALIDATE_STATUS)+`
