 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var tm;function c0(){if(tm)return ks;tm=1;var r=md(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),o=Object.prototype.hasOwnProperty,a=r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function c(f,h,p){var g,v={},x=null,S=null;p!==void 0&&(x=""+p),h.key!==void 0&&(x=""+h.key),h.ref!==void 0&&(S=h.ref);for(g in h)o.call(h,g)&&!l.hasOwnProperty(g)&&(v[g]=h[g]);if(f&&f.defaultProps)for(g in h=f.defaultProps,h)v[g]===void 0&&(v[g]=h[g]);return{$$typeof:e,type:f,key:x,ref:S,props:v,_owner:a.current}}return ks.Fragment=t,ks.jsx=c,ks.jsxs=c,ks}var nm;function f0(){return nm||(nm=1,Oc.exports=c0()),Oc.exports}var Pe=f0(),ue=md();const gd=Rg(ue),d0=l0({__proto__:null,default:gd},[ue]);var vl={},Bc={exports:{}},Nn={},zc={exports:{}},Hc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var im;function h0(){return im||(im=1,function(r){function e(z,le){var oe=z.length;z.push(le);e:for(;0<oe;){var N=oe-1>>>1,ne=z[N];if(0<a(ne,le))z[N]=le,z[oe]=ne,oe=N;else break e}}function t(z){return z.length===0?null:z[0]}function o(z){if(z.length===0)return null;var le=z[0],oe=z.pop();if(oe!==le){z[0]=oe;e:for(var N=0,ne=z.length,Oe=ne>>>1;N<Oe;){var Q=2*(N+1)-1,de=z[Q],Te=Q+1,ye=z[Te];if(0>a(de,oe))Te<ne&&0>a(ye,de)?(z[N]=ye,z[Te]=oe,N=Te):(z[N]=de,z[Q]=oe,N=Q);else if(Te<ne&&0>a(ye,oe))z[N]=ye,z[Te]=oe,N=Te;else break e}}return le}function a(z,le){var oe=z.sortIndex-le.sortIndex;return oe!==0?oe:z.id-le.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;r.unstable_now=function(){return l.now()}}else{var c=Date,f=c.now();r.unstable_now=function(){return c.now()-f}}var h=[],p=[],g=1,v=null,x=3,S=!1,M=!1,w=!1,y=typeof setTimeout=="function"?setTimeout:null,_=typeof clearTimeout=="function"?clearTimeout:null,L=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function P(z){for(var le=t(p);le!==null;){if(le.callback===null)o(p);else if(le.startTime<=z)o(p),le.sortIndex=le.expirationTime,e(h,le);else break;le=t(p)}}function C(z){if(w=!1,P(z),!M)if(t(h)!==null)M=!0,re(G);else{var le=t(p);le!==null&&he(C,le.startTime-z)}}function G(z,le){M=!1,w&&(w=!1,_(W),W=-1),S=!0;var oe=x;try{for(P(le),v=t(h);v!==null&&(!(v.expirationTime>le)||z&&!B());){var N=v.callback;if(typeof N=="function"){v.callback=null,x=v.priorityLevel;var ne=N(v.expirationTime<=le);le=r.unstable_now(),typeof ne=="function"?v.callback=ne:v===t(h)&&o(h),P(le)}else o(h);v=t(h)}if(v!==null)var Oe=!0;else{var Q=t(p);Q!==null&&he(C,Q.startTime-le),Oe=!1}return Oe}finally{v=null,x=oe,S=!1}}var O=!1,I=null,W=-1,b=5,R=-1;function B(){return!(r.unstable_now()-R<b)}function ee(){if(I!==null){var z=r.unstable_now();R=z;var le=!0;try{le=I(!0,z)}finally{le?q():(O=!1,I=null)}}else O=!1}var q;if(typeof L=="function")q=function(){L(ee)};else if(typeof MessageChannel<"u"){var se=new MessageChannel,ce=se.port2;se.port1.onmessage=ee,q=function(){ce.postMessage(null)}}else q=function(){y(ee,0)};function re(z){I=z,O||(O=!0,q())}function he(z,le){W=y(function(){z(r.unstable_now())},le)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(z){z.callback=null},r.unstable_continueExecution=function(){M||S||(M=!0,re(G))},r.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):b=0<z?Math.floor(1e3/z):5},r.unstable_getCurrentPriorityLevel=function(){return x},r.unstable_getFirstCallbackNode=function(){return t(h)},r.unstable_next=function(z){switch(x){case 1:case 2:case 3:var le=3;break;default:le=x}var oe=x;x=le;try{return z()}finally{x=oe}},r.unstable_pauseExecution=function(){},r.unstable_requestPaint=function(){},r.unstable_runWithPriority=function(z,le){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var oe=x;x=z;try{return le()}finally{x=oe}},r.unstable_scheduleCallback=function(z,le,oe){var N=r.unstable_now();switch(typeof oe=="object"&&oe!==null?(oe=oe.delay,oe=typeof oe=="number"&&0<oe?N+oe:N):oe=N,z){case 1:var ne=-1;break;case 2:ne=250;break;case 5:ne=1073741823;break;case 4:ne=1e4;break;default:ne=5e3}return ne=oe+ne,z={id:g++,callback:le,priorityLevel:z,startTime:oe,expirationTime:ne,sortIndex:-1},oe>N?(z.sortIndex=oe,e(p,z),t(h)===null&&z===t(p)&&(w?(_(W),W=-1):w=!0,he(C,oe-N))):(z.sortIndex=ne,e(h,z),M||S||(M=!0,re(G))),z},r.unstable_shouldYield=B,r.unstable_wrapCallback=function(z){var le=x;return function(){var oe=x;x=le;try{return z.apply(this,arguments)}finally{x=oe}}}}(Hc)),Hc}var rm;function p0(){return rm||(rm=1,zc.exports=h0()),zc.exports}/**
 * @license React
...
`)+`
`+_);const P=L+y+c,C=L+_+f,G=og(a,a.VERTEX_SHADER,P),O=og(a,a.FRAGMENT_SHADER,C);a.attachShader(w,G),a.attachShader(w,O),t.index0AttributeName!==void 0?a.bindAttribLocation(w,0,t.index0AttributeName):t.morphTargets===!0&&a.bindAttribLocation(w,0,"position"),a.linkProgram(w);function I(B){if(r.debug.checkShaderErrors){const ee=a.getProgramInfoLog(w).trim(),q=a.getShaderInfoLog(G).trim(),se=a.getShaderInfoLog(O).trim();let ce=!0,re=!0;if(a.getProgramParameter(w,a.LINK_STATUS)===!1)if(ce=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(a,w,G,O);else{const he=ag(a,G,"vertex"),z=ag(a,O,"fragment");console.error("THREE.WebGLProgram: Shader Error "+a.getError()+" - VALIDATE_STATUS "+a.getProgramParameter(w,a.VALIDATE_STATUS)+`
...
Program Info Log: `+ee+`
`+he+`
`+z)}else ee!==""?console.warn("THREE.WebGLProgram: Program Info Log:",ee):(q===""||se==="")&&(re=!1);re&&(B.diagnostics={runnable:ce,programLog:ee,vertexShader:{log:q,prefix:y},fragmentShader:{log:se,prefix:_}})}a.deleteShader(G),a.deleteShader(O),W=new Xl(a,w),b=yw(a,w)}let W;this.getUniforms=function(){return W===void 0&&I(this),W};let b;this.getAttributes=function(){return b===void 0&&I(this),b};let R=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return R===!1&&(R=a.getProgramParameter(w,fw)),R},this.destroy=function(){o.releaseStatesOfProgram(this),a.deleteProgram(w),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=dw++,this.cacheKey=e,this.usedTimes=1,this.program=w,this.vertexShader=G,this.fragmentShader=O,this}let Dw=0;class Uw{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,o=e.fragmentShader,a=this._getShaderStage(t),l=this._getShaderStage(o),c=this._getShaderCacheForMaterial(e);return c.has(a)===!1&&(c.add(a),a.usedTimes++),c.has(l)===!1&&(c.add(l),l.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const o of t)o.usedTimes--,o.usedTimes===0&&this.shaderCache.delete(o.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let o=t.get(e);return o===void 0&&(o=new Set,t.set(e,o)),o}_getShaderStage(e){const t=this.shaderCache;let o=t.get(e);return o===void 0&&(o=new Nw(e),t.set(e,o)),o}}class Nw{constructor(e){this.id=Dw++,this.code=e,this.usedTimes=0}}function Iw(r,e,t,o,a,l,c){const f=new ov,h=new Uw,p=new Set,g=[],v=a.logarithmicDepthBuffer,x=a.vertexTextures;let S=a.precision;const M={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function w(b){return p.add(b),b===0?"uv":`uv${b}`}function y(b,R,B,ee,q){const se=ee.fog,ce=q.geometry,re=b.isMeshStandardMaterial?ee.environment:null,he=(b.isMeshStandardMaterial?t:e).get(b.envMap||re),z=he&&he.mapping===nu?he.image.height:null,le=M[b.type];b.precision!==null&&(S=a.getMaxPrecision(b.precision),S!==b.precision&&console.warn("THREE.WebGLProgram.getParameters:",b.precision,"not supported, using",S,"instead."));const oe=ce.morphAttributes.position||ce.morphAttributes.normal||ce.morphAttributes.color,N=oe!==void 0?oe.length:0;let ne=0;ce.morphAttributes.position!==void 0&&(ne=1),ce.morphAttributes.normal!==void 0&&(ne=2),ce.morphAttributes.color!==void 0&&(ne=3);let Oe,Q,de,Te;if(le){const yt=mi[le];Oe=yt.vertexShader,Q=yt.fragmentShader}else Oe=b.vertexShader,Q=b.fragmentShader,h.update(b),de=h.getVertexShaderID(b),Te=h.getFragmentShaderID(b);const ye=r.getRenderTarget(),Ae=r.state.buffers.depth.getReversed(),Re=q.isInstancedMesh===!0,De=q.isBatchedMesh===!0,At=!!b.map,vt=!!b.matcap,ut=!!he,F=!!b.aoMap,Yt=!!b.lightMap,_t=!!b.bumpMap,Mt=!!b.normalMap,je=!!b.displacementMap,ht=!!b.emissiveMap,qe=!!b.metalnessMap,nt=!!b.roughnessMap,It=b.anisotropy>0,D=b.clearcoat>0,T=b.dispersion>0,K=b.iridescence>0,fe=b.sheen>0,me=b.transmission>0,ae=It&&!!b.anisotropyMap,Ye=D&&!!b.clearcoatMap,Ce=D&&!!b.clearcoatNormalMap,ke=D&&!!b.clearcoatRoughnessMap,Ze=K&&!!b.iridescenceMap,_e=K&&!!b.iridescenceThicknessMap,Be=fe&&!!b.sheenColorMap,it=fe&&!!b.sheenRoughnessMap,Je=!!b.specularMap,be=!!b.specularColorMap,st=!!b.specularIntensityMap,H=me&&!!b.transmissionMap,Le=me&&!!b.thicknessMap,ve=!!b.gradientMap,Ie=!!b.alphaMap,Ee=b.alphaTest>0,pe=!!b.alphaHash,Ge=!!b.extensions;let lt=Hi;b.toneMapped&&(ye===null||ye.isXRRenderTarget===!0)&&(lt=r.toneMapping);const Pt={shaderID:le,shaderType:b.type,shaderName:b.name,vertexShader:Oe,fragmentShader:Q,defines:b.defines,customVertexShaderID:de,customFragmentShaderID:Te,isRawShaderMaterial:b.isRawShaderMaterial===!0,glslVersion:b.glslVersion,precision:S,batching:De,batchingColor:De&&q._colorsTexture!==null,instancing:Re,instancingColor:Re&&q.instanceColor!==null,instancingMorph:Re&&q.morphTexture!==null,supportsVertexTextures:x,outputColorSpace:ye===null?r.outputColorSpace:ye.isXRRenderTarget===!0?ye.texture.colorSpace:es,alphaToCoverage:!!b.alphaToCoverage,map:At,matcap:vt,envMap:ut,envMapMode:ut&&he.mapping,envMapCubeUVHeight:z,aoMap:F,lightMap:Yt,bumpMap:_t,normalMap:Mt,displacementMap:x&&je,emissiveMap:ht,normalMapObjectSpace:Mt&&b.normalMapType===ly,normalMapTangentSpace:Mt&&b.normalMapType===ay,metalnessMap:qe,roughnessMap:nt,anisotropy:It,anisotropyMap:ae,clearcoat:D,clearcoatMap:Ye,clearcoatNormalMap:Ce,clearcoatRoughnessMap:ke,dispersion:T,iridescence:K,iridescenceMap:Ze,iridescenceThicknessMap:_e,sheen:fe,sheenColorMap:Be,sheenRoughnessMap:it,specularMap:Je,specularColorMap:be,specularIntensityMap:st,transmission:me,transmissionMap:H,thicknessMap:Le,gradientMap:ve,opaque:b.transparent===!1&&b.blending===Xo&&b.alphaToCoverage===!1,alphaMap:Ie,alphaTest:Ee,alphaHash:pe,combine:b.combine,mapUv:At&&w(b.map.channel),aoMapUv:F&&w(b.aoMap.channel),lightMapUv:Yt&&w(b.lightMap.channel),bumpMapUv:_t&&w(b.bumpMap.channel),normalMapUv:Mt&&w(b.normalMap.channel),displacementMapUv:je&&w(b.displacementMap.channel),emissiveMapUv:ht&&w(b.emissiveMap.channel),metalnessMapUv:qe&&w(b.metalnessMap.channel),roughnessMapUv:nt&&w(b.roughnessMap.channel),anisotropyMapUv:ae&&w(b.anisotropyMap.channel),clearcoatMapUv:Ye&&w(b.clearcoatMap.channel),clearcoatNormalMapUv:Ce&&w(b.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ke&&w(b.clearcoatRoughnessMap.channel),iridescenceMapUv:Ze&&w(b.iridescenceMap.channel),iridescenceThicknessMapUv:_e&&w(b.iridescenceThicknessMap.channel),sheenColorMapUv:Be&&w(b.sheenColorMap.channel),sheenRoughnessMapUv:it&&w(b.sheenRoughnessMap.channel),specularMapUv:Je&&w(b.specularMap.channel),specularColorMapUv:be&&w(b.specularColorMap.channel),specularIntensityMapUv:st&&w(b.specularIntensityMap.channel),transmissionMapUv:H&&w(b.transmissionMap.channel),thicknessMapUv:Le&&w(b.thicknessMap.channel),alphaMapUv:Ie&&w(b.alphaMap.channel),vertexTangents:!!ce.attributes.tangent&&(Mt||It),vertexColors:b.vertexColors,vertexAlphas:b.vertexColors===!0&&!!ce.attributes.color&&ce.attributes.color.itemSize===4,pointsUvs:q.isPoints===!0&&!!ce.attributes.uv&&(At||Ie),fog:!!se,useFog:b.fog===!0,fogExp2:!!se&&se.isFogExp2,flatShading:b.flatShading===!0&&b.wireframe===!1,sizeAttenuation:b.sizeAttenuation===!0,logarithmicDepthBuffer:v,reverseDepthBuffer:Ae,skinning:q.isSkinnedMesh===!0,morphTargets:ce.morphAttributes.position!==void 0,morphNormals:ce.morphAttributes.normal!==void 0,morphColors:ce.morphAttributes.color!==void 0,morphTargetsCount:N,morphTextureStride:ne,numDirLights:R.directional.length,numPointLights:R.point.length,numSpotLights:R.spot.length,numSpotLightMaps:R.spotLightMap.length,numRectAreaLights:R.rectArea.length,numHemiLights:R.hemi.length,numDirLightShadows:R.directionalShadowMap.length,numPointLightShadows:R.pointShadowMap.length,numSpotLightShadows:R.spotShadowMap.length,numSpotLightShadowsWithMaps:R.numSpotLightShadowsWithMaps,numLightProbes:R.numLightProbes,numClippingPlanes:c.numPlanes,numClipIntersection:c.numIntersection,dithering:b.dithering,shadowMapEnabled:r.shadowMap.enabled&&B.length>0,shadowMapType:r.shadowMap.type,toneMapping:lt,decodeVideoTexture:At&&b.map.isVideoTexture===!0&&wt.getTransfer(b.map.colorSpace)===Dt,decodeVideoTextureEmissive:ht&&b.emissiveMap.isVideoTexture===!0&&wt.getTransfer(b.emissiveMap.colorSpace)===Dt,premultipliedAlpha:b.premultipliedAlpha,doubleSided:b.side===Oi,flipSided:b.side===Fn,useDepthPacking:b.depthPacking>=0,depthPacking:b.depthPacking||0,index0AttributeName:b.index0AttributeName,extensionClipCullDistance:Ge&&b.extensions.clipCullDistance===!0&&o.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Ge&&b.extensions.multiDraw===!0||De)&&o.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:o.has("KHR_parallel_shader_compile"),customProgramCacheKey:b.customProgramCacheKey()};return Pt.vertexUv1s=p.has(1),Pt.vertexUv2s=p.has(2),Pt.vertexUv3s=p.has(3),p.clear(),Pt}function _(b){const R=[];if(b.shaderID?R.push(b.shaderID):(R.push(b.customVertexShaderID),R.push(b.customFragmentShaderID)),b.defines!==void 0)for(const B in b.defines)R.push(B),R.push(b.defines[B]);return b.isRawShaderMaterial===!1&&(L(R,b),P(R,b),R.push(r.outputColorSpace)),R.push(b.customProgramCacheKey),R.join()}function L(b,R){b.push(R.precision),b.push(R.outputColorSpace),b.push(R.envMapMode),b.push(R.envMapCubeUVHeight),b.push(R.mapUv),b.push(R.alphaMapUv),b.push(R.lightMapUv),b.push(R.aoMapUv),b.push(R.bumpMapUv),b.push(R.normalMapUv),b.push(R.displacementMapUv),b.push(R.emissiveMapUv),b.push(R.metalnessMapUv),b.push(R.roughnessMapUv),b.push(R.anisotropyMapUv),b.push(R.clearcoatMapUv),b.push(R.clearcoatNormalMapUv),b.push(R.clearcoatRoughnessMapUv),b.push(R.iridescenceMapUv),b.push(R.iridescenceThicknessMapUv),b.push(R.sheenColorMapUv),b.push(R.sheenRoughnessMapUv),b.push(R.specularMapUv),b.push(R.specularColorMapUv),b.push(R.specularIntensityMapUv),b.push(R.transmissionMapUv),b.push(R.thicknessMapUv),b.push(R.combine),b.push(R.fogExp2),b.push(R.sizeAttenuation),b.push(R.morphTargetsCount),b.push(R.morphAttributeCount),b.push(R.numDirLights),b.push(R.numPointLights),b.push(R.numSpotLights),b.push(R.numSpotLightMaps),b.push(R.numHemiLights),b.push(R.numRectAreaLights),b.push(R.numDirLightShadows),b.push(R.numPointLightShadows),b.push(R.numSpotLightShadows),b.push(R.numSpotLightShadowsWithMaps),b.push(R.numLightProbes),b.push(R.shadowMapType),b.push(R.toneMapping),b.push(R.numClippingPlanes),b.push(R.numClipIntersection),b.push(R.depthPacking)}function P(b,R){f.disableAll(),R.supportsVertexTextures&&f.enable(0),R.instancing&&f.enable(1),R.instancingColor&&f.enable(2),R.instancingMorph&&f.enable(3),R.matcap&&f.enable(4),R.envMap&&f.enable(5),R.normalMapObjectSpace&&f.enable(6),R.normalMapTangentSpace&&f.enable(7),R.clearcoat&&f.enable(8),R.iridescence&&f.enable(9),R.alphaTest&&f.enable(10),R.vertexColors&&f.enable(11),R.vertexAlphas&&f.enable(12),R.vertexUv1s&&f.enable(13),R.vertexUv2s&&f.enable(14),R.vertexUv3s&&f.enable(15),R.vertexTangents&&f.enable(16),R.anisotropy&&f.enable(17),R.alphaHash&&f.enable(18),R.batching&&f.enable(19),R.dispersion&&f.enable(20),R.batchingColor&&f.enable(21),R.gradientMap&&f.enable(22),b.push(f.mask),f.disableAll(),R.fog&&f.enable(0),R.useFog&&f.enable(1),R.flatShading&&f.enable(2),R.logarithmicDepthBuffer&&f.enable(3),R.reverseDepthBuffer&&f.enable(4),R.skinning&&f.enable(5),R.morphTargets&&f.enable(6),R.morphNormals&&f.enable(7),R.morphColors&&f.enable(8),R.premultipliedAlpha&&f.enable(9),R.shadowMapEnabled&&f.enable(10),R.doubleSided&&f.enable(11),R.flipSided&&f.enable(12),R.useDepthPacking&&f.enable(13),R.dithering&&f.enable(14),R.transmission&&f.enable(15),R.sheen&&f.enable(16),R.opaque&&f.enable(17),R.pointsUvs&&f.enable(18),R.decodeVideoTexture&&f.enable(19),R.decodeVideoTextureEmissive&&f.enable(20),R.alphaToCoverage&&f.enable(21),b.push(f.mask)}function C(b){const R=M[b.type];let B;if(R){const ee=mi[R];B=nS.clone(ee.uniforms)}else B=b.uniforms;return B}function G(b,R){let B;for(let ee=0,q=g.length;ee<q;ee++){const se=g[ee];if(se.cacheKey===R){B=se,++B.usedTimes;break}}return B===void 0&&(B=new Lw(r,R,b,l),g.push(B)),B}function O(b){if(--b.usedTimes===0){const R=g.indexOf(b);g[R]=g[g.length-1],g.pop(),b.destroy()}}function I(b){h.remove(b)}function W(){h.dispose()}return{getParameters:y,getProgramCacheKey:_,getUniforms:C,acquireProgram:G,releaseProgram:O,releaseShaderCache:I,programs:g,dispose:W}}function Fw(){let r=new WeakMap;function e(c){return r.has(c)}function t(c){let f=r.get(c);return f===void 0&&(f={},r.set(c,f)),f}function o(c){r.delete(c)}function a(c,f,h){r.get(c)[f]=h}function l(){r=new WeakMap}return{has:e,get:t,remove:o,update:a,dispose:l}}function Ow(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.material.id!==e.material.id?r.material.id-e.material.id:r.z!==e.z?r.z-e.z:r.id-e.id}function dg(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.z!==e.z?e.z-r.z:r.id-e.id}function hg(){const r=[];let e=0;const t=[],o=[],a=[];function l(){e=0,t.length=0,o.length=0,a.length=0}function c(v,x,S,M,w,y){let _=r[e];return _===void 0?(_={id:v.id,object:v,geometry:x,material:S,groupOrder:M,renderOrder:v.renderOrder,z:w,group:y},r[e]=_):(_.id=v.id,_.object=v,_.geometry=x,_.material=S,_.groupOrder=M,_.renderOrder=v.renderOrder,_.z=w,_.group=y),e++,_}function f(v,x,S,M,w,y){const _=c(v,x,S,M,w,y);S.transmission>0?o.push(_):S.transparent===!0?a.push(_):t.push(_)}function h(v,x,S,M,w,y){const _=c(v,x,S,M,w,y);S.transmission>0?o.unshift(_):S.transparent===!0?a.unshift(_):t.unshift(_)}function p(v,x){t.length>1&&t.sort(v||Ow),o.length>1&&o.sort(x||dg),a.length>1&&a.sort(x||dg)}function g(){for(let v=e,x=r.length;v<x;v++){const S=r[v];if(S.id===null)break;S.id=null,S.object=null,S.geometry=null,S.material=null,S.group=null}}return{opaque:t,transmissive:o,transparent:a,init:l,push:f,unshift:h,finish:g,sort:p}}function kw(){let r=new WeakMap;function e(o,a){const l=r.get(o);let c;return l===void 0?(c=new hg,r.set(o,[c])):a>=l.length?(c=new hg,l.push(c)):c=l[a],c}function t(){r=new WeakMap}return{get:e,dispose:t}}function Bw(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new ie,color:new bt};break;case"SpotLight":t={position:new ie,direction:new ie,color:new bt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new ie,color:new bt,distance:0,decay:0};break;case"HemisphereLight":t={direction:new ie,skyColor:new bt,groundColor:new bt};break;case"RectAreaLight":t={color:new bt,position:new ie,halfWidth:new ie,halfHeight:new ie};break}return r[e.id]=t,t}}}function zw(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Rt};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Rt};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Rt,shadowCameraNear:1,shadowCameraFar:1e3};break}return r[e.id]=t,t}}}let Hw=0;function Vw(r,e){return(e.castShadow?2:0)-(r.castShadow?2:0)+(e.map?1:0)-(r.map?1:0)}function Gw(r){const e=new Bw,t=zw(),o={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let p=0;p<9;p++)o.probe.push(new ie);const a=new ie,l=new jt,c=new jt;function f(p){let g=0,v=0,x=0;for(let b=0;b<9;b++)o.probe[b].set(0,0,0);let S=0,M=0,w=0,y=0,_=0,L=0,P=0,C=0,G=0,O=0,I=0;p.sort(Vw);for(let b=0,R=p.length;b<R;b++){const B=p[b],ee=B.color,q=B.intensity,se=B.distance,ce=B.shadow&&B.shadow.map?B.shadow.map.texture:null;if(B.isAmbientLight)g+=ee.r*q,v+=ee.g*q,x+=ee.b*q;else if(B.isLightProbe){for(let re=0;re<9;re++)o.probe[re].addScaledVector(B.sh.coefficients[re],q);I++}else if(B.isDirectionalLight){const re=e.get(B);if(re.color.copy(B.color).multiplyScalar(B.intensity),B.castShadow){const he=B.shadow,z=t.get(B);z.shadowIntensity=he.intensity,z.shadowBias=he.bias,z.shadowNormalBias=he.normalBias,z.shadowRadius=he.radius,z.shadowMapSize=he.mapSize,o.directionalShadow[S]=z,o.directionalShadowMap[S]=ce,o.directionalShadowMatrix[S]=B.shadow.matrix,L++}o.directional[S]=re,S++}else if(B.isSpotLight){const re=e.get(B);re.position.setFromMatrixPosition(B.matrixWorld),re.color.copy(ee).multiplyScalar(q),re.distance=se,re.coneCos=Math.cos(B.angle),re.penumbraCos=Math.cos(B.angle*(1-B.penumbra)),re.decay=B.decay,o.spot[w]=re;const he=B.shadow;if(B.map&&(o.spotLightMap[G]=B.map,G++,he.updateMatrices(B),B.castShadow&&O++),o.spotLightMatrix[w]=he.matrix,B.castShadow){const z=t.get(B);z.shadowIntensity=he.intensity,z.shadowBias=he.bias,z.shadowNormalBias=he.normalBias,z.shadowRadius=he.radius,z.shadowMapSize=he.mapSize,o.spotShadow[w]=z,o.spotShadowMap[w]=ce,C++}w++}else if(B.isRectAreaLight){const re=e.get(B);re.color.copy(ee).multiplyScalar(q),re.halfWidth.set(B.width*.5,0,0),re.halfHeight.set(0,B.height*.5,0),o.rectArea[y]=re,y++}else if(B.isPointLight){const re=e.get(B);if(re.color.copy(B.color).multiplyScalar(B.intensity),re.distance=B.distance,re.decay=B.decay,B.castShadow){const he=B.shadow,z=t.get(B);z.shadowIntensity=he.intensity,z.shadowBias=he.bias,z.shadowNormalBias=he.normalBias,z.shadowRadius=he.radius,z.shadowMapSize=he.mapSize,z.shadowCameraNear=he.camera.near,z.shadowCameraFar=he.camera.far,o.pointShadow[M]=z,o.pointShadowMap[M]=ce,o.pointShadowMatrix[M]=B.shadow.matrix,P++}o.point[M]=re,M++}else if(B.isHemisphereLight){const re=e.get(B);re.skyColor.copy(B.color).multiplyScalar(q),re.groundColor.copy(B.groundColor).multiplyScalar(q),o.hemi[_]=re,_++}}y>0&&(r.has("OES_texture_float_linear")===!0?(o.rectAreaLTC1=Ne.LTC_FLOAT_1,o.rectAreaLTC2=Ne.LTC_FLOAT_2):(o.rectAreaLTC1=Ne.LTC_HALF_1,o.rectAreaLTC2=Ne.LTC_HALF_2)),o.ambient[0]=g,o.ambient[1]=v,o.ambient[2]=x;const W=o.hash;(W.directionalLength!==S||W.pointLength!==M||W.spotLength!==w||W.rectAreaLength!==y||W.hemiLength!==_||W.numDirectionalShadows!==L||W.numPointShadows!==P||W.numSpotShadows!==C||W.numSpotMaps!==G||W.numLightProbes!==I)&&(o.directional.length=S,o.spot.length=w,o.rectArea.length=y,o.point.length=M,o.hemi.length=_,o.directionalShadow.length=L,o.directionalShadowMap.length=L,o.pointShadow.length=P,o.pointShadowMap.length=P,o.spotShadow.length=C,o.spotShadowMap.length=C,o.directionalShadowMatrix.length=L,o.pointShadowMatrix.length=P,o.spotLightMatrix.length=C+G-O,o.spotLightMap.length=G,o.numSpotLightShadowsWithMaps=O,o.numLightProbes=I,W.directionalLength=S,W.pointLength=M,W.spotLength=w,W.rectAreaLength=y,W.hemiLength=_,W.numDirectionalShadows=L,W.numPointShadows=P,W.numSpotShadows=C,W.numSpotMaps=G,W.numLightProbes=I,o.version=Hw++)}function h(p,g){let v=0,x=0,S=0,M=0,w=0;const y=g.matrixWorldInverse;for(let _=0,L=p.length;_<L;_++){const P=p[_];if(P.isDirectionalLight){const C=o.directional[v];C.direction.setFromMatrixPosition(P.matrixWorld),a.setFromMatrixPosition(P.target.matrixWorld),C.direction.sub(a),C.direction.transformDirection(y),v++}else if(P.isSpotLight){const C=o.spot[S];C.position.setFromMatrixPosition(P.matrixWorld),C.position.applyMatrix4(y),C.direction.setFromMatrixPosition(P.matrixWorld),a.setFromMatrixPosition(P.target.matrixWorld),C.direction.sub(a),C.direction.transformDirection(y),S++}else if(P.isRectAreaLight){const C=o.rectArea[M];C.position.setFromMatrixPosition(P.matrixWorld),C.position.applyMatrix4(y),c.identity(),l.copy(P.matrixWorld),l.premultiply(y),c.extractRotation(l),C.halfWidth.set(P.width*.5,0,0),C.halfHeight.set(0,P.height*.5,0),C.halfWidth.applyMatrix4(c),C.halfHeight.applyMatrix4(c),M++}else if(P.isPointLight){const C=o.point[x];C.position.setFromMatrixPosition(P.matrixWorld),C.position.applyMatrix4(y),x++}else if(P.isHemisphereLight){const C=o.hemi[w];C.direction.setFromMatrixPosition(P.matrixWorld),C.direction.transformDirection(y),w++}}}return{setup:f,setupView:h,state:o}}function pg(r){const e=new Gw(r),t=[],o=[];function a(g){p.camera=g,t.length=0,o.length=0}function l(g){t.push(g)}function c(g){o.push(g)}function f(){e.setup(t)}function h(g){e.setupView(t,g)}const p={lightsArray:t,shadowsArray:o,camera:null,lights:e,transmissionRenderTarget:{}};return{init:a,state:p,setupLights:f,setupLightsView:h,pushLight:l,pushShadow:c}}function Ww(r){let e=new WeakMap;function t(a,l=0){const c=e.get(a);let f;return c===void 0?(f=new pg(r),e.set(a,[f])):l>=c.length?(f=new pg(r),c.push(f)):f=c[l],f}function o(){e=new WeakMap}return{get:t,dispose:o}}const Xw=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function Yw(r,e,t){let o=new bd;const a=new Rt,l=new Rt,c=new Wt,f=new dS({depthPacking:sy}),h=new hS,p={},g=t.maxTextureSize,v={[Mr]:Fn,[Fn]:Mr,[Oi]:Oi},x=new Tr({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Rt},radius:{value:4}},vertexShader:Xw,fragmentShader:jw}),S=x.clone();S.defines.HORIZONTAL_PASS=1;const M=new to;M.setAttribute("position",new _i(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const w=new vi(M,x),y=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Xg;let _=this.type;this.render=function(O,I,W){if(y.enabled===!1||y.autoUpdate===!1&&y.needsUpdate===!1||O.length===0)return;const b=r.getRenderTarget(),R=r.getActiveCubeFace(),B=r.getActiveMipmapLevel(),ee=r.state;ee.setBlending(Er),ee.buffers.color.setClear(1,1,1,1),ee.buffers.depth.setTest(!0),ee.setScissorTest(!1);const q=_!==Fi&&this.type===Fi,se=_===Fi&&this.type!==Fi;for(let ce=0,re=O.length;ce<re;ce++){const he=O[ce],z=he.shadow;if(z===void 0){console.warn("THREE.WebGLShadowMap:",he,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;a.copy(z.mapSize);const le=z.getFrameExtents();if(a.multiply(le),l.copy(z.mapSize),(a.x>g||a.y>g)&&(a.x>g&&(l.x=Math.floor(g/le.x),a.x=l.x*le.x,z.mapSize.x=l.x),a.y>g&&(l.y=Math.floor(g/le.y),a.y=l.y*le.y,z.mapSize.y=l.y)),z.map===null||q===!0||se===!0){const N=this.type!==Fi?{minFilter:An,magFilter:An}:{};z.map!==null&&z.map.dispose(),z.map=new Jr(a.x,a.y,N),z.map.texture.name=he.name+".shadowMap",z.camera.updateProjectionMatrix()}r.setRenderTarget(z.map),r.clear();const oe=z.getViewportCount();for(let N=0;N<oe;N++){const ne=z.getViewport(N);c.set(l.x*ne.x,l.y*ne.y,l.x*ne.z,l.y*ne.w),ee.viewport(c),z.updateMatrices(he,N),o=z.getFrustum(),C(I,W,z.camera,he,this.type)}z.isPointLightShadow!==!0&&this.type===Fi&&L(z,W),z.needsUpdate=!1}_=this.type,y.needsUpdate=!1,r.setRenderTarget(b,R,B)};function L(O,I){const W=e.update(w);x.defines.VSM_SAMPLES!==O.blurSamples&&(x.defines.VSM_SAMPLES=O.blurSamples,S.defines.VSM_SAMPLES=O.blurSamples,x.needsUpdate=!0,S.needsUpdate=!0),O.mapPass===null&&(O.mapPass=new Jr(a.x,a.y)),x.uniforms.shadow_pass.value=O.map.texture,x.uniforms.resolution.value=O.mapSize,x.uniforms.radius.value=O.radius,r.setRenderTarget(O.mapPass),r.clear(),r.renderBufferDirect(I,null,W,x,w,null),S.uniforms.shadow_pass.value=O.mapPass.texture,S.uniforms.resolution.value=O.mapSize,S.uniforms.radius.value=O.radius,r.setRenderTarget(O.map),r.clear(),r.renderBufferDirect(I,null,W,S,w,null)}function P(O,I,W,b){let R=null;const B=W.isPointLight===!0?O.customDistanceMaterial:O.customDepthMaterial;if(B!==void 0)R=B;else if(R=W.isPointLight===!0?h:f,r.localClippingEnabled&&I.clipShadows===!0&&Array.isArray(I.clippingPlanes)&&I.clippingPlanes.length!==0||I.displacementMap&&I.displacementScale!==0||I.alphaMap&&I.alphaTest>0||I.map&&I.alphaTest>0||I.alphaToCoverage===!0){const ee=R.uuid,q=I.uuid;let se=p[ee];se===void 0&&(se={},p[ee]=se);let ce=se[q];ce===void 0&&(ce=R.clone(),se[q]=ce,I.addEventListener("dispose",G)),R=ce}if(R.visible=I.visible,R.wireframe=I.wireframe,b===Fi?R.side=I.shadowSide!==null?I.shadowSide:I.side:R.side=I.shadowSide!==null?I.shadowSide:v[I.side],R.alphaMap=I.alphaMap,R.alphaTest=I.alphaToCoverage===!0?.5:I.alphaTest,R.map=I.map,R.clipShadows=I.clipShadows,R.clippingPlanes=I.clippingPlanes,R.clipIntersection=I.clipIntersection,R.displacementMap=I.displacementMap,R.displacementScale=I.displacementScale,R.displacementBias=I.displacementBias,R.wireframeLinewidth=I.wireframeLinewidth,R.linewidth=I.linewidth,W.isPointLight===!0&&R.isMeshDistanceMaterial===!0){const ee=r.properties.get(R);ee.light=W}return R}function C(O,I,W,b,R){if(O.visible===!1)return;if(O.layers.test(I.layers)&&(O.isMesh||O.isLine||O.isPoints)&&(O.castShadow||O.receiveShadow&&R===Fi)&&(!O.frustumCulled||o.intersectsObject(O))){O.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,O.matrixWorld);const q=e.update(O),se=O.material;if(Array.isArray(se)){const ce=q.groups;for(let re=0,he=ce.length;re<he;re++){const z=ce[re],le=se[z.materialIndex];if(le&&le.visible){const oe=P(O,le,b,R);O.onBeforeShadow(r,O,I,W,q,oe,z),r.renderBufferDirect(W,null,q,oe,O,z),O.onAfterShadow(r,O,I,W,q,oe,z)}}}else if(se.visible){const ce=P(O,se,b,R);O.onBeforeShadow(r,O,I,W,q,ce,null),r.renderBufferDirect(W,null,q,ce,O,null),O.onAfterShadow(r,O,I,W,q,ce,null)}}const ee=O.children;for(let q=0,se=ee.length;q<se;q++)C(ee[q],I,W,b,R)}function G(O){O.target.removeEventListener("dispose",G);for(const W in p){const b=p[W],R=O.target.uuid;R in b&&(b[R].dispose(),delete b[R])}}}const $w={[Pf]:Lf,[Df]:If,[Uf]:Ff,[Zo]:Nf,[Lf]:Pf,[If]:Df,[Ff]:Uf,[Nf]:Zo};function qw(r,e){function t(){let H=!1;const Le=new Wt;let ve=null;const Ie=new Wt(0,0,0,0);return{setMask:function(Ee){ve!==Ee&&!H&&(r.colorMask(Ee,Ee,Ee,Ee),ve=Ee)},setLocked:function(Ee){H=Ee},setClear:function(Ee,pe,Ge,lt,Pt){Pt===!0&&(Ee*=lt,pe*=lt,Ge*=lt),Le.set(Ee,pe,Ge,lt),Ie.equals(Le)===!1&&(r.clearColor(Ee,pe,Ge,lt),Ie.copy(Le))},reset:function(){H=!1,ve=null,Ie.set(-1,0,0,0)}}}function o(){let H=!1,Le=!1,ve=null,Ie=null,Ee=null;return{setReversed:function(pe){if(Le!==pe){const Ge=e.get("EXT_clip_control");pe?Ge.clipControlEXT(Ge.LOWER_LEFT_EXT,Ge.ZERO_TO_ONE_EXT):Ge.clipControlEXT(Ge.LOWER_LEFT_EXT,Ge.NEGATIVE_ONE_TO_ONE_EXT),Le=pe;const lt=Ee;Ee=null,this.setClear(lt)}},getReversed:function(){return Le},setTest:function(pe){pe?ye(r.DEPTH_TEST):Ae(r.DEPTH_TEST)},setMask:function(pe){ve!==pe&&!H&&(r.depthMask(pe),ve=pe)},setFunc:function(pe){if(Le&&(pe=$w[pe]),Ie!==pe){switch(pe){case Pf:r.depthFunc(r.NEVER);break;case Lf:r.depthFunc(r.ALWAYS);break;case Df:r.depthFunc(r.LESS);break;case Zo:r.depthFunc(r.LEQUAL);break;case Uf:r.depthFunc(r.EQUAL);break;case Nf:r.depthFunc(r.GEQUAL);break;case If:r.depthFunc(r.GREATER);break;case Ff:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}Ie=pe}},setLocked:function(pe){H=pe},setClear:function(pe){Ee!==pe&&(Le&&(pe=1-pe),r.clearDepth(pe),Ee=pe)},reset:function(){H=!1,ve=null,Ie=null,Ee=null,Le=!1}}}function a(){let H=!1,Le=null,ve=null,Ie=null,Ee=null,pe=null,Ge=null,lt=null,Pt=null;return{setTest:function(yt){H||(yt?ye(r.STENCIL_TEST):Ae(r.STENCIL_TEST))},setMask:function(yt){Le!==yt&&!H&&(r.stencilMask(yt),Le=yt)},setFunc:function(yt,Cn,yn){(ve!==yt||Ie!==Cn||Ee!==yn)&&(r.stencilFunc(yt,Cn,yn),ve=yt,Ie=Cn,Ee=yn)},setOp:function(yt,Cn,yn){(pe!==yt||Ge!==Cn||lt!==yn)&&(r.stencilOp(yt,Cn,yn),pe=yt,Ge=Cn,lt=yn)},setLocked:function(yt){H=yt},setClear:function(yt){Pt!==yt&&(r.clearStencil(yt),Pt=yt)},reset:function(){H=!1,Le=null,ve=null,Ie=null,Ee=null,pe=null,Ge=null,lt=null,Pt=null}}}const l=new t,c=new o,f=new a,h=new WeakMap,p=new WeakMap;let g={},v={},x=new WeakMap,S=[],M=null,w=!1,y=null,_=null,L=null,P=null,C=null,G=null,O=null,I=new bt(0,0,0),W=0,b=!1,R=null,B=null,ee=null,q=null,se=null;const ce=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let re=!1,he=0;const z=r.getParameter(r.VERSION);z.indexOf("WebGL")!==-1?(he=parseFloat(/^WebGL (\d)/.exec(z)[1]),re=he>=1):z.indexOf("OpenGL ES")!==-1&&(he=parseFloat(/^OpenGL ES (\d)/.exec(z)[1]),re=he>=2);let le=null,oe={};const N=r.getParameter(r.SCISSOR_BOX),ne=r.getParameter(r.VIEWPORT),Oe=new Wt().fromArray(N),Q=new Wt().fromArray(ne);function de(H,Le,ve,Ie){const Ee=new Uint8Array(4),pe=r.createTexture();r.bindTexture(H,pe),r.texParameteri(H,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(H,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let Ge=0;Ge<ve;Ge++)H===r.TEXTURE_3D||H===r.TEXTURE_2D_ARRAY?r.texImage3D(Le,0,r.RGBA,1,1,Ie,0,r.RGBA,r.UNSIGNED_BYTE,Ee):r.texImage2D(Le+Ge,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,Ee);return pe}const Te={};Te[r.TEXTURE_2D]=de(r.TEXTURE_2D,r.TEXTURE_2D,1),Te[r.TEXTURE_CUBE_MAP]=de(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),Te[r.TEXTURE_2D_ARRAY]=de(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),Te[r.TEXTURE_3D]=de(r.TEXTURE_3D,r.TEXTURE_3D,1,1),l.setClear(0,0,0,1),c.setClear(1),f.setClear(0),ye(r.DEPTH_TEST),c.setFunc(Zo),_t(!1),Mt(vm),ye(r.CULL_FACE),F(Er);function ye(H){g[H]!==!0&&(r.enable(H),g[H]=!0)}function Ae(H){g[H]!==!1&&(r.disable(H),g[H]=!1)}function Re(H,Le){return v[H]!==Le?(r.bindFramebuffer(H,Le),v[H]=Le,H===r.DRAW_FRAMEBUFFER&&(v[r.FRAMEBUFFER]=Le),H===r.FRAMEBUFFER&&(v[r.DRAW_FRAMEBUFFER]=Le),!0):!1}function De(H,Le){let ve=S,Ie=!1;if(H){ve=x.get(Le),ve===void 0&&(ve=[],x.set(Le,ve));const Ee=H.textures;if(ve.length!==Ee.length||ve[0]!==r.COLOR_ATTACHMENT0){for(let pe=0,Ge=Ee.length;pe<Ge;pe++)ve[pe]=r.COLOR_ATTACHMENT0+pe;ve.length=Ee.length,Ie=!0}}else ve[0]!==r.BACK&&(ve[0]=r.BACK,Ie=!0);Ie&&r.drawBuffers(ve)}function At(H){return M!==H?(r.useProgram(H),M=H,!0):!1}const vt={[$r]:r.FUNC_ADD,[Dx]:r.FUNC_SUBTRACT,[Ux]:r.FUNC_REVERSE_SUBTRACT};vt[Nx]=r.MIN,vt[Ix]=r.MAX;const ut={[Fx]:r.ZERO,[Ox]:r.ONE,[kx]:r.SRC_COLOR,[Cf]:r.SRC_ALPHA,[Wx]:r.SRC_ALPHA_SATURATE,[Vx]:r.DST_COLOR,[zx]:r.DST_ALPHA,[Bx]:r.ONE_MINUS_SRC_COLOR,[bf]:r.ONE_MINUS_SRC_ALPHA,[Gx]:r.ONE_MINUS_DST_COLOR,[Hx]:r.ONE_MINUS_DST_ALPHA,[Xx]:r.CONSTANT_COLOR,[jx]:r.ONE_MINUS_CONSTANT_COLOR,[Yx]:r.CONSTANT_ALPHA,[$x]:r.ONE_MINUS_CONSTANT_ALPHA};function F(H,Le,ve,Ie,Ee,pe,Ge,lt,Pt,yt){if(H===Er){w===!0&&(Ae(r.BLEND),w=!1);return}if(w===!1&&(ye(r.BLEND),w=!0),H!==Lx){if(H!==y||yt!==b){if((_!==$r||C!==$r)&&(r.blendEquation(r.FUNC_ADD),_=$r,C=$r),yt)switch(H){case Xo:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case _m:r.blendFunc(r.ONE,r.ONE);break;case xm:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case ym:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",H);break}else switch(H){case Xo:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case _m:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case xm:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case ym:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",H);break}L=null,P=null,G=null,O=null,I.set(0,0,0),W=0,y=H,b=yt}return}Ee=Ee||Le,pe=pe||ve,Ge=Ge||Ie,(Le!==_||Ee!==C)&&(r.blendEquationSeparate(vt[Le],vt[Ee]),_=Le,C=Ee),(ve!==L||Ie!==P||pe!==G||Ge!==O)&&(r.blendFuncSeparate(ut[ve],ut[Ie],ut[pe],ut[Ge]),L=ve,P=Ie,G=pe,O=Ge),(lt.equals(I)===!1||Pt!==W)&&(r.blendColor(lt.r,lt.g,lt.b,Pt),I.copy(lt),W=Pt),y=H,b=!1}function Yt(H,Le){H.side===Oi?Ae(r.CULL_FACE):ye(r.CULL_FACE);let ve=H.side===Fn;Le&&(ve=!ve),_t(ve),H.blending===Xo&&H.transparent===!1?F(Er):F(H.blending,H.blendEquation,H.blendSrc,H.blendDst,H.blendEquationAlpha,H.blendSrcAlpha,H.blendDstAlpha,H.blendColor,H.blendAlpha,H.premultipliedAlpha),c.setFunc(H.depthFunc),c.setTest(H.depthTest),c.setMask(H.depthWrite),l.setMask(H.colorWrite);const Ie=H.stencilWrite;f.setTest(Ie),Ie&&(f.setMask(H.stencilWriteMask),f.setFunc(H.stencilFunc,H.stencilRef,H.stencilFuncMask),f.setOp(H.stencilFail,H.stencilZFail,H.stencilZPass)),ht(H.polygonOffset,H.polygonOffsetFactor,H.polygonOffsetUnits),H.alphaToCoverage===!0?ye(r.SAMPLE_ALPHA_TO_COVERAGE):Ae(r.SAMPLE_ALPHA_TO_COVERAGE)}function _t(H){R!==H&&(H?r.frontFace(r.CW):r.frontFace(r.CCW),R=H)}function Mt(H){H!==Cx?(ye(r.CULL_FACE),H!==B&&(H===vm?r.cullFace(r.BACK):H===bx?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):Ae(r.CULL_FACE),B=H}function je(H){H!==ee&&(re&&r.lineWidth(H),ee=H)}function ht(H,Le,ve){H?(ye(r.POLYGON_OFFSET_FILL),(q!==Le||se!==ve)&&(r.polygonOffset(Le,ve),q=Le,se=ve)):Ae(r.POLYGON_OFFSET_FILL)}function qe(H){H?ye(r.SCISSOR_TEST):Ae(r.SCISSOR_TEST)}function nt(H){H===void 0&&(H=r.TEXTURE0+ce-1),le!==H&&(r.activeTexture(H),le=H)}function It(H,Le,ve){ve===void 0&&(le===null?ve=r.TEXTURE0+ce-1:ve=le);let Ie=oe[ve];Ie===void 0&&(Ie={type:void 0,texture:void 0},oe[ve]=Ie),(Ie.type!==H||Ie.texture!==Le)&&(le!==ve&&(r.activeTexture(ve),le=ve),r.bindTexture(H,Le||Te[H]),Ie.type=H,Ie.texture=Le)}function D(){const H=oe[le];H!==void 0&&H.type!==void 0&&(r.bindTexture(H.type,null),H.type=void 0,H.texture=void 0)}function T(){try{r.compressedTexImage2D(...arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function K(){try{r.compressedTexImage3D(...arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function fe(){try{r.texSubImage2D(...arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function me(){try{r.texSubImage3D(...arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function ae(){try{r.compressedTexSubImage2D(...arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Ye(){try{r.compressedTexSubImage3D(...arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Ce(){try{r.texStorage2D(...arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function ke(){try{r.texStorage3D(...arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Ze(){try{r.texImage2D(...arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function _e(){try{r.texImage3D(...arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Be(H){Oe.equals(H)===!1&&(r.scissor(H.x,H.y,H.z,H.w),Oe.copy(H))}function it(H){Q.equals(H)===!1&&(r.viewport(H.x,H.y,H.z,H.w),Q.copy(H))}function Je(H,Le){let ve=p.get(Le);ve===void 0&&(ve=new WeakMap,p.set(Le,ve));let Ie=ve.get(H);Ie===void 0&&(Ie=r.getUniformBlockIndex(Le,H.name),ve.set(H,Ie))}function be(H,Le){const Ie=p.get(Le).get(H);h.get(Le)!==Ie&&(r.uniformBlockBinding(Le,Ie,H.__bindingPointIndex),h.set(Le,Ie))}function st(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),c.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),g={},le=null,oe={},v={},x=new WeakMap,S=[],M=null,w=!1,y=null,_=null,L=null,P=null,C=null,G=null,O=null,I=new bt(0,0,0),W=0,b=!1,R=null,B=null,ee=null,q=null,se=null,Oe.set(0,0,r.canvas.width,r.canvas.height),Q.set(0,0,r.canvas.width,r.canvas.height),l.reset(),c.reset(),f.reset()}return{buffers:{color:l,depth:c,stencil:f},enable:ye,disable:Ae,bindFramebuffer:Re,drawBuffers:De,useProgram:At,setBlending:F,setMaterial:Yt,setFlipSided:_t,setCullFace:Mt,setLineWidth:je,setPolygonOffset:ht,setScissorTest:qe,activeTexture:nt,bindTexture:It,unbindTexture:D,compressedTexImage2D:T,compressedTexImage3D:K,texImage2D:Ze,texImage3D:_e,updateUBOMapping:Je,uniformBlockBinding:be,texStorage2D:Ce,texStorage3D:ke,texSubImage2D:fe,texSubImage3D:me,compressedTexSubImage2D:ae,compressedTexSubImage3D:Ye,scissor:Be,viewport:it,reset:st}}function Kw(r,e,t,o,a,l,c){const f=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,h=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new Rt,g=new WeakMap;let v;const x=new WeakMap;let S=!1;try{S=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(D,T){return S?new OffscreenCanvas(D,T):ra("canvas")}function w(D,T,K){let fe=1;const me=It(D);if((me.width>K||me.height>K)&&(fe=K/Math.max(me.width,me.height)),fe<1)if(typeof HTMLImageElement<"u"&&D instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&D instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&D instanceof ImageBitmap||typeof VideoFrame<"u"&&D instanceof VideoFrame){const ae=Math.floor(fe*me.width),Ye=Math.floor(fe*me.height);v===void 0&&(v=M(ae,Ye));const Ce=T?M(ae,Ye):v;return Ce.width=ae,Ce.height=Ye,Ce.getContext("2d").drawImage(D,0,0,ae,Ye),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+me.width+"x"+me.height+") to ("+ae+"x"+Ye+")."),Ce}else return"data"in D&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+me.width+"x"+me.height+")."),D;return D}function y(D){return D.generateMipmaps}function _(D){r.generateMipmap(D)}function L(D){return D.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:D.isWebGL3DRenderTarget?r.TEXTURE_3D:D.isWebGLArrayRenderTarget||D.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function P(D,T,K,fe,me=!1){if(D!==null){if(r[D]!==void 0)return r[D];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+D+"'")}let ae=T;if(T===r.RED&&(K===r.FLOAT&&(ae=r.R32F),K===r.HALF_FLOAT&&(ae=r.R16F),K===r.UNSIGNED_BYTE&&(ae=r.R8)),T===r.RED_INTEGER&&(K===r.UNSIGNED_BYTE&&(ae=r.R8UI),K===r.UNSIGNED_SHORT&&(ae=r.R16UI),K===r.UNSIGNED_INT&&(ae=r.R32UI),K===r.BYTE&&(ae=r.R8I),K===r.SHORT&&(ae=r.R16I),K===r.INT&&(ae=r.R32I)),T===r.RG&&(K===r.FLOAT&&(ae=r.RG32F),K===r.HALF_FLOAT&&(ae=r.RG16F),K===r.UNSIGNED_BYTE&&(ae=r.RG8)),T===r.RG_INTEGER&&(K===r.UNSIGNED_BYTE&&(ae=r.RG8UI),K===r.UNSIGNED_SHORT&&(ae=r.RG16UI),K===r.UNSIGNED_INT&&(ae=r.RG32UI),K===r.BYTE&&(ae=r.RG8I),K===r.SHORT&&(ae=r.RG16I),K===r.INT&&(ae=r.RG32I)),T===r.RGB_INTEGER&&(K===r.UNSIGNED_BYTE&&(ae=r.RGB8UI),K===r.UNSIGNED_SHORT&&(ae=r.RGB16UI),K===r.UNSIGNED_INT&&(ae=r.RGB32UI),K===r.BYTE&&(ae=r.RGB8I),K===r.SHORT&&(ae=r.RGB16I),K===r.INT&&(ae=r.RGB32I)),T===r.RGBA_INTEGER&&(K===r.UNSIGNED_BYTE&&(ae=r.RGBA8UI),K===r.UNSIGNED_SHORT&&(ae=r.RGBA16UI),K===r.UNSIGNED_INT&&(ae=r.RGBA32UI),K===r.BYTE&&(ae=r.RGBA8I),K===r.SHORT&&(ae=r.RGBA16I),K===r.INT&&(ae=r.RGBA32I)),T===r.RGB&&K===r.UNSIGNED_INT_5_9_9_9_REV&&(ae=r.RGB9_E5),T===r.RGBA){const Ye=me?ql:wt.getTransfer(fe);K===r.FLOAT&&(ae=r.RGBA32F),K===r.HALF_FLOAT&&(ae=r.RGBA16F),K===r.UNSIGNED_BYTE&&(ae=Ye===Dt?r.SRGB8_ALPHA8:r.RGBA8),K===r.UNSIGNED_SHORT_4_4_4_4&&(ae=r.RGBA4),K===r.UNSIGNED_SHORT_5_5_5_1&&(ae=r.RGB5_A1)}return(ae===r.R16F||ae===r.R32F||ae===r.RG16F||ae===r.RG32F||ae===r.RGBA16F||ae===r.RGBA32F)&&e.get("EXT_color_buffer_float"),ae}function C(D,T){let K;return D?T===null||T===Qr||T===ea?K=r.DEPTH24_STENCIL8:T===Bi?K=r.DEPTH32F_STENCIL8:T===Js&&(K=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):T===null||T===Qr||T===ea?K=r.DEPTH_COMPONENT24:T===Bi?K=r.DEPTH_COMPONENT32F:T===Js&&(K=r.DEPTH_COMPONENT16),K}function G(D,T){return y(D)===!0||D.isFramebufferTexture&&D.minFilter!==An&&D.minFilter!==gi?Math.log2(Math.max(T.width,T.height))+1:D.mipmaps!==void 0&&D.mipmaps.length>0?D.mipmaps.length:D.isCompressedTexture&&Array.isArray(D.image)?T.mipmaps.length:1}function O(D){const T=D.target;T.removeEventListener("dispose",O),W(T),T.isVideoTexture&&g.delete(T)}function I(D){const T=D.target;T.removeEventListener("dispose",I),R(T)}function W(D){const T=o.get(D);if(T.__webglInit===void 0)return;const K=D.source,fe=x.get(K);if(fe){const me=fe[T.__cacheKey];me.usedTimes--,me.usedTimes===0&&b(D),Object.keys(fe).length===0&&x.delete(K)}o.remove(D)}function b(D){const T=o.get(D);r.deleteTexture(T.__webglTexture);const K=D.source,fe=x.get(K);delete fe[T.__cacheKey],c.memory.textures--}function R(D){const T=o.get(D);if(D.depthTexture&&(D.depthTexture.dispose(),o.remove(D.depthTexture)),D.isWebGLCubeRenderTarget)for(let fe=0;fe<6;fe++){if(Array.isArray(T.__webglFramebuffer[fe]))for(let me=0;me<T.__webglFramebuffer[fe].length;me++)r.deleteFramebuffer(T.__webglFramebuffer[fe][me]);else r.deleteFramebuffer(T.__webglFramebuffer[fe]);T.__webglDepthbuffer&&r.deleteRenderbuffer(T.__webglDepthbuffer[fe])}else{if(Array.isArray(T.__webglFramebuffer))for(let fe=0;fe<T.__webglFramebuffer.length;fe++)r.deleteFramebuffer(T.__webglFramebuffer[fe]);else r.deleteFramebuffer(T.__webglFramebuffer);if(T.__webglDepthbuffer&&r.deleteRenderbuffer(T.__webglDepthbuffer),T.__webglMultisampledFramebuffer&&r.deleteFramebuffer(T.__webglMultisampledFramebuffer),T.__webglColorRenderbuffer)for(let fe=0;fe<T.__webglColorRenderbuffer.length;fe++)T.__webglColorRenderbuffer[fe]&&r.deleteRenderbuffer(T.__webglColorRenderbuffer[fe]);T.__webglDepthRenderbuffer&&r.deleteRenderbuffer(T.__webglDepthRenderbuffer)}const K=D.textures;for(let fe=0,me=K.length;fe<me;fe++){const ae=o.get(K[fe]);ae.__webglTexture&&(r.deleteTexture(ae.__webglTexture),c.memory.textures--),o.remove(K[fe])}o.remove(D)}let B=0;function ee(){B=0}function q(){const D=B;return D>=a.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+D+" texture units while this GPU supports only "+a.maxTextures),B+=1,D}function se(D){const T=[];return T.push(D.wrapS),T.push(D.wrapT),T.push(D.wrapR||0),T.push(D.magFilter),T.push(D.minFilter),T.push(D.anisotropy),T.push(D.internalFormat),T.push(D.format),T.push(D.type),T.push(D.generateMipmaps),T.push(D.premultiplyAlpha),T.push(D.flipY),T.push(D.unpackAlignment),T.push(D.colorSpace),T.join()}function ce(D,T){const K=o.get(D);if(D.isVideoTexture&&qe(D),D.isRenderTargetTexture===!1&&D.version>0&&K.__version!==D.version){const fe=D.image;if(fe===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(fe.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Te(K,D,T);return}}t.bindTexture(r.TEXTURE_2D,K.__webglTexture,r.TEXTURE0+T)}function re(D,T){const K=o.get(D);if(D.version>0&&K.__version!==D.version){Te(K,D,T);return}t.bindTexture(r.TEXTURE_2D_ARRAY,K.__webglTexture,r.TEXTURE0+T)}function he(D,T){const K=o.get(D);if(D.version>0&&K.__version!==D.version){Te(K,D,T);return}t.bindTexture(r.TEXTURE_3D,K.__webglTexture,r.TEXTURE0+T)}function z(D,T){const K=o.get(D);if(D.version>0&&K.__version!==D.version){ye(K,D,T);return}t.bindTexture(r.TEXTURE_CUBE_MAP,K.__webglTexture,r.TEXTURE0+T)}const le={[Qs]:r.REPEAT,[ki]:r.CLAMP_TO_EDGE,[Bf]:r.MIRRORED_REPEAT},oe={[An]:r.NEAREST,[ry]:r.NEAREST_MIPMAP_NEAREST,[_l]:r.NEAREST_MIPMAP_LINEAR,[gi]:r.LINEAR,[Gc]:r.LINEAR_MIPMAP_NEAREST,[Kr]:r.LINEAR_MIPMAP_LINEAR},N={[uy]:r.NEVER,[my]:r.ALWAYS,[cy]:r.LESS,[nv]:r.LEQUAL,[fy]:r.EQUAL,[py]:r.GEQUAL,[dy]:r.GREATER,[hy]:r.NOTEQUAL};function ne(D,T){if(T.type===Bi&&e.has("OES_texture_float_linear")===!1&&(T.magFilter===gi||T.magFilter===Gc||T.magFilter===_l||T.magFilter===Kr||T.minFilter===gi||T.minFilter===Gc||T.minFilter===_l||T.minFilter===Kr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(D,r.TEXTURE_WRAP_S,le[T.wrapS]),r.texParameteri(D,r.TEXTURE_WRAP_T,le[T.wrapT]),(D===r.TEXTURE_3D||D===r.TEXTURE_2D_ARRAY)&&r.texParameteri(D,r.TEXTURE_WRAP_R,le[T.wrapR]),r.texParameteri(D,r.TEXTURE_MAG_FILTER,oe[T.magFilter]),r.texParameteri(D,r.TEXTURE_MIN_FILTER,oe[T.minFilter]),T.compareFunction&&(r.texParameteri(D,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(D,r.TEXTURE_COMPARE_FUNC,N[T.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(T.magFilter===An||T.minFilter!==_l&&T.minFilter!==Kr||T.type===Bi&&e.has("OES_texture_float_linear")===!1)return;if(T.anisotropy>1||o.get(T).__currentAnisotropy){const K=e.get("EXT_texture_filter_anisotropic");r.texParameterf(D,K.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(T.anisotropy,a.getMaxAnisotropy())),o.get(T).__currentAnisotropy=T.anisotropy}}}function Oe(D,T){let K=!1;D.__webglInit===void 0&&(D.__webglInit=!0,T.addEventListener("dispose",O));const fe=T.source;let me=x.get(fe);me===void 0&&(me={},x.set(fe,me));const ae=se(T);if(ae!==D.__cacheKey){me[ae]===void 0&&(me[ae]={texture:r.createTexture(),usedTimes:0},c.memory.textures++,K=!0),me[ae].usedTimes++;const Ye=me[D.__cacheKey];Ye!==void 0&&(me[D.__cacheKey].usedTimes--,Ye.usedTimes===0&&b(T)),D.__cacheKey=ae,D.__webglTexture=me[ae].texture}return K}function Q(D,T,K){return Math.floor(Math.floor(D/K)/T)}function de(D,T,K,fe){const ae=D.updateRanges;if(ae.length===0)t.texSubImage2D(r.TEXTURE_2D,0,0,0,T.width,T.height,K,fe,T.data);else{ae.sort((_e,Be)=>_e.start-Be.start);let Ye=0;for(let _e=1;_e<ae.length;_e++){const Be=ae[Ye],it=ae[_e],Je=Be.start+Be.count,be=Q(it.start,T.width,4),st=Q(Be.start,T.width,4);it.start<=Je+1&&be===st&&Q(it.start+it.count-1,T.width,4)===be?Be.count=Math.max(Be.count,it.start+it.count-Be.start):(++Ye,ae[Ye]=it)}ae.length=Ye+1;const Ce=r.getParameter(r.UNPACK_ROW_LENGTH),ke=r.getParameter(r.UNPACK_SKIP_PIXELS),Ze=r.getParameter(r.UNPACK_SKIP_ROWS);r.pixelStorei(r.UNPACK_ROW_LENGTH,T.width);for(let _e=0,Be=ae.length;_e<Be;_e++){const it=ae[_e],Je=Math.floor(it.start/4),be=Math.ceil(it.count/4),st=Je%T.width,H=Math.floor(Je/T.width),Le=be,ve=1;r.pixelStorei(r.UNPACK_SKIP_PIXELS,st),r.pixelStorei(r.UNPACK_SKIP_ROWS,H),t.texSubImage2D(r.TEXTURE_2D,0,st,H,Le,ve,K,fe,T.data)}D.clearUpdateRanges(),r.pixelStorei(r.UNPACK_ROW_LENGTH,Ce),r.pixelStorei(r.UNPACK_SKIP_PIXELS,ke),r.pixelStorei(r.UNPACK_SKIP_ROWS,Ze)}}function Te(D,T,K){let fe=r.TEXTURE_2D;(T.isDataArrayTexture||T.isCompressedArrayTexture)&&(fe=r.TEXTURE_2D_ARRAY),T.isData3DTexture&&(fe=r.TEXTURE_3D);const me=Oe(D,T),ae=T.source;t.bindTexture(fe,D.__webglTexture,r.TEXTURE0+K);const Ye=o.get(ae);if(ae.version!==Ye.__version||me===!0){t.activeTexture(r.TEXTURE0+K);const Ce=wt.getPrimaries(wt.workingColorSpace),ke=T.colorSpace===xr?null:wt.getPrimaries(T.colorSpace),Ze=T.colorSpace===xr||Ce===ke?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,T.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,T.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ze);let _e=w(T.image,!1,a.maxTextureSize);_e=nt(T,_e);const Be=l.convert(T.format,T.colorSpace),it=l.convert(T.type);let Je=P(T.internalFormat,Be,it,T.colorSpace,T.isVideoTexture);ne(fe,T);let be;const st=T.mipmaps,H=T.isVideoTexture!==!0,Le=Ye.__version===void 0||me===!0,ve=ae.dataReady,Ie=G(T,_e);if(T.isDepthTexture)Je=C(T.format===na,T.type),Le&&(H?t.texStorage2D(r.TEXTURE_2D,1,Je,_e.width,_e.height):t.texImage2D(r.TEXTURE_2D,0,Je,_e.width,_e.height,0,Be,it,null));else if(T.isDataTexture)if(st.length>0){H&&Le&&t.texStorage2D(r.TEXTURE_2D,Ie,Je,st[0].width,st[0].height);for(let Ee=0,pe=st.length;Ee<pe;Ee++)be=st[Ee],H?ve&&t.texSubImage2D(r.TEXTURE_2D,Ee,0,0,be.width,be.height,Be,it,be.data):t.texImage2D(r.TEXTURE_2D,Ee,Je,be.width,be.height,0,Be,it,be.data);T.generateMipmaps=!1}else H?(Le&&t.texStorage2D(r.TEXTURE_2D,Ie,Je,_e.width,_e.height),ve&&de(T,_e,Be,it)):t.texImage2D(r.TEXTURE_2D,0,Je,_e.width,_e.height,0,Be,it,_e.data);else if(T.isCompressedTexture)if(T.isCompressedArrayTexture){H&&Le&&t.texStorage3D(r.TEXTURE_2D_ARRAY,Ie,Je,st[0].width,st[0].height,_e.depth);for(let Ee=0,pe=st.length;Ee<pe;Ee++)if(be=st[Ee],T.format!==li)if(Be!==null)if(H){if(ve)if(T.layerUpdates.size>0){const Ge=Wm(be.width,be.height,T.format,T.type);for(const lt of T.layerUpdates){const Pt=be.data.subarray(lt*Ge/be.data.BYTES_PER_ELEMENT,(lt+1)*Ge/be.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,Ee,0,0,lt,be.width,be.height,1,Be,Pt)}T.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,Ee,0,0,0,be.width,be.height,_e.depth,Be,be.data)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,Ee,Je,be.width,be.height,_e.depth,0,be.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else H?ve&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,Ee,0,0,0,be.width,be.height,_e.depth,Be,it,be.data):t.texImage3D(r.TEXTURE_2D_ARRAY,Ee,Je,be.width,be.height,_e.depth,0,Be,it,be.data)}else{H&&Le&&t.texStorage2D(r.TEXTURE_2D,Ie,Je,st[0].width,st[0].height);for(let Ee=0,pe=st.length;Ee<pe;Ee++)be=st[Ee],T.format!==li?Be!==null?H?ve&&t.compressedTexSubImage2D(r.TEXTURE_2D,Ee,0,0,be.width,be.height,Be,be.data):t.compressedTexImage2D(r.TEXTURE_2D,Ee,Je,be.width,be.height,0,be.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):H?ve&&t.texSubImage2D(r.TEXTURE_2D,Ee,0,0,be.width,be.height,Be,it,be.data):t.texImage2D(r.TEXTURE_2D,Ee,Je,be.width,be.height,0,Be,it,be.data)}else if(T.isDataArrayTexture)if(H){if(Le&&t.texStorage3D(r.TEXTURE_2D_ARRAY,Ie,Je,_e.width,_e.height,_e.depth),ve)if(T.layerUpdates.size>0){const Ee=Wm(_e.width,_e.height,T.format,T.type);for(const pe of T.layerUpdates){const Ge=_e.data.subarray(pe*Ee/_e.data.BYTES_PER_ELEMENT,(pe+1)*Ee/_e.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,pe,_e.width,_e.height,1,Be,it,Ge)}T.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,_e.width,_e.height,_e.depth,Be,it,_e.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,Je,_e.width,_e.height,_e.depth,0,Be,it,_e.data);else if(T.isData3DTexture)H?(Le&&t.texStorage3D(r.TEXTURE_3D,Ie,Je,_e.width,_e.height,_e.depth),ve&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,_e.width,_e.height,_e.depth,Be,it,_e.data)):t.texImage3D(r.TEXTURE_3D,0,Je,_e.width,_e.height,_e.depth,0,Be,it,_e.data);else if(T.isFramebufferTexture){if(Le)if(H)t.texStorage2D(r.TEXTURE_2D,Ie,Je,_e.width,_e.height);else{let Ee=_e.width,pe=_e.height;for(let Ge=0;Ge<Ie;Ge++)t.texImage2D(r.TEXTURE_2D,Ge,Je,Ee,pe,0,Be,it,null),Ee>>=1,pe>>=1}}else if(st.length>0){if(H&&Le){const Ee=It(st[0]);t.texStorage2D(r.TEXTURE_2D,Ie,Je,Ee.width,Ee.height)}for(let Ee=0,pe=st.length;Ee<pe;Ee++)be=st[Ee],H?ve&&t.texSubImage2D(r.TEXTURE_2D,Ee,0,0,Be,it,be):t.texImage2D(r.TEXTURE_2D,Ee,Je,Be,it,be);T.generateMipmaps=!1}else if(H){if(Le){const Ee=It(_e);t.texStorage2D(r.TEXTURE_2D,Ie,Je,Ee.width,Ee.height)}ve&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,Be,it,_e)}else t.texImage2D(r.TEXTURE_2D,0,Je,Be,it,_e);y(T)&&_(fe),Ye.__version=ae.version,T.onUpdate&&T.onUpdate(T)}D.__version=T.version}function ye(D,T,K){if(T.image.length!==6)return;const fe=Oe(D,T),me=T.source;t.bindTexture(r.TEXTURE_CUBE_MAP,D.__webglTexture,r.TEXTURE0+K);const ae=o.get(me);if(me.version!==ae.__version||fe===!0){t.activeTexture(r.TEXTURE0+K);const Ye=wt.getPrimaries(wt.workingColorSpace),Ce=T.colorSpace===xr?null:wt.getPrimaries(T.colorSpace),ke=T.colorSpace===xr||Ye===Ce?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,T.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,T.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,ke);const Ze=T.isCompressedTexture||T.image[0].isCompressedTexture,_e=T.image[0]&&T.image[0].isDataTexture,Be=[];for(let pe=0;pe<6;pe++)!Ze&&!_e?Be[pe]=w(T.image[pe],!0,a.maxCubemapSize):Be[pe]=_e?T.image[pe].image:T.image[pe],Be[pe]=nt(T,Be[pe]);const it=Be[0],Je=l.convert(T.format,T.colorSpace),be=l.convert(T.type),st=P(T.internalFormat,Je,be,T.colorSpace),H=T.isVideoTexture!==!0,Le=ae.__version===void 0||fe===!0,ve=me.dataReady;let Ie=G(T,it);ne(r.TEXTURE_CUBE_MAP,T);let Ee;if(Ze){H&&Le&&t.texStorage2D(r.TEXTURE_CUBE_MAP,Ie,st,it.width,it.height);for(let pe=0;pe<6;pe++){Ee=Be[pe].mipmaps;for(let Ge=0;Ge<Ee.length;Ge++){const lt=Ee[Ge];T.format!==li?Je!==null?H?ve&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+pe,Ge,0,0,lt.width,lt.height,Je,lt.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+pe,Ge,st,lt.width,lt.height,0,lt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):H?ve&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+pe,Ge,0,0,lt.width,lt.height,Je,be,lt.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+pe,Ge,st,lt.width,lt.height,0,Je,be,lt.data)}}}else{if(Ee=T.mipmaps,H&&Le){Ee.length>0&&Ie++;const pe=It(Be[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,Ie,st,pe.width,pe.height)}for(let pe=0;pe<6;pe++)if(_e){H?ve&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+pe,0,0,0,Be[pe].width,Be[pe].height,Je,be,Be[pe].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+pe,0,st,Be[pe].width,Be[pe].height,0,Je,be,Be[pe].data);for(let Ge=0;Ge<Ee.length;Ge++){const Pt=Ee[Ge].image[pe].image;H?ve&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+pe,Ge+1,0,0,Pt.width,Pt.height,Je,be,Pt.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+pe,Ge+1,st,Pt.width,Pt.height,0,Je,be,Pt.data)}}else{H?ve&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+pe,0,0,0,Je,be,Be[pe]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+pe,0,st,Je,be,Be[pe]);for(let Ge=0;Ge<Ee.length;Ge++){const lt=Ee[Ge];H?ve&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+pe,Ge+1,0,0,Je,be,lt.image[pe]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+pe,Ge+1,st,Je,be,lt.image[pe])}}}y(T)&&_(r.TEXTURE_CUBE_MAP),ae.__version=me.version,T.onUpdate&&T.onUpdate(T)}D.__version=T.version}function Ae(D,T,K,fe,me,ae){const Ye=l.convert(K.format,K.colorSpace),Ce=l.convert(K.type),ke=P(K.internalFormat,Ye,Ce,K.colorSpace),Ze=o.get(T),_e=o.get(K);if(_e.__renderTarget=T,!Ze.__hasExternalTextures){const Be=Math.max(1,T.width>>ae),it=Math.max(1,T.height>>ae);me===r.TEXTURE_3D||me===r.TEXTURE_2D_ARRAY?t.texImage3D(me,ae,ke,Be,it,T.depth,0,Ye,Ce,null):t.texImage2D(me,ae,ke,Be,it,0,Ye,Ce,null)}t.bindFramebuffer(r.FRAMEBUFFER,D),ht(T)?f.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,fe,me,_e.__webglTexture,0,je(T)):(me===r.TEXTURE_2D||me>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&me<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,fe,me,_e.__webglTexture,ae),t.bindFramebuffer(r.FRAMEBUFFER,null)}function Re(D,T,K){if(r.bindRenderbuffer(r.RENDERBUFFER,D),T.depthBuffer){const fe=T.depthTexture,me=fe&&fe.isDepthTexture?fe.type:null,ae=C(T.stencilBuffer,me),Ye=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Ce=je(T);ht(T)?f.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Ce,ae,T.width,T.height):K?r.renderbufferStorageMultisample(r.RENDERBUFFER,Ce,ae,T.width,T.height):r.renderbufferStorage(r.RENDERBUFFER,ae,T.width,T.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Ye,r.RENDERBUFFER,D)}else{const fe=T.textures;for(let me=0;me<fe.length;me++){const ae=fe[me],Ye=l.convert(ae.format,ae.colorSpace),Ce=l.convert(ae.type),ke=P(ae.internalFormat,Ye,Ce,ae.colorSpace),Ze=je(T);K&&ht(T)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,Ze,ke,T.width,T.height):ht(T)?f.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Ze,ke,T.width,T.height):r.renderbufferStorage(r.RENDERBUFFER,ke,T.width,T.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function De(D,T){if(T&&T.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(r.FRAMEBUFFER,D),!(T.depthTexture&&T.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const fe=o.get(T.depthTexture);fe.__renderTarget=T,(!fe.__webglTexture||T.depthTexture.image.width!==T.width||T.depthTexture.image.height!==T.height)&&(T.depthTexture.image.width=T.width,T.depthTexture.image.height=T.height,T.depthTexture.needsUpdate=!0),ce(T.depthTexture,0);const me=fe.__webglTexture,ae=je(T);if(T.depthTexture.format===ta)ht(T)?f.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,me,0,ae):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,me,0);else if(T.depthTexture.format===na)ht(T)?f.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,me,0,ae):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,me,0);else throw new Error("Unknown depthTexture format")}function At(D){const T=o.get(D),K=D.isWebGLCubeRenderTarget===!0;if(T.__boundDepthTexture!==D.depthTexture){const fe=D.depthTexture;if(T.__depthDisposeCallback&&T.__depthDisposeCallback(),fe){const me=()=>{delete T.__boundDepthTexture,delete T.__depthDisposeCallback,fe.removeEventListener("dispose",me)};fe.addEventListener("dispose",me),T.__depthDisposeCallback=me}T.__boundDepthTexture=fe}if(D.depthTexture&&!T.__autoAllocateDepthBuffer){if(K)throw new Error("target.depthTexture not supported in Cube render targets");const fe=D.texture.mipmaps;fe&&fe.length>0?De(T.__webglFramebuffer[0],D):De(T.__webglFramebuffer,D)}else if(K){T.__webglDepthbuffer=[];for(let fe=0;fe<6;fe++)if(t.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer[fe]),T.__webglDepthbuffer[fe]===void 0)T.__webglDepthbuffer[fe]=r.createRenderbuffer(),Re(T.__webglDepthbuffer[fe],D,!1);else{const me=D.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ae=T.__webglDepthbuffer[fe];r.bindRenderbuffer(r.RENDERBUFFER,ae),r.framebufferRenderbuffer(r.FRAMEBUFFER,me,r.RENDERBUFFER,ae)}}else{const fe=D.texture.mipmaps;if(fe&&fe.length>0?t.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer[0]):t.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer),T.__webglDepthbuffer===void 0)T.__webglDepthbuffer=r.createRenderbuffer(),Re(T.__webglDepthbuffer,D,!1);else{const me=D.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ae=T.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,ae),r.framebufferRenderbuffer(r.FRAMEBUFFER,me,r.RENDERBUFFER,ae)}}t.bindFramebuffer(r.FRAMEBUFFER,null)}function vt(D,T,K){const fe=o.get(D);T!==void 0&&Ae(fe.__webglFramebuffer,D,D.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),K!==void 0&&At(D)}function ut(D){const T=D.texture,K=o.get(D),fe=o.get(T);D.addEventListener("dispose",I);const me=D.textures,ae=D.isWebGLCubeRenderTarget===!0,Ye=me.length>1;if(Ye||(fe.__webglTexture===void 0&&(fe.__webglTexture=r.createTexture()),fe.__version=T.version,c.memory.textures++),ae){K.__webglFramebuffer=[];for(let Ce=0;Ce<6;Ce++)if(T.mipmaps&&T.mipmaps.length>0){K.__webglFramebuffer[Ce]=[];for(let ke=0;ke<T.mipmaps.length;ke++)K.__webglFramebuffer[Ce][ke]=r.createFramebuffer()}else K.__webglFramebuffer[Ce]=r.createFramebuffer()}else{if(T.mipmaps&&T.mipmaps.length>0){K.__webglFramebuffer=[];for(let Ce=0;Ce<T.mipmaps.length;Ce++)K.__webglFramebuffer[Ce]=r.createFramebuffer()}else K.__webglFramebuffer=r.createFramebuffer();if(Ye)for(let Ce=0,ke=me.length;Ce<ke;Ce++){const Ze=o.get(me[Ce]);Ze.__webglTexture===void 0&&(Ze.__webglTexture=r.createTexture(),c.memory.textures++)}if(D.samples>0&&ht(D)===!1){K.__webglMultisampledFramebuffer=r.createFramebuffer(),K.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,K.__webglMultisampledFramebuffer);for(let Ce=0;Ce<me.length;Ce++){const ke=me[Ce];K.__webglColorRenderbuffer[Ce]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,K.__webglColorRenderbuffer[Ce]);const Ze=l.convert(ke.format,ke.colorSpace),_e=l.convert(ke.type),Be=P(ke.internalFormat,Ze,_e,ke.colorSpace,D.isXRRenderTarget===!0),it=je(D);r.renderbufferStorageMultisample(r.RENDERBUFFER,it,Be,D.width,D.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ce,r.RENDERBUFFER,K.__webglColorRenderbuffer[Ce])}r.bindRenderbuffer(r.RENDERBUFFER,null),D.depthBuffer&&(K.__webglDepthRenderbuffer=r.createRenderbuffer(),Re(K.__webglDepthRenderbuffer,D,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(ae){t.bindTexture(r.TEXTURE_CUBE_MAP,fe.__webglTexture),ne(r.TEXTURE_CUBE_MAP,T);for(let Ce=0;Ce<6;Ce++)if(T.mipmaps&&T.mipmaps.length>0)for(let ke=0;ke<T.mipmaps.length;ke++)Ae(K.__webglFramebuffer[Ce][ke],D,T,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+Ce,ke);else Ae(K.__webglFramebuffer[Ce],D,T,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+Ce,0);y(T)&&_(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ye){for(let Ce=0,ke=me.length;Ce<ke;Ce++){const Ze=me[Ce],_e=o.get(Ze);t.bindTexture(r.TEXTURE_2D,_e.__webglTexture),ne(r.TEXTURE_2D,Ze),Ae(K.__webglFramebuffer,D,Ze,r.COLOR_ATTACHMENT0+Ce,r.TEXTURE_2D,0),y(Ze)&&_(r.TEXTURE_2D)}t.unbindTexture()}else{let Ce=r.TEXTURE_2D;if((D.isWebGL3DRenderTarget||D.isWebGLArrayRenderTarget)&&(Ce=D.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(Ce,fe.__webglTexture),ne(Ce,T),T.mipmaps&&T.mipmaps.length>0)for(let ke=0;ke<T.mipmaps.length;ke++)Ae(K.__webglFramebuffer[ke],D,T,r.COLOR_ATTACHMENT0,Ce,ke);else Ae(K.__webglFramebuffer,D,T,r.COLOR_ATTACHMENT0,Ce,0);y(T)&&_(Ce),t.unbindTexture()}D.depthBuffer&&At(D)}function F(D){const T=D.textures;for(let K=0,fe=T.length;K<fe;K++){const me=T[K];if(y(me)){const ae=L(D),Ye=o.get(me).__webglTexture;t.bindTexture(ae,Ye),_(ae),t.unbindTexture()}}}const Yt=[],_t=[];function Mt(D){if(D.samples>0){if(ht(D)===!1){const T=D.textures,K=D.width,fe=D.height;let me=r.COLOR_BUFFER_BIT;const ae=D.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Ye=o.get(D),Ce=T.length>1;if(Ce)for(let Ze=0;Ze<T.length;Ze++)t.bindFramebuffer(r.FRAMEBUFFER,Ye.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ze,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,Ye.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ze,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,Ye.__webglMultisampledFramebuffer);const ke=D.texture.mipmaps;ke&&ke.length>0?t.bindFramebuffer(r.DRAW_FRAMEBUFFER,Ye.__webglFramebuffer[0]):t.bindFramebuffer(r.DRAW_FRAMEBUFFER,Ye.__webglFramebuffer);for(let Ze=0;Ze<T.length;Ze++){if(D.resolveDepthBuffer&&(D.depthBuffer&&(me|=r.DEPTH_BUFFER_BIT),D.stencilBuffer&&D.resolveStencilBuffer&&(me|=r.STENCIL_BUFFER_BIT)),Ce){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Ye.__webglColorRenderbuffer[Ze]);const _e=o.get(T[Ze]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,_e,0)}r.blitFramebuffer(0,0,K,fe,0,0,K,fe,me,r.NEAREST),h===!0&&(Yt.length=0,_t.length=0,Yt.push(r.COLOR_ATTACHMENT0+Ze),D.depthBuffer&&D.resolveDepthBuffer===!1&&(Yt.push(ae),_t.push(ae),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,_t)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,Yt))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),Ce)for(let Ze=0;Ze<T.length;Ze++){t.bindFramebuffer(r.FRAMEBUFFER,Ye.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ze,r.RENDERBUFFER,Ye.__webglColorRenderbuffer[Ze]);const _e=o.get(T[Ze]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,Ye.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ze,r.TEXTURE_2D,_e,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,Ye.__webglMultisampledFramebuffer)}else if(D.depthBuffer&&D.resolveDepthBuffer===!1&&h){const T=D.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[T])}}}function je(D){return Math.min(a.maxSamples,D.samples)}function ht(D){const T=o.get(D);return D.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&T.__useRenderToTexture!==!1}function qe(D){const T=c.render.frame;g.get(D)!==T&&(g.set(D,T),D.update())}function nt(D,T){const K=D.colorSpace,fe=D.format,me=D.type;return D.isCompressedTexture===!0||D.isVideoTexture===!0||K!==es&&K!==xr&&(wt.getTransfer(K)===Dt?(fe!==li||me!==xi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",K)),T}function It(D){return typeof HTMLImageElement<"u"&&D instanceof HTMLImageElement?(p.width=D.naturalWidth||D.width,p.height=D.naturalHeight||D.height):typeof VideoFrame<"u"&&D instanceof VideoFrame?(p.width=D.displayWidth,p.height=D.displayHeight):(p.width=D.width,p.height=D.height),p}this.allocateTextureUnit=q,this.resetTextureUnits=ee,this.setTexture2D=ce,this.setTexture2DArray=re,this.setTexture3D=he,this.setTextureCube=z,this.rebindTextures=vt,this.setupRenderTarget=ut,this.updateRenderTargetMipmap=F,this.updateMultisampleRenderTarget=Mt,this.setupDepthRenderbuffer=At,this.setupFrameBufferTexture=Ae,this.useMultisampledRTT=ht}function Zw(r,e){function t(o,a=xr){let l;const c=wt.getTransfer(a);if(o===xi)return r.UNSIGNED_BYTE;if(o===Sd)return r.UNSIGNED_SHORT_4_4_4_4;if(o===Ed)return r.UNSIGNED_SHORT_5_5_5_1;if(o===Kg)return r.UNSIGNED_INT_5_9_9_9_REV;if(o===$g)return r.BYTE;if(o===qg)return r.SHORT;if(o===Js)return r.UNSIGNED_SHORT;if(o===yd)return r.INT;if(o===Qr)return r.UNSIGNED_INT;if(o===Bi)return r.FLOAT;if(o===aa)return r.HALF_FLOAT;if(o===Zg)return r.ALPHA;if(o===Qg)return r.RGB;if(o===li)return r.RGBA;if(o===ta)return r.DEPTH_COMPONENT;if(o===na)return r.DEPTH_STENCIL;if(o===Jg)return r.RED;if(o===Md)return r.RED_INTEGER;if(o===ev)return r.RG;if(o===Td)return r.RG_INTEGER;if(o===wd)return r.RGBA_INTEGER;if(o===zl||o===Hl||o===Vl||o===Gl)if(c===Dt)if(l=e.get("WEBGL_compressed_texture_s3tc_srgb"),l!==null){if(o===zl)return l.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(o===Hl)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(o===Vl)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(o===Gl)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(l=e.get("WEBGL_compressed_texture_s3tc"),l!==null){if(o===zl)return l.COMPRESSED_RGB_S3TC_DXT1_EXT;if(o===Hl)return l.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(o===Vl)return l.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(o===Gl)return l.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(o===zf||o===Hf||o===Vf||o===Gf)if(l=e.get("WEBGL_compressed_texture_pvrtc"),l!==null){if(o===zf)return l.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(o===Hf)return l.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(o===Vf)return l.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(o===Gf)return l.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(o===Wf||o===Xf||o===jf)if(l=e.get("WEBGL_compressed_texture_etc"),l!==null){if(o===Wf||o===Xf)return c===Dt?l.COMPRESSED_SRGB8_ETC2:l.COMPRESSED_RGB8_ETC2;if(o===jf)return c===Dt?l.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:l.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(o===Yf||o===$f||o===qf||o===Kf||o===Zf||o===Qf||o===Jf||o===ed||o===td||o===nd||o===id||o===rd||o===od||o===sd)if(l=e.get("WEBGL_compressed_texture_astc"),l!==null){if(o===Yf)return c===Dt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:l.COMPRESSED_RGBA_ASTC_4x4_KHR;if(o===$f)return c===Dt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:l.COMPRESSED_RGBA_ASTC_5x4_KHR;if(o===qf)return c===Dt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:l.COMPRESSED_RGBA_ASTC_5x5_KHR;if(o===Kf)return c===Dt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:l.COMPRESSED_RGBA_ASTC_6x5_KHR;if(o===Zf)return c===Dt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:l.COMPRESSED_RGBA_ASTC_6x6_KHR;if(o===Qf)return c===Dt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:l.COMPRESSED_RGBA_ASTC_8x5_KHR;if(o===Jf)return c===Dt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:l.COMPRESSED_RGBA_ASTC_8x6_KHR;if(o===ed)return c===Dt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:l.COMPRESSED_RGBA_ASTC_8x8_KHR;if(o===td)return c===Dt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:l.COMPRESSED_RGBA_ASTC_10x5_KHR;if(o===nd)return c===Dt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:l.COMPRESSED_RGBA_ASTC_10x6_KHR;if(o===id)return c===Dt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:l.COMPRESSED_RGBA_ASTC_10x8_KHR;if(o===rd)return c===Dt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:l.COMPRESSED_RGBA_ASTC_10x10_KHR;if(o===od)return c===Dt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:l.COMPRESSED_RGBA_ASTC_12x10_KHR;if(o===sd)return c===Dt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:l.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(o===Wl||o===ad||o===ld)if(l=e.get("EXT_texture_compression_bptc"),l!==null){if(o===Wl)return c===Dt?l.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:l.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(o===ad)return l.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(o===ld)return l.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(o===tv||o===ud||o===cd||o===fd)if(l=e.get("EXT_texture_compression_rgtc"),l!==null){if(o===Wl)return l.COMPRESSED_RED_RGTC1_EXT;if(o===ud)return l.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(o===cd)return l.COMPRESSED_RED_GREEN_RGTC2_EXT;if(o===fd)return l.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return o===ea?r.UNSIGNED_INT_24_8:r[o]!==void 0?r[o]:null}return{convert:t}}const Qw=`
void main() {
...
}`;class e1{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,o){if(this.texture===null){const a=new Rn,l=e.properties.get(a);l.__webglTexture=t.texture,(t.depthNear!==o.depthNear||t.depthFar!==o.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=a}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,o=new Tr({vertexShader:Qw,fragmentShader:Jw,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new vi(new ru(20,20),o)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class t1 extends is{constructor(e,t){super();const o=this;let a=null,l=1,c=null,f="local-floor",h=1,p=null,g=null,v=null,x=null,S=null,M=null;const w=new e1,y=t.getContextAttributes();let _=null,L=null;const P=[],C=[],G=new Rt;let O=null;const I=new Zn;I.viewport=new Wt;const W=new Zn;W.viewport=new Wt;const b=[I,W],R=new ES;let B=null,ee=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Q){let de=P[Q];return de===void 0&&(de=new ff,P[Q]=de),de.getTargetRaySpace()},this.getControllerGrip=function(Q){let de=P[Q];return de===void 0&&(de=new ff,P[Q]=de),de.getGripSpace()},this.getHand=function(Q){let de=P[Q];return de===void 0&&(de=new ff,P[Q]=de),de.getHandSpace()};function q(Q){const de=C.indexOf(Q.inputSource);if(de===-1)return;const Te=P[de];Te!==void 0&&(Te.update(Q.inputSource,Q.frame,p||c),Te.dispatchEvent({type:Q.type,data:Q.inputSource}))}function se(){a.removeEventListener("select",q),a.removeEventListener("selectstart",q),a.removeEventListener("selectend",q),a.removeEventListener("squeeze",q),a.removeEventListener("squeezestart",q),a.removeEventListener("squeezeend",q),a.removeEventListener("end",se),a.removeEventListener("inputsourceschange",ce);for(let Q=0;Q<P.length;Q++){const de=C[Q];de!==null&&(C[Q]=null,P[Q].disconnect(de))}B=null,ee=null,w.reset(),e.setRenderTarget(_),S=null,x=null,v=null,a=null,L=null,Oe.stop(),o.isPresenting=!1,e.setPixelRatio(O),e.setSize(G.width,G.height,!1),o.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Q){l=Q,o.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Q){f=Q,o.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||c},this.setReferenceSpace=function(Q){p=Q},this.getBaseLayer=function(){return x!==null?x:S},this.getBinding=function(){return v},this.getFrame=function(){return M},this.getSession=function(){return a},this.setSession=async function(Q){if(a=Q,a!==null){if(_=e.getRenderTarget(),a.addEventListener("select",q),a.addEventListener("selectstart",q),a.addEventListener("selectend",q),a.addEventListener("squeeze",q),a.addEventListener("squeezestart",q),a.addEventListener("squeezeend",q),a.addEventListener("end",se),a.addEventListener("inputsourceschange",ce),y.xrCompatible!==!0&&await t.makeXRCompatible(),O=e.getPixelRatio(),e.getSize(G),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let Te=null,ye=null,Ae=null;y.depth&&(Ae=y.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,Te=y.stencil?na:ta,ye=y.stencil?ea:Qr);const Re={colorFormat:t.RGBA8,depthFormat:Ae,scaleFactor:l};v=new XRWebGLBinding(a,t),x=v.createProjectionLayer(Re),a.updateRenderState({layers:[x]}),e.setPixelRatio(1),e.setSize(x.textureWidth,x.textureHeight,!1),L=new Jr(x.textureWidth,x.textureHeight,{format:li,type:xi,depthTexture:new dv(x.textureWidth,x.textureHeight,ye,void 0,void 0,void 0,void 0,void 0,void 0,Te),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:x.ignoreDepthValues===!1,resolveStencilBuffer:x.ignoreDepthValues===!1})}else{const Te={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:l};S=new XRWebGLLayer(a,t,Te),a.updateRenderState({baseLayer:S}),e.setPixelRatio(1),e.setSize(S.framebufferWidth,S.framebufferHeight,!1),L=new Jr(S.framebufferWidth,S.framebufferHeight,{format:li,type:xi,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil,resolveDepthBuffer:S.ignoreDepthValues===!1,resolveStencilBuffer:S.ignoreDepthValues===!1})}L.isXRRenderTarget=!0,this.setFoveation(h),p=null,c=await a.requestReferenceSpace(f),Oe.setContext(a),Oe.start(),o.isPresenting=!0,o.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(a!==null)return a.environmentBlendMode},this.getDepthTexture=function(){return w.getDepthTexture()};function ce(Q){for(let de=0;de<Q.removed.length;de++){const Te=Q.removed[de],ye=C.indexOf(Te);ye>=0&&(C[ye]=null,P[ye].disconnect(Te))}for(let de=0;de<Q.added.length;de++){const Te=Q.added[de];let ye=C.indexOf(Te);if(ye===-1){for(let Re=0;Re<P.length;Re++)if(Re>=C.length){C.push(Te),ye=Re;break}else if(C[Re]===null){C[Re]=Te,ye=Re;break}if(ye===-1)break}const Ae=P[ye];Ae&&Ae.connect(Te)}}const re=new ie,he=new ie;function z(Q,de,Te){re.setFromMatrixPosition(de.matrixWorld),he.setFromMatrixPosition(Te.matrixWorld);const ye=re.distanceTo(he),Ae=de.projectionMatrix.elements,Re=Te.projectionMatrix.elements,De=Ae[14]/(Ae[10]-1),At=Ae[14]/(Ae[10]+1),vt=(Ae[9]+1)/Ae[5],ut=(Ae[9]-1)/Ae[5],F=(Ae[8]-1)/Ae[0],Yt=(Re[8]+1)/Re[0],_t=De*F,Mt=De*Yt,je=ye/(-F+Yt),ht=je*-F;if(de.matrixWorld.decompose(Q.position,Q.quaternion,Q.scale),Q.translateX(ht),Q.translateZ(je),Q.matrixWorld.compose(Q.position,Q.quaternion,Q.scale),Q.matrixWorldInverse.copy(Q.matrixWorld).invert(),Ae[10]===-1)Q.projectionMatrix.copy(de.projectionMatrix),Q.projectionMatrixInverse.copy(de.projectionMatrixInverse);else{const qe=De+je,nt=At+je,It=_t-ht,D=Mt+(ye-ht),T=vt*At/nt*qe,K=ut*At/nt*qe;Q.projectionMatrix.makePerspective(It,D,T,K,qe,nt),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert()}}function le(Q,de){de===null?Q.matrixWorld.copy(Q.matrix):Q.matrixWorld.multiplyMatrices(de.matrixWorld,Q.matrix),Q.matrixWorldInverse.copy(Q.matrixWorld).invert()}this.updateCamera=function(Q){if(a===null)return;let de=Q.near,Te=Q.far;w.texture!==null&&(w.depthNear>0&&(de=w.depthNear),w.depthFar>0&&(Te=w.depthFar)),R.near=W.near=I.near=de,R.far=W.far=I.far=Te,(B!==R.near||ee!==R.far)&&(a.updateRenderState({depthNear:R.near,depthFar:R.far}),B=R.near,ee=R.far),I.layers.mask=Q.layers.mask|2,W.layers.mask=Q.layers.mask|4,R.layers.mask=I.layers.mask|W.layers.mask;const ye=Q.parent,Ae=R.cameras;le(R,ye);for(let Re=0;Re<Ae.length;Re++)le(Ae[Re],ye);Ae.length===2?z(R,I,W):R.projectionMatrix.copy(I.projectionMatrix),oe(Q,R,ye)};function oe(Q,de,Te){Te===null?Q.matrix.copy(de.matrixWorld):(Q.matrix.copy(Te.matrixWorld),Q.matrix.invert(),Q.matrix.multiply(de.matrixWorld)),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.updateMatrixWorld(!0),Q.projectionMatrix.copy(de.projectionMatrix),Q.projectionMatrixInverse.copy(de.projectionMatrixInverse),Q.isPerspectiveCamera&&(Q.fov=ia*2*Math.atan(1/Q.projectionMatrix.elements[5]),Q.zoom=1)}this.getCamera=function(){return R},this.getFoveation=function(){if(!(x===null&&S===null))return h},this.setFoveation=function(Q){h=Q,x!==null&&(x.fixedFoveation=Q),S!==null&&S.fixedFoveation!==void 0&&(S.fixedFoveation=Q)},this.hasDepthSensing=function(){return w.texture!==null},this.getDepthSensingMesh=function(){return w.getMesh(R)};let N=null;function ne(Q,de){if(g=de.getViewerPose(p||c),M=de,g!==null){const Te=g.views;S!==null&&(e.setRenderTargetFramebuffer(L,S.framebuffer),e.setRenderTarget(L));let ye=!1;Te.length!==R.cameras.length&&(R.cameras.length=0,ye=!0);for(let De=0;De<Te.length;De++){const At=Te[De];let vt=null;if(S!==null)vt=S.getViewport(At);else{const F=v.getViewSubImage(x,At);vt=F.viewport,De===0&&(e.setRenderTargetTextures(L,F.colorTexture,F.depthStencilTexture),e.setRenderTarget(L))}let ut=b[De];ut===void 0&&(ut=new Zn,ut.layers.enable(De),ut.viewport=new Wt,b[De]=ut),ut.matrix.fromArray(At.transform.matrix),ut.matrix.decompose(ut.position,ut.quaternion,ut.scale),ut.projectionMatrix.fromArray(At.projectionMatrix),ut.projectionMatrixInverse.copy(ut.projectionMatrix).invert(),ut.viewport.set(vt.x,vt.y,vt.width,vt.height),De===0&&(R.matrix.copy(ut.matrix),R.matrix.decompose(R.position,R.quaternion,R.scale)),ye===!0&&R.cameras.push(ut)}const Ae=a.enabledFeatures;if(Ae&&Ae.includes("depth-sensing")&&a.depthUsage=="gpu-optimized"&&v){const De=v.getDepthInformation(Te[0]);De&&De.isValid&&De.texture&&w.init(e,De,a.renderState)}}for(let Te=0;Te<P.length;Te++){const ye=C[Te],Ae=P[Te];ye!==null&&Ae!==void 0&&Ae.update(ye,de,p||c)}N&&N(Q,de),de.detectedPlanes&&o.dispatchEvent({type:"planesdetected",data:de}),M=null}const Oe=new pv;Oe.setAnimationLoop(ne),this.setAnimationLoop=function(Q){N=Q},this.dispose=function(){}}}const Xr=new Gi,n1=new jt;function i1(r,e){function t(y,_){y.matrixAutoUpdate===!0&&y.updateMatrix(),_.value.copy(y.matrix)}function o(y,_){_.color.getRGB(y.fogColor.value,uv(r)),_.isFog?(y.fogNear.value=_.near,y.fogFar.value=_.far):_.isFogExp2&&(y.fogDensity.value=_.density)}function a(y,_,L,P,C){_.isMeshBasicMaterial||_.isMeshLambertMaterial?l(y,_):_.isMeshToonMaterial?(l(y,_),v(y,_)):_.isMeshPhongMaterial?(l(y,_),g(y,_)):_.isMeshStandardMaterial?(l(y,_),x(y,_),_.isMeshPhysicalMaterial&&S(y,_,C)):_.isMeshMatcapMaterial?(l(y,_),M(y,_)):_.isMeshDepthMaterial?l(y,_):_.isMeshDistanceMaterial?(l(y,_),w(y,_)):_.isMeshNormalMaterial?l(y,_):_.isLineBasicMaterial?(c(y,_),_.isLineDashedMaterial&&f(y,_)):_.isPointsMaterial?h(y,_,L,P):_.isSpriteMaterial?p(y,_):_.isShadowMaterial?(y.color.value.copy(_.color),y.opacity.value=_.opacity):_.isShaderMaterial&&(_.uniformsNeedUpdate=!1)}function l(y,_){y.opacity.value=_.opacity,_.color&&y.diffuse.value.copy(_.color),_.emissive&&y.emissive.value.copy(_.emissive).multiplyScalar(_.emissiveIntensity),_.map&&(y.map.value=_.map,t(_.map,y.mapTransform)),_.alphaMap&&(y.alphaMap.value=_.alphaMap,t(_.alphaMap,y.alphaMapTransform)),_.bumpMap&&(y.bumpMap.value=_.bumpMap,t(_.bumpMap,y.bumpMapTransform),y.bumpScale.value=_.bumpScale,_.side===Fn&&(y.bumpScale.value*=-1)),_.normalMap&&(y.normalMap.value=_.normalMap,t(_.normalMap,y.normalMapTransform),y.normalScale.value.copy(_.normalScale),_.side===Fn&&y.normalScale.value.negate()),_.displacementMap&&(y.displacementMap.value=_.displacementMap,t(_.displacementMap,y.displacementMapTransform),y.displacementScale.value=_.displacementScale,y.displacementBias.value=_.displacementBias),_.emissiveMap&&(y.emissiveMap.value=_.emissiveMap,t(_.emissiveMap,y.emissiveMapTransform)),_.specularMap&&(y.specularMap.value=_.specularMap,t(_.specularMap,y.specularMapTransform)),_.alphaTest>0&&(y.alphaTest.value=_.alphaTest);const L=e.get(_),P=L.envMap,C=L.envMapRotation;P&&(y.envMap.value=P,Xr.copy(C),Xr.x*=-1,Xr.y*=-1,Xr.z*=-1,P.isCubeTexture&&P.isRenderTargetTexture===!1&&(Xr.y*=-1,Xr.z*=-1),y.envMapRotation.value.setFromMatrix4(n1.makeRotationFromEuler(Xr)),y.flipEnvMap.value=P.isCubeTexture&&P.isRenderTargetTexture===!1?-1:1,y.reflectivity.value=_.reflectivity,y.ior.value=_.ior,y.refractionRatio.value=_.refractionRatio),_.lightMap&&(y.lightMap.value=_.lightMap,y.lightMapIntensity.value=_.lightMapIntensity,t(_.lightMap,y.lightMapTransform)),_.aoMap&&(y.aoMap.value=_.aoMap,y.aoMapIntensity.value=_.aoMapIntensity,t(_.aoMap,y.aoMapTransform))}function c(y,_){y.diffuse.value.copy(_.color),y.opacity.value=_.opacity,_.map&&(y.map.value=_.map,t(_.map,y.mapTransform))}function f(y,_){y.dashSize.value=_.dashSize,y.totalSize.value=_.dashSize+_.gapSize,y.scale.value=_.scale}function h(y,_,L,P){y.diffuse.value.copy(_.color),y.opacity.value=_.opacity,y.size.value=_.size*L,y.scale.value=P*.5,_.map&&(y.map.value=_.map,t(_.map,y.uvTransform)),_.alphaMap&&(y.alphaMap.value=_.alphaMap,t(_.alphaMap,y.alphaMapTransform)),_.alphaTest>0&&(y.alphaTest.value=_.alphaTest)}function p(y,_){y.diffuse.value.copy(_.color),y.opacity.value=_.opacity,y.rotation.value=_.rotation,_.map&&(y.map.value=_.map,t(_.map,y.mapTransform)),_.alphaMap&&(y.alphaMap.value=_.alphaMap,t(_.alphaMap,y.alphaMapTransform)),_.alphaTest>0&&(y.alphaTest.value=_.alphaTest)}function g(y,_){y.specular.value.copy(_.specular),y.shininess.value=Math.max(_.shininess,1e-4)}function v(y,_){_.gradientMap&&(y.gradientMap.value=_.gradientMap)}function x(y,_){y.metalness.value=_.metalness,_.metalnessMap&&(y.metalnessMap.value=_.metalnessMap,t(_.metalnessMap,y.metalnessMapTransform)),y.roughness.value=_.roughness,_.roughnessMap&&(y.roughnessMap.value=_.roughnessMap,t(_.roughnessMap,y.roughnessMapTransform)),_.envMap&&(y.envMapIntensity.value=_.envMapIntensity)}function S(y,_,L){y.ior.value=_.ior,_.sheen>0&&(y.sheenColor.value.copy(_.sheenColor).multiplyScalar(_.sheen),y.sheenRoughness.value=_.sheenRoughness,_.sheenColorMap&&(y.sheenColorMap.value=_.sheenColorMap,t(_.sheenColorMap,y.sheenColorMapTransform)),_.sheenRoughnessMap&&(y.sheenRoughnessMap.value=_.sheenRoughnessMap,t(_.sheenRoughnessMap,y.sheenRoughnessMapTransform))),_.clearcoat>0&&(y.clearcoat.value=_.clearcoat,y.clearcoatRoughness.value=_.clearcoatRoughness,_.clearcoatMap&&(y.clearcoatMap.value=_.clearcoatMap,t(_.clearcoatMap,y.clearcoatMapTransform)),_.clearcoatRoughnessMap&&(y.clearcoatRoughnessMap.value=_.clearcoatRoughnessMap,t(_.clearcoatRoughnessMap,y.clearcoatRoughnessMapTransform)),_.clearcoatNormalMap&&(y.clearcoatNormalMap.value=_.clearcoatNormalMap,t(_.clearcoatNormalMap,y.clearcoatNormalMapTransform),y.clearcoatNormalScale.value.copy(_.clearcoatNormalScale),_.side===Fn&&y.clearcoatNormalScale.value.negate())),_.dispersion>0&&(y.dispersion.value=_.dispersion),_.iridescence>0&&(y.iridescence.value=_.iridescence,y.iridescenceIOR.value=_.iridescenceIOR,y.iridescenceThicknessMinimum.value=_.iridescenceThicknessRange[0],y.iridescenceThicknessMaximum.value=_.iridescenceThicknessRange[1],_.iridescenceMap&&(y.iridescenceMap.value=_.iridescenceMap,t(_.iridescenceMap,y.iridescenceMapTransform)),_.iridescenceThicknessMap&&(y.iridescenceThicknessMap.value=_.iridescenceThicknessMap,t(_.iridescenceThicknessMap,y.iridescenceThicknessMapTransform))),_.transmission>0&&(y.transmission.value=_.transmission,y.transmissionSamplerMap.value=L.texture,y.transmissionSamplerSize.value.set(L.width,L.height),_.transmissionMap&&(y.transmissionMap.value=_.transmissionMap,t(_.transmissionMap,y.transmissionMapTransform)),y.thickness.value=_.thickness,_.thicknessMap&&(y.thicknessMap.value=_.thicknessMap,t(_.thicknessMap,y.thicknessMapTransform)),y.attenuationDistance.value=_.attenuationDistance,y.attenuationColor.value.copy(_.attenuationColor)),_.anisotropy>0&&(y.anisotropyVector.value.set(_.anisotropy*Math.cos(_.anisotropyRotation),_.anisotropy*Math.sin(_.anisotropyRotation)),_.anisotropyMap&&(y.anisotropyMap.value=_.anisotropyMap,t(_.anisotropyMap,y.anisotropyMapTransform))),y.specularIntensity.value=_.specularIntensity,y.specularColor.value.copy(_.specularColor),_.specularColorMap&&(y.specularColorMap.value=_.specularColorMap,t(_.specularColorMap,y.specularColorMapTransform)),_.specularIntensityMap&&(y.specularIntensityMap.value=_.specularIntensityMap,t(_.specularIntensityMap,y.specularIntensityMapTransform))}function M(y,_){_.matcap&&(y.matcap.value=_.matcap)}function w(y,_){const L=e.get(_).light;y.referencePosition.value.setFromMatrixPosition(L.matrixWorld),y.nearDistance.value=L.shadow.camera.near,y.farDistance.value=L.shadow.camera.far}return{refreshFogUniforms:o,refreshMaterialUniforms:a}}function r1(r,e,t,o){let a={},l={},c=[];const f=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function h(L,P){const C=P.program;o.uniformBlockBinding(L,C)}function p(L,P){let C=a[L.id];C===void 0&&(M(L),C=g(L),a[L.id]=C,L.addEventListener("dispose",y));const G=P.program;o.updateUBOMapping(L,G);const O=e.render.frame;l[L.id]!==O&&(x(L),l[L.id]=O)}function g(L){const P=v();L.__bindingPointIndex=P;const C=r.createBuffer(),G=L.__size,O=L.usage;return r.bindBuffer(r.UNIFORM_BUFFER,C),r.bufferData(r.UNIFORM_BUFFER,G,O),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,P,C),C}function v(){for(let L=0;L<f;L++)if(c.indexOf(L)===-1)return c.push(L),L;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function x(L){const P=a[L.id],C=L.uniforms,G=L.__cache;r.bindBuffer(r.UNIFORM_BUFFER,P);for(let O=0,I=C.length;O<I;O++){const W=Array.isArray(C[O])?C[O]:[C[O]];for(let b=0,R=W.length;b<R;b++){const B=W[b];if(S(B,O,b,G)===!0){const ee=B.__offset,q=Array.isArray(B.value)?B.value:[B.value];let se=0;for(let ce=0;ce<q.length;ce++){const re=q[ce],he=w(re);typeof re=="number"||typeof re=="boolean"?(B.__data[0]=re,r.bufferSubData(r.UNIFORM_BUFFER,ee+se,B.__data)):re.isMatrix3?(B.__data[0]=re.elements[0],B.__data[1]=re.elements[1],B.__data[2]=re.elements[2],B.__data[3]=0,B.__data[4]=re.elements[3],B.__data[5]=re.elements[4],B.__data[6]=re.elements[5],B.__data[7]=0,B.__data[8]=re.elements[6],B.__data[9]=re.elements[7],B.__data[10]=re.elements[8],B.__data[11]=0):(re.toArray(B.__data,se),se+=he.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,ee,B.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function S(L,P,C,G){const O=L.value,I=P+"_"+C;if(G[I]===void 0)return typeof O=="number"||typeof O=="boolean"?G[I]=O:G[I]=O.clone(),!0;{const W=G[I];if(typeof O=="number"||typeof O=="boolean"){if(W!==O)return G[I]=O,!0}else if(W.equals(O)===!1)return W.copy(O),!0}return!1}function M(L){const P=L.uniforms;let C=0;const G=16;for(let I=0,W=P.length;I<W;I++){const b=Array.isArray(P[I])?P[I]:[P[I]];for(let R=0,B=b.length;R<B;R++){const ee=b[R],q=Array.isArray(ee.value)?ee.value:[ee.value];for(let se=0,ce=q.length;se<ce;se++){const re=q[se],he=w(re),z=C%G,le=z%he.boundary,oe=z+le;C+=le,oe!==0&&G-oe<he.storage&&(C+=G-oe),ee.__data=new Float32Array(he.storage/Float32Array.BYTES_PER_ELEMENT),ee.__offset=C,C+=he.storage}}}const O=C%G;return O>0&&(C+=G-O),L.__size=C,L.__cache={},this}function w(L){const P={boundary:0,storage:0};return typeof L=="number"||typeof L=="boolean"?(P.boundary=4,P.storage=4):L.isVector2?(P.boundary=8,P.storage=8):L.isVector3||L.isColor?(P.boundary=16,P.storage=12):L.isVector4?(P.boundary=16,P.storage=16):L.isMatrix3?(P.boundary=48,P.storage=48):L.isMatrix4?(P.boundary=64,P.storage=64):L.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",L),P}function y(L){const P=L.target;P.removeEventListener("dispose",y);const C=c.indexOf(P.__bindingPointIndex);c.splice(C,1),r.deleteBuffer(a[P.id]),delete a[P.id],delete l[P.id]}function _(){for(const L in a)r.deleteBuffer(a[L]);c=[],a={},l={}}return{bind:h,update:p,dispose:_}}class o1{constructor(e={}){const{canvas:t=Uy(),context:o=null,depth:a=!0,stencil:l=!1,alpha:c=!1,antialias:f=!1,premultipliedAlpha:h=!0,preserveDrawingBuffer:p=!1,powerPreference:g="default",failIfMajorPerformanceCaveat:v=!1,reverseDepthBuffer:x=!1}=e;this.isWebGLRenderer=!0;let S;if(o!==null){if(typeof WebGLRenderingContext<"u"&&o instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");S=o.getContextAttributes().alpha}else S=c;const M=new Uint32Array(4),w=new Int32Array(4);let y=null,_=null;const L=[],P=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Hi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const C=this;let G=!1;this._outputColorSpace=In;let O=0,I=0,W=null,b=-1,R=null;const B=new Wt,ee=new Wt;let q=null;const se=new bt(0);let ce=0,re=t.width,he=t.height,z=1,le=null,oe=null;const N=new Wt(0,0,re,he),ne=new Wt(0,0,re,he);let Oe=!1;const Q=new bd;let de=!1,Te=!1;const ye=new jt,Ae=new jt,Re=new ie,De=new Wt,At={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let vt=!1;function ut(){return W===null?z:1}let F=o;function Yt(A,X){return t.getContext(A,X)}try{const A={alpha:!0,depth:a,stencil:l,antialias:f,premultipliedAlpha:h,preserveDrawingBuffer:p,powerPreference:g,failIfMajorPerformanceCaveat:v};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${xd}`),t.addEventListener("webglcontextlost",Ie,!1),t.addEventListener("webglcontextrestored",Ee,!1),t.addEventListener("webglcontextcreationerror",pe,!1),F===null){const X="webgl2";if(F=Yt(X,A),F===null)throw Yt(X)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw console.error("THREE.WebGLRenderer: "+A.message),A}let _t,Mt,je,ht,qe,nt,It,D,T,K,fe,me,ae,Ye,Ce,ke,Ze,_e,Be,it,Je,be,st,H;function Le(){_t=new mT(F),_t.init(),be=new Zw(F,_t),Mt=new lT(F,_t,e,be),je=new qw(F,_t),Mt.reverseDepthBuffer&&x&&je.buffers.depth.setReversed(!0),ht=new _T(F),qe=new Fw,nt=new Kw(F,_t,je,qe,Mt,be,ht),It=new cT(C),D=new pT(C),T=new TS(F),st=new sT(F,T),K=new gT(F,T,ht,st),fe=new yT(F,K,T,ht),Be=new xT(F,Mt,nt),ke=new uT(qe),me=new Iw(C,It,D,_t,Mt,st,ke),ae=new i1(C,qe),Ye=new kw,Ce=new Ww(_t),_e=new oT(C,It,D,je,fe,S,h),Ze=new Yw(C,fe,Mt),H=new r1(F,ht,Mt,je),it=new aT(F,_t,ht),Je=new vT(F,_t,ht),ht.programs=me.programs,C.capabilities=Mt,C.extensions=_t,C.properties=qe,C.renderLists=Ye,C.shadowMap=Ze,C.state=je,C.info=ht}Le();const ve=new t1(C,F);this.xr=ve,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){const A=_t.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=_t.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return z},this.setPixelRatio=function(A){A!==void 0&&(z=A,this.setSize(re,he,!1))},this.getSize=function(A){return A.set(re,he)},this.setSize=function(A,X,te=!0){if(ve.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}re=A,he=X,t.width=Math.floor(A*z),t.height=Math.floor(X*z),te===!0&&(t.style.width=A+"px",t.style.height=X+"px"),this.setViewport(0,0,A,X)},this.getDrawingBufferSize=function(A){return A.set(re*z,he*z).floor()},this.setDrawingBufferSize=function(A,X,te){re=A,he=X,z=te,t.width=Math.floor(A*te),t.height=Math.floor(X*te),this.setViewport(0,0,A,X)},this.getCurrentViewport=function(A){return A.copy(B)},this.getViewport=function(A){return A.copy(N)},this.setViewport=function(A,X,te,$){A.isVector4?N.set(A.x,A.y,A.z,A.w):N.set(A,X,te,$),je.viewport(B.copy(N).multiplyScalar(z).round())},this.getScissor=function(A){return A.copy(ne)},this.setScissor=function(A,X,te,$){A.isVector4?ne.set(A.x,A.y,A.z,A.w):ne.set(A,X,te,$),je.scissor(ee.copy(ne).multiplyScalar(z).round())},this.getScissorTest=function(){return Oe},this.setScissorTest=function(A){je.setScissorTest(Oe=A)},this.setOpaqueSort=function(A){le=A},this.setTransparentSort=function(A){oe=A},this.getClearColor=function(A){return A.copy(_e.getClearColor())},this.setClearColor=function(){_e.setClearColor(...arguments)},this.getClearAlpha=function(){return _e.getClearAlpha()},this.setClearAlpha=function(){_e.setClearAlpha(...arguments)},this.clear=function(A=!0,X=!0,te=!0){let $=0;if(A){let j=!1;if(W!==null){const Me=W.texture.format;j=Me===wd||Me===Td||Me===Md}if(j){const Me=W.texture.type,Ue=Me===xi||Me===Qr||Me===Js||Me===ea||Me===Sd||Me===Ed,He=_e.getClearColor(),ze=_e.getClearAlpha(),ot=He.r,rt=He.g,We=He.b;Ue?(M[0]=ot,M[1]=rt,M[2]=We,M[3]=ze,F.clearBufferuiv(F.COLOR,0,M)):(w[0]=ot,w[1]=rt,w[2]=We,w[3]=ze,F.clearBufferiv(F.COLOR,0,w))}else $|=F.COLOR_BUFFER_BIT}X&&($|=F.DEPTH_BUFFER_BIT),te&&($|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),F.clear($)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Ie,!1),t.removeEventListener("webglcontextrestored",Ee,!1),t.removeEventListener("webglcontextcreationerror",pe,!1),_e.dispose(),Ye.dispose(),Ce.dispose(),qe.dispose(),It.dispose(),D.dispose(),fe.dispose(),st.dispose(),H.dispose(),me.dispose(),ve.dispose(),ve.removeEventListener("sessionstart",no),ve.removeEventListener("sessionend",Wi),yi.stop()};function Ie(A){A.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),G=!0}function Ee(){console.log("THREE.WebGLRenderer: Context Restored."),G=!1;const A=ht.autoReset,X=Ze.enabled,te=Ze.autoUpdate,$=Ze.needsUpdate,j=Ze.type;Le(),ht.autoReset=A,Ze.enabled=X,Ze.autoUpdate=te,Ze.needsUpdate=$,Ze.type=j}function pe(A){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function Ge(A){const X=A.target;X.removeEventListener("dispose",Ge),lt(X)}function lt(A){Pt(A),qe.remove(A)}function Pt(A){const X=qe.get(A).programs;X!==void 0&&(X.forEach(function(te){me.releaseProgram(te)}),A.isShaderMaterial&&me.releaseShaderCache(A))}this.renderBufferDirect=function(A,X,te,$,j,Me){X===null&&(X=At);const Ue=j.isMesh&&j.matrixWorld.determinant()<0,He=da(A,X,te,$,j);je.setMaterial($,Ue);let ze=te.index,ot=1;if($.wireframe===!0){if(ze=K.getWireframeAttribute(te),ze===void 0)return;ot=2}const rt=te.drawRange,We=te.attributes.position;let pt=rt.start*ot,ft=(rt.start+rt.count)*ot;Me!==null&&(pt=Math.max(pt,Me.start*ot),ft=Math.min(ft,(Me.start+Me.count)*ot)),ze!==null?(pt=Math.max(pt,0),ft=Math.min(ft,ze.count)):We!=null&&(pt=Math.max(pt,0),ft=Math.min(ft,We.count));const Bt=ft-pt;if(Bt<0||Bt===1/0)return;st.setup(j,$,He,te,ze);let Ut,Ct=it;if(ze!==null&&(Ut=T.get(ze),Ct=Je,Ct.setIndex(Ut)),j.isMesh)$.wireframe===!0?(je.setLineWidth($.wireframeLinewidth*ut()),Ct.setMode(F.LINES)):Ct.setMode(F.TRIANGLES);else if(j.isLine){let Qe=$.linewidth;Qe===void 0&&(Qe=1),je.setLineWidth(Qe*ut()),j.isLineSegments?Ct.setMode(F.LINES):j.isLineLoop?Ct.setMode(F.LINE_LOOP):Ct.setMode(F.LINE_STRIP)}else j.isPoints?Ct.setMode(F.POINTS):j.isSprite&&Ct.setMode(F.TRIANGLES);if(j.isBatchedMesh)if(j._multiDrawInstances!==null)jo("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Ct.renderMultiDrawInstances(j._multiDrawStarts,j._multiDrawCounts,j._multiDrawCount,j._multiDrawInstances);else if(_t.get("WEBGL_multi_draw"))Ct.renderMultiDraw(j._multiDrawStarts,j._multiDrawCounts,j._multiDrawCount);else{const Qe=j._multiDrawStarts,Lt=j._multiDrawCounts,mt=j._multiDrawCount,tn=ze?T.get(ze).bytesPerElement:1,ji=qe.get($).currentProgram.getUniforms();for(let Sn=0;Sn<mt;Sn++)ji.setValue(F,"_gl_DrawID",Sn),Ct.render(Qe[Sn]/tn,Lt[Sn])}else if(j.isInstancedMesh)Ct.renderInstances(pt,Bt,j.count);else if(te.isInstancedBufferGeometry){const Qe=te._maxInstanceCount!==void 0?te._maxInstanceCount:1/0,Lt=Math.min(te.instanceCount,Qe);Ct.renderInstances(pt,Bt,Lt)}else Ct.render(pt,Bt)};function yt(A,X,te){A.transparent===!0&&A.side===Oi&&A.forceSinglePass===!1?(A.side=Fn,A.needsUpdate=!0,io(A,X,te),A.side=Mr,A.needsUpdate=!0,io(A,X,te),A.side=Oi):io(A,X,te)}this.compile=function(A,X,te=null){te===null&&(te=A),_=Ce.get(te),_.init(X),P.push(_),te.traverseVisible(function(j){j.isLight&&j.layers.test(X.layers)&&(_.pushLight(j),j.castShadow&&_.pushShadow(j))}),A!==te&&A.traverseVisible(function(j){j.isLight&&j.layers.test(X.layers)&&(_.pushLight(j),j.castShadow&&_.pushShadow(j))}),_.setupLights();const $=new Set;return A.traverse(function(j){if(!(j.isMesh||j.isPoints||j.isLine||j.isSprite))return;const Me=j.material;if(Me)if(Array.isArray(Me))for(let Ue=0;Ue<Me.length;Ue++){const He=Me[Ue];yt(He,te,j),$.add(He)}else yt(Me,te,j),$.add(Me)}),_=P.pop(),$},this.compileAsync=function(A,X,te=null){const $=this.compile(A,X,te);return new Promise(j=>{function Me(){if($.forEach(function(Ue){qe.get(Ue).currentProgram.isReady()&&$.delete(Ue)}),$.size===0){j(A);return}setTimeout(Me,10)}_t.get("KHR_parallel_shader_compile")!==null?Me():setTimeout(Me,10)})};let Cn=null;function yn(A){Cn&&Cn(A)}function no(){yi.stop()}function Wi(){yi.start()}const yi=new pv;yi.setAnimationLoop(yn),typeof self<"u"&&yi.setContext(self),this.setAnimationLoop=function(A){Cn=A,ve.setAnimationLoop(A),A===null?yi.stop():yi.start()},ve.addEventListener("sessionstart",no),ve.addEventListener("sessionend",Wi),this.render=function(A,X){if(X!==void 0&&X.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(G===!0)return;if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),X.parent===null&&X.matrixWorldAutoUpdate===!0&&X.updateMatrixWorld(),ve.enabled===!0&&ve.isPresenting===!0&&(ve.cameraAutoUpdate===!0&&ve.updateCamera(X),X=ve.getCamera()),A.isScene===!0&&A.onBeforeRender(C,A,X,W),_=Ce.get(A,P.length),_.init(X),P.push(_),Ae.multiplyMatrices(X.projectionMatrix,X.matrixWorldInverse),Q.setFromProjectionMatrix(Ae),Te=this.localClippingEnabled,de=ke.init(this.clippingPlanes,Te),y=Ye.get(A,L.length),y.init(),L.push(y),ve.enabled===!0&&ve.isPresenting===!0){const Me=C.xr.getDepthSensingMesh();Me!==null&&Si(Me,X,-1/0,C.sortObjects)}Si(A,X,0,C.sortObjects),y.finish(),C.sortObjects===!0&&y.sort(le,oe),vt=ve.enabled===!1||ve.isPresenting===!1||ve.hasDepthSensing()===!1,vt&&_e.addToRenderList(y,A),this.info.render.frame++,de===!0&&ke.beginShadows();const te=_.state.shadowsArray;Ze.render(te,A,X),de===!0&&ke.endShadows(),this.info.autoReset===!0&&this.info.reset();const $=y.opaque,j=y.transmissive;if(_.setupLights(),X.isArrayCamera){const Me=X.cameras;if(j.length>0)for(let Ue=0,He=Me.length;Ue<He;Ue++){const ze=Me[Ue];Rr($,j,A,ze)}vt&&_e.render(A);for(let Ue=0,He=Me.length;Ue<He;Ue++){const ze=Me[Ue];Ar(y,A,ze,ze.viewport)}}else j.length>0&&Rr($,j,A,X),vt&&_e.render(A),Ar(y,A,X);W!==null&&I===0&&(nt.updateMultisampleRenderTarget(W),nt.updateRenderTargetMipmap(W)),A.isScene===!0&&A.onAfterRender(C,A,X),st.resetDefaultState(),b=-1,R=null,P.pop(),P.length>0?(_=P[P.length-1],de===!0&&ke.setGlobalState(C.clippingPlanes,_.state.camera)):_=null,L.pop(),L.length>0?y=L[L.length-1]:y=null};function Si(A,X,te,$){if(A.visible===!1)return;if(A.layers.test(X.layers)){if(A.isGroup)te=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(X);else if(A.isLight)_.pushLight(A),A.castShadow&&_.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||Q.intersectsSprite(A)){$&&De.setFromMatrixPosition(A.matrixWorld).applyMatrix4(Ae);const Ue=fe.update(A),He=A.material;He.visible&&y.push(A,Ue,He,te,De.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||Q.intersectsObject(A))){const Ue=fe.update(A),He=A.material;if($&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),De.copy(A.boundingSphere.center)):(Ue.boundingSphere===null&&Ue.computeBoundingSphere(),De.copy(Ue.boundingSphere.center)),De.applyMatrix4(A.matrixWorld).applyMatrix4(Ae)),Array.isArray(He)){const ze=Ue.groups;for(let ot=0,rt=ze.length;ot<rt;ot++){const We=ze[ot],pt=He[We.materialIndex];pt&&pt.visible&&y.push(A,Ue,pt,te,De.z,We)}}else He.visible&&y.push(A,Ue,He,te,De.z,null)}}const Me=A.children;for(let Ue=0,He=Me.length;Ue<He;Ue++)Si(Me[Ue],X,te,$)}function Ar(A,X,te,$){const j=A.opaque,Me=A.transmissive,Ue=A.transparent;_.setupLightsView(te),de===!0&&ke.setGlobalState(C.clippingPlanes,te),$&&je.viewport(B.copy($)),j.length>0&&Xi(j,X,te),Me.length>0&&Xi(Me,X,te),Ue.length>0&&Xi(Ue,X,te),je.buffers.depth.setTest(!0),je.buffers.depth.setMask(!0),je.buffers.color.setMask(!0),je.setPolygonOffset(!1)}function Rr(A,X,te,$){if((te.isScene===!0?te.overrideMaterial:null)!==null)return;_.state.transmissionRenderTarget[$.id]===void 0&&(_.state.transmissionRenderTarget[$.id]=new Jr(1,1,{generateMipmaps:!0,type:_t.has("EXT_color_buffer_half_float")||_t.has("EXT_color_buffer_float")?aa:xi,minFilter:Kr,samples:4,stencilBuffer:l,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:wt.workingColorSpace}));const Me=_.state.transmissionRenderTarget[$.id],Ue=$.viewport||B;Me.setSize(Ue.z*C.transmissionResolutionScale,Ue.w*C.transmissionResolutionScale);const He=C.getRenderTarget(),ze=C.getActiveCubeFace(),ot=C.getActiveMipmapLevel();C.setRenderTarget(Me),C.getClearColor(se),ce=C.getClearAlpha(),ce<1&&C.setClearColor(16777215,.5),C.clear(),vt&&_e.render(te);const rt=C.toneMapping;C.toneMapping=Hi;const We=$.viewport;if($.viewport!==void 0&&($.viewport=void 0),_.setupLightsView($),de===!0&&ke.setGlobalState(C.clippingPlanes,$),Xi(A,te,$),nt.updateMultisampleRenderTarget(Me),nt.updateRenderTargetMipmap(Me),_t.has("WEBGL_multisampled_render_to_texture")===!1){let pt=!1;for(let ft=0,Bt=X.length;ft<Bt;ft++){const Ut=X[ft],Ct=Ut.object,Qe=Ut.geometry,Lt=Ut.material,mt=Ut.group;if(Lt.side===Oi&&Ct.layers.test($.layers)){const tn=Lt.side;Lt.side=Fn,Lt.needsUpdate=!0,ca(Ct,te,$,Qe,Lt,mt),Lt.side=tn,Lt.needsUpdate=!0,pt=!0}}pt===!0&&(nt.updateMultisampleRenderTarget(Me),nt.updateRenderTargetMipmap(Me))}C.setRenderTarget(He,ze,ot),C.setClearColor(se,ce),We!==void 0&&($.viewport=We),C.toneMapping=rt}function Xi(A,X,te){const $=X.isScene===!0?X.overrideMaterial:null;for(let j=0,Me=A.length;j<Me;j++){const Ue=A[j],He=Ue.object,ze=Ue.geometry,ot=Ue.group;let rt=Ue.material;rt.allowOverride===!0&&$!==null&&(rt=$),He.layers.test(te.layers)&&ca(He,X,te,ze,rt,ot)}}function ca(A,X,te,$,j,Me){A.onBeforeRender(C,X,te,$,j,Me),A.modelViewMatrix.multiplyMatrices(te.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),j.onBeforeRender(C,X,te,$,A,Me),j.transparent===!0&&j.side===Oi&&j.forceSinglePass===!1?(j.side=Fn,j.needsUpdate=!0,C.renderBufferDirect(te,X,$,j,A,Me),j.side=Mr,j.needsUpdate=!0,C.renderBufferDirect(te,X,$,j,A,Me),j.side=Oi):C.renderBufferDirect(te,X,$,j,A,Me),A.onAfterRender(C,X,te,$,j,Me)}function io(A,X,te){X.isScene!==!0&&(X=At);const $=qe.get(A),j=_.state.lights,Me=_.state.shadowsArray,Ue=j.state.version,He=me.getParameters(A,j.state,Me,X,te),ze=me.getProgramCacheKey(He);let ot=$.programs;$.environment=A.isMeshStandardMaterial?X.environment:null,$.fog=X.fog,$.envMap=(A.isMeshStandardMaterial?D:It).get(A.envMap||$.environment),$.envMapRotation=$.environment!==null&&A.envMap===null?X.environmentRotation:A.envMapRotation,ot===void 0&&(A.addEventListener("dispose",Ge),ot=new Map,$.programs=ot);let rt=ot.get(ze);if(rt!==void 0){if($.currentProgram===rt&&$.lightsStateVersion===Ue)return ui(A,He),rt}else He.uniforms=me.getUniforms(A),A.onBeforeCompile(He,C),rt=me.acquireProgram(He,ze),ot.set(ze,rt),$.uniforms=He.uniforms;const We=$.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(We.clippingPlanes=ke.uniform),ui(A,He),$.needsLights=su(A),$.lightsStateVersion=Ue,$.needsLights&&(We.ambientLightColor.value=j.state.ambient,We.lightProbe.value=j.state.probe,We.directionalLights.value=j.state.directional,We.directionalLightShadows.value=j.state.directionalShadow,We.spotLights.value=j.state.spot,We.spotLightShadows.value=j.state.spotShadow,We.rectAreaLights.value=j.state.rectArea,We.ltc_1.value=j.state.rectAreaLTC1,We.ltc_2.value=j.state.rectAreaLTC2,We.pointLights.value=j.state.point,We.pointLightShadows.value=j.state.pointShadow,We.hemisphereLights.value=j.state.hemi,We.directionalShadowMap.value=j.state.directionalShadowMap,We.directionalShadowMatrix.value=j.state.directionalShadowMatrix,We.spotShadowMap.value=j.state.spotShadowMap,We.spotLightMatrix.value=j.state.spotLightMatrix,We.spotLightMap.value=j.state.spotLightMap,We.pointShadowMap.value=j.state.pointShadowMap,We.pointShadowMatrix.value=j.state.pointShadowMatrix),$.currentProgram=rt,$.uniformsList=null,rt}function fa(A){if(A.uniformsList===null){const X=A.currentProgram.getUniforms();A.uniformsList=Xl.seqWithValue(X.seq,A.uniforms)}return A.uniformsList}function ui(A,X){const te=qe.get(A);te.outputColorSpace=X.outputColorSpace,te.batching=X.batching,te.batchingColor=X.batchingColor,te.instancing=X.instancing,te.instancingColor=X.instancingColor,te.instancingMorph=X.instancingMorph,te.skinning=X.skinning,te.morphTargets=X.morphTargets,te.morphNormals=X.morphNormals,te.morphColors=X.morphColors,te.morphTargetsCount=X.morphTargetsCount,te.numClippingPlanes=X.numClippingPlanes,te.numIntersection=X.numClipIntersection,te.vertexAlphas=X.vertexAlphas,te.vertexTangents=X.vertexTangents,te.toneMapping=X.toneMapping}function da(A,X,te,$,j){X.isScene!==!0&&(X=At),nt.resetTextureUnits();const Me=X.fog,Ue=$.isMeshStandardMaterial?X.environment:null,He=W===null?C.outputColorSpace:W.isXRRenderTarget===!0?W.texture.colorSpace:es,ze=($.isMeshStandardMaterial?D:It).get($.envMap||Ue),ot=$.vertexColors===!0&&!!te.attributes.color&&te.attributes.color.itemSize===4,rt=!!te.attributes.tangent&&(!!$.normalMap||$.anisotropy>0),We=!!te.morphAttributes.position,pt=!!te.morphAttributes.normal,ft=!!te.morphAttributes.color;let Bt=Hi;$.toneMapped&&(W===null||W.isXRRenderTarget===!0)&&(Bt=C.toneMapping);const Ut=te.morphAttributes.position||te.morphAttributes.normal||te.morphAttributes.color,Ct=Ut!==void 0?Ut.length:0,Qe=qe.get($),Lt=_.state.lights;if(de===!0&&(Te===!0||A!==R)){const un=A===R&&$.id===b;ke.setState($,A,un)}let mt=!1;$.version===Qe.__version?(Qe.needsLights&&Qe.lightsStateVersion!==Lt.state.version||Qe.outputColorSpace!==He||j.isBatchedMesh&&Qe.batching===!1||!j.isBatchedMesh&&Qe.batching===!0||j.isBatchedMesh&&Qe.batchingColor===!0&&j.colorTexture===null||j.isBatchedMesh&&Qe.batchingColor===!1&&j.colorTexture!==null||j.isInstancedMesh&&Qe.instancing===!1||!j.isInstancedMesh&&Qe.instancing===!0||j.isSkinnedMesh&&Qe.skinning===!1||!j.isSkinnedMesh&&Qe.skinning===!0||j.isInstancedMesh&&Qe.instancingColor===!0&&j.instanceColor===null||j.isInstancedMesh&&Qe.instancingColor===!1&&j.instanceColor!==null||j.isInstancedMesh&&Qe.instancingMorph===!0&&j.morphTexture===null||j.isInstancedMesh&&Qe.instancingMorph===!1&&j.morphTexture!==null||Qe.envMap!==ze||$.fog===!0&&Qe.fog!==Me||Qe.numClippingPlanes!==void 0&&(Qe.numClippingPlanes!==ke.numPlanes||Qe.numIntersection!==ke.numIntersection)||Qe.vertexAlphas!==ot||Qe.vertexTangents!==rt||Qe.morphTargets!==We||Qe.morphNormals!==pt||Qe.morphColors!==ft||Qe.toneMapping!==Bt||Qe.morphTargetsCount!==Ct)&&(mt=!0):(mt=!0,Qe.__version=$.version);let tn=Qe.currentProgram;mt===!0&&(tn=io($,X,j));let ji=!1,Sn=!1,Ei=!1;const Nt=tn.getUniforms(),dn=Qe.uniforms;if(je.useProgram(tn.program)&&(ji=!0,Sn=!0,Ei=!0),$.id!==b&&(b=$.id,Sn=!0),ji||R!==A){je.buffers.depth.getReversed()?(ye.copy(A.projectionMatrix),Iy(ye),Fy(ye),Nt.setValue(F,"projectionMatrix",ye)):Nt.setValue(F,"projectionMatrix",A.projectionMatrix),Nt.setValue(F,"viewMatrix",A.matrixWorldInverse);const rn=Nt.map.cameraPosition;rn!==void 0&&rn.setValue(F,Re.setFromMatrixPosition(A.matrixWorld)),Mt.logarithmicDepthBuffer&&Nt.setValue(F,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),($.isMeshPhongMaterial||$.isMeshToonMaterial||$.isMeshLambertMaterial||$.isMeshBasicMaterial||$.isMeshStandardMaterial||$.isShaderMaterial)&&Nt.setValue(F,"isOrthographic",A.isOrthographicCamera===!0),R!==A&&(R=A,Sn=!0,Ei=!0)}if(j.isSkinnedMesh){Nt.setOptional(F,j,"bindMatrix"),Nt.setOptional(F,j,"bindMatrixInverse");const un=j.skeleton;un&&(un.boneTexture===null&&un.computeBoneTexture(),Nt.setValue(F,"boneTexture",un.boneTexture,nt))}j.isBatchedMesh&&(Nt.setOptional(F,j,"batchingTexture"),Nt.setValue(F,"batchingTexture",j._matricesTexture,nt),Nt.setOptional(F,j,"batchingIdTexture"),Nt.setValue(F,"batchingIdTexture",j._indirectTexture,nt),Nt.setOptional(F,j,"batchingColorTexture"),j._colorsTexture!==null&&Nt.setValue(F,"batchingColorTexture",j._colorsTexture,nt));const nn=te.morphAttributes;if((nn.position!==void 0||nn.normal!==void 0||nn.color!==void 0)&&Be.update(j,te,tn),(Sn||Qe.receiveShadow!==j.receiveShadow)&&(Qe.receiveShadow=j.receiveShadow,Nt.setValue(F,"receiveShadow",j.receiveShadow)),$.isMeshGouraudMaterial&&$.envMap!==null&&(dn.envMap.value=ze,dn.flipEnvMap.value=ze.isCubeTexture&&ze.isRenderTargetTexture===!1?-1:1),$.isMeshStandardMaterial&&$.envMap===null&&X.environment!==null&&(dn.envMapIntensity.value=X.environmentIntensity),Sn&&(Nt.setValue(F,"toneMappingExposure",C.toneMappingExposure),Qe.needsLights&&ha(dn,Ei),Me&&$.fog===!0&&ae.refreshFogUniforms(dn,Me),ae.refreshMaterialUniforms(dn,$,z,he,_.state.transmissionRenderTarget[A.id]),Xl.upload(F,fa(Qe),dn,nt)),$.isShaderMaterial&&$.uniformsNeedUpdate===!0&&(Xl.upload(F,fa(Qe),dn,nt),$.uniformsNeedUpdate=!1),$.isSpriteMaterial&&Nt.setValue(F,"center",j.center),Nt.setValue(F,"modelViewMatrix",j.modelViewMatrix),Nt.setValue(F,"normalMatrix",j.normalMatrix),Nt.setValue(F,"modelMatrix",j.matrixWorld),$.isShaderMaterial||$.isRawShaderMaterial){const un=$.uniformsGroups;for(let rn=0,St=un.length;rn<St;rn++){const ci=un[rn];H.update(ci,tn),H.bind(ci,tn)}}return tn}function ha(A,X){A.ambientLightColor.needsUpdate=X,A.lightProbe.needsUpdate=X,A.directionalLights.needsUpdate=X,A.directionalLightShadows.needsUpdate=X,A.pointLights.needsUpdate=X,A.pointLightShadows.needsUpdate=X,A.spotLights.needsUpdate=X,A.spotLightShadows.needsUpdate=X,A.rectAreaLights.needsUpdate=X,A.hemisphereLights.needsUpdate=X}function su(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return O},this.getActiveMipmapLevel=function(){return I},this.getRenderTarget=function(){return W},this.setRenderTargetTextures=function(A,X,te){const $=qe.get(A);$.__autoAllocateDepthBuffer=A.resolveDepthBuffer===!1,$.__autoAllocateDepthBuffer===!1&&($.__useRenderToTexture=!1),qe.get(A.texture).__webglTexture=X,qe.get(A.depthTexture).__webglTexture=$.__autoAllocateDepthBuffer?void 0:te,$.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(A,X){const te=qe.get(A);te.__webglFramebuffer=X,te.__useDefaultFramebuffer=X===void 0};const pa=F.createFramebuffer();this.setRenderTarget=function(A,X=0,te=0){W=A,O=X,I=te;let $=!0,j=null,Me=!1,Ue=!1;if(A){const ze=qe.get(A);if(ze.__useDefaultFramebuffer!==void 0)je.bindFramebuffer(F.FRAMEBUFFER,null),$=!1;else if(ze.__webglFramebuffer===void 0)nt.setupRenderTarget(A);else if(ze.__hasExternalTextures)nt.rebindTextures(A,qe.get(A.texture).__webglTexture,qe.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const We=A.depthTexture;if(ze.__boundDepthTexture!==We){if(We!==null&&qe.has(We)&&(A.width!==We.image.width||A.height!==We.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");nt.setupDepthRenderbuffer(A)}}const ot=A.texture;(ot.isData3DTexture||ot.isDataArrayTexture||ot.isCompressedArrayTexture)&&(Ue=!0);const rt=qe.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray(rt[X])?j=rt[X][te]:j=rt[X],Me=!0):A.samples>0&&nt.useMultisampledRTT(A)===!1?j=qe.get(A).__webglMultisampledFramebuffer:Array.isArray(rt)?j=rt[te]:j=rt,B.copy(A.viewport),ee.copy(A.scissor),q=A.scissorTest}else B.copy(N).multiplyScalar(z).floor(),ee.copy(ne).multiplyScalar(z).floor(),q=Oe;if(te!==0&&(j=pa),je.bindFramebuffer(F.FRAMEBUFFER,j)&&$&&je.drawBuffers(A,j),je.viewport(B),je.scissor(ee),je.setScissorTest(q),Me){const ze=qe.get(A.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+X,ze.__webglTexture,te)}else if(Ue){const ze=qe.get(A.texture),ot=X;F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,ze.__webglTexture,te,ot)}else if(A!==null&&te!==0){const ze=qe.get(A.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,ze.__webglTexture,te)}b=-1},this.readRenderTargetPixels=function(A,X,te,$,j,Me,Ue,He=0){if(!(A&&A.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ze=qe.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Ue!==void 0&&(ze=ze[Ue]),ze){je.bindFramebuffer(F.FRAMEBUFFER,ze);try{const ot=A.textures[He],rt=ot.format,We=ot.type;if(!Mt.textureFormatReadable(rt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Mt.textureTypeReadable(We)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}X>=0&&X<=A.width-$&&te>=0&&te<=A.height-j&&(A.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+He),F.readPixels(X,te,$,j,be.convert(rt),be.convert(We),Me))}finally{const ot=W!==null?qe.get(W).__webglFramebuffer:null;je.bindFramebuffer(F.FRAMEBUFFER,ot)}}},this.readRenderTargetPixelsAsync=async function(A,X,te,$,j,Me,Ue,He=0){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ze=qe.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Ue!==void 0&&(ze=ze[Ue]),ze)if(X>=0&&X<=A.width-$&&te>=0&&te<=A.height-j){je.bindFramebuffer(F.FRAMEBUFFER,ze);const ot=A.textures[He],rt=ot.format,We=ot.type;if(!Mt.textureFormatReadable(rt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Mt.textureTypeReadable(We))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const pt=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,pt),F.bufferData(F.PIXEL_PACK_BUFFER,Me.byteLength,F.STREAM_READ),A.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+He),F.readPixels(X,te,$,j,be.convert(rt),be.convert(We),0);const ft=W!==null?qe.get(W).__webglFramebuffer:null;je.bindFramebuffer(F.FRAMEBUFFER,ft);const Bt=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await Ny(F,Bt,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,pt),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,Me),F.deleteBuffer(pt),F.deleteSync(Bt),Me}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(A,X=null,te=0){const $=Math.pow(2,-te),j=Math.floor(A.image.width*$),Me=Math.floor(A.image.height*$),Ue=X!==null?X.x:0,He=X!==null?X.y:0;nt.setTexture2D(A,0),F.copyTexSubImage2D(F.TEXTURE_2D,te,0,0,Ue,He,j,Me),je.unbindTexture()};const ma=F.createFramebuffer(),ga=F.createFramebuffer();this.copyTextureToTexture=function(A,X,te=null,$=null,j=0,Me=null){Me===null&&(j!==0?(jo("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Me=j,j=0):Me=0);let Ue,He,ze,ot,rt,We,pt,ft,Bt;const Ut=A.isCompressedTexture?A.mipmaps[Me]:A.image;if(te!==null)Ue=te.max.x-te.min.x,He=te.max.y-te.min.y,ze=te.isBox3?te.max.z-te.min.z:1,ot=te.min.x,rt=te.min.y,We=te.isBox3?te.min.z:0;else{const nn=Math.pow(2,-j);Ue=Math.floor(Ut.width*nn),He=Math.floor(Ut.height*nn),A.isDataArrayTexture?ze=Ut.depth:A.isData3DTexture?ze=Math.floor(Ut.depth*nn):ze=1,ot=0,rt=0,We=0}$!==null?(pt=$.x,ft=$.y,Bt=$.z):(pt=0,ft=0,Bt=0);const Ct=be.convert(X.format),Qe=be.convert(X.type);let Lt;X.isData3DTexture?(nt.setTexture3D(X,0),Lt=F.TEXTURE_3D):X.isDataArrayTexture||X.isCompressedArrayTexture?(nt.setTexture2DArray(X,0),Lt=F.TEXTURE_2D_ARRAY):(nt.setTexture2D(X,0),Lt=F.TEXTURE_2D),F.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,X.flipY),F.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,X.premultiplyAlpha),F.pixelStorei(F.UNPACK_ALIGNMENT,X.unpackAlignment);const mt=F.getParameter(F.UNPACK_ROW_LENGTH),tn=F.getParameter(F.UNPACK_IMAGE_HEIGHT),ji=F.getParameter(F.UNPACK_SKIP_PIXELS),Sn=F.getParameter(F.UNPACK_SKIP_ROWS),Ei=F.getParameter(F.UNPACK_SKIP_IMAGES);F.pixelStorei(F.UNPACK_ROW_LENGTH,Ut.width),F.pixelStorei(F.UNPACK_IMAGE_HEIGHT,Ut.height),F.pixelStorei(F.UNPACK_SKIP_PIXELS,ot),F.pixelStorei(F.UNPACK_SKIP_ROWS,rt),F.pixelStorei(F.UNPACK_SKIP_IMAGES,We);const Nt=A.isDataArrayTexture||A.isData3DTexture,dn=X.isDataArrayTexture||X.isData3DTexture;if(A.isDepthTexture){const nn=qe.get(A),un=qe.get(X),rn=qe.get(nn.__renderTarget),St=qe.get(un.__renderTarget);je.bindFramebuffer(F.READ_FRAMEBUFFER,rn.__webglFramebuffer),je.bindFramebuffer(F.DRAW_FRAMEBUFFER,St.__webglFramebuffer);for(let ci=0;ci<ze;ci++)Nt&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,qe.get(A).__webglTexture,j,We+ci),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,qe.get(X).__webglTexture,Me,Bt+ci)),F.blitFramebuffer(ot,rt,Ue,He,pt,ft,Ue,He,F.DEPTH_BUFFER_BIT,F.NEAREST);je.bindFramebuffer(F.READ_FRAMEBUFFER,null),je.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(j!==0||A.isRenderTargetTexture||qe.has(A)){const nn=qe.get(A),un=qe.get(X);je.bindFramebuffer(F.READ_FRAMEBUFFER,ma),je.bindFramebuffer(F.DRAW_FRAMEBUFFER,ga);for(let rn=0;rn<ze;rn++)Nt?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,nn.__webglTexture,j,We+rn):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,nn.__webglTexture,j),dn?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,un.__webglTexture,Me,Bt+rn):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,un.__webglTexture,Me),j!==0?F.blitFramebuffer(ot,rt,Ue,He,pt,ft,Ue,He,F.COLOR_BUFFER_BIT,F.NEAREST):dn?F.copyTexSubImage3D(Lt,Me,pt,ft,Bt+rn,ot,rt,Ue,He):F.copyTexSubImage2D(Lt,Me,pt,ft,ot,rt,Ue,He);je.bindFramebuffer(F.READ_FRAMEBUFFER,null),je.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else dn?A.isDataTexture||A.isData3DTexture?F.texSubImage3D(Lt,Me,pt,ft,Bt,Ue,He,ze,Ct,Qe,Ut.data):X.isCompressedArrayTexture?F.compressedTexSubImage3D(Lt,Me,pt,ft,Bt,Ue,He,ze,Ct,Ut.data):F.texSubImage3D(Lt,Me,pt,ft,Bt,Ue,He,ze,Ct,Qe,Ut):A.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,Me,pt,ft,Ue,He,Ct,Qe,Ut.data):A.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,Me,pt,ft,Ut.width,Ut.height,Ct,Ut.data):F.texSubImage2D(F.TEXTURE_2D,Me,pt,ft,Ue,He,Ct,Qe,Ut);F.pixelStorei(F.UNPACK_ROW_LENGTH,mt),F.pixelStorei(F.UNPACK_IMAGE_HEIGHT,tn),F.pixelStorei(F.UNPACK_SKIP_PIXELS,ji),F.pixelStorei(F.UNPACK_SKIP_ROWS,Sn),F.pixelStorei(F.UNPACK_SKIP_IMAGES,Ei),Me===0&&X.generateMipmaps&&F.generateMipmap(Lt),je.unbindTexture()},this.copyTextureToTexture3D=function(A,X,te=null,$=null,j=0){return jo('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(A,X,te,$,j)},this.initRenderTarget=function(A){qe.get(A).__webglFramebuffer===void 0&&nt.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?nt.setTextureCube(A,0):A.isData3DTexture?nt.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?nt.setTexture2DArray(A,0):nt.setTexture2D(A,0),je.unbindTexture()},this.resetState=function(){O=0,I=0,W=null,je.reset(),st.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return zi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=wt._getDrawingBufferColorSpace(e),t.unpackColorSpace=wt._getUnpackColorSpace()}}const s1=-6,a1=6,l1=-10,u1=10,Bl=16,mg=-2,gg=2;function c1(r,e,t={}){const{armL:o,armR:a,legL:l,legR:c,armLOL:f,armROL:h,legLOL:p,legROL:g}=e,v=t.leftArmX??a1,x=t.rightArmX??s1,S=t.leftArmX!==void 0?t.leftArmX+4:u1,M=t.rightArmX!==void 0?t.rightArmX-4:l1;if(!(!o||!a||!l||!c)){if([o,a,l,c,f,h,p,g].forEach(w=>w?.rotation.set(0,0,0)),o.position.set(v,12,0),a.position.set(x,12,0),l.position.set(gg,0,0),c.position.set(mg,0,0),f?.position.set(v,12,0),h?.position.set(x,12,0),p?.position.set(gg,0,0),g?.position.set(mg,0,0),r==="tpose"){const w=Math.PI/2;o.position.set(S,Bl,0),a.position.set(M,Bl,0),o.rotation.z=w,a.rotation.z=-w,f?.position.set(S,Bl,0),h?.position.set(M,Bl,0),f?.rotation.set(0,0,w),h?.rotation.set(0,0,-w)}else if(r==="walking"){const w=-Math.PI/4,y=Math.PI/4,_=13;o.rotation.x=w,o.position.set(o.position.x,_,3),a.rotation.x=y,a.position.set(a.position.x,_,-3),l.rotation.x=y,l.position.set(l.position.x,1,-4),c.rotation.x=w,c.position.set(c.position.x,1,4),f&&(f.rotation.x=w,f.position.set(f.position.x,_,3)),h&&(h.rotation.x=y,h.position.set(h.position.x,_,-3)),p&&(p.rotation.x=y,p.position.set(p.position.x,1,-4)),g&&(g.rotation.x=w,g.position.set(g.position.x,1,4))}}}const Vo=64;function Kn(r,e,t,o,a,l,c,f,h={}){const{transparent:p=!1,expand:g=0,rotate180Faces:v=[],flipXFaces:x=[],flipYFaces:S=[]}=h,M=new Set(v),w=new Set(x),y=new Set(S),_=new os(e+g,t+g,o+g),L=[new _r({transparent:p,toneMapped:!1}),new _r({transparent:p,toneMapped:!1}),new _r({transparent:p,toneMapped:!1}),new _r({transparent:p,toneMapped:!1}),new _r({transparent:p,toneMapped:!1}),new _r({transparent:p,toneMapped:!1})],P=(I,W,b=!1,R=!1)=>{const B=r.clone(),ee=(W[2]-W[0])/Vo,q=(W[3]-W[1])/Vo,se=W[0]/Vo,ce=W[2]/Vo,re=1-W[1]/Vo,he=1-W[3]/Vo;B.magFilter=An,B.minFilter=An,B.wrapS=Qs,B.wrapT=Qs,B.repeat.set(b?-ee:ee,R?-q:q),B.offset.set(b?ce:se,R?re:he),B.needsUpdate=!0,I.map=B},C=I=>M.has(I)||w.has(I),G=I=>M.has(I)||y.has(I);P(L[0],f.right,C("right"),G("right")),P(L[1],f.left,C("left"),G("left")),P(L[2],f.top,C("top"),G("top")),P(L[3],f.bottom,C("bottom"),G("bottom")),P(L[4],f.front,C("front"),G("front")),P(L[5],f.back,C("back"),G("back"));const O=new vi(_,L);return O.position.set(a,l,c),O}const f1={left:[0,8,8,16],right:[16,8,24,16],top:[8,0,16,8],bottom:[16,0,24,8],front:[8,8,16,16],back:[24,8,32,16]},d1={right:[28,20,32,32],left:[16,20,20,32],top:[20,16,28,20],bottom:[28,16,36,20],front:[20,20,28,32],back:[32,20,40,32]},h1={left:[40,20,44,32],right:[48,20,52,32],top:[44,16,48,20],bottom:[48,16,52,20],front:[44,20,48,32],back:[52,20,56,32]},p1={left:[40,20,44,32],right:[47,20,51,32],top:[44,16,47,20],bottom:[47,16,50,20],front:[44,20,47,32],back:[51,20,54,32]},m1={left:[0,20,4,32],right:[8,20,12,32],top:[4,16,8,20],bottom:[8,16,12,20],front:[4,20,8,32],back:[12,20,16,32]},g1={left:[32,8,40,16],right:[48,8,56,16],top:[40,0,48,8],bottom:[48,0,56,8],front:[40,8,48,16],back:[56,8,64,16]},v1={right:[28,36,32,48],left:[16,36,20,48],top:[20,32,28,36],bottom:[28,32,36,36],front:[20,36,28,48],back:[32,36,40,48]},_1={left:[40,36,44,48],right:[48,36,52,48],top:[44,32,48,36],bottom:[48,32,52,36],front:[44,36,48,48],back:[52,36,56,48]},x1={left:[40,36,44,48],right:[47,36,51,48],top:[44,32,47,36],bottom:[47,32,50,36],front:[44,36,47,48],back:[51,36,54,48]},y1={left:[0,36,4,48],right:[8,36,12,48],top:[4,32,8,36],bottom:[8,32,12,36],front:[4,36,8,48],back:[12,36,16,48]},S1={left:[32,52,36,64],right:[40,52,44,64],top:[36,48,40,52],bottom:[40,48,44,52],front:[36,52,40,64],back:[44,52,48,64]},E1={left:[32,52,36,64],right:[39,52,43,64],top:[36,48,39,52],bottom:[39,48,42,52],front:[36,52,39,64],back:[43,52,46,64]},M1={left:[16,52,20,64],right:[24,52,28,64],top:[20,48,24,52],bottom:[24,48,28,52],front:[20,52,24,64],back:[28,52,32,64]},T1={left:[48,52,52,64],right:[56,52,60,64],top:[52,48,56,52],bottom:[56,48,60,52],front:[52,52,56,64],back:[60,52,64,64]},w1={left:[48,52,52,64],right:[55,52,59,64],top:[52,48,55,52],bottom:[55,48,58,52],front:[52,52,55,64],back:[59,52,62,64]},A1={left:[0,52,4,64],right:[8,52,12,64],top:[4,48,8,52],bottom:[8,48,12,52],front:[4,52,8,64],back:[12,52,16,64]},vg=()=>Math.min(window.devicePixelRatio||1,2),Sf=0,R1=44,C1=24,b1=72,P1=.04,L1=.5,_g=-6,xg=6,yg=-5.5,Sg=5.5,Eg=-2,Mg=2;function D1({texture:r,pose:e="default",model:t="classic",showOverlay:o=!0,autoRotate:a=!0,bottomOffset:l=0,style:c}){const f=ue.useRef(null),h=ue.useRef(),p=ue.useRef(),g=ue.useRef(),v=ue.useRef(0),x=ue.useRef(a),S=ue.useRef(R1),[M,w]=ue.useState(0),y=ue.useRef(null),_=ue.useRef(null),L=ue.useRef(null),P=ue.useRef(null),C=ue.useRef(null),G=ue.useRef(null),O=ue.useRef(null),I=ue.useRef(null),W=ue.useRef(null),b=ue.useRef(null),R=ue.useMemo(()=>[W,b,C,G,O,I],[]),B=ue.useCallback(ee=>{const q=t==="slim";c1(ee,{armL:y.current,armR:_.current,legL:L.current,legR:P.current,armLOL:C.current,armROL:G.current,legLOL:O.current,legROL:I.current},{leftArmX:q?Sg:xg,rightArmX:q?yg:_g})},[t]);return ue.useEffect(()=>{const ee=f.current;if(!ee)return;const q=ee.clientWidth||1,se=ee.clientHeight||1,ce=new o1({antialias:!1,alpha:!0});ce.setClearColor(0,0),ce.outputColorSpace=In,ce.toneMapping=Hi,ce.setPixelRatio(vg()),ce.setSize(q,se),ee.appendChild(ce.domElement),h.current=ce;const re=new Zn(52,q/se,.1,1e3);re.position.set(0,Sf,S.current),re.lookAt(0,Sf,0),p.current=re;const he=new lS;g.current=he;const z=new SS(16777215,1);z.position.set(10,10,10),he.add(z);const le=new Ws;le.position.y=-10,le.rotation.y=v.current,he.add(le);const oe=new vS,N=r??"/textures/steve.png",ne=Re=>{Re.magFilter=An,Re.minFilter=An,Re.generateMipmaps=!1,Re.colorSpace=In,Re.wrapS=ki,Re.wrapT=ki;const De=Kn(Re,8,8,8,0,22,0,f1,{flipYFaces:["bottom"]}),At=Kn(Re,8,12,4,0,12,0,d1),vt=t==="slim",ut=vt?3:4,F=vt?yg:_g,Yt=vt?Sg:xg,_t=vt?p1:h1,Mt=vt?E1:S1,je=vt?x1:_1,ht=vt?w1:T1,qe=Kn(Re,ut,12,4,F,12,0,_t),nt=Kn(Re,ut,12,4,Yt,12,0,Mt),It=Kn(Re,4,12,4,Eg,0,0,m1),D=Kn(Re,4,12,4,Mg,0,0,M1);_.current=qe,y.current=nt,P.current=It,L.current=D;const T=L1,K=Kn(Re,8,8,8,0,22,0,g1,{transparent:!0,expand:T,flipYFaces:["bottom"]}),fe=Kn(Re,8,12,4,0,12,0,v1,{transparent:!0,expand:T}),me=Kn(Re,ut,12,4,F,12,0,je,{transparent:!0,expand:T}),ae=Kn(Re,ut,12,4,Yt,12,0,ht,{transparent:!0,expand:T}),Ye=Kn(Re,4,12,4,Eg,0,0,y1,{transparent:!0,expand:T}),Ce=Kn(Re,4,12,4,Mg,0,0,A1,{transparent:!0,expand:T});W.current=K,b.current=fe,G.current=me,C.current=ae,I.current=Ye,O.current=Ce,le.add(De,At,qe,nt,It,D,K,fe,me,ae,Ye,Ce),R.forEach(ke=>{ke.current&&(ke.current.visible=o)}),B(e)},Oe=oe.load(N,ne,void 0,Re=>console.error("Texture load failed",Re));let Q;const de=()=>{Q=requestAnimationFrame(de),x.current&&(le.rotation.y+=.01),ce.render(he,re)};de();const Te=()=>{if(!ee||!h.current||!p.current)return;const Re=ee.clientWidth||1,De=ee.clientHeight||1;h.current.setPixelRatio(vg()),h.current.setSize(Re,De),p.current.aspect=Re/De,p.current.updateProjectionMatrix()},ye=new ResizeObserver(Te);ye.observe(ee),window.addEventListener("resize",Te),Te();const Ae=Re=>{Re.preventDefault();const De=Dy.clamp(S.current+Re.deltaY*P1,C1,b1);S.current=De,re.position.z=De,re.lookAt(0,Sf,0),re.updateProjectionMatrix()};return ee.addEventListener("wheel",Ae,{passive:!1}),()=>{ee.removeEventListener("wheel",Ae),window.removeEventListener("resize",Te),ye.disconnect(),cancelAnimationFrame(Q),v.current=le.rotation.y,g.current&&g.current.traverse(Re=>{const De=Re;De.geometry&&De.geometry.dispose(),(Array.isArray(De.material)?De.material:[De.material]).filter(Boolean).forEach(vt=>vt.dispose?.())}),Oe?.dispose?.(),ce.dispose(),ce.domElement.parentNode&&ce.domElement.parentNode.removeChild(ce.domElement),ee.innerHTML=""}},[r,B,e,o,R,t]),ue.useEffect(()=>{x.current=a},[a]),ue.useEffect(()=>{B(e)},[e,B]),ue.useEffect(()=>{R.forEach(ee=>{ee.current&&(ee.current.visible=o)})},[o,R]),ue.useEffect(()=>{const ee=()=>{const q=f.current?.getBoundingClientRect();if(!q)return;const ce=document.documentElement.clientHeight-q.top-l;w(ce>0?ce:0)};return ee(),window.addEventListener("resize",ee),()=>window.removeEventListener("resize",ee)},[l]),Pe.jsx("div",{ref:f,style:{width:"100%",minHeight:200,height:M?`${M}px`:"100%",position:"relative",touchAction:"none",...c??{}}})}const U1=r=>vd(tu,r);function xv({texture:r,model:e="classic",footerHeight:t=0,t:o=U1}){const[a,l]=ue.useState("default"),[c,f]=ue.useState(!0),[h,p]=ue.useState(!0),[g,v]=ue.useState(0),x=ue.useRef(null),S=()=>{l(_=>_==="default"?"tpose":_==="tpose"?"walking":"default")},M=()=>{f(_=>!_)},w=()=>{p(_=>!_)},y=()=>{if(!r)return;const _=document.createElement("a");_.href=r,_.download="skincrafter-skin.png",_.click()};return ue.useEffect(()=>{const _=()=>{const L=x.current?.offsetHeight??0;v(L+t)};return _(),window.addEventListener("resize",_),()=>window.removeEventListener("resize",_)},[t]),Pe.jsxs(_d,{title:o("panel.preview"),icon:"fa-eye",children:[Pe.jsx("div",{className:"bg-gray-800 shadow-lg overflow-hidden pixel-border flex-grow min-h-0 max-h-[70dvh] md:max-h-full",children:Pe.jsx("div",{className:"flex justify-center items-center model-placeholder md:h-full",children:Pe.jsx(D1,{texture:r,pose:a,model:e,showOverlay:c,autoRotate:h,bottomOffset:g})})}),Pe.jsxs("div",{ref:x,className:"mt-4 preview-actions",children:[Pe.jsx(Gs,{className:"bg-gray-200 hover:bg-gray-300",icon:"fa-arrows-rotate","aria-label":o("action.changePose"),onClick:S,children:o("action.changePose")}),Pe.jsx(Gs,{className:"bg-gray-200 hover:bg-gray-300",icon:"fa-layer-group","aria-label":o(c?"action.hideOverlay":"action.showOverlay"),onClick:M,children:o(c?"action.hideOverlay":"action.showOverlay")}),Pe.jsx(Gs,{className:"bg-gray-200 hover:bg-gray-300",icon:h?"fa-pause":"fa-play","aria-label":o(h?"action.disableAutoRotate":"action.enableAutoRotate"),onClick:w,children:o(h?"action.disableAutoRotate":"action.enableAutoRotate")}),Pe.jsx(Gs,{className:"bg-gray-200 hover:bg-gray-300 disabled:opacity-50 disabled:cursor-not-allowed",icon:"fa-download","aria-label":o("action.downloadSkin"),onClick:y,disabled:!r,children:o("action.download")})]})]})}function yv({left:r,right:e}){return Pe.jsxs("div",{className:"flex-1 min-h-0 flex flex-col md:flex-row",children:[Pe.jsx("div",{className:"flex-1 min-h-0 w-full md:w-1/2",children:r}),Pe.jsx("div",{className:"flex-1 min-h-0 w-full md:w-1/2",children:e})]})}const N1="modulepreload",I1=function(r){return"/"+r},Tg={},F1=function(e,t,o){let a=Promise.resolve();if(t&&t.length>0){let h=function(p){return Promise.all(p.map(g=>Promise.resolve(g).then(v=>({status:"fulfilled",value:v}),v=>({status:"rejected",reason:v}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),f=c?.nonce||c?.getAttribute("nonce");a=h(t.map(p=>{if(p=I1(p),p in Tg)return;Tg[p]=!0;const g=p.endsWith(".css"),v=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${v}`))return;const x=document.createElement("link");if(x.rel=g?"stylesheet":N1,g||(x.as="script"),x.crossOrigin="",x.href=p,f&&x.setAttribute("nonce",f),document.head.appendChild(x),g)return new Promise((S,M)=>{x.addEventListener("load",S),x.addEventListener("error",()=>M(new Error(`Unable to preload CSS for ${p}`)))})}))}function l(c){const f=new Event("vite:preloadError",{cancelable:!0});if(f.payload=c,window.dispatchEvent(f),!f.defaultPrevented)throw c}return a.then(c=>{for(const f of c||[])f.status==="rejected"&&l(f.reason);return e().catch(l)})};function hd({heading:r,icon:e,iconClassName:t="text-amber-600",className:o="",children:a,...l}){return Pe.jsxs("div",{className:`option-card bg-white shadow p-4 pixel-border relative ${r?"pt-5":""} ${o}`,...l,children:[r&&Pe.jsxs("h3",{className:"font-medium text-gray-800 mb-2 flex items-center absolute -top-3 left-4 px-2 bg-white z-10",children:[e&&Pe.jsx("i",{className:`fas ${e} mr-2 ${t}`}),r]}),a]})}const O1=["Human","Bear","Orc","Zombie"],Sv={Human:{Male:"/textures/race/human/male.png",Female:"/textures/race/human/female.png"},Bear:{Male:"/textures/race/bear/male.png"},Orc:{Male:"/textures/race/orc/male.png"},Zombie:{Male:"/textures/race/zombie/male.png"},Template:{None:"/textures/race/template/none.png"}};function Ev(r){return Object.keys(Sv[r])}function Mv(r,e){const t=Sv[r],o=Ev(r)[0];return t[e]??t[o]??""}const Tv={Human:["#D5BAAA","#E0AC69","#C68642"],Bear:["#5D4037","#8D6E63","#A1887F"],Orc:["#558B2F","#7CB342"],Zombie:["#556B2F"],Template:["#FFFFFF"]},k1=["None","Duck"],wv={None:null,Duck:"/textures/hat/duck.png"},B1=["None","Hoodie"],Av={None:null,Hoodie:"/textures/top/male/hoodie.png"},z1=["None","Pants"],Rv={None:null,Pants:"/textures/bottom/pants.png"},pd=[{id:"race",labelKey:"category.race",icon:"fa-user-tag",control:"choice"},{id:"sex",labelKey:"category.sex",icon:"fa-venus-mars",control:"choice"},{id:"skinColor",labelKey:"category.skinColor",icon:"fa-palette",control:"color"},{id:"eyes",labelKey:"category.eyes",icon:"fa-eye",control:"choice"},{id:"eyesColor",labelKey:"category.eyesColor",icon:"fa-eye-dropper",control:"color"},{id:"hair",labelKey:"category.hair",icon:"fa-scissors",control:"choice"},{id:"hairColor",labelKey:"category.hairColor",icon:"fa-fill-drip",control:"color"},{id:"hat",labelKey:"category.hat",icon:"fa-hat-cowboy",control:"choice"},{id:"shirt",labelKey:"category.shirt",icon:"fa-shirt",control:"choice"},{id:"pants",labelKey:"category.pants",icon:"fa-person",control:"choice"},{id:"shoes",labelKey:"category.shoes",icon:"fa-shoe-prints",control:"choice"},{id:"accessory",labelKey:"category.accessory",icon:"fa-gem",control:"choice"}],$o={race:"Human",sex:"Male",skinColor:Tv.Human[0],eyes:"Classic",eyesColor:"#2F5D9B",hair:"None",hairColor:"#4A2F20",hat:"None",shirt:"None",pants:"None",shoes:"None",accessory:"None"},Zl=["hat","shirt","pants","shoes","accessory"],$s={id:"None",labelKey:"option.none",texture:null},H1={id:"Male",labelKey:"option.sex.Male",texture:null},V1={id:"Female",labelKey:"option.sex.Female",texture:null},G1={Male:H1,Female:V1,None:$s},W1={race:O1.map(r=>({id:r,labelKey:`option.race.${r}`,texture:Mv(r,"Male")})),eyes:[{id:"Classic",labelKey:"option.eyes.Classic",texture:"/textures/eyes/clasic.png"},{id:"Small",labelKey:"option.eyes.Small",texture:"/textures/eyes/small.png"},{id:"Big",labelKey:"option.eyes.Big",texture:"/textures/eyes/big.png"}],eyesColor:[{id:"#2F5D9B",labelKey:"option.color.blue",color:"#2F5D9B"},{id:"#2F8F4E",labelKey:"option.color.green",color:"#2F8F4E"},{id:"#5B3A29",labelKey:"option.color.brown",color:"#5B3A29"}],hair:[$s],hairColor:[{id:"#4A2F20",labelKey:"option.color.brown",color:"#4A2F20"},{id:"#D6B15D",labelKey:"option.color.blond",color:"#D6B15D"},{id:"#1F1A17",labelKey:"option.color.black",color:"#1F1A17"}],hat:k1.map(r=>({id:r,labelKey:r==="None"?"option.none":`option.hat.${r}`,texture:wv[r]})),shirt:B1.map(r=>({id:r,labelKey:r==="None"?"option.none":`option.shirt.${r}`,texture:Av[r]})),pants:z1.map(r=>({id:r,labelKey:r==="None"?"option.none":`option.pants.${r}`,texture:Rv[r]})),shoes:[$s],accessory:[$s]};function qo(r,e){if(r==="sex"){const t=e.race;return Ev(t).map(o=>G1[o])}if(r==="skinColor"){const t=e.race;return Tv[t].map(o=>({id:o,labelKey:`option.skinColor.${o}`,color:o}))}return W1[r]??[$s]}function jl(r){const e={...$o,...r??{}};qo("race",e).map(a=>a.id).includes(e.race)||(e.race=$o.race);const o=qo("skinColor",e).map(a=>a.id);return o.includes(e.skinColor)||(e.skinColor=o[0]??$o.skinColor),pd.forEach(a=>{const l=qo(a.id,e).map(c=>c.id);l.includes(e[a.id])||(e[a.id]=l[0]??"None")}),e}function qs(r){const e=new Set(Zl),t=[];return(r??[]).forEach(o=>{if(e.has(o)){const a=o;t.includes(a)||t.push(a)}}),Zl.forEach(o=>{t.includes(o)||t.push(o)}),t}function X1(r,e=Zl){return["race","sex","eyes","hair",...qs(e)].map(o=>{if(o==="race"){const l=r.race;return{url:Mv(l,r.sex),tint:r.skinColor,blendMode:"multiply"}}if(o==="hat")return wv[r.hat];if(o==="shirt"){const l=Av[r.shirt];return l?{url:l,blendMode:"source-over"}:null}if(o==="pants"){const l=Rv[r.pants];return l?{url:l,blendMode:"source-over"}:null}if(o==="eyes"){const l=qo("eyes",r).find(c=>c.id===r.eyes);return l?.texture?{url:l.texture,tint:r.eyesColor,blendMode:"source-over",tintTarget:"nonWhite"}:null}return qo(o,r).find(l=>l.id===r[o])?.texture??null})}const Ef=r=>Zl.includes(r);function j1({appearance:r,textureLayerOrder:e,onAppearanceChange:t,onLayerOrderChange:o,t:a}){const l=ue.useRef(null),{fixedCategories:c,layerCategories:f}=ue.useMemo(()=>{const g=new Map(pd.map(S=>[S.id,S])),v=pd.filter(S=>!Ef(S.id)),x=e.map(S=>g.get(S)).filter(S=>!!S);return{fixedCategories:v,layerCategories:x}},[e]),h=(g,v)=>{const x=e.indexOf(g),S=x+v;if(x<0||S<0||S>=e.length)return;const M=[...e];[M[x],M[S]]=[M[S],M[x]],o(M)};ue.useEffect(()=>{const g=l.current;if(!g)return;let v=!1,x=null;const S=()=>Array.from(g.querySelectorAll("[data-layer-id]")).reduce((w,y)=>{const _=y.dataset.layerId;return Ef(_)&&w.push(_),w},[]);return(async()=>{const w=window;w.global??=window;const y=await F1(()=>import("./dragula-SHh7_YLN.js").then(L=>L.d),[]);if(v)return;const _=y.default([g],{accepts:(L,P)=>P===g,direction:"vertical",moves:(L,P,C)=>!!C?.closest(".layer-order-handle"),revertOnSpill:!0});_.on("drag",L=>{L.classList.add("is-dragging")}),_.on("dragend",L=>{L.classList.remove("is-dragging")}),_.on("drop",()=>{o(S())}),x=()=>_.destroy()})(),()=>{v=!0,x?.()}},[o]);const p=g=>{const v=qo(g.id,r),x=Ef(g.id)?g.id:null,S=x?e.indexOf(x):-1;return Pe.jsxs(hd,{heading:a(g.labelKey),icon:g.icon,className:`wardrobe-option-card p-2.5 pt-6 ${x?"layer-order-card":""}`,"data-layer-id":x??void 0,children:[x&&Pe.jsxs("div",{className:"layer-order-controls","aria-hidden":!1,children:[Pe.jsx("button",{type:"button",className:"layer-order-handle","aria-label":`${a("action.dragLayer")} ${a(g.labelKey)}`,title:a("action.dragLayer"),children:Pe.jsx("i",{className:"fas fa-grip-vertical","aria-hidden":"true"})}),Pe.jsx("button",{type:"button",className:"layer-order-nudge","aria-label":`${a("action.moveLayerUp")} ${a(g.labelKey)}`,title:a("action.moveLayerUp"),disabled:S<=0,onClick:()=>h(x,-1),children:Pe.jsx("i",{className:"fas fa-chevron-up","aria-hidden":"true"})}),Pe.jsx("button",{type:"button",className:"layer-order-nudge","aria-label":`${a("action.moveLayerDown")} ${a(g.labelKey)}`,title:a("action.moveLayerDown"),disabled:S>=e.length-1,onClick:()=>h(x,1),children:Pe.jsx("i",{className:"fas fa-chevron-down","aria-hidden":"true"})})]}),Pe.jsx("div",{className:g.control==="color"?"mt-2 flex flex-wrap gap-1.5":"mt-2 grid grid-cols-2 lg:grid-cols-3 gap-1.5",role:"group","aria-label":a(g.labelKey),children:v.map(M=>{const w=r[g.id]===M.id;return g.control==="color"?Pe.jsx("button",{type:"button",className:`color-option-swatch h-7 w-7 border pixel-border transition-transform hover:scale-105 ${w?"is-selected":""}`,style:{backgroundColor:M.color??M.id},"aria-label":a(M.labelKey),"aria-pressed":w,onClick:()=>t(g.id,M.id),children:w&&Pe.jsx("i",{className:"fas fa-check","aria-hidden":"true"})},M.id):Pe.jsx("button",{type:"button",className:`pixel-button min-h-8 px-2 py-1 border text-xs leading-tight transition-colors ${w?"bg-green-700 text-white":"bg-gray-100 hover:bg-gray-200 text-gray-800"}`,"aria-pressed":w,onClick:()=>t(g.id,M.id),children:a(M.labelKey)},M.id)})})]},g.id)};return Pe.jsx(_d,{title:a("panel.customization"),icon:"fa-sliders",className:"overflow-visible md:overflow-hidden customization-panel p-3",children:Pe.jsxs("div",{className:"space-y-1.5 options-container md:flex-1 md:min-h-0",children:[c.map(p),Pe.jsx("div",{ref:l,className:"layer-order-list space-y-1.5",children:f.map(p)})]})})}const wg=r=>r.replace(/^http:\/\//,"https://");async function Y1(r){const e=await fetch(`https://playerdb.co/api/player/minecraft/${encodeURIComponent(r)}`);if(!e.ok)throw new Error("User not found");const t=await e.json(),o=t.data?.player;if(!t.success||!o)throw new Error("User not found");if(o.skin_texture)return wg(o.skin_texture);const a=o.properties?.find(f=>f.name==="textures");if(!a)throw new Error("Skin texture not found");const c=JSON.parse(atob(a.value)).textures.SKIN?.url;if(!c)throw new Error("Skin texture not found");return wg(c)}const $1=()=>{const[r,e]=ue.useState(""),[t,o]=ue.useState(null),[a,l]=ue.useState(null),[c,f]=ue.useState(!1),h=ue.useCallback(g=>{e(g.target.value)},[]),p=ue.useCallback(async g=>{if(g.preventDefault(),!r.trim()){l("Please enter a username.");return}l(null),f(!0);try{const v=await Y1(r.trim());o(v)}catch(v){v instanceof Error?l(v.message):l("An unexpected error occurred."),o(null)}finally{f(!1)}},[r]);return Pe.jsx(Wg,{children:({footerHeight:g,t:v})=>Pe.jsx(yv,{left:Pe.jsx(xv,{texture:t,footerHeight:g,t:v}),right:Pe.jsx(_d,{title:v("panel.loadSkin"),icon:"fa-user",children:Pe.jsxs("div",{className:"space-y-4 options-container md:flex-1 md:min-h-0",children:[Pe.jsx(hd,{heading:v("skinView.player"),icon:"fa-id-card",children:Pe.jsxs("form",{onSubmit:p,className:"mt-4 flex flex-col gap-3",children:[Pe.jsx("input",{type:"text",value:r,onChange:h,placeholder:v("skinView.username"),"aria-label":v("skinView.username"),className:"w-full border px-3 py-2 pixel-border bg-gray-50 text-gray-800"}),Pe.jsx(Gs,{type:"submit",disabled:c,icon:"fa-cloud-arrow-down",className:"bg-green-700 hover:bg-green-800 disabled:opacity-50 disabled:cursor-not-allowed text-white",children:v(c?"action.loading":"action.loadSkin")})]})}),a&&Pe.jsx(hd,{className:"bg-red-50 text-red-700",children:a})]})})})})},Ag=64,q1=r=>r?typeof r=="string"?{url:r,blendMode:"source-over",tintTarget:"all"}:r.url?{url:r.url,tint:r.tint,blendMode:r.blendMode??"source-over",tintTarget:r.tintTarget??"all"}:null:null;function K1(r){const e=r.replace("#",""),t=e.length===3?e.split("").map(o=>`${o}${o}`).join(""):e;return{r:Number.parseInt(t.slice(0,2),16),g:Number.parseInt(t.slice(2,4),16),b:Number.parseInt(t.slice(4,6),16),a:255}}function Z1(r){return r.r>=250&&r.g>=250&&r.b>=250}function Q1(r,e){return r.a===0||Z1(r)?r:{r:e.r,g:e.g,b:e.b,a:r.a}}const J1=(r,e,t,o,a)=>{const l=document.createElement("canvas");l.width=o,l.height=a;const c=l.getContext("2d",{willReadFrequently:!0});if(!c){r.drawImage(e,0,0,o,a);return}c.imageSmoothingEnabled=!1,c.drawImage(e,0,0,o,a);const f=c.getImageData(0,0,o,a),h=K1(t);for(let p=0;p<f.data.length;p+=4){const g={r:f.data[p],g:f.data[p+1],b:f.data[p+2],a:f.data[p+3]},v=Q1(g,h);f.data[p]=v.r,f.data[p+1]=v.g,f.data[p+2]=v.b,f.data[p+3]=v.a}c.putImageData(f,0,0),r.drawImage(l,0,0)},eA=(r,e,t,o,a,l,c)=>{if(!t){r.drawImage(e,0,0,l,c);return}if(a==="nonWhite"){J1(r,e,t,l,c);return}const f=document.createElement("canvas");f.width=l,f.height=c;const h=f.getContext("2d",{willReadFrequently:!0});if(!h){r.drawImage(e,0,0,l,c);return}h.imageSmoothingEnabled=!1,h.drawImage(e,0,0,l,c),h.globalCompositeOperation=o,h.fillStyle=t,h.fillRect(0,0,f.width,f.height),h.globalCompositeOperation="destination-in",h.drawImage(e,0,0,l,c),r.drawImage(f,0,0)};async function tA(r){const e=r.map(q1).filter(c=>!!c),t=e.map(c=>c.url);if(t.length===0)return"";const o=await Promise.all(t.map(c=>new Promise((f,h)=>{const p=new Image;p.crossOrigin="anonymous",p.onload=()=>f(p),p.onerror=h,p.src=c}))),a=document.createElement("canvas");a.width=Ag,a.height=Ag;const l=a.getContext("2d",{willReadFrequently:!0});return l?(l.imageSmoothingEnabled=!1,o.forEach((c,f)=>{const h=e[f];eA(l,c,h.tint,h.blendMode,h.tintTarget,a.width,a.height)}),a.toDataURL("image/png")):""}const Cv="wardrobeAppearance",bv="wardrobeLayerOrder",nA=()=>{const r=localStorage.getItem(Cv);if(r)try{return jl(JSON.parse(r))}catch{return jl(null)}return jl({race:localStorage.getItem("wardrobeRace")??$o.race,skinColor:localStorage.getItem("wardrobeSkinColor")??$o.skinColor,hat:localStorage.getItem("wardrobeHat")??$o.hat})},iA=()=>{const r=localStorage.getItem(bv);if(!r)return qs(null);try{return qs(JSON.parse(r))}catch{return qs(null)}},rA=()=>{const[r,e]=ue.useState(()=>nA()),[t,o]=ue.useState(()=>iA()),[a,l]=ue.useState(null),c=ue.useCallback((p,g)=>{e(v=>jl({...v,[p]:g}))},[]),f=ue.useCallback(p=>{o(qs(p))},[]);ue.useEffect(()=>{localStorage.setItem(Cv,JSON.stringify(r))},[r]),ue.useEffect(()=>{localStorage.setItem(bv,JSON.stringify(t))},[t]);const h=ue.useMemo(()=>X1(r,t),[r,t]);return ue.useEffect(()=>{let p=!0;return tA(h).then(g=>{p&&l(g)}),()=>{p=!1}},[h]),Pe.jsx(Wg,{children:({footerHeight:p,t:g})=>Pe.jsx(yv,{left:Pe.jsx(xv,{texture:a,model:r.sex==="Female"?"slim":"classic",footerHeight:p,t:g}),right:Pe.jsx(j1,{appearance:r,textureLayerOrder:t,onAppearanceChange:c,onLayerOrderChange:f,t:g})})})},oA=()=>Pe.jsxs(lx,{children:[Pe.jsx(wf,{path:"/",element:Pe.jsx(rA,{})}),Pe.jsx(wf,{path:"/mcskinview",element:Pe.jsx($1,{})})]});_0.createRoot(document.getElementById("root")).render(Pe.jsx(gd.StrictMode,{children:Pe.jsx(gx,{children:Pe.jsx(oA,{})})}));export{sA as c,Rg as g};
