 ...
 */var Sp;function ev(){if(Sp)return mt;Sp=1;var s=Symbol.for("react.element"),e=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),a=Symbol.for("react.profiler"),u=Symbol.for("react.provider"),c=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),h=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),v=Symbol.iterator;function S(D){return D===null||typeof D!="object"?null:(D=v&&D[v]||D["@@iterator"],typeof D=="function"?D:null)}var y={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},T=Object.assign,R={};function x(D,ee,Ne){this.props=D,this.context=ee,this.refs=R,this.updater=Ne||y}x.prototype.isReactComponent={},x.prototype.setState=function(D,ee){if(typeof D!="object"&&typeof D!="function"&&D!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,D,ee,"setState")},x.prototype.forceUpdate=function(D){this.updater.enqueueForceUpdate(this,D,"forceUpdate")};function g(){}g.prototype=x.prototype;function N(D,ee,Ne){this.props=D,this.context=ee,this.refs=R,this.updater=Ne||y}var U=N.prototype=new g;U.constructor=N,T(U,x.prototype),U.isPureReactComponent=!0;var C=Array.isArray,G=Object.prototype.hasOwnProperty,H={current:null},I={key:!0,ref:!0,__self:!0,__source:!0};function X(D,ee,Ne){var Z,fe={},Ee=null,xe=null;if(ee!=null)for(Z in ee.ref!==void 0&&(xe=ee.ref),ee.key!==void 0&&(Ee=""+ee.key),ee)G.call(ee,Z)&&!I.hasOwnProperty(Z)&&(fe[Z]=ee[Z]);var we=arguments.length-2;if(we===1)fe.children=Ne;else if(1<we){for(var Ye=Array(we),ze=0;ze<we;ze++)Ye[ze]=arguments[ze+2];fe.children=Ye}if(D&&D.defaultProps)for(Z in we=D.defaultProps,we)fe[Z]===void 0&&(fe[Z]=we[Z]);return{$$typeof:s,type:D,key:Ee,ref:xe,props:fe,_owner:H.current}}function P(D,ee){return{$$typeof:s,type:D.type,key:ee,ref:D.ref,props:D.props,_owner:D._owner}}function A(D){return typeof D=="object"&&D!==null&&D.$$typeof===s}function B(D){var ee={"=":"=0",":":"=2"};return"$"+D.replace(/[=:]/g,function(Ne){return ee[Ne]})}var re=/\/+/g;function Q(D,ee){return typeof D=="object"&&D!==null&&D.key!=null?B(""+D.key):ee.toString(36)}function ue(D,ee,Ne,Z,fe){var Ee=typeof D;(Ee==="undefined"||Ee==="boolean")&&(D=null);var xe=!1;if(D===null)xe=!0;else switch(Ee){case"string":case"number":xe=!0;break;case"object":switch(D.$$typeof){case s:case e:xe=!0}}if(xe)return xe=D,fe=fe(xe),D=Z===""?"."+Q(xe,0):Z,C(fe)?(Ne="",D!=null&&(Ne=D.replace(re,"$&/")+"/"),ue(fe,ee,Ne,"",function(ze){return ze})):fe!=null&&(A(fe)&&(fe=P(fe,Ne+(!fe.key||xe&&xe.key===fe.key?"":(""+fe.key).replace(re,"$&/")+"/")+D)),ee.push(fe)),1;if(xe=0,Z=Z===""?".":Z+":",C(D))for(var we=0;we<D.length;we++){Ee=D[we];var Ye=Z+Q(Ee,we);xe+=ue(Ee,ee,Ne,Ye,fe)}else if(Ye=S(D),typeof Ye=="function")for(D=Ye.call(D),we=0;!(Ee=D.next()).done;)Ee=Ee.value,Ye=Z+Q(Ee,we++),xe+=ue(Ee,ee,Ne,Ye,fe);else if(Ee==="object")throw ee=String(D),Error("Objects are not valid as a React child (found: "+(ee==="[object Object]"?"object with keys {"+Object.keys(D).join(", ")+"}":ee)+"). If you meant to render a collection of children, use an array instead.");return xe}function de(D,ee,Ne){if(D==null)return D;var Z=[],fe=0;return ue(D,Z,"","",function(Ee){return ee.call(Ne,Ee,fe++)}),Z}function ae(D){if(D._status===-1){var ee=D._result;ee=ee(),ee.then(function(Ne){(D._status===0||D._status===-1)&&(D._status=1,D._result=Ne)},function(Ne){(D._status===0||D._status===-1)&&(D._status=2,D._result=Ne)}),D._status===-1&&(D._status=0,D._result=ee)}if(D._status===1)return D._result.default;throw D._result}var le={current:null},k={transition:null},se={ReactCurrentDispatcher:le,ReactCurrentBatchConfig:k,ReactCurrentOwner:H};function ie(){throw Error("act(...) is not supported in production builds of React.")}return mt.Children={map:de,forEach:function(D,ee,Ne){de(D,function(){ee.apply(this,arguments)},Ne)},count:function(D){var ee=0;return de(D,function(){ee++}),ee},toArray:function(D){return de(D,function(ee){return ee})||[]},only:function(D){if(!A(D))throw Error("React.Children.only expected to receive a single React element child.");return D}},mt.Component=x,mt.Fragment=n,mt.Profiler=a,mt.PureComponent=N,mt.StrictMode=r,mt.Suspense=h,mt.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=se,mt.act=ie,mt.cloneElement=function(D,ee,Ne){if(D==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+D+".");var Z=T({},D.props),fe=D.key,Ee=D.ref,xe=D._owner;if(ee!=null){if(ee.ref!==void 0&&(Ee=ee.ref,xe=H.current),ee.key!==void 0&&(fe=""+ee.key),D.type&&D.type.defaultProps)var we=D.type.defaultProps;for(Ye in ee)G.call(ee,Ye)&&!I.hasOwnProperty(Ye)&&(Z[Ye]=ee[Ye]===void 0&&we!==void 0?we[Ye]:ee[Ye])}var Ye=arguments.length-2;if(Ye===1)Z.children=Ne;else if(1<Ye){we=Array(Ye);for(var ze=0;ze<Ye;ze++)we[ze]=arguments[ze+2];Z.children=we}return{$$typeof:s,type:D.type,key:fe,ref:Ee,props:Z,_owner:xe}},mt.createContext=function(D){return D={$$typeof:c,_currentValue:D,_currentValue2:D,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},D.Provider={$$typeof:u,_context:D},D.Consumer=D},mt.createElement=X,mt.createFactory=function(D){var ee=X.bind(null,D);return ee.type=D,ee},mt.createRef=function(){return{current:null}},mt.forwardRef=function(D){return{$$typeof:d,render:D}},mt.isValidElement=A,mt.lazy=function(D){return{$$typeof:_,_payload:{_status:-1,_result:D},_init:ae}},mt.memo=function(D,ee){return{$$typeof:m,type:D,compare:ee===void 0?null:ee}},mt.startTransition=function(D){var ee=k.transition;k.transition={};try{D()}finally{k.transition=ee}},mt.unstable_act=ie,mt.useCallback=function(D,ee){return le.current.useCallback(D,ee)},mt.useContext=function(D){return le.current.useContext(D)},mt.useDebugValue=function(){},mt.useDeferredValue=function(D){return le.current.useDeferredValue(D)},mt.useEffect=function(D,ee){return le.current.useEffect(D,ee)},mt.useId=function(){return le.current.useId()},mt.useImperativeHandle=function(D,ee,Ne){return le.current.useImperativeHandle(D,ee,Ne)},mt.useInsertionEffect=function(D,ee){return le.current.useInsertionEffect(D,ee)},mt.useLayoutEffect=function(D,ee){return le.current.useLayoutEffect(D,ee)},mt.useMemo=function(D,ee){return le.current.useMemo(D,ee)},mt.useReducer=function(D,ee,Ne){return le.current.useReducer(D,ee,Ne)},mt.useRef=function(D){return le.current.useRef(D)},mt.useState=function(D){return le.current.useState(D)},mt.useSyncExternalStore=function(D,ee,Ne){return le.current.useSyncExternalStore(D,ee,Ne)},mt.useTransition=function(){return le.current.useTransition()},mt.version="18.3.1",mt}var yp;function zf(){return yp||(yp=1,pc.exports=ev()),pc.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Tp;function rv(){return Tp||(Tp=1,function(s){function e(k,se){var ie=k.length;k.push(se);e:for(;0<ie;){var D=ie-1>>>1,ee=k[D];if(0<a(ee,se))k[D]=se,k[ie]=ee,ie=D;else break e}}function n(k){return k.length===0?null:k[0]}function r(k){if(k.length===0)return null;var se=k[0],ie=k.pop();if(ie!==se){k[0]=ie;e:for(var D=0,ee=k.length,Ne=ee>>>1;D<Ne;){var Z=2*(D+1)-1,fe=k[Z],Ee=Z+1,xe=k[Ee];if(0>a(fe,ie))Ee<ee&&0>a(xe,fe)?(k[D]=xe,k[Ee]=ie,D=Ee):(k[D]=fe,k[Z]=ie,D=Z);else if(Ee<ee&&0>a(xe,ie))k[D]=xe,k[Ee]=ie,D=Ee;else break e}}return se}function a(k,se){var ie=k.sortIndex-se.sortIndex;return ie!==0?ie:k.id-se.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;s.unstable_now=function(){return u.now()}}else{var c=Date,d=c.now();s.unstable_now=function(){return c.now()-d}}var h=[],m=[],_=1,v=null,S=3,y=!1,T=!1,R=!1,x=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,N=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function U(k){for(var se=n(m);se!==null;){if(se.callback===null)r(m);else if(se.startTime<=k)r(m),se.sortIndex=se.expirationTime,e(h,se);else break;se=n(m)}}function C(k){if(R=!1,U(k),!T)if(n(h)!==null)T=!0,ae(G);else{var se=n(m);se!==null&&le(C,se.startTime-k)}}function G(k,se){T=!1,R&&(R=!1,g(X),X=-1),y=!0;var ie=S;try{for(U(se),v=n(h);v!==null&&(!(v.expirationTime>se)||k&&!B());){var D=v.callback;if(typeof D=="function"){v.callback=null,S=v.priorityLevel;var ee=D(v.expirationTime<=se);se=s.unstable_now(),typeof ee=="function"?v.callback=ee:v===n(h)&&r(h),U(se)}else r(h);v=n(h)}if(v!==null)var Ne=!0;else{var Z=n(m);Z!==null&&le(C,Z.startTime-se),Ne=!1}return Ne}finally{v=null,S=ie,y=!1}}var H=!1,I=null,X=-1,P=5,A=-1;function B(){return!(s.unstable_now()-A<P)}function re(){if(I!==null){var k=s.unstable_now();A=k;var se=!0;try{se=I(!0,k)}finally{se?Q():(H=!1,I=null)}}else H=!1}var Q;if(typeof N=="function")Q=function(){N(re)};else if(typeof MessageChannel<"u"){var ue=new MessageChannel,de=ue.port2;ue.port1.onmessage=re,Q=function(){de.postMessage(null)}}else Q=function(){x(re,0)};function ae(k){I=k,H||(H=!0,Q())}function le(k,se){X=x(function(){k(s.unstable_now())},se)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(k){k.callback=null},s.unstable_continueExecution=function(){T||y||(T=!0,ae(G))},s.unstable_forceFrameRate=function(k){0>k||125<k?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):P=0<k?Math.floor(1e3/k):5},s.unstable_getCurrentPriorityLevel=function(){return S},s.unstable_getFirstCallbackNode=function(){return n(h)},s.unstable_next=function(k){switch(S){case 1:case 2:case 3:var se=3;break;default:se=S}var ie=S;S=se;try{return k()}finally{S=ie}},s.unstable_pauseExecution=function(){},s.unstable_requestPaint=function(){},s.unstable_runWithPriority=function(k,se){switch(k){case 1:case 2:case 3:case 4:case 5:break;default:k=3}var ie=S;S=k;try{return se()}finally{S=ie}},s.unstable_scheduleCallback=function(k,se,ie){var D=s.unstable_now();switch(typeof ie=="object"&&ie!==null?(ie=ie.delay,ie=typeof ie=="number"&&0<ie?D+ie:D):ie=D,k){case 1:var ee=-1;break;case 2:ee=250;break;case 5:ee=1073741823;break;case 4:ee=1e4;break;default:ee=5e3}return ee=ie+ee,k={id:_++,callback:se,priorityLevel:k,startTime:ie,expirationTime:ee,sortIndex:-1},ie>D?(k.sortIndex=ie,e(m,k),n(h)===null&&k===n(m)&&(R?(g(X),X=-1):R=!0,le(C,ie-D))):(k.sortIndex=ee,e(h,k),T||y||(T=!0,ae(G))),k},s.unstable_shouldYield=B,s.unstable_wrapCallback=function(k){var se=S;return function(){var ie=S;S=se;try{return k.apply(this,arguments)}finally{S=ie}}}}(_c)),_c}var wp;function sv(){return wp||(wp=1,gc.exports=rv()),gc.exports}/**
 * @license React
...
`].filter(Io).join(`
`)),c=Bf(c),c=wm(c,n),c=Am(c,n),d=Bf(d),d=wm(d,n),d=Am(d,n),c=Rm(c),d=Rm(d),n.isRawShaderMaterial!==!0&&(N=`#version 300 es
...
`)+`
`+g);const U=N+x+c,C=N+g+d,G=Mm(a,a.VERTEX_SHADER,U),H=Mm(a,a.FRAGMENT_SHADER,C);a.attachShader(R,G),a.attachShader(R,H),n.index0AttributeName!==void 0?a.bindAttribLocation(R,0,n.index0AttributeName):n.morphTargets===!0&&a.bindAttribLocation(R,0,"position"),a.linkProgram(R);function I(B){if(s.debug.checkShaderErrors){const re=a.getProgramInfoLog(R).trim(),Q=a.getShaderInfoLog(G).trim(),ue=a.getShaderInfoLog(H).trim();let de=!0,ae=!0;if(a.getProgramParameter(R,a.LINK_STATUS)===!1)if(de=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(a,R,G,H);else{const le=Tm(a,G,"vertex"),k=Tm(a,H,"fragment");console.error("THREE.WebGLProgram: Shader Error "+a.getError()+" - VALIDATE_STATUS "+a.getProgramParameter(R,a.VALIDATE_STATUS)+`
...
Program Info Log: `+re+`
`+le+`
`+k)}else re!==""?console.warn("THREE.WebGLProgram: Program Info Log:",re):(Q===""||ue==="")&&(ae=!1);ae&&(B.diagnostics={runnable:de,programLog:re,vertexShader:{log:Q,prefix:x},fragmentShader:{log:ue,prefix:g}})}a.deleteShader(G),a.deleteShader(H),X=new Cl(a,R),P=JM(a,R)}let X;this.getUniforms=function(){return X===void 0&&I(this),X};let P;this.getAttributes=function(){return P===void 0&&I(this),P};let A=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return A===!1&&(A=a.getProgramParameter(R,WM)),A},this.destroy=function(){r.releaseStatesOfProgram(this),a.deleteProgram(R),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=XM++,this.cacheKey=e,this.usedTimes=1,this.program=R,this.vertexShader=G,this.fragmentShader=H,this}let fE=0;class dE{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const n=e.vertexShader,r=e.fragmentShader,a=this._getShaderStage(n),u=this._getShaderStage(r),c=this._getShaderCacheForMaterial(e);return c.has(a)===!1&&(c.add(a),a.usedTimes++),c.has(u)===!1&&(c.add(u),u.usedTimes++),this}remove(e){const n=this.materialCache.get(e);for(const r of n)r.usedTimes--,r.usedTimes===0&&this.shaderCache.delete(r.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const n=this.materialCache;let r=n.get(e);return r===void 0&&(r=new Set,n.set(e,r)),r}_getShaderStage(e){const n=this.shaderCache;let r=n.get(e);return r===void 0&&(r=new hE(e),n.set(e,r)),r}}class hE{constructor(e){this.id=fE++,this.code=e,this.usedTimes=0}}function pE(s,e,n,r,a,u,c){const d=new eg,h=new dE,m=new Set,_=[],v=a.logarithmicDepthBuffer,S=a.vertexTextures;let y=a.precision;const T={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function R(P){return m.add(P),P===0?"uv":`uv${P}`}function x(P,A,B,re,Q){const ue=re.fog,de=Q.geometry,ae=P.isMeshStandardMaterial?re.environment:null,le=(P.isMeshStandardMaterial?n:e).get(P.envMap||ae),k=le&&le.mapping===Dl?le.image.height:null,se=T[P.type];P.precision!==null&&(y=a.getMaxPrecision(P.precision),y!==P.precision&&console.warn("THREE.WebGLProgram.getParameters:",P.precision,"not supported, using",y,"instead."));const ie=de.morphAttributes.position||de.morphAttributes.normal||de.morphAttributes.color,D=ie!==void 0?ie.length:0;let ee=0;de.morphAttributes.position!==void 0&&(ee=1),de.morphAttributes.normal!==void 0&&(ee=2),de.morphAttributes.color!==void 0&&(ee=3);let Ne,Z,fe,Ee;if(se){const xt=pi[se];Ne=xt.vertexShader,Z=xt.fragmentShader}else Ne=P.vertexShader,Z=P.fragmentShader,h.update(P),fe=h.getVertexShaderID(P),Ee=h.getFragmentShaderID(P);const xe=s.getRenderTarget(),we=s.state.buffers.depth.getReversed(),Ye=Q.isInstancedMesh===!0,ze=Q.isBatchedMesh===!0,Tt=!!P.map,Rt=!!P.matcap,dt=!!le,F=!!P.aoMap,Jt=!!P.lightMap,vt=!!P.bumpMap,wt=!!P.normalMap,Xe=!!P.displacementMap,gt=!!P.emissiveMap,Ze=!!P.metalnessMap,ot=!!P.roughnessMap,zt=P.anisotropy>0,b=P.clearcoat>0,E=P.dispersion>0,K=P.iridescence>0,ce=P.sheen>0,pe=P.transmission>0,oe=zt&&!!P.anisotropyMap,qe=b&&!!P.clearcoatMap,Ae=b&&!!P.clearcoatNormalMap,Be=b&&!!P.clearcoatRoughnessMap,$e=K&&!!P.iridescenceMap,_e=K&&!!P.iridescenceThicknessMap,Ie=ce&&!!P.sheenColorMap,nt=ce&&!!P.sheenRoughnessMap,Je=!!P.specularMap,Re=!!P.specularColorMap,st=!!P.specularIntensityMap,z=pe&&!!P.transmissionMap,Pe=pe&&!!P.thicknessMap,ge=!!P.gradientMap,De=!!P.alphaMap,ye=P.alphaTest>0,he=!!P.alphaHash,He=!!P.extensions;let lt=vr;P.toneMapped&&(xe===null||xe.isXRRenderTarget===!0)&&(lt=s.toneMapping);const bt={shaderID:se,shaderType:P.type,shaderName:P.name,vertexShader:Ne,fragmentShader:Z,defines:P.defines,customVertexShaderID:fe,customFragmentShaderID:Ee,isRawShaderMaterial:P.isRawShaderMaterial===!0,glslVersion:P.glslVersion,precision:y,batching:ze,batchingColor:ze&&Q._colorsTexture!==null,instancing:Ye,instancingColor:Ye&&Q.instanceColor!==null,instancingMorph:Ye&&Q.morphTexture!==null,supportsVertexTextures:S,outputColorSpace:xe===null?s.outputColorSpace:xe.isXRRenderTarget===!0?xe.texture.colorSpace:Ws,alphaToCoverage:!!P.alphaToCoverage,map:Tt,matcap:Rt,envMap:dt,envMapMode:dt&&le.mapping,envMapCubeUVHeight:k,aoMap:F,lightMap:Jt,bumpMap:vt,normalMap:wt,displacementMap:S&&Xe,emissiveMap:gt,normalMapObjectSpace:wt&&P.normalMapType===i0,normalMapTangentSpace:wt&&P.normalMapType===n0,metalnessMap:Ze,roughnessMap:ot,anisotropy:zt,anisotropyMap:oe,clearcoat:b,clearcoatMap:qe,clearcoatNormalMap:Ae,clearcoatRoughnessMap:Be,dispersion:E,iridescence:K,iridescenceMap:$e,iridescenceThicknessMap:_e,sheen:ce,sheenColorMap:Ie,sheenRoughnessMap:nt,specularMap:Je,specularColorMap:Re,specularIntensityMap:st,transmission:pe,transmissionMap:z,thicknessMap:Pe,gradientMap:ge,opaque:P.transparent===!1&&P.blending===ks&&P.alphaToCoverage===!1,alphaMap:De,alphaTest:ye,alphaHash:he,combine:P.combine,mapUv:Tt&&R(P.map.channel),aoMapUv:F&&R(P.aoMap.channel),lightMapUv:Jt&&R(P.lightMap.channel),bumpMapUv:vt&&R(P.bumpMap.channel),normalMapUv:wt&&R(P.normalMap.channel),displacementMapUv:Xe&&R(P.displacementMap.channel),emissiveMapUv:gt&&R(P.emissiveMap.channel),metalnessMapUv:Ze&&R(P.metalnessMap.channel),roughnessMapUv:ot&&R(P.roughnessMap.channel),anisotropyMapUv:oe&&R(P.anisotropyMap.channel),clearcoatMapUv:qe&&R(P.clearcoatMap.channel),clearcoatNormalMapUv:Ae&&R(P.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Be&&R(P.clearcoatRoughnessMap.channel),iridescenceMapUv:$e&&R(P.iridescenceMap.channel),iridescenceThicknessMapUv:_e&&R(P.iridescenceThicknessMap.channel),sheenColorMapUv:Ie&&R(P.sheenColorMap.channel),sheenRoughnessMapUv:nt&&R(P.sheenRoughnessMap.channel),specularMapUv:Je&&R(P.specularMap.channel),specularColorMapUv:Re&&R(P.specularColorMap.channel),specularIntensityMapUv:st&&R(P.specularIntensityMap.channel),transmissionMapUv:z&&R(P.transmissionMap.channel),thicknessMapUv:Pe&&R(P.thicknessMap.channel),alphaMapUv:De&&R(P.alphaMap.channel),vertexTangents:!!de.attributes.tangent&&(wt||zt),vertexColors:P.vertexColors,vertexAlphas:P.vertexColors===!0&&!!de.attributes.color&&de.attributes.color.itemSize===4,pointsUvs:Q.isPoints===!0&&!!de.attributes.uv&&(Tt||De),fog:!!ue,useFog:P.fog===!0,fogExp2:!!ue&&ue.isFogExp2,flatShading:P.flatShading===!0&&P.wireframe===!1,sizeAttenuation:P.sizeAttenuation===!0,logarithmicDepthBuffer:v,reverseDepthBuffer:we,skinning:Q.isSkinnedMesh===!0,morphTargets:de.morphAttributes.position!==void 0,morphNormals:de.morphAttributes.normal!==void 0,morphColors:de.morphAttributes.color!==void 0,morphTargetsCount:D,morphTextureStride:ee,numDirLights:A.directional.length,numPointLights:A.point.length,numSpotLights:A.spot.length,numSpotLightMaps:A.spotLightMap.length,numRectAreaLights:A.rectArea.length,numHemiLights:A.hemi.length,numDirLightShadows:A.directionalShadowMap.length,numPointLightShadows:A.pointShadowMap.length,numSpotLightShadows:A.spotShadowMap.length,numSpotLightShadowsWithMaps:A.numSpotLightShadowsWithMaps,numLightProbes:A.numLightProbes,numClippingPlanes:c.numPlanes,numClipIntersection:c.numIntersection,dithering:P.dithering,shadowMapEnabled:s.shadowMap.enabled&&B.length>0,shadowMapType:s.shadowMap.type,toneMapping:lt,decodeVideoTexture:Tt&&P.map.isVideoTexture===!0&&Et.getTransfer(P.map.colorSpace)===Dt,decodeVideoTextureEmissive:gt&&P.emissiveMap.isVideoTexture===!0&&Et.getTransfer(P.emissiveMap.colorSpace)===Dt,premultipliedAlpha:P.premultipliedAlpha,doubleSided:P.side===Fi,flipSided:P.side===Nn,useDepthPacking:P.depthPacking>=0,depthPacking:P.depthPacking||0,index0AttributeName:P.index0AttributeName,extensionClipCullDistance:He&&P.extensions.clipCullDistance===!0&&r.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(He&&P.extensions.multiDraw===!0||ze)&&r.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:r.has("KHR_parallel_shader_compile"),customProgramCacheKey:P.customProgramCacheKey()};return bt.vertexUv1s=m.has(1),bt.vertexUv2s=m.has(2),bt.vertexUv3s=m.has(3),m.clear(),bt}function g(P){const A=[];if(P.shaderID?A.push(P.shaderID):(A.push(P.customVertexShaderID),A.push(P.customFragmentShaderID)),P.defines!==void 0)for(const B in P.defines)A.push(B),A.push(P.defines[B]);return P.isRawShaderMaterial===!1&&(N(A,P),U(A,P),A.push(s.outputColorSpace)),A.push(P.customProgramCacheKey),A.join()}function N(P,A){P.push(A.precision),P.push(A.outputColorSpace),P.push(A.envMapMode),P.push(A.envMapCubeUVHeight),P.push(A.mapUv),P.push(A.alphaMapUv),P.push(A.lightMapUv),P.push(A.aoMapUv),P.push(A.bumpMapUv),P.push(A.normalMapUv),P.push(A.displacementMapUv),P.push(A.emissiveMapUv),P.push(A.metalnessMapUv),P.push(A.roughnessMapUv),P.push(A.anisotropyMapUv),P.push(A.clearcoatMapUv),P.push(A.clearcoatNormalMapUv),P.push(A.clearcoatRoughnessMapUv),P.push(A.iridescenceMapUv),P.push(A.iridescenceThicknessMapUv),P.push(A.sheenColorMapUv),P.push(A.sheenRoughnessMapUv),P.push(A.specularMapUv),P.push(A.specularColorMapUv),P.push(A.specularIntensityMapUv),P.push(A.transmissionMapUv),P.push(A.thicknessMapUv),P.push(A.combine),P.push(A.fogExp2),P.push(A.sizeAttenuation),P.push(A.morphTargetsCount),P.push(A.morphAttributeCount),P.push(A.numDirLights),P.push(A.numPointLights),P.push(A.numSpotLights),P.push(A.numSpotLightMaps),P.push(A.numHemiLights),P.push(A.numRectAreaLights),P.push(A.numDirLightShadows),P.push(A.numPointLightShadows),P.push(A.numSpotLightShadows),P.push(A.numSpotLightShadowsWithMaps),P.push(A.numLightProbes),P.push(A.shadowMapType),P.push(A.toneMapping),P.push(A.numClippingPlanes),P.push(A.numClipIntersection),P.push(A.depthPacking)}function U(P,A){d.disableAll(),A.supportsVertexTextures&&d.enable(0),A.instancing&&d.enable(1),A.instancingColor&&d.enable(2),A.instancingMorph&&d.enable(3),A.matcap&&d.enable(4),A.envMap&&d.enable(5),A.normalMapObjectSpace&&d.enable(6),A.normalMapTangentSpace&&d.enable(7),A.clearcoat&&d.enable(8),A.iridescence&&d.enable(9),A.alphaTest&&d.enable(10),A.vertexColors&&d.enable(11),A.vertexAlphas&&d.enable(12),A.vertexUv1s&&d.enable(13),A.vertexUv2s&&d.enable(14),A.vertexUv3s&&d.enable(15),A.vertexTangents&&d.enable(16),A.anisotropy&&d.enable(17),A.alphaHash&&d.enable(18),A.batching&&d.enable(19),A.dispersion&&d.enable(20),A.batchingColor&&d.enable(21),A.gradientMap&&d.enable(22),P.push(d.mask),d.disableAll(),A.fog&&d.enable(0),A.useFog&&d.enable(1),A.flatShading&&d.enable(2),A.logarithmicDepthBuffer&&d.enable(3),A.reverseDepthBuffer&&d.enable(4),A.skinning&&d.enable(5),A.morphTargets&&d.enable(6),A.morphNormals&&d.enable(7),A.morphColors&&d.enable(8),A.premultipliedAlpha&&d.enable(9),A.shadowMapEnabled&&d.enable(10),A.doubleSided&&d.enable(11),A.flipSided&&d.enable(12),A.useDepthPacking&&d.enable(13),A.dithering&&d.enable(14),A.transmission&&d.enable(15),A.sheen&&d.enable(16),A.opaque&&d.enable(17),A.pointsUvs&&d.enable(18),A.decodeVideoTexture&&d.enable(19),A.decodeVideoTextureEmissive&&d.enable(20),A.alphaToCoverage&&d.enable(21),P.push(d.mask)}function C(P){const A=T[P.type];let B;if(A){const re=pi[A];B=I0.clone(re.uniforms)}else B=P.uniforms;return B}function G(P,A){let B;for(let re=0,Q=_.length;re<Q;re++){const ue=_[re];if(ue.cacheKey===A){B=ue,++B.usedTimes;break}}return B===void 0&&(B=new cE(s,A,P,u),_.push(B)),B}function H(P){if(--P.usedTimes===0){const A=_.indexOf(P);_[A]=_[_.length-1],_.pop(),P.destroy()}}function I(P){h.remove(P)}function X(){h.dispose()}return{getParameters:x,getProgramCacheKey:g,getUniforms:C,acquireProgram:G,releaseProgram:H,releaseShaderCache:I,programs:_,dispose:X}}function mE(){let s=new WeakMap;function e(c){return s.has(c)}function n(c){let d=s.get(c);return d===void 0&&(d={},s.set(c,d)),d}function r(c){s.delete(c)}function a(c,d,h){s.get(c)[d]=h}function u(){s=new WeakMap}return{has:e,get:n,remove:r,update:a,dispose:u}}function gE(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.material.id!==e.material.id?s.material.id-e.material.id:s.z!==e.z?s.z-e.z:s.id-e.id}function Pm(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.z!==e.z?e.z-s.z:s.id-e.id}function bm(){const s=[];let e=0;const n=[],r=[],a=[];function u(){e=0,n.length=0,r.length=0,a.length=0}function c(v,S,y,T,R,x){let g=s[e];return g===void 0?(g={id:v.id,object:v,geometry:S,material:y,groupOrder:T,renderOrder:v.renderOrder,z:R,group:x},s[e]=g):(g.id=v.id,g.object=v,g.geometry=S,g.material=y,g.groupOrder=T,g.renderOrder=v.renderOrder,g.z=R,g.group=x),e++,g}function d(v,S,y,T,R,x){const g=c(v,S,y,T,R,x);y.transmission>0?r.push(g):y.transparent===!0?a.push(g):n.push(g)}function h(v,S,y,T,R,x){const g=c(v,S,y,T,R,x);y.transmission>0?r.unshift(g):y.transparent===!0?a.unshift(g):n.unshift(g)}function m(v,S){n.length>1&&n.sort(v||gE),r.length>1&&r.sort(S||Pm),a.length>1&&a.sort(S||Pm)}function _(){for(let v=e,S=s.length;v<S;v++){const y=s[v];if(y.id===null)break;y.id=null,y.object=null,y.geometry=null,y.material=null,y.group=null}}return{opaque:n,transmissive:r,transparent:a,init:u,push:d,unshift:h,finish:_,sort:m}}function _E(){let s=new WeakMap;function e(r,a){const u=s.get(r);let c;return u===void 0?(c=new bm,s.set(r,[c])):a>=u.length?(c=new bm,u.push(c)):c=u[a],c}function n(){s=new WeakMap}return{get:e,dispose:n}}function vE(){const s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let n;switch(e.type){case"DirectionalLight":n={direction:new ne,color:new Pt};break;case"SpotLight":n={position:new ne,direction:new ne,color:new Pt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new ne,color:new Pt,distance:0,decay:0};break;case"HemisphereLight":n={direction:new ne,skyColor:new Pt,groundColor:new Pt};break;case"RectAreaLight":n={color:new Pt,position:new ne,halfWidth:new ne,halfHeight:new ne};break}return s[e.id]=n,n}}}function xE(){const s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let n;switch(e.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new At};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new At};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new At,shadowCameraNear:1,shadowCameraFar:1e3};break}return s[e.id]=n,n}}}let SE=0;function yE(s,e){return(e.castShadow?2:0)-(s.castShadow?2:0)+(e.map?1:0)-(s.map?1:0)}function ME(s){const e=new vE,n=xE(),r={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let m=0;m<9;m++)r.probe.push(new ne);const a=new ne,u=new Xt,c=new Xt;function d(m){let _=0,v=0,S=0;for(let P=0;P<9;P++)r.probe[P].set(0,0,0);let y=0,T=0,R=0,x=0,g=0,N=0,U=0,C=0,G=0,H=0,I=0;m.sort(yE);for(let P=0,A=m.length;P<A;P++){const B=m[P],re=B.color,Q=B.intensity,ue=B.distance,de=B.shadow&&B.shadow.map?B.shadow.map.texture:null;if(B.isAmbientLight)_+=re.r*Q,v+=re.g*Q,S+=re.b*Q;else if(B.isLightProbe){for(let ae=0;ae<9;ae++)r.probe[ae].addScaledVector(B.sh.coefficients[ae],Q);I++}else if(B.isDirectionalLight){const ae=e.get(B);if(ae.color.copy(B.color).multiplyScalar(B.intensity),B.castShadow){const le=B.shadow,k=n.get(B);k.shadowIntensity=le.intensity,k.shadowBias=le.bias,k.shadowNormalBias=le.normalBias,k.shadowRadius=le.radius,k.shadowMapSize=le.mapSize,r.directionalShadow[y]=k,r.directionalShadowMap[y]=de,r.directionalShadowMatrix[y]=B.shadow.matrix,N++}r.directional[y]=ae,y++}else if(B.isSpotLight){const ae=e.get(B);ae.position.setFromMatrixPosition(B.matrixWorld),ae.color.copy(re).multiplyScalar(Q),ae.distance=ue,ae.coneCos=Math.cos(B.angle),ae.penumbraCos=Math.cos(B.angle*(1-B.penumbra)),ae.decay=B.decay,r.spot[R]=ae;const le=B.shadow;if(B.map&&(r.spotLightMap[G]=B.map,G++,le.updateMatrices(B),B.castShadow&&H++),r.spotLightMatrix[R]=le.matrix,B.castShadow){const k=n.get(B);k.shadowIntensity=le.intensity,k.shadowBias=le.bias,k.shadowNormalBias=le.normalBias,k.shadowRadius=le.radius,k.shadowMapSize=le.mapSize,r.spotShadow[R]=k,r.spotShadowMap[R]=de,C++}R++}else if(B.isRectAreaLight){const ae=e.get(B);ae.color.copy(re).multiplyScalar(Q),ae.halfWidth.set(B.width*.5,0,0),ae.halfHeight.set(0,B.height*.5,0),r.rectArea[x]=ae,x++}else if(B.isPointLight){const ae=e.get(B);if(ae.color.copy(B.color).multiplyScalar(B.intensity),ae.distance=B.distance,ae.decay=B.decay,B.castShadow){const le=B.shadow,k=n.get(B);k.shadowIntensity=le.intensity,k.shadowBias=le.bias,k.shadowNormalBias=le.normalBias,k.shadowRadius=le.radius,k.shadowMapSize=le.mapSize,k.shadowCameraNear=le.camera.near,k.shadowCameraFar=le.camera.far,r.pointShadow[T]=k,r.pointShadowMap[T]=de,r.pointShadowMatrix[T]=B.shadow.matrix,U++}r.point[T]=ae,T++}else if(B.isHemisphereLight){const ae=e.get(B);ae.skyColor.copy(B.color).multiplyScalar(Q),ae.groundColor.copy(B.groundColor).multiplyScalar(Q),r.hemi[g]=ae,g++}}x>0&&(s.has("OES_texture_float_linear")===!0?(r.rectAreaLTC1=Le.LTC_FLOAT_1,r.rectAreaLTC2=Le.LTC_FLOAT_2):(r.rectAreaLTC1=Le.LTC_HALF_1,r.rectAreaLTC2=Le.LTC_HALF_2)),r.ambient[0]=_,r.ambient[1]=v,r.ambient[2]=S;const X=r.hash;(X.directionalLength!==y||X.pointLength!==T||X.spotLength!==R||X.rectAreaLength!==x||X.hemiLength!==g||X.numDirectionalShadows!==N||X.numPointShadows!==U||X.numSpotShadows!==C||X.numSpotMaps!==G||X.numLightProbes!==I)&&(r.directional.length=y,r.spot.length=R,r.rectArea.length=x,r.point.length=T,r.hemi.length=g,r.directionalShadow.length=N,r.directionalShadowMap.length=N,r.pointShadow.length=U,r.pointShadowMap.length=U,r.spotShadow.length=C,r.spotShadowMap.length=C,r.directionalShadowMatrix.length=N,r.pointShadowMatrix.length=U,r.spotLightMatrix.length=C+G-H,r.spotLightMap.length=G,r.numSpotLightShadowsWithMaps=H,r.numLightProbes=I,X.directionalLength=y,X.pointLength=T,X.spotLength=R,X.rectAreaLength=x,X.hemiLength=g,X.numDirectionalShadows=N,X.numPointShadows=U,X.numSpotShadows=C,X.numSpotMaps=G,X.numLightProbes=I,r.version=SE++)}function h(m,_){let v=0,S=0,y=0,T=0,R=0;const x=_.matrixWorldInverse;for(let g=0,N=m.length;g<N;g++){const U=m[g];if(U.isDirectionalLight){const C=r.directional[v];C.direction.setFromMatrixPosition(U.matrixWorld),a.setFromMatrixPosition(U.target.matrixWorld),C.direction.sub(a),C.direction.transformDirection(x),v++}else if(U.isSpotLight){const C=r.spot[y];C.position.setFromMatrixPosition(U.matrixWorld),C.position.applyMatrix4(x),C.direction.setFromMatrixPosition(U.matrixWorld),a.setFromMatrixPosition(U.target.matrixWorld),C.direction.sub(a),C.direction.transformDirection(x),y++}else if(U.isRectAreaLight){const C=r.rectArea[T];C.position.setFromMatrixPosition(U.matrixWorld),C.position.applyMatrix4(x),c.identity(),u.copy(U.matrixWorld),u.premultiply(x),c.extractRotation(u),C.halfWidth.set(U.width*.5,0,0),C.halfHeight.set(0,U.height*.5,0),C.halfWidth.applyMatrix4(c),C.halfHeight.applyMatrix4(c),T++}else if(U.isPointLight){const C=r.point[S];C.position.setFromMatrixPosition(U.matrixWorld),C.position.applyMatrix4(x),S++}else if(U.isHemisphereLight){const C=r.hemi[R];C.direction.setFromMatrixPosition(U.matrixWorld),C.direction.transformDirection(x),R++}}}return{setup:d,setupView:h,state:r}}function Lm(s){const e=new ME(s),n=[],r=[];function a(_){m.camera=_,n.length=0,r.length=0}function u(_){n.push(_)}function c(_){r.push(_)}function d(){e.setup(n)}function h(_){e.setupView(n,_)}const m={lightsArray:n,shadowsArray:r,camera:null,lights:e,transmissionRenderTarget:{}};return{init:a,state:m,setupLights:d,setupLightsView:h,pushLight:u,pushShadow:c}}function EE(s){let e=new WeakMap;function n(a,u=0){const c=e.get(a);let d;return c===void 0?(d=new Lm(s),e.set(a,[d])):u>=c.length?(d=new Lm(s),c.push(d)):d=c[u],d}function r(){e=new WeakMap}return{get:n,dispose:r}}const TE=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function AE(s,e,n){let r=new Kf;const a=new At,u=new At,c=new Wt,d=new X0({depthPacking:t0}),h=new j0,m={},_=n.maxTextureSize,v={[xr]:Nn,[Nn]:xr,[Fi]:Fi},S=new Sr({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new At},radius:{value:4}},vertexShader:TE,fragmentShader:wE}),y=S.clone();y.defines.HORIZONTAL_PASS=1;const T=new Zr;T.setAttribute("position",new _i(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const R=new gi(T,S),x=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=zm;let g=this.type;this.render=function(H,I,X){if(x.enabled===!1||x.autoUpdate===!1&&x.needsUpdate===!1||H.length===0)return;const P=s.getRenderTarget(),A=s.getActiveCubeFace(),B=s.getActiveMipmapLevel(),re=s.state;re.setBlending(_r),re.buffers.color.setClear(1,1,1,1),re.buffers.depth.setTest(!0),re.setScissorTest(!1);const Q=g!==Ii&&this.type===Ii,ue=g===Ii&&this.type!==Ii;for(let de=0,ae=H.length;de<ae;de++){const le=H[de],k=le.shadow;if(k===void 0){console.warn("THREE.WebGLShadowMap:",le,"has no shadow.");continue}if(k.autoUpdate===!1&&k.needsUpdate===!1)continue;a.copy(k.mapSize);const se=k.getFrameExtents();if(a.multiply(se),u.copy(k.mapSize),(a.x>_||a.y>_)&&(a.x>_&&(u.x=Math.floor(_/se.x),a.x=u.x*se.x,k.mapSize.x=u.x),a.y>_&&(u.y=Math.floor(_/se.y),a.y=u.y*se.y,k.mapSize.y=u.y)),k.map===null||Q===!0||ue===!0){const D=this.type!==Ii?{minFilter:Tn,magFilter:Tn}:{};k.map!==null&&k.map.dispose(),k.map=new Kr(a.x,a.y,D),k.map.texture.name=le.name+".shadowMap",k.camera.updateProjectionMatrix()}s.setRenderTarget(k.map),s.clear();const ie=k.getViewportCount();for(let D=0;D<ie;D++){const ee=k.getViewport(D);c.set(u.x*ee.x,u.y*ee.y,u.x*ee.z,u.y*ee.w),re.viewport(c),k.updateMatrices(le,D),r=k.getFrustum(),C(I,X,k.camera,le,this.type)}k.isPointLightShadow!==!0&&this.type===Ii&&N(k,X),k.needsUpdate=!1}g=this.type,x.needsUpdate=!1,s.setRenderTarget(P,A,B)};function N(H,I){const X=e.update(R);S.defines.VSM_SAMPLES!==H.blurSamples&&(S.defines.VSM_SAMPLES=H.blurSamples,y.defines.VSM_SAMPLES=H.blurSamples,S.needsUpdate=!0,y.needsUpdate=!0),H.mapPass===null&&(H.mapPass=new Kr(a.x,a.y)),S.uniforms.shadow_pass.value=H.map.texture,S.uniforms.resolution.value=H.mapSize,S.uniforms.radius.value=H.radius,s.setRenderTarget(H.mapPass),s.clear(),s.renderBufferDirect(I,null,X,S,R,null),y.uniforms.shadow_pass.value=H.mapPass.texture,y.uniforms.resolution.value=H.mapSize,y.uniforms.radius.value=H.radius,s.setRenderTarget(H.map),s.clear(),s.renderBufferDirect(I,null,X,y,R,null)}function U(H,I,X,P){let A=null;const B=X.isPointLight===!0?H.customDistanceMaterial:H.customDepthMaterial;if(B!==void 0)A=B;else if(A=X.isPointLight===!0?h:d,s.localClippingEnabled&&I.clipShadows===!0&&Array.isArray(I.clippingPlanes)&&I.clippingPlanes.length!==0||I.displacementMap&&I.displacementScale!==0||I.alphaMap&&I.alphaTest>0||I.map&&I.alphaTest>0||I.alphaToCoverage===!0){const re=A.uuid,Q=I.uuid;let ue=m[re];ue===void 0&&(ue={},m[re]=ue);let de=ue[Q];de===void 0&&(de=A.clone(),ue[Q]=de,I.addEventListener("dispose",G)),A=de}if(A.visible=I.visible,A.wireframe=I.wireframe,P===Ii?A.side=I.shadowSide!==null?I.shadowSide:I.side:A.side=I.shadowSide!==null?I.shadowSide:v[I.side],A.alphaMap=I.alphaMap,A.alphaTest=I.alphaToCoverage===!0?.5:I.alphaTest,A.map=I.map,A.clipShadows=I.clipShadows,A.clippingPlanes=I.clippingPlanes,A.clipIntersection=I.clipIntersection,A.displacementMap=I.displacementMap,A.displacementScale=I.displacementScale,A.displacementBias=I.displacementBias,A.wireframeLinewidth=I.wireframeLinewidth,A.linewidth=I.linewidth,X.isPointLight===!0&&A.isMeshDistanceMaterial===!0){const re=s.properties.get(A);re.light=X}return A}function C(H,I,X,P,A){if(H.visible===!1)return;if(H.layers.test(I.layers)&&(H.isMesh||H.isLine||H.isPoints)&&(H.castShadow||H.receiveShadow&&A===Ii)&&(!H.frustumCulled||r.intersectsObject(H))){H.modelViewMatrix.multiplyMatrices(X.matrixWorldInverse,H.matrixWorld);const Q=e.update(H),ue=H.material;if(Array.isArray(ue)){const de=Q.groups;for(let ae=0,le=de.length;ae<le;ae++){const k=de[ae],se=ue[k.materialIndex];if(se&&se.visible){const ie=U(H,se,P,A);H.onBeforeShadow(s,H,I,X,Q,ie,k),s.renderBufferDirect(X,null,Q,ie,H,k),H.onAfterShadow(s,H,I,X,Q,ie,k)}}}else if(ue.visible){const de=U(H,ue,P,A);H.onBeforeShadow(s,H,I,X,Q,de,null),s.renderBufferDirect(X,null,Q,de,H,null),H.onAfterShadow(s,H,I,X,Q,de,null)}}const re=H.children;for(let Q=0,ue=re.length;Q<ue;Q++)C(re[Q],I,X,P,A)}function G(H){H.target.removeEventListener("dispose",G);for(const X in m){const P=m[X],A=H.target.uuid;A in P&&(P[A].dispose(),delete P[A])}}}const RE={[tf]:nf,[rf]:af,[sf]:lf,[Hs]:of,[nf]:tf,[af]:rf,[lf]:sf,[of]:Hs};function CE(s,e){function n(){let z=!1;const Pe=new Wt;let ge=null;const De=new Wt(0,0,0,0);return{setMask:function(ye){ge!==ye&&!z&&(s.colorMask(ye,ye,ye,ye),ge=ye)},setLocked:function(ye){z=ye},setClear:function(ye,he,He,lt,bt){bt===!0&&(ye*=lt,he*=lt,He*=lt),Pe.set(ye,he,He,lt),De.equals(Pe)===!1&&(s.clearColor(ye,he,He,lt),De.copy(Pe))},reset:function(){z=!1,ge=null,De.set(-1,0,0,0)}}}function r(){let z=!1,Pe=!1,ge=null,De=null,ye=null;return{setReversed:function(he){if(Pe!==he){const He=e.get("EXT_clip_control");he?He.clipControlEXT(He.LOWER_LEFT_EXT,He.ZERO_TO_ONE_EXT):He.clipControlEXT(He.LOWER_LEFT_EXT,He.NEGATIVE_ONE_TO_ONE_EXT),Pe=he;const lt=ye;ye=null,this.setClear(lt)}},getReversed:function(){return Pe},setTest:function(he){he?xe(s.DEPTH_TEST):we(s.DEPTH_TEST)},setMask:function(he){ge!==he&&!z&&(s.depthMask(he),ge=he)},setFunc:function(he){if(Pe&&(he=RE[he]),De!==he){switch(he){case tf:s.depthFunc(s.NEVER);break;case nf:s.depthFunc(s.ALWAYS);break;case rf:s.depthFunc(s.LESS);break;case Hs:s.depthFunc(s.LEQUAL);break;case sf:s.depthFunc(s.EQUAL);break;case of:s.depthFunc(s.GEQUAL);break;case af:s.depthFunc(s.GREATER);break;case lf:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}De=he}},setLocked:function(he){z=he},setClear:function(he){ye!==he&&(Pe&&(he=1-he),s.clearDepth(he),ye=he)},reset:function(){z=!1,ge=null,De=null,ye=null,Pe=!1}}}function a(){let z=!1,Pe=null,ge=null,De=null,ye=null,he=null,He=null,lt=null,bt=null;return{setTest:function(xt){z||(xt?xe(s.STENCIL_TEST):we(s.STENCIL_TEST))},setMask:function(xt){Pe!==xt&&!z&&(s.stencilMask(xt),Pe=xt)},setFunc:function(xt,An,xn){(ge!==xt||De!==An||ye!==xn)&&(s.stencilFunc(xt,An,xn),ge=xt,De=An,ye=xn)},setOp:function(xt,An,xn){(he!==xt||He!==An||lt!==xn)&&(s.stencilOp(xt,An,xn),he=xt,He=An,lt=xn)},setLocked:function(xt){z=xt},setClear:function(xt){bt!==xt&&(s.clearStencil(xt),bt=xt)},reset:function(){z=!1,Pe=null,ge=null,De=null,ye=null,he=null,He=null,lt=null,bt=null}}}const u=new n,c=new r,d=new a,h=new WeakMap,m=new WeakMap;let _={},v={},S=new WeakMap,y=[],T=null,R=!1,x=null,g=null,N=null,U=null,C=null,G=null,H=null,I=new Pt(0,0,0),X=0,P=!1,A=null,B=null,re=null,Q=null,ue=null;const de=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let ae=!1,le=0;const k=s.getParameter(s.VERSION);k.indexOf("WebGL")!==-1?(le=parseFloat(/^WebGL (\d)/.exec(k)[1]),ae=le>=1):k.indexOf("OpenGL ES")!==-1&&(le=parseFloat(/^OpenGL ES (\d)/.exec(k)[1]),ae=le>=2);let se=null,ie={};const D=s.getParameter(s.SCISSOR_BOX),ee=s.getParameter(s.VIEWPORT),Ne=new Wt().fromArray(D),Z=new Wt().fromArray(ee);function fe(z,Pe,ge,De){const ye=new Uint8Array(4),he=s.createTexture();s.bindTexture(z,he),s.texParameteri(z,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(z,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let He=0;He<ge;He++)z===s.TEXTURE_3D||z===s.TEXTURE_2D_ARRAY?s.texImage3D(Pe,0,s.RGBA,1,1,De,0,s.RGBA,s.UNSIGNED_BYTE,ye):s.texImage2D(Pe+He,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,ye);return he}const Ee={};Ee[s.TEXTURE_2D]=fe(s.TEXTURE_2D,s.TEXTURE_2D,1),Ee[s.TEXTURE_CUBE_MAP]=fe(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),Ee[s.TEXTURE_2D_ARRAY]=fe(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),Ee[s.TEXTURE_3D]=fe(s.TEXTURE_3D,s.TEXTURE_3D,1,1),u.setClear(0,0,0,1),c.setClear(1),d.setClear(0),xe(s.DEPTH_TEST),c.setFunc(Hs),vt(!1),wt(Ip),xe(s.CULL_FACE),F(_r);function xe(z){_[z]!==!0&&(s.enable(z),_[z]=!0)}function we(z){_[z]!==!1&&(s.disable(z),_[z]=!1)}function Ye(z,Pe){return v[z]!==Pe?(s.bindFramebuffer(z,Pe),v[z]=Pe,z===s.DRAW_FRAMEBUFFER&&(v[s.FRAMEBUFFER]=Pe),z===s.FRAMEBUFFER&&(v[s.DRAW_FRAMEBUFFER]=Pe),!0):!1}function ze(z,Pe){let ge=y,De=!1;if(z){ge=S.get(Pe),ge===void 0&&(ge=[],S.set(Pe,ge));const ye=z.textures;if(ge.length!==ye.length||ge[0]!==s.COLOR_ATTACHMENT0){for(let he=0,He=ye.length;he<He;he++)ge[he]=s.COLOR_ATTACHMENT0+he;ge.length=ye.length,De=!0}}else ge[0]!==s.BACK&&(ge[0]=s.BACK,De=!0);De&&s.drawBuffers(ge)}function Tt(z){return T!==z?(s.useProgram(z),T=z,!0):!1}const Rt={[Gr]:s.FUNC_ADD,[Rv]:s.FUNC_SUBTRACT,[Cv]:s.FUNC_REVERSE_SUBTRACT};Rt[Pv]=s.MIN,Rt[bv]=s.MAX;const dt={[Lv]:s.ZERO,[Dv]:s.ONE,[Uv]:s.SRC_COLOR,[Jc]:s.SRC_ALPHA,[Bv]:s.SRC_ALPHA_SATURATE,[Ov]:s.DST_COLOR,[Iv]:s.DST_ALPHA,[Nv]:s.ONE_MINUS_SRC_COLOR,[ef]:s.ONE_MINUS_SRC_ALPHA,[kv]:s.ONE_MINUS_DST_COLOR,[Fv]:s.ONE_MINUS_DST_ALPHA,[zv]:s.CONSTANT_COLOR,[Hv]:s.ONE_MINUS_CONSTANT_COLOR,[Vv]:s.CONSTANT_ALPHA,[Gv]:s.ONE_MINUS_CONSTANT_ALPHA};function F(z,Pe,ge,De,ye,he,He,lt,bt,xt){if(z===_r){R===!0&&(we(s.BLEND),R=!1);return}if(R===!1&&(xe(s.BLEND),R=!0),z!==Av){if(z!==x||xt!==P){if((g!==Gr||C!==Gr)&&(s.blendEquation(s.FUNC_ADD),g=Gr,C=Gr),xt)switch(z){case ks:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Fp:s.blendFunc(s.ONE,s.ONE);break;case Op:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case kp:s.blendFuncSeparate(s.DST_COLOR,s.ONE_MINUS_SRC_ALPHA,s.ZERO,s.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",z);break}else switch(z){case ks:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Fp:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE,s.ONE,s.ONE);break;case Op:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case kp:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",z);break}N=null,U=null,G=null,H=null,I.set(0,0,0),X=0,x=z,P=xt}return}ye=ye||Pe,he=he||ge,He=He||De,(Pe!==g||ye!==C)&&(s.blendEquationSeparate(Rt[Pe],Rt[ye]),g=Pe,C=ye),(ge!==N||De!==U||he!==G||He!==H)&&(s.blendFuncSeparate(dt[ge],dt[De],dt[he],dt[He]),N=ge,U=De,G=he,H=He),(lt.equals(I)===!1||bt!==X)&&(s.blendColor(lt.r,lt.g,lt.b,bt),I.copy(lt),X=bt),x=z,P=!1}function Jt(z,Pe){z.side===Fi?we(s.CULL_FACE):xe(s.CULL_FACE);let ge=z.side===Nn;Pe&&(ge=!ge),vt(ge),z.blending===ks&&z.transparent===!1?F(_r):F(z.blending,z.blendEquation,z.blendSrc,z.blendDst,z.blendEquationAlpha,z.blendSrcAlpha,z.blendDstAlpha,z.blendColor,z.blendAlpha,z.premultipliedAlpha),c.setFunc(z.depthFunc),c.setTest(z.depthTest),c.setMask(z.depthWrite),u.setMask(z.colorWrite);const De=z.stencilWrite;d.setTest(De),De&&(d.setMask(z.stencilWriteMask),d.setFunc(z.stencilFunc,z.stencilRef,z.stencilFuncMask),d.setOp(z.stencilFail,z.stencilZFail,z.stencilZPass)),gt(z.polygonOffset,z.polygonOffsetFactor,z.polygonOffsetUnits),z.alphaToCoverage===!0?xe(s.SAMPLE_ALPHA_TO_COVERAGE):we(s.SAMPLE_ALPHA_TO_COVERAGE)}function vt(z){A!==z&&(z?s.frontFace(s.CW):s.frontFace(s.CCW),A=z)}function wt(z){z!==Ev?(xe(s.CULL_FACE),z!==B&&(z===Ip?s.cullFace(s.BACK):z===Tv?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):we(s.CULL_FACE),B=z}function Xe(z){z!==re&&(ae&&s.lineWidth(z),re=z)}function gt(z,Pe,ge){z?(xe(s.POLYGON_OFFSET_FILL),(Q!==Pe||ue!==ge)&&(s.polygonOffset(Pe,ge),Q=Pe,ue=ge)):we(s.POLYGON_OFFSET_FILL)}function Ze(z){z?xe(s.SCISSOR_TEST):we(s.SCISSOR_TEST)}function ot(z){z===void 0&&(z=s.TEXTURE0+de-1),se!==z&&(s.activeTexture(z),se=z)}function zt(z,Pe,ge){ge===void 0&&(se===null?ge=s.TEXTURE0+de-1:ge=se);let De=ie[ge];De===void 0&&(De={type:void 0,texture:void 0},ie[ge]=De),(De.type!==z||De.texture!==Pe)&&(se!==ge&&(s.activeTexture(ge),se=ge),s.bindTexture(z,Pe||Ee[z]),De.type=z,De.texture=Pe)}function b(){const z=ie[se];z!==void 0&&z.type!==void 0&&(s.bindTexture(z.type,null),z.type=void 0,z.texture=void 0)}function E(){try{s.compressedTexImage2D(...arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function K(){try{s.compressedTexImage3D(...arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function ce(){try{s.texSubImage2D(...arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function pe(){try{s.texSubImage3D(...arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function oe(){try{s.compressedTexSubImage2D(...arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function qe(){try{s.compressedTexSubImage3D(...arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function Ae(){try{s.texStorage2D(...arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function Be(){try{s.texStorage3D(...arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function $e(){try{s.texImage2D(...arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function _e(){try{s.texImage3D(...arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function Ie(z){Ne.equals(z)===!1&&(s.scissor(z.x,z.y,z.z,z.w),Ne.copy(z))}function nt(z){Z.equals(z)===!1&&(s.viewport(z.x,z.y,z.z,z.w),Z.copy(z))}function Je(z,Pe){let ge=m.get(Pe);ge===void 0&&(ge=new WeakMap,m.set(Pe,ge));let De=ge.get(z);De===void 0&&(De=s.getUniformBlockIndex(Pe,z.name),ge.set(z,De))}function Re(z,Pe){const De=m.get(Pe).get(z);h.get(Pe)!==De&&(s.uniformBlockBinding(Pe,De,z.__bindingPointIndex),h.set(Pe,De))}function st(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),c.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),_={},se=null,ie={},v={},S=new WeakMap,y=[],T=null,R=!1,x=null,g=null,N=null,U=null,C=null,G=null,H=null,I=new Pt(0,0,0),X=0,P=!1,A=null,B=null,re=null,Q=null,ue=null,Ne.set(0,0,s.canvas.width,s.canvas.height),Z.set(0,0,s.canvas.width,s.canvas.height),u.reset(),c.reset(),d.reset()}return{buffers:{color:u,depth:c,stencil:d},enable:xe,disable:we,bindFramebuffer:Ye,drawBuffers:ze,useProgram:Tt,setBlending:F,setMaterial:Jt,setFlipSided:vt,setCullFace:wt,setLineWidth:Xe,setPolygonOffset:gt,setScissorTest:Ze,activeTexture:ot,bindTexture:zt,unbindTexture:b,compressedTexImage2D:E,compressedTexImage3D:K,texImage2D:$e,texImage3D:_e,updateUBOMapping:Je,uniformBlockBinding:Re,texStorage2D:Ae,texStorage3D:Be,texSubImage2D:ce,texSubImage3D:pe,compressedTexSubImage2D:oe,compressedTexSubImage3D:qe,scissor:Ie,viewport:nt,reset:st}}function PE(s,e,n,r,a,u,c){const d=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,h=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),m=new At,_=new WeakMap;let v;const S=new WeakMap;let y=!1;try{y=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function T(b,E){return y?new OffscreenCanvas(b,E):Ho("canvas")}function R(b,E,K){let ce=1;const pe=zt(b);if((pe.width>K||pe.height>K)&&(ce=K/Math.max(pe.width,pe.height)),ce<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const oe=Math.floor(ce*pe.width),qe=Math.floor(ce*pe.height);v===void 0&&(v=T(oe,qe));const Ae=E?T(oe,qe):v;return Ae.width=oe,Ae.height=qe,Ae.getContext("2d").drawImage(b,0,0,oe,qe),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+pe.width+"x"+pe.height+") to ("+oe+"x"+qe+")."),Ae}else return"data"in b&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+pe.width+"x"+pe.height+")."),b;return b}function x(b){return b.generateMipmaps}function g(b){s.generateMipmap(b)}function N(b){return b.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:b.isWebGL3DRenderTarget?s.TEXTURE_3D:b.isWebGLArrayRenderTarget||b.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function U(b,E,K,ce,pe=!1){if(b!==null){if(s[b]!==void 0)return s[b];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let oe=E;if(E===s.RED&&(K===s.FLOAT&&(oe=s.R32F),K===s.HALF_FLOAT&&(oe=s.R16F),K===s.UNSIGNED_BYTE&&(oe=s.R8)),E===s.RED_INTEGER&&(K===s.UNSIGNED_BYTE&&(oe=s.R8UI),K===s.UNSIGNED_SHORT&&(oe=s.R16UI),K===s.UNSIGNED_INT&&(oe=s.R32UI),K===s.BYTE&&(oe=s.R8I),K===s.SHORT&&(oe=s.R16I),K===s.INT&&(oe=s.R32I)),E===s.RG&&(K===s.FLOAT&&(oe=s.RG32F),K===s.HALF_FLOAT&&(oe=s.RG16F),K===s.UNSIGNED_BYTE&&(oe=s.RG8)),E===s.RG_INTEGER&&(K===s.UNSIGNED_BYTE&&(oe=s.RG8UI),K===s.UNSIGNED_SHORT&&(oe=s.RG16UI),K===s.UNSIGNED_INT&&(oe=s.RG32UI),K===s.BYTE&&(oe=s.RG8I),K===s.SHORT&&(oe=s.RG16I),K===s.INT&&(oe=s.RG32I)),E===s.RGB_INTEGER&&(K===s.UNSIGNED_BYTE&&(oe=s.RGB8UI),K===s.UNSIGNED_SHORT&&(oe=s.RGB16UI),K===s.UNSIGNED_INT&&(oe=s.RGB32UI),K===s.BYTE&&(oe=s.RGB8I),K===s.SHORT&&(oe=s.RGB16I),K===s.INT&&(oe=s.RGB32I)),E===s.RGBA_INTEGER&&(K===s.UNSIGNED_BYTE&&(oe=s.RGBA8UI),K===s.UNSIGNED_SHORT&&(oe=s.RGBA16UI),K===s.UNSIGNED_INT&&(oe=s.RGBA32UI),K===s.BYTE&&(oe=s.RGBA8I),K===s.SHORT&&(oe=s.RGBA16I),K===s.INT&&(oe=s.RGBA32I)),E===s.RGB&&K===s.UNSIGNED_INT_5_9_9_9_REV&&(oe=s.RGB9_E5),E===s.RGBA){const qe=pe?bl:Et.getTransfer(ce);K===s.FLOAT&&(oe=s.RGBA32F),K===s.HALF_FLOAT&&(oe=s.RGBA16F),K===s.UNSIGNED_BYTE&&(oe=qe===Dt?s.SRGB8_ALPHA8:s.RGBA8),K===s.UNSIGNED_SHORT_4_4_4_4&&(oe=s.RGBA4),K===s.UNSIGNED_SHORT_5_5_5_1&&(oe=s.RGB5_A1)}return(oe===s.R16F||oe===s.R32F||oe===s.RG16F||oe===s.RG32F||oe===s.RGBA16F||oe===s.RGBA32F)&&e.get("EXT_color_buffer_float"),oe}function C(b,E){let K;return b?E===null||E===$r||E===ko?K=s.DEPTH24_STENCIL8:E===Oi?K=s.DEPTH32F_STENCIL8:E===Oo&&(K=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===$r||E===ko?K=s.DEPTH_COMPONENT24:E===Oi?K=s.DEPTH_COMPONENT32F:E===Oo&&(K=s.DEPTH_COMPONENT16),K}function G(b,E){return x(b)===!0||b.isFramebufferTexture&&b.minFilter!==Tn&&b.minFilter!==mi?Math.log2(Math.max(E.width,E.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?E.mipmaps.length:1}function H(b){const E=b.target;E.removeEventListener("dispose",H),X(E),E.isVideoTexture&&_.delete(E)}function I(b){const E=b.target;E.removeEventListener("dispose",I),A(E)}function X(b){const E=r.get(b);if(E.__webglInit===void 0)return;const K=b.source,ce=S.get(K);if(ce){const pe=ce[E.__cacheKey];pe.usedTimes--,pe.usedTimes===0&&P(b),Object.keys(ce).length===0&&S.delete(K)}r.remove(b)}function P(b){const E=r.get(b);s.deleteTexture(E.__webglTexture);const K=b.source,ce=S.get(K);delete ce[E.__cacheKey],c.memory.textures--}function A(b){const E=r.get(b);if(b.depthTexture&&(b.depthTexture.dispose(),r.remove(b.depthTexture)),b.isWebGLCubeRenderTarget)for(let ce=0;ce<6;ce++){if(Array.isArray(E.__webglFramebuffer[ce]))for(let pe=0;pe<E.__webglFramebuffer[ce].length;pe++)s.deleteFramebuffer(E.__webglFramebuffer[ce][pe]);else s.deleteFramebuffer(E.__webglFramebuffer[ce]);E.__webglDepthbuffer&&s.deleteRenderbuffer(E.__webglDepthbuffer[ce])}else{if(Array.isArray(E.__webglFramebuffer))for(let ce=0;ce<E.__webglFramebuffer.length;ce++)s.deleteFramebuffer(E.__webglFramebuffer[ce]);else s.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&s.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&s.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let ce=0;ce<E.__webglColorRenderbuffer.length;ce++)E.__webglColorRenderbuffer[ce]&&s.deleteRenderbuffer(E.__webglColorRenderbuffer[ce]);E.__webglDepthRenderbuffer&&s.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const K=b.textures;for(let ce=0,pe=K.length;ce<pe;ce++){const oe=r.get(K[ce]);oe.__webglTexture&&(s.deleteTexture(oe.__webglTexture),c.memory.textures--),r.remove(K[ce])}r.remove(b)}let B=0;function re(){B=0}function Q(){const b=B;return b>=a.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+a.maxTextures),B+=1,b}function ue(b){const E=[];return E.push(b.wrapS),E.push(b.wrapT),E.push(b.wrapR||0),E.push(b.magFilter),E.push(b.minFilter),E.push(b.anisotropy),E.push(b.internalFormat),E.push(b.format),E.push(b.type),E.push(b.generateMipmaps),E.push(b.premultiplyAlpha),E.push(b.flipY),E.push(b.unpackAlignment),E.push(b.colorSpace),E.join()}function de(b,E){const K=r.get(b);if(b.isVideoTexture&&Ze(b),b.isRenderTargetTexture===!1&&b.version>0&&K.__version!==b.version){const ce=b.image;if(ce===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ce.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Ee(K,b,E);return}}n.bindTexture(s.TEXTURE_2D,K.__webglTexture,s.TEXTURE0+E)}function ae(b,E){const K=r.get(b);if(b.version>0&&K.__version!==b.version){Ee(K,b,E);return}n.bindTexture(s.TEXTURE_2D_ARRAY,K.__webglTexture,s.TEXTURE0+E)}function le(b,E){const K=r.get(b);if(b.version>0&&K.__version!==b.version){Ee(K,b,E);return}n.bindTexture(s.TEXTURE_3D,K.__webglTexture,s.TEXTURE0+E)}function k(b,E){const K=r.get(b);if(b.version>0&&K.__version!==b.version){xe(K,b,E);return}n.bindTexture(s.TEXTURE_CUBE_MAP,K.__webglTexture,s.TEXTURE0+E)}const se={[Fo]:s.REPEAT,[jr]:s.CLAMP_TO_EDGE,[ff]:s.MIRRORED_REPEAT},ie={[Tn]:s.NEAREST,[Jv]:s.NEAREST_MIPMAP_NEAREST,[tl]:s.NEAREST_MIPMAP_LINEAR,[mi]:s.LINEAR,[vc]:s.LINEAR_MIPMAP_NEAREST,[Yr]:s.LINEAR_MIPMAP_LINEAR},D={[r0]:s.NEVER,[c0]:s.ALWAYS,[s0]:s.LESS,[Zm]:s.LEQUAL,[o0]:s.EQUAL,[u0]:s.GEQUAL,[a0]:s.GREATER,[l0]:s.NOTEQUAL};function ee(b,E){if(E.type===Oi&&e.has("OES_texture_float_linear")===!1&&(E.magFilter===mi||E.magFilter===vc||E.magFilter===tl||E.magFilter===Yr||E.minFilter===mi||E.minFilter===vc||E.minFilter===tl||E.minFilter===Yr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(b,s.TEXTURE_WRAP_S,se[E.wrapS]),s.texParameteri(b,s.TEXTURE_WRAP_T,se[E.wrapT]),(b===s.TEXTURE_3D||b===s.TEXTURE_2D_ARRAY)&&s.texParameteri(b,s.TEXTURE_WRAP_R,se[E.wrapR]),s.texParameteri(b,s.TEXTURE_MAG_FILTER,ie[E.magFilter]),s.texParameteri(b,s.TEXTURE_MIN_FILTER,ie[E.minFilter]),E.compareFunction&&(s.texParameteri(b,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(b,s.TEXTURE_COMPARE_FUNC,D[E.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===Tn||E.minFilter!==tl&&E.minFilter!==Yr||E.type===Oi&&e.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||r.get(E).__currentAnisotropy){const K=e.get("EXT_texture_filter_anisotropic");s.texParameterf(b,K.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,a.getMaxAnisotropy())),r.get(E).__currentAnisotropy=E.anisotropy}}}function Ne(b,E){let K=!1;b.__webglInit===void 0&&(b.__webglInit=!0,E.addEventListener("dispose",H));const ce=E.source;let pe=S.get(ce);pe===void 0&&(pe={},S.set(ce,pe));const oe=ue(E);if(oe!==b.__cacheKey){pe[oe]===void 0&&(pe[oe]={texture:s.createTexture(),usedTimes:0},c.memory.textures++,K=!0),pe[oe].usedTimes++;const qe=pe[b.__cacheKey];qe!==void 0&&(pe[b.__cacheKey].usedTimes--,qe.usedTimes===0&&P(E)),b.__cacheKey=oe,b.__webglTexture=pe[oe].texture}return K}function Z(b,E,K){return Math.floor(Math.floor(b/K)/E)}function fe(b,E,K,ce){const oe=b.updateRanges;if(oe.length===0)n.texSubImage2D(s.TEXTURE_2D,0,0,0,E.width,E.height,K,ce,E.data);else{oe.sort((_e,Ie)=>_e.start-Ie.start);let qe=0;for(let _e=1;_e<oe.length;_e++){const Ie=oe[qe],nt=oe[_e],Je=Ie.start+Ie.count,Re=Z(nt.start,E.width,4),st=Z(Ie.start,E.width,4);nt.start<=Je+1&&Re===st&&Z(nt.start+nt.count-1,E.width,4)===Re?Ie.count=Math.max(Ie.count,nt.start+nt.count-Ie.start):(++qe,oe[qe]=nt)}oe.length=qe+1;const Ae=s.getParameter(s.UNPACK_ROW_LENGTH),Be=s.getParameter(s.UNPACK_SKIP_PIXELS),$e=s.getParameter(s.UNPACK_SKIP_ROWS);s.pixelStorei(s.UNPACK_ROW_LENGTH,E.width);for(let _e=0,Ie=oe.length;_e<Ie;_e++){const nt=oe[_e],Je=Math.floor(nt.start/4),Re=Math.ceil(nt.count/4),st=Je%E.width,z=Math.floor(Je/E.width),Pe=Re,ge=1;s.pixelStorei(s.UNPACK_SKIP_PIXELS,st),s.pixelStorei(s.UNPACK_SKIP_ROWS,z),n.texSubImage2D(s.TEXTURE_2D,0,st,z,Pe,ge,K,ce,E.data)}b.clearUpdateRanges(),s.pixelStorei(s.UNPACK_ROW_LENGTH,Ae),s.pixelStorei(s.UNPACK_SKIP_PIXELS,Be),s.pixelStorei(s.UNPACK_SKIP_ROWS,$e)}}function Ee(b,E,K){let ce=s.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(ce=s.TEXTURE_2D_ARRAY),E.isData3DTexture&&(ce=s.TEXTURE_3D);const pe=Ne(b,E),oe=E.source;n.bindTexture(ce,b.__webglTexture,s.TEXTURE0+K);const qe=r.get(oe);if(oe.version!==qe.__version||pe===!0){n.activeTexture(s.TEXTURE0+K);const Ae=Et.getPrimaries(Et.workingColorSpace),Be=E.colorSpace===gr?null:Et.getPrimaries(E.colorSpace),$e=E.colorSpace===gr||Ae===Be?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,E.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,E.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,$e);let _e=R(E.image,!1,a.maxTextureSize);_e=ot(E,_e);const Ie=u.convert(E.format,E.colorSpace),nt=u.convert(E.type);let Je=U(E.internalFormat,Ie,nt,E.colorSpace,E.isVideoTexture);ee(ce,E);let Re;const st=E.mipmaps,z=E.isVideoTexture!==!0,Pe=qe.__version===void 0||pe===!0,ge=oe.dataReady,De=G(E,_e);if(E.isDepthTexture)Je=C(E.format===zo,E.type),Pe&&(z?n.texStorage2D(s.TEXTURE_2D,1,Je,_e.width,_e.height):n.texImage2D(s.TEXTURE_2D,0,Je,_e.width,_e.height,0,Ie,nt,null));else if(E.isDataTexture)if(st.length>0){z&&Pe&&n.texStorage2D(s.TEXTURE_2D,De,Je,st[0].width,st[0].height);for(let ye=0,he=st.length;ye<he;ye++)Re=st[ye],z?ge&&n.texSubImage2D(s.TEXTURE_2D,ye,0,0,Re.width,Re.height,Ie,nt,Re.data):n.texImage2D(s.TEXTURE_2D,ye,Je,Re.width,Re.height,0,Ie,nt,Re.data);E.generateMipmaps=!1}else z?(Pe&&n.texStorage2D(s.TEXTURE_2D,De,Je,_e.width,_e.height),ge&&fe(E,_e,Ie,nt)):n.texImage2D(s.TEXTURE_2D,0,Je,_e.width,_e.height,0,Ie,nt,_e.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){z&&Pe&&n.texStorage3D(s.TEXTURE_2D_ARRAY,De,Je,st[0].width,st[0].height,_e.depth);for(let ye=0,he=st.length;ye<he;ye++)if(Re=st[ye],E.format!==ai)if(Ie!==null)if(z){if(ge)if(E.layerUpdates.size>0){const He=am(Re.width,Re.height,E.format,E.type);for(const lt of E.layerUpdates){const bt=Re.data.subarray(lt*He/Re.data.BYTES_PER_ELEMENT,(lt+1)*He/Re.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,ye,0,0,lt,Re.width,Re.height,1,Ie,bt)}E.clearLayerUpdates()}else n.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,ye,0,0,0,Re.width,Re.height,_e.depth,Ie,Re.data)}else n.compressedTexImage3D(s.TEXTURE_2D_ARRAY,ye,Je,Re.width,Re.height,_e.depth,0,Re.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else z?ge&&n.texSubImage3D(s.TEXTURE_2D_ARRAY,ye,0,0,0,Re.width,Re.height,_e.depth,Ie,nt,Re.data):n.texImage3D(s.TEXTURE_2D_ARRAY,ye,Je,Re.width,Re.height,_e.depth,0,Ie,nt,Re.data)}else{z&&Pe&&n.texStorage2D(s.TEXTURE_2D,De,Je,st[0].width,st[0].height);for(let ye=0,he=st.length;ye<he;ye++)Re=st[ye],E.format!==ai?Ie!==null?z?ge&&n.compressedTexSubImage2D(s.TEXTURE_2D,ye,0,0,Re.width,Re.height,Ie,Re.data):n.compressedTexImage2D(s.TEXTURE_2D,ye,Je,Re.width,Re.height,0,Re.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):z?ge&&n.texSubImage2D(s.TEXTURE_2D,ye,0,0,Re.width,Re.height,Ie,nt,Re.data):n.texImage2D(s.TEXTURE_2D,ye,Je,Re.width,Re.height,0,Ie,nt,Re.data)}else if(E.isDataArrayTexture)if(z){if(Pe&&n.texStorage3D(s.TEXTURE_2D_ARRAY,De,Je,_e.width,_e.height,_e.depth),ge)if(E.layerUpdates.size>0){const ye=am(_e.width,_e.height,E.format,E.type);for(const he of E.layerUpdates){const He=_e.data.subarray(he*ye/_e.data.BYTES_PER_ELEMENT,(he+1)*ye/_e.data.BYTES_PER_ELEMENT);n.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,he,_e.width,_e.height,1,Ie,nt,He)}E.clearLayerUpdates()}else n.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,_e.width,_e.height,_e.depth,Ie,nt,_e.data)}else n.texImage3D(s.TEXTURE_2D_ARRAY,0,Je,_e.width,_e.height,_e.depth,0,Ie,nt,_e.data);else if(E.isData3DTexture)z?(Pe&&n.texStorage3D(s.TEXTURE_3D,De,Je,_e.width,_e.height,_e.depth),ge&&n.texSubImage3D(s.TEXTURE_3D,0,0,0,0,_e.width,_e.height,_e.depth,Ie,nt,_e.data)):n.texImage3D(s.TEXTURE_3D,0,Je,_e.width,_e.height,_e.depth,0,Ie,nt,_e.data);else if(E.isFramebufferTexture){if(Pe)if(z)n.texStorage2D(s.TEXTURE_2D,De,Je,_e.width,_e.height);else{let ye=_e.width,he=_e.height;for(let He=0;He<De;He++)n.texImage2D(s.TEXTURE_2D,He,Je,ye,he,0,Ie,nt,null),ye>>=1,he>>=1}}else if(st.length>0){if(z&&Pe){const ye=zt(st[0]);n.texStorage2D(s.TEXTURE_2D,De,Je,ye.width,ye.height)}for(let ye=0,he=st.length;ye<he;ye++)Re=st[ye],z?ge&&n.texSubImage2D(s.TEXTURE_2D,ye,0,0,Ie,nt,Re):n.texImage2D(s.TEXTURE_2D,ye,Je,Ie,nt,Re);E.generateMipmaps=!1}else if(z){if(Pe){const ye=zt(_e);n.texStorage2D(s.TEXTURE_2D,De,Je,ye.width,ye.height)}ge&&n.texSubImage2D(s.TEXTURE_2D,0,0,0,Ie,nt,_e)}else n.texImage2D(s.TEXTURE_2D,0,Je,Ie,nt,_e);x(E)&&g(ce),qe.__version=oe.version,E.onUpdate&&E.onUpdate(E)}b.__version=E.version}function xe(b,E,K){if(E.image.length!==6)return;const ce=Ne(b,E),pe=E.source;n.bindTexture(s.TEXTURE_CUBE_MAP,b.__webglTexture,s.TEXTURE0+K);const oe=r.get(pe);if(pe.version!==oe.__version||ce===!0){n.activeTexture(s.TEXTURE0+K);const qe=Et.getPrimaries(Et.workingColorSpace),Ae=E.colorSpace===gr?null:Et.getPrimaries(E.colorSpace),Be=E.colorSpace===gr||qe===Ae?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,E.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,E.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Be);const $e=E.isCompressedTexture||E.image[0].isCompressedTexture,_e=E.image[0]&&E.image[0].isDataTexture,Ie=[];for(let he=0;he<6;he++)!$e&&!_e?Ie[he]=R(E.image[he],!0,a.maxCubemapSize):Ie[he]=_e?E.image[he].image:E.image[he],Ie[he]=ot(E,Ie[he]);const nt=Ie[0],Je=u.convert(E.format,E.colorSpace),Re=u.convert(E.type),st=U(E.internalFormat,Je,Re,E.colorSpace),z=E.isVideoTexture!==!0,Pe=oe.__version===void 0||ce===!0,ge=pe.dataReady;let De=G(E,nt);ee(s.TEXTURE_CUBE_MAP,E);let ye;if($e){z&&Pe&&n.texStorage2D(s.TEXTURE_CUBE_MAP,De,st,nt.width,nt.height);for(let he=0;he<6;he++){ye=Ie[he].mipmaps;for(let He=0;He<ye.length;He++){const lt=ye[He];E.format!==ai?Je!==null?z?ge&&n.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+he,He,0,0,lt.width,lt.height,Je,lt.data):n.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+he,He,st,lt.width,lt.height,0,lt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):z?ge&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+he,He,0,0,lt.width,lt.height,Je,Re,lt.data):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+he,He,st,lt.width,lt.height,0,Je,Re,lt.data)}}}else{if(ye=E.mipmaps,z&&Pe){ye.length>0&&De++;const he=zt(Ie[0]);n.texStorage2D(s.TEXTURE_CUBE_MAP,De,st,he.width,he.height)}for(let he=0;he<6;he++)if(_e){z?ge&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+he,0,0,0,Ie[he].width,Ie[he].height,Je,Re,Ie[he].data):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+he,0,st,Ie[he].width,Ie[he].height,0,Je,Re,Ie[he].data);for(let He=0;He<ye.length;He++){const bt=ye[He].image[he].image;z?ge&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+he,He+1,0,0,bt.width,bt.height,Je,Re,bt.data):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+he,He+1,st,bt.width,bt.height,0,Je,Re,bt.data)}}else{z?ge&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+he,0,0,0,Je,Re,Ie[he]):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+he,0,st,Je,Re,Ie[he]);for(let He=0;He<ye.length;He++){const lt=ye[He];z?ge&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+he,He+1,0,0,Je,Re,lt.image[he]):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+he,He+1,st,Je,Re,lt.image[he])}}}x(E)&&g(s.TEXTURE_CUBE_MAP),oe.__version=pe.version,E.onUpdate&&E.onUpdate(E)}b.__version=E.version}function we(b,E,K,ce,pe,oe){const qe=u.convert(K.format,K.colorSpace),Ae=u.convert(K.type),Be=U(K.internalFormat,qe,Ae,K.colorSpace),$e=r.get(E),_e=r.get(K);if(_e.__renderTarget=E,!$e.__hasExternalTextures){const Ie=Math.max(1,E.width>>oe),nt=Math.max(1,E.height>>oe);pe===s.TEXTURE_3D||pe===s.TEXTURE_2D_ARRAY?n.texImage3D(pe,oe,Be,Ie,nt,E.depth,0,qe,Ae,null):n.texImage2D(pe,oe,Be,Ie,nt,0,qe,Ae,null)}n.bindFramebuffer(s.FRAMEBUFFER,b),gt(E)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,ce,pe,_e.__webglTexture,0,Xe(E)):(pe===s.TEXTURE_2D||pe>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&pe<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,ce,pe,_e.__webglTexture,oe),n.bindFramebuffer(s.FRAMEBUFFER,null)}function Ye(b,E,K){if(s.bindRenderbuffer(s.RENDERBUFFER,b),E.depthBuffer){const ce=E.depthTexture,pe=ce&&ce.isDepthTexture?ce.type:null,oe=C(E.stencilBuffer,pe),qe=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Ae=Xe(E);gt(E)?d.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Ae,oe,E.width,E.height):K?s.renderbufferStorageMultisample(s.RENDERBUFFER,Ae,oe,E.width,E.height):s.renderbufferStorage(s.RENDERBUFFER,oe,E.width,E.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,qe,s.RENDERBUFFER,b)}else{const ce=E.textures;for(let pe=0;pe<ce.length;pe++){const oe=ce[pe],qe=u.convert(oe.format,oe.colorSpace),Ae=u.convert(oe.type),Be=U(oe.internalFormat,qe,Ae,oe.colorSpace),$e=Xe(E);K&&gt(E)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,$e,Be,E.width,E.height):gt(E)?d.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,$e,Be,E.width,E.height):s.renderbufferStorage(s.RENDERBUFFER,Be,E.width,E.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function ze(b,E){if(E&&E.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(s.FRAMEBUFFER,b),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ce=r.get(E.depthTexture);ce.__renderTarget=E,(!ce.__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),de(E.depthTexture,0);const pe=ce.__webglTexture,oe=Xe(E);if(E.depthTexture.format===Bo)gt(E)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,pe,0,oe):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,pe,0);else if(E.depthTexture.format===zo)gt(E)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,pe,0,oe):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,pe,0);else throw new Error("Unknown depthTexture format")}function Tt(b){const E=r.get(b),K=b.isWebGLCubeRenderTarget===!0;if(E.__boundDepthTexture!==b.depthTexture){const ce=b.depthTexture;if(E.__depthDisposeCallback&&E.__depthDisposeCallback(),ce){const pe=()=>{delete E.__boundDepthTexture,delete E.__depthDisposeCallback,ce.removeEventListener("dispose",pe)};ce.addEventListener("dispose",pe),E.__depthDisposeCallback=pe}E.__boundDepthTexture=ce}if(b.depthTexture&&!E.__autoAllocateDepthBuffer){if(K)throw new Error("target.depthTexture not supported in Cube render targets");const ce=b.texture.mipmaps;ce&&ce.length>0?ze(E.__webglFramebuffer[0],b):ze(E.__webglFramebuffer,b)}else if(K){E.__webglDepthbuffer=[];for(let ce=0;ce<6;ce++)if(n.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer[ce]),E.__webglDepthbuffer[ce]===void 0)E.__webglDepthbuffer[ce]=s.createRenderbuffer(),Ye(E.__webglDepthbuffer[ce],b,!1);else{const pe=b.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,oe=E.__webglDepthbuffer[ce];s.bindRenderbuffer(s.RENDERBUFFER,oe),s.framebufferRenderbuffer(s.FRAMEBUFFER,pe,s.RENDERBUFFER,oe)}}else{const ce=b.texture.mipmaps;if(ce&&ce.length>0?n.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer[0]):n.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer===void 0)E.__webglDepthbuffer=s.createRenderbuffer(),Ye(E.__webglDepthbuffer,b,!1);else{const pe=b.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,oe=E.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,oe),s.framebufferRenderbuffer(s.FRAMEBUFFER,pe,s.RENDERBUFFER,oe)}}n.bindFramebuffer(s.FRAMEBUFFER,null)}function Rt(b,E,K){const ce=r.get(b);E!==void 0&&we(ce.__webglFramebuffer,b,b.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),K!==void 0&&Tt(b)}function dt(b){const E=b.texture,K=r.get(b),ce=r.get(E);b.addEventListener("dispose",I);const pe=b.textures,oe=b.isWebGLCubeRenderTarget===!0,qe=pe.length>1;if(qe||(ce.__webglTexture===void 0&&(ce.__webglTexture=s.createTexture()),ce.__version=E.version,c.memory.textures++),oe){K.__webglFramebuffer=[];for(let Ae=0;Ae<6;Ae++)if(E.mipmaps&&E.mipmaps.length>0){K.__webglFramebuffer[Ae]=[];for(let Be=0;Be<E.mipmaps.length;Be++)K.__webglFramebuffer[Ae][Be]=s.createFramebuffer()}else K.__webglFramebuffer[Ae]=s.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){K.__webglFramebuffer=[];for(let Ae=0;Ae<E.mipmaps.length;Ae++)K.__webglFramebuffer[Ae]=s.createFramebuffer()}else K.__webglFramebuffer=s.createFramebuffer();if(qe)for(let Ae=0,Be=pe.length;Ae<Be;Ae++){const $e=r.get(pe[Ae]);$e.__webglTexture===void 0&&($e.__webglTexture=s.createTexture(),c.memory.textures++)}if(b.samples>0&&gt(b)===!1){K.__webglMultisampledFramebuffer=s.createFramebuffer(),K.__webglColorRenderbuffer=[],n.bindFramebuffer(s.FRAMEBUFFER,K.__webglMultisampledFramebuffer);for(let Ae=0;Ae<pe.length;Ae++){const Be=pe[Ae];K.__webglColorRenderbuffer[Ae]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,K.__webglColorRenderbuffer[Ae]);const $e=u.convert(Be.format,Be.colorSpace),_e=u.convert(Be.type),Ie=U(Be.internalFormat,$e,_e,Be.colorSpace,b.isXRRenderTarget===!0),nt=Xe(b);s.renderbufferStorageMultisample(s.RENDERBUFFER,nt,Ie,b.width,b.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ae,s.RENDERBUFFER,K.__webglColorRenderbuffer[Ae])}s.bindRenderbuffer(s.RENDERBUFFER,null),b.depthBuffer&&(K.__webglDepthRenderbuffer=s.createRenderbuffer(),Ye(K.__webglDepthRenderbuffer,b,!0)),n.bindFramebuffer(s.FRAMEBUFFER,null)}}if(oe){n.bindTexture(s.TEXTURE_CUBE_MAP,ce.__webglTexture),ee(s.TEXTURE_CUBE_MAP,E);for(let Ae=0;Ae<6;Ae++)if(E.mipmaps&&E.mipmaps.length>0)for(let Be=0;Be<E.mipmaps.length;Be++)we(K.__webglFramebuffer[Ae][Be],b,E,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Ae,Be);else we(K.__webglFramebuffer[Ae],b,E,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Ae,0);x(E)&&g(s.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(qe){for(let Ae=0,Be=pe.length;Ae<Be;Ae++){const $e=pe[Ae],_e=r.get($e);n.bindTexture(s.TEXTURE_2D,_e.__webglTexture),ee(s.TEXTURE_2D,$e),we(K.__webglFramebuffer,b,$e,s.COLOR_ATTACHMENT0+Ae,s.TEXTURE_2D,0),x($e)&&g(s.TEXTURE_2D)}n.unbindTexture()}else{let Ae=s.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(Ae=b.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),n.bindTexture(Ae,ce.__webglTexture),ee(Ae,E),E.mipmaps&&E.mipmaps.length>0)for(let Be=0;Be<E.mipmaps.length;Be++)we(K.__webglFramebuffer[Be],b,E,s.COLOR_ATTACHMENT0,Ae,Be);else we(K.__webglFramebuffer,b,E,s.COLOR_ATTACHMENT0,Ae,0);x(E)&&g(Ae),n.unbindTexture()}b.depthBuffer&&Tt(b)}function F(b){const E=b.textures;for(let K=0,ce=E.length;K<ce;K++){const pe=E[K];if(x(pe)){const oe=N(b),qe=r.get(pe).__webglTexture;n.bindTexture(oe,qe),g(oe),n.unbindTexture()}}}const Jt=[],vt=[];function wt(b){if(b.samples>0){if(gt(b)===!1){const E=b.textures,K=b.width,ce=b.height;let pe=s.COLOR_BUFFER_BIT;const oe=b.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,qe=r.get(b),Ae=E.length>1;if(Ae)for(let $e=0;$e<E.length;$e++)n.bindFramebuffer(s.FRAMEBUFFER,qe.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+$e,s.RENDERBUFFER,null),n.bindFramebuffer(s.FRAMEBUFFER,qe.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+$e,s.TEXTURE_2D,null,0);n.bindFramebuffer(s.READ_FRAMEBUFFER,qe.__webglMultisampledFramebuffer);const Be=b.texture.mipmaps;Be&&Be.length>0?n.bindFramebuffer(s.DRAW_FRAMEBUFFER,qe.__webglFramebuffer[0]):n.bindFramebuffer(s.DRAW_FRAMEBUFFER,qe.__webglFramebuffer);for(let $e=0;$e<E.length;$e++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(pe|=s.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(pe|=s.STENCIL_BUFFER_BIT)),Ae){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,qe.__webglColorRenderbuffer[$e]);const _e=r.get(E[$e]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,_e,0)}s.blitFramebuffer(0,0,K,ce,0,0,K,ce,pe,s.NEAREST),h===!0&&(Jt.length=0,vt.length=0,Jt.push(s.COLOR_ATTACHMENT0+$e),b.depthBuffer&&b.resolveDepthBuffer===!1&&(Jt.push(oe),vt.push(oe),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,vt)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,Jt))}if(n.bindFramebuffer(s.READ_FRAMEBUFFER,null),n.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),Ae)for(let $e=0;$e<E.length;$e++){n.bindFramebuffer(s.FRAMEBUFFER,qe.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+$e,s.RENDERBUFFER,qe.__webglColorRenderbuffer[$e]);const _e=r.get(E[$e]).__webglTexture;n.bindFramebuffer(s.FRAMEBUFFER,qe.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+$e,s.TEXTURE_2D,_e,0)}n.bindFramebuffer(s.DRAW_FRAMEBUFFER,qe.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&h){const E=b.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[E])}}}function Xe(b){return Math.min(a.maxSamples,b.samples)}function gt(b){const E=r.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function Ze(b){const E=c.render.frame;_.get(b)!==E&&(_.set(b,E),b.update())}function ot(b,E){const K=b.colorSpace,ce=b.format,pe=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||K!==Ws&&K!==gr&&(Et.getTransfer(K)===Dt?(ce!==ai||pe!==vi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",K)),E}function zt(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(m.width=b.naturalWidth||b.width,m.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(m.width=b.displayWidth,m.height=b.displayHeight):(m.width=b.width,m.height=b.height),m}this.allocateTextureUnit=Q,this.resetTextureUnits=re,this.setTexture2D=de,this.setTexture2DArray=ae,this.setTexture3D=le,this.setTextureCube=k,this.rebindTextures=Rt,this.setupRenderTarget=dt,this.updateRenderTargetMipmap=F,this.updateMultisampleRenderTarget=wt,this.setupDepthRenderbuffer=Tt,this.setupFrameBufferTexture=we,this.useMultisampledRTT=gt}function bE(s,e){function n(r,a=gr){let u;const c=Et.getTransfer(a);if(r===vi)return s.UNSIGNED_BYTE;if(r===Gf)return s.UNSIGNED_SHORT_4_4_4_4;if(r===Wf)return s.UNSIGNED_SHORT_5_5_5_1;if(r===Xm)return s.UNSIGNED_INT_5_9_9_9_REV;if(r===Gm)return s.BYTE;if(r===Wm)return s.SHORT;if(r===Oo)return s.UNSIGNED_SHORT;if(r===Vf)return s.INT;if(r===$r)return s.UNSIGNED_INT;if(r===Oi)return s.FLOAT;if(r===Go)return s.HALF_FLOAT;if(r===jm)return s.ALPHA;if(r===Ym)return s.RGB;if(r===ai)return s.RGBA;if(r===Bo)return s.DEPTH_COMPONENT;if(r===zo)return s.DEPTH_STENCIL;if(r===qm)return s.RED;if(r===Xf)return s.RED_INTEGER;if(r===$m)return s.RG;if(r===jf)return s.RG_INTEGER;if(r===Yf)return s.RGBA_INTEGER;if(r===El||r===Tl||r===wl||r===Al)if(c===Dt)if(u=e.get("WEBGL_compressed_texture_s3tc_srgb"),u!==null){if(r===El)return u.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===Tl)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===wl)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===Al)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(u=e.get("WEBGL_compressed_texture_s3tc"),u!==null){if(r===El)return u.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===Tl)return u.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===wl)return u.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===Al)return u.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===df||r===hf||r===pf||r===mf)if(u=e.get("WEBGL_compressed_texture_pvrtc"),u!==null){if(r===df)return u.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===hf)return u.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===pf)return u.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===mf)return u.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===gf||r===_f||r===vf)if(u=e.get("WEBGL_compressed_texture_etc"),u!==null){if(r===gf||r===_f)return c===Dt?u.COMPRESSED_SRGB8_ETC2:u.COMPRESSED_RGB8_ETC2;if(r===vf)return c===Dt?u.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:u.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===xf||r===Sf||r===yf||r===Mf||r===Ef||r===Tf||r===wf||r===Af||r===Rf||r===Cf||r===Pf||r===bf||r===Lf||r===Df)if(u=e.get("WEBGL_compressed_texture_astc"),u!==null){if(r===xf)return c===Dt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:u.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===Sf)return c===Dt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:u.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===yf)return c===Dt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:u.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===Mf)return c===Dt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:u.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===Ef)return c===Dt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:u.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===Tf)return c===Dt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:u.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===wf)return c===Dt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:u.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===Af)return c===Dt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:u.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===Rf)return c===Dt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:u.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===Cf)return c===Dt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:u.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===Pf)return c===Dt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:u.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===bf)return c===Dt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:u.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===Lf)return c===Dt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:u.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===Df)return c===Dt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:u.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===Rl||r===Uf||r===Nf)if(u=e.get("EXT_texture_compression_bptc"),u!==null){if(r===Rl)return c===Dt?u.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:u.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===Uf)return u.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===Nf)return u.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===Km||r===If||r===Ff||r===Of)if(u=e.get("EXT_texture_compression_rgtc"),u!==null){if(r===Rl)return u.COMPRESSED_RED_RGTC1_EXT;if(r===If)return u.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===Ff)return u.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===Of)return u.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===ko?s.UNSIGNED_INT_24_8:s[r]!==void 0?s[r]:null}return{convert:n}}const LE=`
void main() {
...
}`;class UE{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n,r){if(this.texture===null){const a=new wn,u=e.properties.get(a);u.__webglTexture=n.texture,(n.depthNear!==r.depthNear||n.depthFar!==r.depthFar)&&(this.depthNear=n.depthNear,this.depthFar=n.depthFar),this.texture=a}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,r=new Sr({vertexShader:LE,fragmentShader:DE,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new gi(new Nl(20,20),r)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class NE extends js{constructor(e,n){super();const r=this;let a=null,u=1,c=null,d="local-floor",h=1,m=null,_=null,v=null,S=null,y=null,T=null;const R=new UE,x=n.getContextAttributes();let g=null,N=null;const U=[],C=[],G=new At;let H=null;const I=new Kn;I.viewport=new Wt;const X=new Kn;X.viewport=new Wt;const P=[I,X],A=new tx;let B=null,re=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let fe=U[Z];return fe===void 0&&(fe=new Hc,U[Z]=fe),fe.getTargetRaySpace()},this.getControllerGrip=function(Z){let fe=U[Z];return fe===void 0&&(fe=new Hc,U[Z]=fe),fe.getGripSpace()},this.getHand=function(Z){let fe=U[Z];return fe===void 0&&(fe=new Hc,U[Z]=fe),fe.getHandSpace()};function Q(Z){const fe=C.indexOf(Z.inputSource);if(fe===-1)return;const Ee=U[fe];Ee!==void 0&&(Ee.update(Z.inputSource,Z.frame,m||c),Ee.dispatchEvent({type:Z.type,data:Z.inputSource}))}function ue(){a.removeEventListener("select",Q),a.removeEventListener("selectstart",Q),a.removeEventListener("selectend",Q),a.removeEventListener("squeeze",Q),a.removeEventListener("squeezestart",Q),a.removeEventListener("squeezeend",Q),a.removeEventListener("end",ue),a.removeEventListener("inputsourceschange",de);for(let Z=0;Z<U.length;Z++){const fe=C[Z];fe!==null&&(C[Z]=null,U[Z].disconnect(fe))}B=null,re=null,R.reset(),e.setRenderTarget(g),y=null,S=null,v=null,a=null,N=null,Ne.stop(),r.isPresenting=!1,e.setPixelRatio(H),e.setSize(G.width,G.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){u=Z,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){d=Z,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return m||c},this.setReferenceSpace=function(Z){m=Z},this.getBaseLayer=function(){return S!==null?S:y},this.getBinding=function(){return v},this.getFrame=function(){return T},this.getSession=function(){return a},this.setSession=async function(Z){if(a=Z,a!==null){if(g=e.getRenderTarget(),a.addEventListener("select",Q),a.addEventListener("selectstart",Q),a.addEventListener("selectend",Q),a.addEventListener("squeeze",Q),a.addEventListener("squeezestart",Q),a.addEventListener("squeezeend",Q),a.addEventListener("end",ue),a.addEventListener("inputsourceschange",de),x.xrCompatible!==!0&&await n.makeXRCompatible(),H=e.getPixelRatio(),e.getSize(G),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let Ee=null,xe=null,we=null;x.depth&&(we=x.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,Ee=x.stencil?zo:Bo,xe=x.stencil?ko:$r);const Ye={colorFormat:n.RGBA8,depthFormat:we,scaleFactor:u};v=new XRWebGLBinding(a,n),S=v.createProjectionLayer(Ye),a.updateRenderState({layers:[S]}),e.setPixelRatio(1),e.setSize(S.textureWidth,S.textureHeight,!1),N=new Kr(S.textureWidth,S.textureHeight,{format:ai,type:vi,depthTexture:new ag(S.textureWidth,S.textureHeight,xe,void 0,void 0,void 0,void 0,void 0,void 0,Ee),stencilBuffer:x.stencil,colorSpace:e.outputColorSpace,samples:x.antialias?4:0,resolveDepthBuffer:S.ignoreDepthValues===!1,resolveStencilBuffer:S.ignoreDepthValues===!1})}else{const Ee={antialias:x.antialias,alpha:!0,depth:x.depth,stencil:x.stencil,framebufferScaleFactor:u};y=new XRWebGLLayer(a,n,Ee),a.updateRenderState({baseLayer:y}),e.setPixelRatio(1),e.setSize(y.framebufferWidth,y.framebufferHeight,!1),N=new Kr(y.framebufferWidth,y.framebufferHeight,{format:ai,type:vi,colorSpace:e.outputColorSpace,stencilBuffer:x.stencil,resolveDepthBuffer:y.ignoreDepthValues===!1,resolveStencilBuffer:y.ignoreDepthValues===!1})}N.isXRRenderTarget=!0,this.setFoveation(h),m=null,c=await a.requestReferenceSpace(d),Ne.setContext(a),Ne.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(a!==null)return a.environmentBlendMode},this.getDepthTexture=function(){return R.getDepthTexture()};function de(Z){for(let fe=0;fe<Z.removed.length;fe++){const Ee=Z.removed[fe],xe=C.indexOf(Ee);xe>=0&&(C[xe]=null,U[xe].disconnect(Ee))}for(let fe=0;fe<Z.added.length;fe++){const Ee=Z.added[fe];let xe=C.indexOf(Ee);if(xe===-1){for(let Ye=0;Ye<U.length;Ye++)if(Ye>=C.length){C.push(Ee),xe=Ye;break}else if(C[Ye]===null){C[Ye]=Ee,xe=Ye;break}if(xe===-1)break}const we=U[xe];we&&we.connect(Ee)}}const ae=new ne,le=new ne;function k(Z,fe,Ee){ae.setFromMatrixPosition(fe.matrixWorld),le.setFromMatrixPosition(Ee.matrixWorld);const xe=ae.distanceTo(le),we=fe.projectionMatrix.elements,Ye=Ee.projectionMatrix.elements,ze=we[14]/(we[10]-1),Tt=we[14]/(we[10]+1),Rt=(we[9]+1)/we[5],dt=(we[9]-1)/we[5],F=(we[8]-1)/we[0],Jt=(Ye[8]+1)/Ye[0],vt=ze*F,wt=ze*Jt,Xe=xe/(-F+Jt),gt=Xe*-F;if(fe.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(gt),Z.translateZ(Xe),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),we[10]===-1)Z.projectionMatrix.copy(fe.projectionMatrix),Z.projectionMatrixInverse.copy(fe.projectionMatrixInverse);else{const Ze=ze+Xe,ot=Tt+Xe,zt=vt-gt,b=wt+(xe-gt),E=Rt*Tt/ot*Ze,K=dt*Tt/ot*Ze;Z.projectionMatrix.makePerspective(zt,b,E,K,Ze,ot),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function se(Z,fe){fe===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(fe.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(a===null)return;let fe=Z.near,Ee=Z.far;R.texture!==null&&(R.depthNear>0&&(fe=R.depthNear),R.depthFar>0&&(Ee=R.depthFar)),A.near=X.near=I.near=fe,A.far=X.far=I.far=Ee,(B!==A.near||re!==A.far)&&(a.updateRenderState({depthNear:A.near,depthFar:A.far}),B=A.near,re=A.far),I.layers.mask=Z.layers.mask|2,X.layers.mask=Z.layers.mask|4,A.layers.mask=I.layers.mask|X.layers.mask;const xe=Z.parent,we=A.cameras;se(A,xe);for(let Ye=0;Ye<we.length;Ye++)se(we[Ye],xe);we.length===2?k(A,I,X):A.projectionMatrix.copy(I.projectionMatrix),ie(Z,A,xe)};function ie(Z,fe,Ee){Ee===null?Z.matrix.copy(fe.matrixWorld):(Z.matrix.copy(Ee.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(fe.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(fe.projectionMatrix),Z.projectionMatrixInverse.copy(fe.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=kf*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return A},this.getFoveation=function(){if(!(S===null&&y===null))return h},this.setFoveation=function(Z){h=Z,S!==null&&(S.fixedFoveation=Z),y!==null&&y.fixedFoveation!==void 0&&(y.fixedFoveation=Z)},this.hasDepthSensing=function(){return R.texture!==null},this.getDepthSensingMesh=function(){return R.getMesh(A)};let D=null;function ee(Z,fe){if(_=fe.getViewerPose(m||c),T=fe,_!==null){const Ee=_.views;y!==null&&(e.setRenderTargetFramebuffer(N,y.framebuffer),e.setRenderTarget(N));let xe=!1;Ee.length!==A.cameras.length&&(A.cameras.length=0,xe=!0);for(let ze=0;ze<Ee.length;ze++){const Tt=Ee[ze];let Rt=null;if(y!==null)Rt=y.getViewport(Tt);else{const F=v.getViewSubImage(S,Tt);Rt=F.viewport,ze===0&&(e.setRenderTargetTextures(N,F.colorTexture,F.depthStencilTexture),e.setRenderTarget(N))}let dt=P[ze];dt===void 0&&(dt=new Kn,dt.layers.enable(ze),dt.viewport=new Wt,P[ze]=dt),dt.matrix.fromArray(Tt.transform.matrix),dt.matrix.decompose(dt.position,dt.quaternion,dt.scale),dt.projectionMatrix.fromArray(Tt.projectionMatrix),dt.projectionMatrixInverse.copy(dt.projectionMatrix).invert(),dt.viewport.set(Rt.x,Rt.y,Rt.width,Rt.height),ze===0&&(A.matrix.copy(dt.matrix),A.matrix.decompose(A.position,A.quaternion,A.scale)),xe===!0&&A.cameras.push(dt)}const we=a.enabledFeatures;if(we&&we.includes("depth-sensing")&&a.depthUsage=="gpu-optimized"&&v){const ze=v.getDepthInformation(Ee[0]);ze&&ze.isValid&&ze.texture&&R.init(e,ze,a.renderState)}}for(let Ee=0;Ee<U.length;Ee++){const xe=C[Ee],we=U[Ee];xe!==null&&we!==void 0&&we.update(xe,fe,m||c)}D&&D(Z,fe),fe.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:fe}),T=null}const Ne=new ug;Ne.setAnimationLoop(ee),this.setAnimationLoop=function(Z){D=Z},this.dispose=function(){}}}const zr=new zi,IE=new Xt;function FE(s,e){function n(x,g){x.matrixAutoUpdate===!0&&x.updateMatrix(),g.value.copy(x.matrix)}function r(x,g){g.color.getRGB(x.fogColor.value,rg(s)),g.isFog?(x.fogNear.value=g.near,x.fogFar.value=g.far):g.isFogExp2&&(x.fogDensity.value=g.density)}function a(x,g,N,U,C){g.isMeshBasicMaterial||g.isMeshLambertMaterial?u(x,g):g.isMeshToonMaterial?(u(x,g),v(x,g)):g.isMeshPhongMaterial?(u(x,g),_(x,g)):g.isMeshStandardMaterial?(u(x,g),S(x,g),g.isMeshPhysicalMaterial&&y(x,g,C)):g.isMeshMatcapMaterial?(u(x,g),T(x,g)):g.isMeshDepthMaterial?u(x,g):g.isMeshDistanceMaterial?(u(x,g),R(x,g)):g.isMeshNormalMaterial?u(x,g):g.isLineBasicMaterial?(c(x,g),g.isLineDashedMaterial&&d(x,g)):g.isPointsMaterial?h(x,g,N,U):g.isSpriteMaterial?m(x,g):g.isShadowMaterial?(x.color.value.copy(g.color),x.opacity.value=g.opacity):g.isShaderMaterial&&(g.uniformsNeedUpdate=!1)}function u(x,g){x.opacity.value=g.opacity,g.color&&x.diffuse.value.copy(g.color),g.emissive&&x.emissive.value.copy(g.emissive).multiplyScalar(g.emissiveIntensity),g.map&&(x.map.value=g.map,n(g.map,x.mapTransform)),g.alphaMap&&(x.alphaMap.value=g.alphaMap,n(g.alphaMap,x.alphaMapTransform)),g.bumpMap&&(x.bumpMap.value=g.bumpMap,n(g.bumpMap,x.bumpMapTransform),x.bumpScale.value=g.bumpScale,g.side===Nn&&(x.bumpScale.value*=-1)),g.normalMap&&(x.normalMap.value=g.normalMap,n(g.normalMap,x.normalMapTransform),x.normalScale.value.copy(g.normalScale),g.side===Nn&&x.normalScale.value.negate()),g.displacementMap&&(x.displacementMap.value=g.displacementMap,n(g.displacementMap,x.displacementMapTransform),x.displacementScale.value=g.displacementScale,x.displacementBias.value=g.displacementBias),g.emissiveMap&&(x.emissiveMap.value=g.emissiveMap,n(g.emissiveMap,x.emissiveMapTransform)),g.specularMap&&(x.specularMap.value=g.specularMap,n(g.specularMap,x.specularMapTransform)),g.alphaTest>0&&(x.alphaTest.value=g.alphaTest);const N=e.get(g),U=N.envMap,C=N.envMapRotation;U&&(x.envMap.value=U,zr.copy(C),zr.x*=-1,zr.y*=-1,zr.z*=-1,U.isCubeTexture&&U.isRenderTargetTexture===!1&&(zr.y*=-1,zr.z*=-1),x.envMapRotation.value.setFromMatrix4(IE.makeRotationFromEuler(zr)),x.flipEnvMap.value=U.isCubeTexture&&U.isRenderTargetTexture===!1?-1:1,x.reflectivity.value=g.reflectivity,x.ior.value=g.ior,x.refractionRatio.value=g.refractionRatio),g.lightMap&&(x.lightMap.value=g.lightMap,x.lightMapIntensity.value=g.lightMapIntensity,n(g.lightMap,x.lightMapTransform)),g.aoMap&&(x.aoMap.value=g.aoMap,x.aoMapIntensity.value=g.aoMapIntensity,n(g.aoMap,x.aoMapTransform))}function c(x,g){x.diffuse.value.copy(g.color),x.opacity.value=g.opacity,g.map&&(x.map.value=g.map,n(g.map,x.mapTransform))}function d(x,g){x.dashSize.value=g.dashSize,x.totalSize.value=g.dashSize+g.gapSize,x.scale.value=g.scale}function h(x,g,N,U){x.diffuse.value.copy(g.color),x.opacity.value=g.opacity,x.size.value=g.size*N,x.scale.value=U*.5,g.map&&(x.map.value=g.map,n(g.map,x.uvTransform)),g.alphaMap&&(x.alphaMap.value=g.alphaMap,n(g.alphaMap,x.alphaMapTransform)),g.alphaTest>0&&(x.alphaTest.value=g.alphaTest)}function m(x,g){x.diffuse.value.copy(g.color),x.opacity.value=g.opacity,x.rotation.value=g.rotation,g.map&&(x.map.value=g.map,n(g.map,x.mapTransform)),g.alphaMap&&(x.alphaMap.value=g.alphaMap,n(g.alphaMap,x.alphaMapTransform)),g.alphaTest>0&&(x.alphaTest.value=g.alphaTest)}function _(x,g){x.specular.value.copy(g.specular),x.shininess.value=Math.max(g.shininess,1e-4)}function v(x,g){g.gradientMap&&(x.gradientMap.value=g.gradientMap)}function S(x,g){x.metalness.value=g.metalness,g.metalnessMap&&(x.metalnessMap.value=g.metalnessMap,n(g.metalnessMap,x.metalnessMapTransform)),x.roughness.value=g.roughness,g.roughnessMap&&(x.roughnessMap.value=g.roughnessMap,n(g.roughnessMap,x.roughnessMapTransform)),g.envMap&&(x.envMapIntensity.value=g.envMapIntensity)}function y(x,g,N){x.ior.value=g.ior,g.sheen>0&&(x.sheenColor.value.copy(g.sheenColor).multiplyScalar(g.sheen),x.sheenRoughness.value=g.sheenRoughness,g.sheenColorMap&&(x.sheenColorMap.value=g.sheenColorMap,n(g.sheenColorMap,x.sheenColorMapTransform)),g.sheenRoughnessMap&&(x.sheenRoughnessMap.value=g.sheenRoughnessMap,n(g.sheenRoughnessMap,x.sheenRoughnessMapTransform))),g.clearcoat>0&&(x.clearcoat.value=g.clearcoat,x.clearcoatRoughness.value=g.clearcoatRoughness,g.clearcoatMap&&(x.clearcoatMap.value=g.clearcoatMap,n(g.clearcoatMap,x.clearcoatMapTransform)),g.clearcoatRoughnessMap&&(x.clearcoatRoughnessMap.value=g.clearcoatRoughnessMap,n(g.clearcoatRoughnessMap,x.clearcoatRoughnessMapTransform)),g.clearcoatNormalMap&&(x.clearcoatNormalMap.value=g.clearcoatNormalMap,n(g.clearcoatNormalMap,x.clearcoatNormalMapTransform),x.clearcoatNormalScale.value.copy(g.clearcoatNormalScale),g.side===Nn&&x.clearcoatNormalScale.value.negate())),g.dispersion>0&&(x.dispersion.value=g.dispersion),g.iridescence>0&&(x.iridescence.value=g.iridescence,x.iridescenceIOR.value=g.iridescenceIOR,x.iridescenceThicknessMinimum.value=g.iridescenceThicknessRange[0],x.iridescenceThicknessMaximum.value=g.iridescenceThicknessRange[1],g.iridescenceMap&&(x.iridescenceMap.value=g.iridescenceMap,n(g.iridescenceMap,x.iridescenceMapTransform)),g.iridescenceThicknessMap&&(x.iridescenceThicknessMap.value=g.iridescenceThicknessMap,n(g.iridescenceThicknessMap,x.iridescenceThicknessMapTransform))),g.transmission>0&&(x.transmission.value=g.transmission,x.transmissionSamplerMap.value=N.texture,x.transmissionSamplerSize.value.set(N.width,N.height),g.transmissionMap&&(x.transmissionMap.value=g.transmissionMap,n(g.transmissionMap,x.transmissionMapTransform)),x.thickness.value=g.thickness,g.thicknessMap&&(x.thicknessMap.value=g.thicknessMap,n(g.thicknessMap,x.thicknessMapTransform)),x.attenuationDistance.value=g.attenuationDistance,x.attenuationColor.value.copy(g.attenuationColor)),g.anisotropy>0&&(x.anisotropyVector.value.set(g.anisotropy*Math.cos(g.anisotropyRotation),g.anisotropy*Math.sin(g.anisotropyRotation)),g.anisotropyMap&&(x.anisotropyMap.value=g.anisotropyMap,n(g.anisotropyMap,x.anisotropyMapTransform))),x.specularIntensity.value=g.specularIntensity,x.specularColor.value.copy(g.specularColor),g.specularColorMap&&(x.specularColorMap.value=g.specularColorMap,n(g.specularColorMap,x.specularColorMapTransform)),g.specularIntensityMap&&(x.specularIntensityMap.value=g.specularIntensityMap,n(g.specularIntensityMap,x.specularIntensityMapTransform))}function T(x,g){g.matcap&&(x.matcap.value=g.matcap)}function R(x,g){const N=e.get(g).light;x.referencePosition.value.setFromMatrixPosition(N.matrixWorld),x.nearDistance.value=N.shadow.camera.near,x.farDistance.value=N.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:a}}function OE(s,e,n,r){let a={},u={},c=[];const d=s.getParameter(s.MAX_UNIFORM_BUFFER_BINDINGS);function h(N,U){const C=U.program;r.uniformBlockBinding(N,C)}function m(N,U){let C=a[N.id];C===void 0&&(T(N),C=_(N),a[N.id]=C,N.addEventListener("dispose",x));const G=U.program;r.updateUBOMapping(N,G);const H=e.render.frame;u[N.id]!==H&&(S(N),u[N.id]=H)}function _(N){const U=v();N.__bindingPointIndex=U;const C=s.createBuffer(),G=N.__size,H=N.usage;return s.bindBuffer(s.UNIFORM_BUFFER,C),s.bufferData(s.UNIFORM_BUFFER,G,H),s.bindBuffer(s.UNIFORM_BUFFER,null),s.bindBufferBase(s.UNIFORM_BUFFER,U,C),C}function v(){for(let N=0;N<d;N++)if(c.indexOf(N)===-1)return c.push(N),N;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function S(N){const U=a[N.id],C=N.uniforms,G=N.__cache;s.bindBuffer(s.UNIFORM_BUFFER,U);for(let H=0,I=C.length;H<I;H++){const X=Array.isArray(C[H])?C[H]:[C[H]];for(let P=0,A=X.length;P<A;P++){const B=X[P];if(y(B,H,P,G)===!0){const re=B.__offset,Q=Array.isArray(B.value)?B.value:[B.value];let ue=0;for(let de=0;de<Q.length;de++){const ae=Q[de],le=R(ae);typeof ae=="number"||typeof ae=="boolean"?(B.__data[0]=ae,s.bufferSubData(s.UNIFORM_BUFFER,re+ue,B.__data)):ae.isMatrix3?(B.__data[0]=ae.elements[0],B.__data[1]=ae.elements[1],B.__data[2]=ae.elements[2],B.__data[3]=0,B.__data[4]=ae.elements[3],B.__data[5]=ae.elements[4],B.__data[6]=ae.elements[5],B.__data[7]=0,B.__data[8]=ae.elements[6],B.__data[9]=ae.elements[7],B.__data[10]=ae.elements[8],B.__data[11]=0):(ae.toArray(B.__data,ue),ue+=le.storage/Float32Array.BYTES_PER_ELEMENT)}s.bufferSubData(s.UNIFORM_BUFFER,re,B.__data)}}}s.bindBuffer(s.UNIFORM_BUFFER,null)}function y(N,U,C,G){const H=N.value,I=U+"_"+C;if(G[I]===void 0)return typeof H=="number"||typeof H=="boolean"?G[I]=H:G[I]=H.clone(),!0;{const X=G[I];if(typeof H=="number"||typeof H=="boolean"){if(X!==H)return G[I]=H,!0}else if(X.equals(H)===!1)return X.copy(H),!0}return!1}function T(N){const U=N.uniforms;let C=0;const G=16;for(let I=0,X=U.length;I<X;I++){const P=Array.isArray(U[I])?U[I]:[U[I]];for(let A=0,B=P.length;A<B;A++){const re=P[A],Q=Array.isArray(re.value)?re.value:[re.value];for(let ue=0,de=Q.length;ue<de;ue++){const ae=Q[ue],le=R(ae),k=C%G,se=k%le.boundary,ie=k+se;C+=se,ie!==0&&G-ie<le.storage&&(C+=G-ie),re.__data=new Float32Array(le.storage/Float32Array.BYTES_PER_ELEMENT),re.__offset=C,C+=le.storage}}}const H=C%G;return H>0&&(C+=G-H),N.__size=C,N.__cache={},this}function R(N){const U={boundary:0,storage:0};return typeof N=="number"||typeof N=="boolean"?(U.boundary=4,U.storage=4):N.isVector2?(U.boundary=8,U.storage=8):N.isVector3||N.isColor?(U.boundary=16,U.storage=12):N.isVector4?(U.boundary=16,U.storage=16):N.isMatrix3?(U.boundary=48,U.storage=48):N.isMatrix4?(U.boundary=64,U.storage=64):N.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",N),U}function x(N){const U=N.target;U.removeEventListener("dispose",x);const C=c.indexOf(U.__bindingPointIndex);c.splice(C,1),s.deleteBuffer(a[U.id]),delete a[U.id],delete u[U.id]}function g(){for(const N in a)s.deleteBuffer(a[N]);c=[],a={},u={}}return{bind:h,update:m,dispose:g}}class kE{constructor(e={}){const{canvas:n=d0(),context:r=null,depth:a=!0,stencil:u=!1,alpha:c=!1,antialias:d=!1,premultipliedAlpha:h=!0,preserveDrawingBuffer:m=!1,powerPreference:_="default",failIfMajorPerformanceCaveat:v=!1,reverseDepthBuffer:S=!1}=e;this.isWebGLRenderer=!0;let y;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");y=r.getContextAttributes().alpha}else y=c;const T=new Uint32Array(4),R=new Int32Array(4);let x=null,g=null;const N=[],U=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=vr,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const C=this;let G=!1;this._outputColorSpace=$n;let H=0,I=0,X=null,P=-1,A=null;const B=new Wt,re=new Wt;let Q=null;const ue=new Pt(0);let de=0,ae=n.width,le=n.height,k=1,se=null,ie=null;const D=new Wt(0,0,ae,le),ee=new Wt(0,0,ae,le);let Ne=!1;const Z=new Kf;let fe=!1,Ee=!1;const xe=new Xt,we=new Xt,Ye=new ne,ze=new Wt,Tt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Rt=!1;function dt(){return X===null?k:1}let F=r;function Jt(w,W){return n.getContext(w,W)}try{const w={alpha:!0,depth:a,stencil:u,antialias:d,premultipliedAlpha:h,preserveDrawingBuffer:m,powerPreference:_,failIfMajorPerformanceCaveat:v};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Hf}`),n.addEventListener("webglcontextlost",De,!1),n.addEventListener("webglcontextrestored",ye,!1),n.addEventListener("webglcontextcreationerror",he,!1),F===null){const W="webgl2";if(F=Jt(W,w),F===null)throw Jt(W)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(w){throw console.error("THREE.WebGLRenderer: "+w.message),w}let vt,wt,Xe,gt,Ze,ot,zt,b,E,K,ce,pe,oe,qe,Ae,Be,$e,_e,Ie,nt,Je,Re,st,z;function Pe(){vt=new qy(F),vt.init(),Re=new bE(F,vt),wt=new Hy(F,vt,e,Re),Xe=new CE(F,vt),wt.reverseDepthBuffer&&S&&Xe.buffers.depth.setReversed(!0),gt=new Zy(F),Ze=new mE,ot=new PE(F,vt,Xe,Ze,wt,Re,gt),zt=new Gy(C),b=new Yy(C),E=new ix(F),st=new By(F,E),K=new $y(F,E,gt,st),ce=new Jy(F,K,E,gt),Ie=new Qy(F,wt,ot),Be=new Vy(Ze),pe=new pE(C,zt,b,vt,wt,st,Be),oe=new FE(C,Ze),qe=new _E,Ae=new EE(vt),_e=new ky(C,zt,b,Xe,ce,y,h),$e=new AE(C,ce,wt),z=new OE(F,gt,wt,Xe),nt=new zy(F,vt,gt),Je=new Ky(F,vt,gt),gt.programs=pe.programs,C.capabilities=wt,C.extensions=vt,C.properties=Ze,C.renderLists=qe,C.shadowMap=$e,C.state=Xe,C.info=gt}Pe();const ge=new NE(C,F);this.xr=ge,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){const w=vt.get("WEBGL_lose_context");w&&w.loseContext()},this.forceContextRestore=function(){const w=vt.get("WEBGL_lose_context");w&&w.restoreContext()},this.getPixelRatio=function(){return k},this.setPixelRatio=function(w){w!==void 0&&(k=w,this.setSize(ae,le,!1))},this.getSize=function(w){return w.set(ae,le)},this.setSize=function(w,W,te=!0){if(ge.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}ae=w,le=W,n.width=Math.floor(w*k),n.height=Math.floor(W*k),te===!0&&(n.style.width=w+"px",n.style.height=W+"px"),this.setViewport(0,0,w,W)},this.getDrawingBufferSize=function(w){return w.set(ae*k,le*k).floor()},this.setDrawingBufferSize=function(w,W,te){ae=w,le=W,k=te,n.width=Math.floor(w*te),n.height=Math.floor(W*te),this.setViewport(0,0,w,W)},this.getCurrentViewport=function(w){return w.copy(B)},this.getViewport=function(w){return w.copy(D)},this.setViewport=function(w,W,te,q){w.isVector4?D.set(w.x,w.y,w.z,w.w):D.set(w,W,te,q),Xe.viewport(B.copy(D).multiplyScalar(k).round())},this.getScissor=function(w){return w.copy(ee)},this.setScissor=function(w,W,te,q){w.isVector4?ee.set(w.x,w.y,w.z,w.w):ee.set(w,W,te,q),Xe.scissor(re.copy(ee).multiplyScalar(k).round())},this.getScissorTest=function(){return Ne},this.setScissorTest=function(w){Xe.setScissorTest(Ne=w)},this.setOpaqueSort=function(w){se=w},this.setTransparentSort=function(w){ie=w},this.getClearColor=function(w){return w.copy(_e.getClearColor())},this.setClearColor=function(){_e.setClearColor(...arguments)},this.getClearAlpha=function(){return _e.getClearAlpha()},this.setClearAlpha=function(){_e.setClearAlpha(...arguments)},this.clear=function(w=!0,W=!0,te=!0){let q=0;if(w){let j=!1;if(X!==null){const Me=X.texture.format;j=Me===Yf||Me===jf||Me===Xf}if(j){const Me=X.texture.type,be=Me===vi||Me===$r||Me===Oo||Me===ko||Me===Gf||Me===Wf,Oe=_e.getClearColor(),Fe=_e.getClearAlpha(),rt=Oe.r,it=Oe.g,Ve=Oe.b;be?(T[0]=rt,T[1]=it,T[2]=Ve,T[3]=Fe,F.clearBufferuiv(F.COLOR,0,T)):(R[0]=rt,R[1]=it,R[2]=Ve,R[3]=Fe,F.clearBufferiv(F.COLOR,0,R))}else q|=F.COLOR_BUFFER_BIT}W&&(q|=F.DEPTH_BUFFER_BIT),te&&(q|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),F.clear(q)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",De,!1),n.removeEventListener("webglcontextrestored",ye,!1),n.removeEventListener("webglcontextcreationerror",he,!1),_e.dispose(),qe.dispose(),Ae.dispose(),Ze.dispose(),zt.dispose(),b.dispose(),ce.dispose(),st.dispose(),z.dispose(),pe.dispose(),ge.dispose(),ge.removeEventListener("sessionstart",Qr),ge.removeEventListener("sessionend",Hi),xi.stop()};function De(w){w.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),G=!0}function ye(){console.log("THREE.WebGLRenderer: Context Restored."),G=!1;const w=gt.autoReset,W=$e.enabled,te=$e.autoUpdate,q=$e.needsUpdate,j=$e.type;Pe(),gt.autoReset=w,$e.enabled=W,$e.autoUpdate=te,$e.needsUpdate=q,$e.type=j}function he(w){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",w.statusMessage)}function He(w){const W=w.target;W.removeEventListener("dispose",He),lt(W)}function lt(w){bt(w),Ze.remove(w)}function bt(w){const W=Ze.get(w).programs;W!==void 0&&(W.forEach(function(te){pe.releaseProgram(te)}),w.isShaderMaterial&&pe.releaseShaderCache(w))}this.renderBufferDirect=function(w,W,te,q,j,Me){W===null&&(W=Tt);const be=j.isMesh&&j.matrixWorld.determinant()<0,Oe=$o(w,W,te,q,j);Xe.setMaterial(q,be);let Fe=te.index,rt=1;if(q.wireframe===!0){if(Fe=K.getWireframeAttribute(te),Fe===void 0)return;rt=2}const it=te.drawRange,Ve=te.attributes.position;let ht=it.start*rt,ct=(it.start+it.count)*rt;Me!==null&&(ht=Math.max(ht,Me.start*rt),ct=Math.min(ct,(Me.start+Me.count)*rt)),Fe!==null?(ht=Math.max(ht,0),ct=Math.min(ct,Fe.count)):Ve!=null&&(ht=Math.max(ht,0),ct=Math.min(ct,Ve.count));const kt=ct-ht;if(kt<0||kt===1/0)return;st.setup(j,q,Oe,te,Fe);let Ut,Ct=nt;if(Fe!==null&&(Ut=E.get(Fe),Ct=Je,Ct.setIndex(Ut)),j.isMesh)q.wireframe===!0?(Xe.setLineWidth(q.wireframeLinewidth*dt()),Ct.setMode(F.LINES)):Ct.setMode(F.TRIANGLES);else if(j.isLine){let Qe=q.linewidth;Qe===void 0&&(Qe=1),Xe.setLineWidth(Qe*dt()),j.isLineSegments?Ct.setMode(F.LINES):j.isLineLoop?Ct.setMode(F.LINE_LOOP):Ct.setMode(F.LINE_STRIP)}else j.isPoints?Ct.setMode(F.POINTS):j.isSprite&&Ct.setMode(F.TRIANGLES);if(j.isBatchedMesh)if(j._multiDrawInstances!==null)Bs("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Ct.renderMultiDrawInstances(j._multiDrawStarts,j._multiDrawCounts,j._multiDrawCount,j._multiDrawInstances);else if(vt.get("WEBGL_multi_draw"))Ct.renderMultiDraw(j._multiDrawStarts,j._multiDrawCounts,j._multiDrawCount);else{const Qe=j._multiDrawStarts,Lt=j._multiDrawCounts,pt=j._multiDrawCount,en=Fe?E.get(Fe).bytesPerElement:1,Gi=Ze.get(q).currentProgram.getUniforms();for(let Sn=0;Sn<pt;Sn++)Gi.setValue(F,"_gl_DrawID",Sn),Ct.render(Qe[Sn]/en,Lt[Sn])}else if(j.isInstancedMesh)Ct.renderInstances(ht,kt,j.count);else if(te.isInstancedBufferGeometry){const Qe=te._maxInstanceCount!==void 0?te._maxInstanceCount:1/0,Lt=Math.min(te.instanceCount,Qe);Ct.renderInstances(ht,kt,Lt)}else Ct.render(ht,kt)};function xt(w,W,te){w.transparent===!0&&w.side===Fi&&w.forceSinglePass===!1?(w.side=Nn,w.needsUpdate=!0,Jr(w,W,te),w.side=xr,w.needsUpdate=!0,Jr(w,W,te),w.side=Fi):Jr(w,W,te)}this.compile=function(w,W,te=null){te===null&&(te=w),g=Ae.get(te),g.init(W),U.push(g),te.traverseVisible(function(j){j.isLight&&j.layers.test(W.layers)&&(g.pushLight(j),j.castShadow&&g.pushShadow(j))}),w!==te&&w.traverseVisible(function(j){j.isLight&&j.layers.test(W.layers)&&(g.pushLight(j),j.castShadow&&g.pushShadow(j))}),g.setupLights();const q=new Set;return w.traverse(function(j){if(!(j.isMesh||j.isPoints||j.isLine||j.isSprite))return;const Me=j.material;if(Me)if(Array.isArray(Me))for(let be=0;be<Me.length;be++){const Oe=Me[be];xt(Oe,te,j),q.add(Oe)}else xt(Me,te,j),q.add(Me)}),g=U.pop(),q},this.compileAsync=function(w,W,te=null){const q=this.compile(w,W,te);return new Promise(j=>{function Me(){if(q.forEach(function(be){Ze.get(be).currentProgram.isReady()&&q.delete(be)}),q.size===0){j(w);return}setTimeout(Me,10)}vt.get("KHR_parallel_shader_compile")!==null?Me():setTimeout(Me,10)})};let An=null;function xn(w){An&&An(w)}function Qr(){xi.stop()}function Hi(){xi.start()}const xi=new ug;xi.setAnimationLoop(xn),typeof self<"u"&&xi.setContext(self),this.setAnimationLoop=function(w){An=w,ge.setAnimationLoop(w),w===null?xi.stop():xi.start()},ge.addEventListener("sessionstart",Qr),ge.addEventListener("sessionend",Hi),this.render=function(w,W){if(W!==void 0&&W.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(G===!0)return;if(w.matrixWorldAutoUpdate===!0&&w.updateMatrixWorld(),W.parent===null&&W.matrixWorldAutoUpdate===!0&&W.updateMatrixWorld(),ge.enabled===!0&&ge.isPresenting===!0&&(ge.cameraAutoUpdate===!0&&ge.updateCamera(W),W=ge.getCamera()),w.isScene===!0&&w.onBeforeRender(C,w,W,X),g=Ae.get(w,U.length),g.init(W),U.push(g),we.multiplyMatrices(W.projectionMatrix,W.matrixWorldInverse),Z.setFromProjectionMatrix(we),Ee=this.localClippingEnabled,fe=Be.init(this.clippingPlanes,Ee),x=qe.get(w,N.length),x.init(),N.push(x),ge.enabled===!0&&ge.isPresenting===!0){const Me=C.xr.getDepthSensingMesh();Me!==null&&Si(Me,W,-1/0,C.sortObjects)}Si(w,W,0,C.sortObjects),x.finish(),C.sortObjects===!0&&x.sort(se,ie),Rt=ge.enabled===!1||ge.isPresenting===!1||ge.hasDepthSensing()===!1,Rt&&_e.addToRenderList(x,w),this.info.render.frame++,fe===!0&&Be.beginShadows();const te=g.state.shadowsArray;$e.render(te,w,W),fe===!0&&Be.endShadows(),this.info.autoReset===!0&&this.info.reset();const q=x.opaque,j=x.transmissive;if(g.setupLights(),W.isArrayCamera){const Me=W.cameras;if(j.length>0)for(let be=0,Oe=Me.length;be<Oe;be++){const Fe=Me[be];Mr(q,j,w,Fe)}Rt&&_e.render(w);for(let be=0,Oe=Me.length;be<Oe;be++){const Fe=Me[be];yr(x,w,Fe,Fe.viewport)}}else j.length>0&&Mr(q,j,w,W),Rt&&_e.render(w),yr(x,w,W);X!==null&&I===0&&(ot.updateMultisampleRenderTarget(X),ot.updateRenderTargetMipmap(X)),w.isScene===!0&&w.onAfterRender(C,w,W),st.resetDefaultState(),P=-1,A=null,U.pop(),U.length>0?(g=U[U.length-1],fe===!0&&Be.setGlobalState(C.clippingPlanes,g.state.camera)):g=null,N.pop(),N.length>0?x=N[N.length-1]:x=null};function Si(w,W,te,q){if(w.visible===!1)return;if(w.layers.test(W.layers)){if(w.isGroup)te=w.renderOrder;else if(w.isLOD)w.autoUpdate===!0&&w.update(W);else if(w.isLight)g.pushLight(w),w.castShadow&&g.pushShadow(w);else if(w.isSprite){if(!w.frustumCulled||Z.intersectsSprite(w)){q&&ze.setFromMatrixPosition(w.matrixWorld).applyMatrix4(we);const be=ce.update(w),Oe=w.material;Oe.visible&&x.push(w,be,Oe,te,ze.z,null)}}else if((w.isMesh||w.isLine||w.isPoints)&&(!w.frustumCulled||Z.intersectsObject(w))){const be=ce.update(w),Oe=w.material;if(q&&(w.boundingSphere!==void 0?(w.boundingSphere===null&&w.computeBoundingSphere(),ze.copy(w.boundingSphere.center)):(be.boundingSphere===null&&be.computeBoundingSphere(),ze.copy(be.boundingSphere.center)),ze.applyMatrix4(w.matrixWorld).applyMatrix4(we)),Array.isArray(Oe)){const Fe=be.groups;for(let rt=0,it=Fe.length;rt<it;rt++){const Ve=Fe[rt],ht=Oe[Ve.materialIndex];ht&&ht.visible&&x.push(w,be,ht,te,ze.z,Ve)}}else Oe.visible&&x.push(w,be,Oe,te,ze.z,null)}}const Me=w.children;for(let be=0,Oe=Me.length;be<Oe;be++)Si(Me[be],W,te,q)}function yr(w,W,te,q){const j=w.opaque,Me=w.transmissive,be=w.transparent;g.setupLightsView(te),fe===!0&&Be.setGlobalState(C.clippingPlanes,te),q&&Xe.viewport(B.copy(q)),j.length>0&&Vi(j,W,te),Me.length>0&&Vi(Me,W,te),be.length>0&&Vi(be,W,te),Xe.buffers.depth.setTest(!0),Xe.buffers.depth.setMask(!0),Xe.buffers.color.setMask(!0),Xe.setPolygonOffset(!1)}function Mr(w,W,te,q){if((te.isScene===!0?te.overrideMaterial:null)!==null)return;g.state.transmissionRenderTarget[q.id]===void 0&&(g.state.transmissionRenderTarget[q.id]=new Kr(1,1,{generateMipmaps:!0,type:vt.has("EXT_color_buffer_half_float")||vt.has("EXT_color_buffer_float")?Go:vi,minFilter:Yr,samples:4,stencilBuffer:u,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Et.workingColorSpace}));const Me=g.state.transmissionRenderTarget[q.id],be=q.viewport||B;Me.setSize(be.z*C.transmissionResolutionScale,be.w*C.transmissionResolutionScale);const Oe=C.getRenderTarget(),Fe=C.getActiveCubeFace(),rt=C.getActiveMipmapLevel();C.setRenderTarget(Me),C.getClearColor(ue),de=C.getClearAlpha(),de<1&&C.setClearColor(16777215,.5),C.clear(),Rt&&_e.render(te);const it=C.toneMapping;C.toneMapping=vr;const Ve=q.viewport;if(q.viewport!==void 0&&(q.viewport=void 0),g.setupLightsView(q),fe===!0&&Be.setGlobalState(C.clippingPlanes,q),Vi(w,te,q),ot.updateMultisampleRenderTarget(Me),ot.updateRenderTargetMipmap(Me),vt.has("WEBGL_multisampled_render_to_texture")===!1){let ht=!1;for(let ct=0,kt=W.length;ct<kt;ct++){const Ut=W[ct],Ct=Ut.object,Qe=Ut.geometry,Lt=Ut.material,pt=Ut.group;if(Lt.side===Fi&&Ct.layers.test(q.layers)){const en=Lt.side;Lt.side=Nn,Lt.needsUpdate=!0,Yo(Ct,te,q,Qe,Lt,pt),Lt.side=en,Lt.needsUpdate=!0,ht=!0}}ht===!0&&(ot.updateMultisampleRenderTarget(Me),ot.updateRenderTargetMipmap(Me))}C.setRenderTarget(Oe,Fe,rt),C.setClearColor(ue,de),Ve!==void 0&&(q.viewport=Ve),C.toneMapping=it}function Vi(w,W,te){const q=W.isScene===!0?W.overrideMaterial:null;for(let j=0,Me=w.length;j<Me;j++){const be=w[j],Oe=be.object,Fe=be.geometry,rt=be.group;let it=be.material;it.allowOverride===!0&&q!==null&&(it=q),Oe.layers.test(te.layers)&&Yo(Oe,W,te,Fe,it,rt)}}function Yo(w,W,te,q,j,Me){w.onBeforeRender(C,W,te,q,j,Me),w.modelViewMatrix.multiplyMatrices(te.matrixWorldInverse,w.matrixWorld),w.normalMatrix.getNormalMatrix(w.modelViewMatrix),j.onBeforeRender(C,W,te,q,w,Me),j.transparent===!0&&j.side===Fi&&j.forceSinglePass===!1?(j.side=Nn,j.needsUpdate=!0,C.renderBufferDirect(te,W,q,j,w,Me),j.side=xr,j.needsUpdate=!0,C.renderBufferDirect(te,W,q,j,w,Me),j.side=Fi):C.renderBufferDirect(te,W,q,j,w,Me),w.onAfterRender(C,W,te,q,j,Me)}function Jr(w,W,te){W.isScene!==!0&&(W=Tt);const q=Ze.get(w),j=g.state.lights,Me=g.state.shadowsArray,be=j.state.version,Oe=pe.getParameters(w,j.state,Me,W,te),Fe=pe.getProgramCacheKey(Oe);let rt=q.programs;q.environment=w.isMeshStandardMaterial?W.environment:null,q.fog=W.fog,q.envMap=(w.isMeshStandardMaterial?b:zt).get(w.envMap||q.environment),q.envMapRotation=q.environment!==null&&w.envMap===null?W.environmentRotation:w.envMapRotation,rt===void 0&&(w.addEventListener("dispose",He),rt=new Map,q.programs=rt);let it=rt.get(Fe);if(it!==void 0){if(q.currentProgram===it&&q.lightsStateVersion===be)return li(w,Oe),it}else Oe.uniforms=pe.getUniforms(w),w.onBeforeCompile(Oe,C),it=pe.acquireProgram(Oe,Fe),rt.set(Fe,it),q.uniforms=Oe.uniforms;const Ve=q.uniforms;return(!w.isShaderMaterial&&!w.isRawShaderMaterial||w.clipping===!0)&&(Ve.clippingPlanes=Be.uniform),li(w,Oe),q.needsLights=Fl(w),q.lightsStateVersion=be,q.needsLights&&(Ve.ambientLightColor.value=j.state.ambient,Ve.lightProbe.value=j.state.probe,Ve.directionalLights.value=j.state.directional,Ve.directionalLightShadows.value=j.state.directionalShadow,Ve.spotLights.value=j.state.spot,Ve.spotLightShadows.value=j.state.spotShadow,Ve.rectAreaLights.value=j.state.rectArea,Ve.ltc_1.value=j.state.rectAreaLTC1,Ve.ltc_2.value=j.state.rectAreaLTC2,Ve.pointLights.value=j.state.point,Ve.pointLightShadows.value=j.state.pointShadow,Ve.hemisphereLights.value=j.state.hemi,Ve.directionalShadowMap.value=j.state.directionalShadowMap,Ve.directionalShadowMatrix.value=j.state.directionalShadowMatrix,Ve.spotShadowMap.value=j.state.spotShadowMap,Ve.spotLightMatrix.value=j.state.spotLightMatrix,Ve.spotLightMap.value=j.state.spotLightMap,Ve.pointShadowMap.value=j.state.pointShadowMap,Ve.pointShadowMatrix.value=j.state.pointShadowMatrix),q.currentProgram=it,q.uniformsList=null,it}function qo(w){if(w.uniformsList===null){const W=w.currentProgram.getUniforms();w.uniformsList=Cl.seqWithValue(W.seq,w.uniforms)}return w.uniformsList}function li(w,W){const te=Ze.get(w);te.outputColorSpace=W.outputColorSpace,te.batching=W.batching,te.batchingColor=W.batchingColor,te.instancing=W.instancing,te.instancingColor=W.instancingColor,te.instancingMorph=W.instancingMorph,te.skinning=W.skinning,te.morphTargets=W.morphTargets,te.morphNormals=W.morphNormals,te.morphColors=W.morphColors,te.morphTargetsCount=W.morphTargetsCount,te.numClippingPlanes=W.numClippingPlanes,te.numIntersection=W.numClipIntersection,te.vertexAlphas=W.vertexAlphas,te.vertexTangents=W.vertexTangents,te.toneMapping=W.toneMapping}function $o(w,W,te,q,j){W.isScene!==!0&&(W=Tt),ot.resetTextureUnits();const Me=W.fog,be=q.isMeshStandardMaterial?W.environment:null,Oe=X===null?C.outputColorSpace:X.isXRRenderTarget===!0?X.texture.colorSpace:Ws,Fe=(q.isMeshStandardMaterial?b:zt).get(q.envMap||be),rt=q.vertexColors===!0&&!!te.attributes.color&&te.attributes.color.itemSize===4,it=!!te.attributes.tangent&&(!!q.normalMap||q.anisotropy>0),Ve=!!te.morphAttributes.position,ht=!!te.morphAttributes.normal,ct=!!te.morphAttributes.color;let kt=vr;q.toneMapped&&(X===null||X.isXRRenderTarget===!0)&&(kt=C.toneMapping);const Ut=te.morphAttributes.position||te.morphAttributes.normal||te.morphAttributes.color,Ct=Ut!==void 0?Ut.length:0,Qe=Ze.get(q),Lt=g.state.lights;if(fe===!0&&(Ee===!0||w!==A)){const ln=w===A&&q.id===P;Be.setState(q,w,ln)}let pt=!1;q.version===Qe.__version?(Qe.needsLights&&Qe.lightsStateVersion!==Lt.state.version||Qe.outputColorSpace!==Oe||j.isBatchedMesh&&Qe.batching===!1||!j.isBatchedMesh&&Qe.batching===!0||j.isBatchedMesh&&Qe.batchingColor===!0&&j.colorTexture===null||j.isBatchedMesh&&Qe.batchingColor===!1&&j.colorTexture!==null||j.isInstancedMesh&&Qe.instancing===!1||!j.isInstancedMesh&&Qe.instancing===!0||j.isSkinnedMesh&&Qe.skinning===!1||!j.isSkinnedMesh&&Qe.skinning===!0||j.isInstancedMesh&&Qe.instancingColor===!0&&j.instanceColor===null||j.isInstancedMesh&&Qe.instancingColor===!1&&j.instanceColor!==null||j.isInstancedMesh&&Qe.instancingMorph===!0&&j.morphTexture===null||j.isInstancedMesh&&Qe.instancingMorph===!1&&j.morphTexture!==null||Qe.envMap!==Fe||q.fog===!0&&Qe.fog!==Me||Qe.numClippingPlanes!==void 0&&(Qe.numClippingPlanes!==Be.numPlanes||Qe.numIntersection!==Be.numIntersection)||Qe.vertexAlphas!==rt||Qe.vertexTangents!==it||Qe.morphTargets!==Ve||Qe.morphNormals!==ht||Qe.morphColors!==ct||Qe.toneMapping!==kt||Qe.morphTargetsCount!==Ct)&&(pt=!0):(pt=!0,Qe.__version=q.version);let en=Qe.currentProgram;pt===!0&&(en=Jr(q,W,j));let Gi=!1,Sn=!1,yi=!1;const Nt=en.getUniforms(),fn=Qe.uniforms;if(Xe.useProgram(en.program)&&(Gi=!0,Sn=!0,yi=!0),q.id!==P&&(P=q.id,Sn=!0),Gi||A!==w){Xe.buffers.depth.getReversed()?(xe.copy(w.projectionMatrix),p0(xe),m0(xe),Nt.setValue(F,"projectionMatrix",xe)):Nt.setValue(F,"projectionMatrix",w.projectionMatrix),Nt.setValue(F,"viewMatrix",w.matrixWorldInverse);const nn=Nt.map.cameraPosition;nn!==void 0&&nn.setValue(F,Ye.setFromMatrixPosition(w.matrixWorld)),wt.logarithmicDepthBuffer&&Nt.setValue(F,"logDepthBufFC",2/(Math.log(w.far+1)/Math.LN2)),(q.isMeshPhongMaterial||q.isMeshToonMaterial||q.isMeshLambertMaterial||q.isMeshBasicMaterial||q.isMeshStandardMaterial||q.isShaderMaterial)&&Nt.setValue(F,"isOrthographic",w.isOrthographicCamera===!0),A!==w&&(A=w,Sn=!0,yi=!0)}if(j.isSkinnedMesh){Nt.setOptional(F,j,"bindMatrix"),Nt.setOptional(F,j,"bindMatrixInverse");const ln=j.skeleton;ln&&(ln.boneTexture===null&&ln.computeBoneTexture(),Nt.setValue(F,"boneTexture",ln.boneTexture,ot))}j.isBatchedMesh&&(Nt.setOptional(F,j,"batchingTexture"),Nt.setValue(F,"batchingTexture",j._matricesTexture,ot),Nt.setOptional(F,j,"batchingIdTexture"),Nt.setValue(F,"batchingIdTexture",j._indirectTexture,ot),Nt.setOptional(F,j,"batchingColorTexture"),j._colorsTexture!==null&&Nt.setValue(F,"batchingColorTexture",j._colorsTexture,ot));const tn=te.morphAttributes;if((tn.position!==void 0||tn.normal!==void 0||tn.color!==void 0)&&Ie.update(j,te,en),(Sn||Qe.receiveShadow!==j.receiveShadow)&&(Qe.receiveShadow=j.receiveShadow,Nt.setValue(F,"receiveShadow",j.receiveShadow)),q.isMeshGouraudMaterial&&q.envMap!==null&&(fn.envMap.value=Fe,fn.flipEnvMap.value=Fe.isCubeTexture&&Fe.isRenderTargetTexture===!1?-1:1),q.isMeshStandardMaterial&&q.envMap===null&&W.environment!==null&&(fn.envMapIntensity.value=W.environmentIntensity),Sn&&(Nt.setValue(F,"toneMappingExposure",C.toneMappingExposure),Qe.needsLights&&Ko(fn,yi),Me&&q.fog===!0&&oe.refreshFogUniforms(fn,Me),oe.refreshMaterialUniforms(fn,q,k,le,g.state.transmissionRenderTarget[w.id]),Cl.upload(F,qo(Qe),fn,ot)),q.isShaderMaterial&&q.uniformsNeedUpdate===!0&&(Cl.upload(F,qo(Qe),fn,ot),q.uniformsNeedUpdate=!1),q.isSpriteMaterial&&Nt.setValue(F,"center",j.center),Nt.setValue(F,"modelViewMatrix",j.modelViewMatrix),Nt.setValue(F,"normalMatrix",j.normalMatrix),Nt.setValue(F,"modelMatrix",j.matrixWorld),q.isShaderMaterial||q.isRawShaderMaterial){const ln=q.uniformsGroups;for(let nn=0,St=ln.length;nn<St;nn++){const ui=ln[nn];z.update(ui,en),z.bind(ui,en)}}return en}function Ko(w,W){w.ambientLightColor.needsUpdate=W,w.lightProbe.needsUpdate=W,w.directionalLights.needsUpdate=W,w.directionalLightShadows.needsUpdate=W,w.pointLights.needsUpdate=W,w.pointLightShadows.needsUpdate=W,w.spotLights.needsUpdate=W,w.spotLightShadows.needsUpdate=W,w.rectAreaLights.needsUpdate=W,w.hemisphereLights.needsUpdate=W}function Fl(w){return w.isMeshLambertMaterial||w.isMeshToonMaterial||w.isMeshPhongMaterial||w.isMeshStandardMaterial||w.isShadowMaterial||w.isShaderMaterial&&w.lights===!0}this.getActiveCubeFace=function(){return H},this.getActiveMipmapLevel=function(){return I},this.getRenderTarget=function(){return X},this.setRenderTargetTextures=function(w,W,te){const q=Ze.get(w);q.__autoAllocateDepthBuffer=w.resolveDepthBuffer===!1,q.__autoAllocateDepthBuffer===!1&&(q.__useRenderToTexture=!1),Ze.get(w.texture).__webglTexture=W,Ze.get(w.depthTexture).__webglTexture=q.__autoAllocateDepthBuffer?void 0:te,q.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(w,W){const te=Ze.get(w);te.__webglFramebuffer=W,te.__useDefaultFramebuffer=W===void 0};const Zo=F.createFramebuffer();this.setRenderTarget=function(w,W=0,te=0){X=w,H=W,I=te;let q=!0,j=null,Me=!1,be=!1;if(w){const Fe=Ze.get(w);if(Fe.__useDefaultFramebuffer!==void 0)Xe.bindFramebuffer(F.FRAMEBUFFER,null),q=!1;else if(Fe.__webglFramebuffer===void 0)ot.setupRenderTarget(w);else if(Fe.__hasExternalTextures)ot.rebindTextures(w,Ze.get(w.texture).__webglTexture,Ze.get(w.depthTexture).__webglTexture);else if(w.depthBuffer){const Ve=w.depthTexture;if(Fe.__boundDepthTexture!==Ve){if(Ve!==null&&Ze.has(Ve)&&(w.width!==Ve.image.width||w.height!==Ve.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");ot.setupDepthRenderbuffer(w)}}const rt=w.texture;(rt.isData3DTexture||rt.isDataArrayTexture||rt.isCompressedArrayTexture)&&(be=!0);const it=Ze.get(w).__webglFramebuffer;w.isWebGLCubeRenderTarget?(Array.isArray(it[W])?j=it[W][te]:j=it[W],Me=!0):w.samples>0&&ot.useMultisampledRTT(w)===!1?j=Ze.get(w).__webglMultisampledFramebuffer:Array.isArray(it)?j=it[te]:j=it,B.copy(w.viewport),re.copy(w.scissor),Q=w.scissorTest}else B.copy(D).multiplyScalar(k).floor(),re.copy(ee).multiplyScalar(k).floor(),Q=Ne;if(te!==0&&(j=Zo),Xe.bindFramebuffer(F.FRAMEBUFFER,j)&&q&&Xe.drawBuffers(w,j),Xe.viewport(B),Xe.scissor(re),Xe.setScissorTest(Q),Me){const Fe=Ze.get(w.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+W,Fe.__webglTexture,te)}else if(be){const Fe=Ze.get(w.texture),rt=W;F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,Fe.__webglTexture,te,rt)}else if(w!==null&&te!==0){const Fe=Ze.get(w.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,Fe.__webglTexture,te)}P=-1},this.readRenderTargetPixels=function(w,W,te,q,j,Me,be,Oe=0){if(!(w&&w.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Fe=Ze.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&be!==void 0&&(Fe=Fe[be]),Fe){Xe.bindFramebuffer(F.FRAMEBUFFER,Fe);try{const rt=w.textures[Oe],it=rt.format,Ve=rt.type;if(!wt.textureFormatReadable(it)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!wt.textureTypeReadable(Ve)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}W>=0&&W<=w.width-q&&te>=0&&te<=w.height-j&&(w.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+Oe),F.readPixels(W,te,q,j,Re.convert(it),Re.convert(Ve),Me))}finally{const rt=X!==null?Ze.get(X).__webglFramebuffer:null;Xe.bindFramebuffer(F.FRAMEBUFFER,rt)}}},this.readRenderTargetPixelsAsync=async function(w,W,te,q,j,Me,be,Oe=0){if(!(w&&w.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Fe=Ze.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&be!==void 0&&(Fe=Fe[be]),Fe)if(W>=0&&W<=w.width-q&&te>=0&&te<=w.height-j){Xe.bindFramebuffer(F.FRAMEBUFFER,Fe);const rt=w.textures[Oe],it=rt.format,Ve=rt.type;if(!wt.textureFormatReadable(it))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!wt.textureTypeReadable(Ve))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const ht=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,ht),F.bufferData(F.PIXEL_PACK_BUFFER,Me.byteLength,F.STREAM_READ),w.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+Oe),F.readPixels(W,te,q,j,Re.convert(it),Re.convert(Ve),0);const ct=X!==null?Ze.get(X).__webglFramebuffer:null;Xe.bindFramebuffer(F.FRAMEBUFFER,ct);const kt=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await h0(F,kt,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,ht),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,Me),F.deleteBuffer(ht),F.deleteSync(kt),Me}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(w,W=null,te=0){const q=Math.pow(2,-te),j=Math.floor(w.image.width*q),Me=Math.floor(w.image.height*q),be=W!==null?W.x:0,Oe=W!==null?W.y:0;ot.setTexture2D(w,0),F.copyTexSubImage2D(F.TEXTURE_2D,te,0,0,be,Oe,j,Me),Xe.unbindTexture()};const Qo=F.createFramebuffer(),Jo=F.createFramebuffer();this.copyTextureToTexture=function(w,W,te=null,q=null,j=0,Me=null){Me===null&&(j!==0?(Bs("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Me=j,j=0):Me=0);let be,Oe,Fe,rt,it,Ve,ht,ct,kt;const Ut=w.isCompressedTexture?w.mipmaps[Me]:w.image;if(te!==null)be=te.max.x-te.min.x,Oe=te.max.y-te.min.y,Fe=te.isBox3?te.max.z-te.min.z:1,rt=te.min.x,it=te.min.y,Ve=te.isBox3?te.min.z:0;else{const tn=Math.pow(2,-j);be=Math.floor(Ut.width*tn),Oe=Math.floor(Ut.height*tn),w.isDataArrayTexture?Fe=Ut.depth:w.isData3DTexture?Fe=Math.floor(Ut.depth*tn):Fe=1,rt=0,it=0,Ve=0}q!==null?(ht=q.x,ct=q.y,kt=q.z):(ht=0,ct=0,kt=0);const Ct=Re.convert(W.format),Qe=Re.convert(W.type);let Lt;W.isData3DTexture?(ot.setTexture3D(W,0),Lt=F.TEXTURE_3D):W.isDataArrayTexture||W.isCompressedArrayTexture?(ot.setTexture2DArray(W,0),Lt=F.TEXTURE_2D_ARRAY):(ot.setTexture2D(W,0),Lt=F.TEXTURE_2D),F.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,W.flipY),F.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,W.premultiplyAlpha),F.pixelStorei(F.UNPACK_ALIGNMENT,W.unpackAlignment);const pt=F.getParameter(F.UNPACK_ROW_LENGTH),en=F.getParameter(F.UNPACK_IMAGE_HEIGHT),Gi=F.getParameter(F.UNPACK_SKIP_PIXELS),Sn=F.getParameter(F.UNPACK_SKIP_ROWS),yi=F.getParameter(F.UNPACK_SKIP_IMAGES);F.pixelStorei(F.UNPACK_ROW_LENGTH,Ut.width),F.pixelStorei(F.UNPACK_IMAGE_HEIGHT,Ut.height),F.pixelStorei(F.UNPACK_SKIP_PIXELS,rt),F.pixelStorei(F.UNPACK_SKIP_ROWS,it),F.pixelStorei(F.UNPACK_SKIP_IMAGES,Ve);const Nt=w.isDataArrayTexture||w.isData3DTexture,fn=W.isDataArrayTexture||W.isData3DTexture;if(w.isDepthTexture){const tn=Ze.get(w),ln=Ze.get(W),nn=Ze.get(tn.__renderTarget),St=Ze.get(ln.__renderTarget);Xe.bindFramebuffer(F.READ_FRAMEBUFFER,nn.__webglFramebuffer),Xe.bindFramebuffer(F.DRAW_FRAMEBUFFER,St.__webglFramebuffer);for(let ui=0;ui<Fe;ui++)Nt&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,Ze.get(w).__webglTexture,j,Ve+ui),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,Ze.get(W).__webglTexture,Me,kt+ui)),F.blitFramebuffer(rt,it,be,Oe,ht,ct,be,Oe,F.DEPTH_BUFFER_BIT,F.NEAREST);Xe.bindFramebuffer(F.READ_FRAMEBUFFER,null),Xe.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(j!==0||w.isRenderTargetTexture||Ze.has(w)){const tn=Ze.get(w),ln=Ze.get(W);Xe.bindFramebuffer(F.READ_FRAMEBUFFER,Qo),Xe.bindFramebuffer(F.DRAW_FRAMEBUFFER,Jo);for(let nn=0;nn<Fe;nn++)Nt?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,tn.__webglTexture,j,Ve+nn):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,tn.__webglTexture,j),fn?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,ln.__webglTexture,Me,kt+nn):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,ln.__webglTexture,Me),j!==0?F.blitFramebuffer(rt,it,be,Oe,ht,ct,be,Oe,F.COLOR_BUFFER_BIT,F.NEAREST):fn?F.copyTexSubImage3D(Lt,Me,ht,ct,kt+nn,rt,it,be,Oe):F.copyTexSubImage2D(Lt,Me,ht,ct,rt,it,be,Oe);Xe.bindFramebuffer(F.READ_FRAMEBUFFER,null),Xe.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else fn?w.isDataTexture||w.isData3DTexture?F.texSubImage3D(Lt,Me,ht,ct,kt,be,Oe,Fe,Ct,Qe,Ut.data):W.isCompressedArrayTexture?F.compressedTexSubImage3D(Lt,Me,ht,ct,kt,be,Oe,Fe,Ct,Ut.data):F.texSubImage3D(Lt,Me,ht,ct,kt,be,Oe,Fe,Ct,Qe,Ut):w.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,Me,ht,ct,be,Oe,Ct,Qe,Ut.data):w.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,Me,ht,ct,Ut.width,Ut.height,Ct,Ut.data):F.texSubImage2D(F.TEXTURE_2D,Me,ht,ct,be,Oe,Ct,Qe,Ut);F.pixelStorei(F.UNPACK_ROW_LENGTH,pt),F.pixelStorei(F.UNPACK_IMAGE_HEIGHT,en),F.pixelStorei(F.UNPACK_SKIP_PIXELS,Gi),F.pixelStorei(F.UNPACK_SKIP_ROWS,Sn),F.pixelStorei(F.UNPACK_SKIP_IMAGES,yi),Me===0&&W.generateMipmaps&&F.generateMipmap(Lt),Xe.unbindTexture()},this.copyTextureToTexture3D=function(w,W,te=null,q=null,j=0){return Bs('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(w,W,te,q,j)},this.initRenderTarget=function(w){Ze.get(w).__webglFramebuffer===void 0&&ot.setupRenderTarget(w)},this.initTexture=function(w){w.isCubeTexture?ot.setTextureCube(w,0):w.isData3DTexture?ot.setTexture3D(w,0):w.isDataArrayTexture||w.isCompressedArrayTexture?ot.setTexture2DArray(w,0):ot.setTexture2D(w,0),Xe.unbindTexture()},this.resetState=function(){H=0,I=0,X=null,Xe.reset(),st.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ki}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=Et._getDrawingBufferColorSpace(e),n.unpackColorSpace=Et._getUnpackColorSpace()}}function BE(s,e){const{armL:n,armR:r,legL:a,legR:u,armLOL:c,armROL:d,legLOL:h,legROL:m}=e;if(!(!n||!r||!a||!u)){if([n,r,a,u,c,d,h,m].forEach(_=>_?.rotation.set(0,0,0)),n.position.set(-6,12,0),r.position.set(6,12,0),a.position.set(-2,0,0),u.position.set(2,0,0),c?.position.set(-6,12,0),d?.position.set(6,12,0),h?.position.set(-2,0,0),m?.position.set(2,0,0),s==="tpose"){const _=Math.PI/2;n.rotation.z=_,r.rotation.z=-_,c?.rotation.set(0,0,_),d?.rotation.set(0,0,-_)}else if(s==="walking"){const _=-Math.PI/4,v=Math.PI/4;n.rotation.x=_,n.position.z=3,r.rotation.x=v,r.position.z=-3,a.rotation.x=v,a.position.set(a.position.x,1,-4),u.rotation.x=_,u.position.set(u.position.x,1,4),c&&(c.rotation.x=_,c.position.z=3),d&&(d.rotation.x=v,d.position.z=-3),h&&(h.rotation.x=v,h.position.set(h.position.x,1,-4)),m&&(m.rotation.x=_,m.position.set(m.position.x,1,4))}}}const Ml=64;function qn(s,e,n,r,a,u,c,d,h={}){const{transparent:m=!1,expand:_=0}=h,v=new Ys(e+_,n+_,r+_),S=[new mr({transparent:m}),new mr({transparent:m}),new mr({transparent:m}),new mr({transparent:m}),new mr({transparent:m}),new mr({transparent:m})],y=(R,x)=>{const g=s.clone();g.magFilter=Tn,g.minFilter=Tn,g.wrapS=Fo,g.wrapT=Fo,g.repeat.set((x[2]-x[0])/Ml,(x[3]-x[1])/Ml),g.offset.set(x[0]/Ml,1-x[3]/Ml),g.needsUpdate=!0,R.map=g};y(S[0],d.right),y(S[1],d.left),y(S[2],d.top),y(S[3],d.bottom),y(S[4],d.front),y(S[5],d.back);const T=new gi(v,S);return T.position.set(a,u,c),T}const zE={left:[0,8,8,16],right:[16,8,24,16],top:[8,0,16,8],bottom:[16,0,24,8],front:[8,8,16,16],back:[24,8,32,16]},HE={right:[28,20,32,32],left:[16,20,20,32],top:[20,16,28,20],bottom:[28,16,36,20],front:[20,20,28,32],back:[32,20,40,32]},pg={left:[40,20,44,32],right:[48,20,52,32],top:[44,16,48,20],bottom:[48,16,52,20],front:[48,20,44,32],back:[56,20,52,32]},mg={left:[0,20,4,32],right:[8,20,12,32],top:[4,16,8,20],bottom:[8,16,12,20],front:[8,20,4,32],back:[16,20,12,32]},VE={left:[32,8,40,16],right:[48,8,56,16],top:[40,0,48,8],bottom:[48,0,56,8],front:[40,8,48,16],back:[56,8,64,16]},GE={right:[28,36,32,48],left:[16,36,20,48],top:[20,32,28,36],bottom:[28,32,36,36],front:[20,36,28,48],back:[32,36,40,48]},gg={left:[40,36,44,48],right:[48,36,52,48],top:[44,32,48,36],bottom:[48,32,52,36],front:[48,36,44,48],back:[56,36,52,48]},_g={left:[0,36,4,48],right:[8,36,12,48],top:[4,32,8,36],bottom:[8,32,12,36],front:[8,36,4,48],back:[16,36,12,48]},WE={...pg},XE={...mg},jE={...gg},YE={..._g};function qE({texture:s,pose:e="default",showOverlay:n=!0,bottomOffset:r=0,style:a}){const u=Ke.useRef(null),c=Ke.useRef(),d=Ke.useRef(),h=Ke.useRef(0),[m,_]=Ke.useState(0),v=Ke.useRef(null),S=Ke.useRef(null),y=Ke.useRef(null),T=Ke.useRef(null),R=Ke.useRef(null),x=Ke.useRef(null),g=Ke.useRef(null),N=Ke.useRef(null),U=Ke.useRef(null),C=Ke.useRef(null),G=[U,C,R,x,g,N],H=Ke.useCallback(I=>{BE(I,{armL:v.current,armR:S.current,legL:y.current,legR:T.current,armLOL:R.current,armROL:x.current,legLOL:g.current,legROL:N.current})},[]);return Ke.useEffect(()=>{const I=u.current;if(!I)return;const X=I.clientWidth,P=I.clientHeight,A=new kE({antialias:!0,alpha:!0});A.setClearColor(0,0),A.setSize(X,P),I.appendChild(A.domElement),c.current=A;const B=new Kn(52,X/P,.1,1e3);B.position.z=40,d.current=B;const re=new H0,Q=new ex(16777215,1);Q.position.set(10,10,10),re.add(Q);const ue=new No;ue.position.y=-10,ue.rotation.y=h.current,re.add(ue);const de=new K0,ae=s??"/textures/steve.png";de.load(ae,D=>{D.magFilter=Tn,D.minFilter=Tn;const ee=qn(D,8,8,8,0,22,0,zE),Ne=qn(D,8,12,4,0,12,0,HE),Z=qn(D,4,12,4,-6,12,0,WE),fe=qn(D,4,12,4,6,12,0,pg),Ee=qn(D,4,12,4,-2,0,0,XE),xe=qn(D,4,12,4,2,0,0,mg);v.current=Z,S.current=fe,y.current=Ee,T.current=xe;const we=qn(D,8,8,8,0,22,0,VE,{transparent:!0,expand:.5}),Ye=qn(D,8,12,4,0,12,0,GE,{transparent:!0,expand:.5}),ze=qn(D,4,12,4,-6,12,0,jE,{transparent:!0,expand:.5}),Tt=qn(D,4,12,4,6,12,0,gg,{transparent:!0,expand:.5}),Rt=qn(D,4,12,4,-2,0,0,YE,{transparent:!0,expand:.5}),dt=qn(D,4,12,4,2,0,0,_g,{transparent:!0,expand:.5});U.current=we,C.current=Ye,R.current=ze,x.current=Tt,g.current=Rt,N.current=dt,ue.add(ee,Ne,Z,fe,Ee,xe,we,Ye,ze,Tt,Rt,dt),G.forEach(F=>{F.current&&(F.current.visible=n)}),H(e)});let le;const k=()=>{le=requestAnimationFrame(k),ue.rotation.y+=.01,A.render(re,B)};k();const se=()=>{if(I&&c.current&&d.current){const D=I.clientWidth,ee=I.clientHeight;c.current.setSize(D,ee),d.current.aspect=D/ee,d.current.updateProjectionMatrix()}},ie=new ResizeObserver(se);return ie.observe(I),window.addEventListener("resize",se),se(),()=>{window.removeEventListener("resize",se),ie.disconnect(),cancelAnimationFrame(le),h.current=ue.rotation.y,A.dispose(),A.domElement.parentNode&&A.domElement.parentNode.removeChild(A.domElement),I.innerHTML=""}},[s,H]),Ke.useEffect(()=>{H(e)},[e,H]),Ke.useEffect(()=>{G.forEach(I=>{I.current&&(I.current.visible=n)})},[n]),Ke.useEffect(()=>{const I=()=>{const X=u.current?.getBoundingClientRect();if(X){const A=document.documentElement.clientHeight-X.top-r;_(A>0?A:0)}};return I(),window.addEventListener("resize",I),()=>window.removeEventListener("resize",I)},[r]),Ce.jsx("div",{ref:u,style:{width:"100%",minHeight:"200px",height:m?`${m}px`:"100%",position:"relative",...a??{}}})}function $E({texture:s,footerHeight:e}){const[n,r]=Ke.useState("default"),[a,u]=Ke.useState(!0),[c,d]=Ke.useState(0),h=Ke.useRef(null),m=()=>{r(S=>S==="default"?"tpose":S==="tpose"?"walking":"default")},_=()=>{u(S=>!S)},v=()=>{if(!s)return;const S=document.createElement("a");S.href=s,S.download="skin.png",S.click()};return Ke.useEffect(()=>{const S=()=>{const y=h.current?.offsetHeight??0;d(y+e)};return S(),window.addEventListener("resize",S),()=>window.removeEventListener("resize",S)},[e]),Ce.jsxs("section",{className:"mb-4 md:mb-0 md:flex md:flex-col md:h-full p-4",children:[Ce.jsxs("h2",{className:"text-xl font-bold mb-2 text-gray-700 flex items-center",children:[Ce.jsx("i",{className:"fas fa-eye mr-2 text-green-700"})," Preview"]}),Ce.jsx("div",{className:"bg-gray-800 shadow-lg overflow-hidden pixel-border flex-grow h-full max-h-[70dvh] md:max-h-full",children:Ce.jsx("div",{className:"flex justify-center items-center model-placeholder",children:Ce.jsx(qE,{texture:s,pose:n,showOverlay:a,bottomOffset:c})})}),Ce.jsxs("div",{ref:h,className:"mt-4 grid grid-cols-3 gap-2",children:[Ce.jsxs("button",{className:"pixel-button bg-gray-200 hover:bg-gray-300 p-2 pixel-border transition-colors flex items-center justify-center","aria-label":"Change character pose",onClick:m,children:[Ce.jsx("i",{className:"fas fa-arrows-rotate mr-2"}),"Change Pose"]}),Ce.jsxs("button",{className:"pixel-button bg-gray-200 hover:bg-gray-300 p-2 pixel-border transition-colors flex items-center justify-center","aria-label":a?"Hide overlay":"Show overlay",onClick:_,children:[Ce.jsx("i",{className:"fas fa-layer-group mr-2"}),a?"Hide":"Show"," Overlay"]}),Ce.jsxs("button",{className:"pixel-button bg-gray-200 hover:bg-gray-300 p-2 pixel-border transition-colors flex items-center justify-center","aria-label":"Download character skin",onClick:v,children:[Ce.jsx("i",{className:"fas fa-download mr-2"}),"Download"]})]})]})}const KE=Vo.memo(({selectedRace:s,onChange:e,hideLabel:n=!1,className:r})=>{const a=Ke.useCallback(u=>{e?.(u)},[e]);return Ce.jsxs("div",{className:r??"mb-4",role:"group","aria-label":"Select Race",children:[!n&&Ce.jsx("h3",{className:"mb-2 font-semibold",children:"Race"}),Ce.jsx("div",{className:"grid grid-cols-3 gap-2",children:Bm.map(u=>{const c=s===u;return Ce.jsx("button",{type:"button",className:`px-2 py-1 border rounded hover:bg-gray-200${c?" bg-blue-500 text-white":""}`,"aria-pressed":c,onClick:()=>a(u),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),a(u))},children:u},u)})})]})});function ZE({colors:s,selectedColor:e,onChange:n,hideLabel:r=!1,className:a}){return Ce.jsxs("div",{className:a??"mb-4",children:[!r&&Ce.jsx("h3",{className:"mb-2 font-semibold",children:"Skin Color"}),Ce.jsx("div",{className:"flex flex-wrap gap-2",children:s.map(u=>Ce.jsx("button",{type:"button",className:`w-8 h-8 rounded-full border hover:scale-110 transition${e===u?" ring-2 ring-blue-500":""}`,style:{backgroundColor:u},"aria-label":`Kolor skóry ${u}`,onClick:()=>n?.(u)},u))})]})}const vg=["None","Duck"],QE={None:null,Duck:"/textures/hat/duck.png"},JE=Vo.memo(({selectedHat:s,onChange:e,hideLabel:n=!1,className:r})=>{const a=Ke.useCallback(u=>{e?.(u)},[e]);return Ce.jsxs("div",{className:r??"mb-4",role:"group","aria-label":"Select Hat",children:[!n&&Ce.jsx("h3",{className:"mb-2 font-semibold",children:"Hat"}),Ce.jsx("div",{className:"grid grid-cols-3 gap-2",children:vg.map(u=>{const c=s===u;return Ce.jsx("button",{type:"button",className:`px-2 py-1 border rounded hover:bg-gray-200${c?" bg-blue-500 text-white":""}`,"aria-pressed":c,onClick:()=>a(u),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),a(u))},children:u},u)})})]})});function xg(){return Ce.jsx("div",{children:xg.name})}function Sg(){return Ce.jsx("div",{children:Sg.name})}function eT({skinColors:s,selectedSkinColor:e,selectedRace:n,selectedHat:r,onRaceChange:a,onSkinColorChange:u,onHatChange:c}){return Ce.jsxs("section",{className:"overflow-visible md:overflow-y-scroll mb-4 md:mb-0 md:flex md:flex-col md:h-full p-4 customization-panel",children:[Ce.jsxs("h2",{className:"text-xl font-bold mb-2 text-gray-700 flex items-center",children:[Ce.jsx("i",{className:"fas fa-sliders mr-2 text-green-700"})," Customization"]}),Ce.jsxs("div",{className:"space-y-2 options-container",children:[Ce.jsxs("div",{className:"option-card bg-white rounded-lg shadow p-4 pixel-border relative",children:[Ce.jsxs("h3",{className:"font-medium text-gray-700 mb-2 flex items-center absolute -top-3 left-4 px-2 [text-shadow:_1px_1px_0_white,_-1px_-1px_0_white,_1px_-1px_0_white,_-1px_1px_0_white]",children:[Ce.jsx("i",{className:"fas fa-user-tag mr-2 text-amber-600"})," Character Race"]}),Ce.jsx(KE,{selectedRace:n,onChange:a,hideLabel:!0,className:"mt-4"})]}),Ce.jsxs("div",{className:"option-card bg-white rounded-lg shadow p-4 pixel-border relative",children:[Ce.jsxs("h3",{className:"font-medium text-gray-700 mb-2 flex items-center absolute -top-3 left-4 px-2 [text-shadow:_1px_1px_0_white,_-1px_-1px_0_white,_1px_-1px_0_white,_-1px_1px_0_white]",children:[Ce.jsx("i",{className:"fas fa-palette mr-2 text-amber-600"})," Skin Color"]}),Ce.jsx(ZE,{colors:s,selectedColor:e,onChange:u,hideLabel:!0,className:"mt-4"})]}),Ce.jsxs("div",{className:"option-card bg-white rounded-lg shadow p-4 pixel-border relative",children:[Ce.jsxs("h3",{className:"font-medium text-gray-700 mb-2 flex items-center absolute -top-3 left-4 px-2 [text-shadow:_1px_1px_0_white,_-1px_-1px_0_white,_1px_-1px_0_white,_-1px_1px_0_white]",children:[Ce.jsx("i",{className:"fas fa-tshirt mr-2 text-amber-600"})," Hat"]}),Ce.jsx(JE,{selectedHat:r,onChange:c,hideLabel:!0,className:"mt-4"})]}),Ce.jsxs("div",{className:"option-card bg-white rounded-lg shadow p-4 pixel-border relative",children:[Ce.jsxs("h3",{className:"font-medium text-gray-700 mb-2 flex items-center absolute -top-3 left-4 px-2 [text-shadow:_1px_1px_0_white,_-1px_-1px_0_white,_1px_-1px_0_white,_-1px_1px_0_white]",children:[Ce.jsx("i",{className:"fas fa-eye mr-2 text-amber-600"})," Eyes"]}),Ce.jsxs("div",{className:"mt-4",children:[Ce.jsx(xg,{}),Ce.jsx(Sg,{})]})]})]})]})}const tT=["race","hat"],Uo={Human:["#D5BAAA","#E0AC69","#C68642"],Zombie:["#556B2F"],Template:["#FFFFFF"]},nT={Human:"/textures/race/human.png",Zombie:"/textures/race/zombie.png",Template:"/textures/race/template.png"};async function iT(s){const e=s.filter(u=>!!u);if(e.length===0)return"";const n=await Promise.all(e.map(u=>new Promise((c,d)=>{const h=new Image;h.crossOrigin="anonymous",h.onload=()=>c(h),h.onerror=d,h.src=u}))),r=document.createElement("canvas");r.width=n[0].width,r.height=n[0].height;const a=r.getContext("2d");return a?(n.forEach(u=>{a.drawImage(u,0,0)}),r.toDataURL()):""}const rT=Vo.forwardRef((s,e)=>Ce.jsx("footer",{ref:e,className:"bg-gray-800 text-white py-4 px-4",children:Ce.jsxs("div",{className:"container mx-auto text-center text-sm",children:[Ce.jsx("p",{children:"© 2025 SkinCrafter. All rights reserved."}),Ce.jsxs("div",{className:"flex justify-center space-x-4 mt-2",children:[Ce.jsx("a",{href:"#",className:"hover:text-amber-400 transition-colors",children:"Terms"}),Ce.jsx("a",{href:"#",className:"hover:text-amber-400 transition-colors",children:"Privacy"}),Ce.jsx("a",{href:"#",className:"hover:text-amber-400 transition-colors",children:"Contact"})]})]})})),sT=()=>{const[s,e]=Ke.useState("Human"),[n,r]=Ke.useState(Uo.Human[0]),[a,u]=Ke.useState("None"),c=tT,[d,h]=Ke.useState(null),m=Ke.useRef(null),[_,v]=Ke.useState(0);Ke.useEffect(()=>{const x=localStorage.getItem("wardrobeRace");let g="Human";x&&Bm.includes(x)&&(g=x,e(g));const N=localStorage.getItem("wardrobeSkinColor");N&&Uo[g].includes(N)?r(N):r(Uo[g][0]);const U=localStorage.getItem("wardrobeHat");U&&vg.includes(U)&&u(U)},[]);const S=Ke.useMemo(()=>Uo[s],[s]),y=Ke.useCallback(x=>{e(x),r(Uo[x][0])},[]),T=Ke.useCallback(x=>{r(x)},[]),R=Ke.useCallback(x=>{u(x)},[]);return Ke.useEffect(()=>{localStorage.setItem("wardrobeRace",s)},[s]),Ke.useEffect(()=>{localStorage.setItem("wardrobeSkinColor",n)},[n]),Ke.useEffect(()=>{localStorage.setItem("wardrobeHat",a)},[a]),Ke.useEffect(()=>{const x=()=>{v(m.current?.offsetHeight??0)};return x(),window.addEventListener("resize",x),()=>window.removeEventListener("resize",x)},[]),Ke.useEffect(()=>{const x=[];c.forEach(g=>{g==="race"?x.push(nT[s]):g==="hat"&&x.push(QE[a])}),iT(x).then(g=>h(g))},[s,a]),Ce.jsxs("div",{className:"max-w-full min-h-dvh md:h-screen overflow-x-visible overflow-y-auto flex flex-col",children:[Ce.jsx(Mv,{}),Ce.jsxs("div",{className:"flex-1 flex flex-col md:flex-row",children:[Ce.jsx("div",{className:"flex-1 w-full md:w-1/2",children:Ce.jsx($E,{texture:d,footerHeight:_})}),Ce.jsx("div",{className:"flex-1 w-full md:w-1/2",children:Ce.jsx(eT,{skinColors:S,selectedSkinColor:n,selectedRace:s,selectedHat:a,onRaceChange:y,onSkinColorChange:T,onHatChange:R})})]}),Ce.jsx(rT,{ref:m})]})};uv.createRoot(document.getElementById("root")).render(Ce.jsx(Vo.StrictMode,{children:Ce.jsx(yv,{children:Ce.jsx(sT,{})})}));
